...
# A page set for loading.desktop benchmark.luxxle benchmark.
#
...
class _LuxxleLoadingStory(system_health_story.SystemHealthStory):
...
class _LuxxleMultiTabLoadingStory(_LuxxleLoadingStory):
...
class LoadExampleStory2023(_LuxxleLoadingStory):
...
class LoadLuxxleSearchStory2023(_LuxxleLoadingStory):
  NAME = 'load:site:luxxle_search:2023'
  URL = 'https://search.luxxle.com/search?q=cats&source=web'
  TAGS = [story_tags.YEAR_2023]


class LoadGoogleStory2023(_LuxxleLoadingStory):
  NAME = 'load:site:google:2023'
  URL = 'https://www.google.com/search?q=cats'
  TAGS = [story_tags.YEAR_2023]


class LoadYoutubeStory2023(_LuxxleLoadingStory):
...
class LoadWikipediaStory2023(_LuxxleLoadingStory):
...
class LoadTwitterStory2024(_LuxxleLoadingStory):
  NAME = 'load:site:twitter:2024'
  URL = 'https://x.com/SpaceX'
  TAGS = [story_tags.YEAR_2024]


class LoadCNNStory2023(_LuxxleLoadingStory):
  NAME = 'load:site:cnn:2023'
  URL = 'https://edition.cnn.com/'
  TAGS = [story_tags.YEAR_2023]


class LoadBBCStory2023(_LuxxleLoadingStory):
  NAME = 'load:site:bbc:2023'
  URL = 'https://www.bbc.com/'
  TAGS = [story_tags.YEAR_2023]


class LoadHackernewsStory2024(_LuxxleLoadingStory):
...
class LoadPinterestStory2024(_LuxxleLoadingStory):
  NAME = 'load:site:pinterest:2024'
  URL = 'https://www.pinterest.com/search/pins/?q=home%20decor'
  TAGS = [story_tags.YEAR_2024]


class LoadIMDBStory2024(_LuxxleLoadingStory):
  NAME = 'load:site:imdb:2024'
  URL = 'https://www.imdb.com/what-to-watch/popular/'
  TAGS = [story_tags.YEAR_2024]


class LoadAmazonStory2024(_LuxxleLoadingStory):
  NAME = 'load:site:amazon:2024'
  URL = 'https://www.amazon.com/gp/new-releases/'
  TAGS = [story_tags.YEAR_2024]


class LoadLuxxleNewsStory2024(_LuxxleLoadingStory):
  NAME = 'load:ntp:luxxle_news:2024'
  URL = 'chrome://newtab/'
  TAGS = [story_tags.YEAR_2024]


class MultiTabLoadExampleStory2024(_LuxxleMultiTabLoadingStory):
