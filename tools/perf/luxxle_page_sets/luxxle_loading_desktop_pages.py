...
class LuxxleLoadingDesktopStorySet(story.StorySet):
  """ Luxxle version of LoadingDesktopStorySet.

  See loading_desktop.py for details.
  """

  def __init__(self, startup_delay=False):
    archive_data_file = GetPageSetsDataPath('luxxle_loading_desktop.json')
    ...
    self.AddStories(['typical'],
                    [('https://example.com/', 'example.com'),
                     ('https://search.luxxle.com/', 'LuxxleSearch'),
