...
constexpr char kLuxxleOriginTrialsPublicKey[] =
...
base::LazyInstance<LuxxleContentRendererClient>::DestructorAtExit
    g_luxxle_content_renderer_client = LAZY_INSTANCE_INITIALIZER;
base::LazyInstance<LuxxleContentUtilityClient>::DestructorAtExit
    g_luxxle_content_utility_client = LAZY_INSTANCE_INITIALIZER;
#endif
#if !defined(CHROME_MULTIPLE_DLL_CHILD)
base::LazyInstance<LuxxleContentBrowserClient>::DestructorAtExit
    g_luxxle_content_browser_client = LAZY_INSTANCE_INITIALIZER;
#endif

#if BUILDFLAG(IS_ANDROID)
LuxxleMainDelegate::LuxxleMainDelegate() : ChromeMainDelegate() {}
#endif
...
content::ContentBrowserClient* LuxxleMainDelegate::CreateContentBrowserClient() {
  ...
  if (chrome_content_browser_client_ == nullptr) {
    chrome_content_browser_client_ =
        std::make_unique<LuxxleContentBrowserClient>();
  }
...
LuxxleMainDelegate::CreateContentRendererClient() {
#if defined(CHROME_MULTIPLE_DLL_BROWSER)
  return NULL;
#else
  return g_luxxle_content_renderer_client.Pointer();
#endif
}
...
content::ContentUtilityClient* LuxxleMainDelegate::CreateContentUtilityClient() {
  ...
  return NULL;
#else
  return g_luxxle_content_utility_client.Pointer();
#endif
}

// static
void LuxxleMainDelegate::AppendCommandLineOptions() {
  ...
  if (!base::CommandLine::ForCurrentProcess()->HasSwitch(
    ...
    command_line->AppendSwitchASCII(embedder_support::kOriginTrialPublicKey,
                                    kLuxxleOriginTrialsPublicKey);
  }

  std::string luxxle_sync_service_url = BUILDFLAG(LUXXLE_SYNC_ENDPOINT);
...
std::optional<int> LuxxleMainDelegate::BasicStartupComplete() {
  LuxxleMainDelegate::AppendCommandLineOptions();
  return ChromeMainDelegate::BasicStartupComplete();
}

void LuxxleMainDelegate::PreSandboxStartup() {
...
std::optional<int> LuxxleMainDelegate::PostEarlyInitialization(
