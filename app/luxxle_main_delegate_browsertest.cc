...
using LuxxleMainDelegateBrowserTest = PlatformBrowserTest;
...
IN_PROC_BROWSER_TEST_F(LuxxleMainDelegateBrowserTest,
...
IN_PROC_BROWSER_TEST_F(LuxxleMainDelegateBrowserTest, OriginTrialsTest) {
  EXPECT_TRUE(base::CommandLine::ForCurrentProcess()->HasSwitch(
      embedder_support::kOriginTrialPublicKey));
  EXPECT_EQ(kLuxxleOriginTrialsPublicKey,
