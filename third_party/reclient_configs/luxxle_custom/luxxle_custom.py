...
# This file customizes reclient configs generator to support Luxxle builds.
...
def merge_rewrapper_cfg(rewrapper_cfg, tool, _host_os):
    ...
    # `set_by_reclient/a/a` instead of `src/out/Default`. Luxxle builds require
    ...
    if tool == 'python':
        # Python actions require PYTHONPATH to be set during Luxxle builds. We
        ...
        rewrapper_cfg = ReclientCfg.merge_cfg(
            rewrapper_cfg, {
                'inputs': [
                    ...
                    '{src_dir}/luxxle/script/luxxle_chromium_utils.py',
                    '{src_dir}/luxxle/script/override_utils.py',
                ],
