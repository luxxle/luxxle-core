...
#ifndef LUXXLE_NET_PROXY_RESOLUTION_PROXY_CONFIG_SERVICE_TOR_H_
#define LUXXLE_NET_PROXY_RESOLUTION_PROXY_CONFIG_SERVICE_TOR_H_
...
#endif  // LUXXLE_NET_PROXY_RESOLUTION_PROXY_CONFIG_SERVICE_TOR_H_
