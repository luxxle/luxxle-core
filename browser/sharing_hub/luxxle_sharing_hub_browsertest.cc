...
using LuxxleSharingHubTest = InProcessBrowserTest;

namespace sharing_hub {

IN_PROC_BROWSER_TEST_F(LuxxleSharingHubTest, SharingHubIconVisibility) {
...
IN_PROC_BROWSER_TEST_F(LuxxleSharingHubTest, CopyCommandsOrder) {
  views::View* sharing_hub_icon =
      BrowserView::GetBrowserViewForBrowser(browser())
          ->toolbar_button_provider()
          ->GetPageActionIconView(PageActionIconType::kSharingHub);
