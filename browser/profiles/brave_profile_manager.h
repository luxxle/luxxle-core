...
#ifndef LUXXLE_BROWSER_PROFILES_BRAVE_PROFILE_MANAGER_H_
#define LUXXLE_BROWSER_PROFILES_BRAVE_PROFILE_MANAGER_H_
...
#endif  // LUXXLE_BROWSER_PROFILES_BRAVE_PROFILE_MANAGER_H_
