...
class LuxxlePolicyTest : public InProcessBrowserTest {
 protected:
  LuxxlePolicyTest() = default;
  ~LuxxlePolicyTest() override = default;
...
class TorDisabledPolicyBrowserTest : public LuxxlePolicyTest {
 public:
  TorDisabledPolicyBrowserTest() = default;
  ~TorDisabledPolicyBrowserTest() override = default;

  void SetUpInProcessBrowserTestFixture() override {
    LuxxlePolicyTest::SetUpInProcessBrowserTestFixture();
...
class TorEnabledPolicyBrowserTest : public LuxxlePolicyTest {
 public:
...
class BrowserAddPersonPolicyTest : public LuxxlePolicyTest {
 public:
...
template <bool enable>
class BrowserGuestModePolicyTest : public LuxxlePolicyTest {
 public:
