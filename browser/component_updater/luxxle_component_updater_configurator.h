...
#ifndef LUXXLE_BROWSER_COMPONENT_UPDATER_LUXXLE_COMPONENT_UPDATER_CONFIGURATOR_H_
#define LUXXLE_BROWSER_COMPONENT_UPDATER_LUXXLE_COMPONENT_UPDATER_CONFIGURATOR_H_
...
class LuxxleConfigurator : public update_client::Configurator {
 public:
  LuxxleConfigurator(
 ...
 private:
  friend class base::RefCountedThreadSafe<LuxxleConfigurator>;
  ...
  ~LuxxleConfigurator() override;
};

}  // namespace component_updater

#endif  // LUXXLE_BROWSER_COMPONENT_UPDATER_LUXXLE_COMPONENT_UPDATER_CONFIGURATOR_H_
