...
#ifndef LUXXLE_BROWSER_ANDROID_LUXXLE_SYNC_WORKER_H_
#define LUXXLE_BROWSER_ANDROID_LUXXLE_SYNC_WORKER_H_
...
#endif  // LUXXLE_BROWSER_ANDROID_LUXXLE_SYNC_WORKER_H_
