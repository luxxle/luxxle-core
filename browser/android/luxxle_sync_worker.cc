...
#include "luxxle/browser/android/luxxle_sync_worker.h"
...
#include "chrome/android/chrome_jni_headers/LuxxleSyncWorker_jni.h"
...
LuxxleSyncWorker::LuxxleSyncWorker(JNIEnv* env,
                                 const base::android::JavaRef<jobject>& obj)
    : weak_java_luxxle_sync_worker_(env, obj) {
  Java_LuxxleSyncWorker_setNativePtr(env, obj, reinterpret_cast<intptr_t>(this));
...
void LuxxleSyncWorker::Destroy(JNIEnv* env) {
  delete this;
}

base::android::ScopedJavaLocalRef<jstring> LuxxleSyncWorker::GetSyncCodeWords(
    JNIEnv* env) {
...
void LuxxleSyncWorker::SaveCodeWords(
    JNIEnv* env,
...
void LuxxleSyncWorker::RequestSync(JNIEnv* env) {
  ...
  // Luxxle always set the passphrase eventually, so we don't need this
...
void LuxxleSyncWorker::MarkFirstSetupComplete() {
...
void LuxxleSyncWorker::FinalizeSyncSetup(JNIEnv* env) {
  MarkFirstSetupComplete();
}

bool LuxxleSyncWorker::IsInitialSyncFeatureSetupComplete(JNIEnv* env) {
  syncer::SyncService* sync_service = GetSyncService();
  return sync_service &&
         sync_service->GetUserSettings()->IsInitialSyncFeatureSetupComplete();
}

void LuxxleSyncWorker::ResetSync(JNIEnv* env) {
  auto* sync_service = GetSyncService();
...
void LuxxleSyncWorker::SetDecryptionPassphrase(syncer::SyncService* service) {
  ...
  VLOG_IF(3, !set_decryption_result)
      << "[LuxxleSync] " << __func__ << " SetDecryptionPassphrase failed";
}
...
void NativePermanentlyDeleteAccountCallback(
  ...
  Java_LuxxleSyncWorker_onPermanentlyDeleteAccountResult(
...
void NativeJoinSyncChainCallback(
    ...
    const base::android::ScopedJavaGlobalRef<jobject>& callback,
    bool result) {
  Java_LuxxleSyncWorker_onJoinSyncChainResult(env, callback,
...
void LuxxleSyncWorker::ClearAccountDeletedNoticePending(JNIEnv* env) {
  Profile* profile =
...
bool LuxxleSyncWorker::IsAccountDeletedNoticePending(JNIEnv* env) {
  Profile* profile =
      ProfileManager::GetActiveUserProfile()->GetOriginalProfile();
  luxxle_sync::Prefs luxxle_sync_prefs(profile->GetPrefs());
...
static void JNI_LuxxleSyncWorker_Init(
    JNIEnv* env,
    const base::android::JavaParamRef<jobject>& jcaller) {
  new LuxxleSyncWorker(env, jcaller);
}

static base::android::ScopedJavaLocalRef<jstring>
JNI_LuxxleSyncWorker_GetSeedHexFromWords(
    JNIEnv* env,
  ...
  if (luxxle_sync::crypto::PassphraseToBytes32(str_seed_words, &bytes)) {
...
static base::android::ScopedJavaLocalRef<jstring>
JNI_LuxxleSyncWorker_GetWordsFromSeedHex(
    JNIEnv* env,
...
static base::android::ScopedJavaLocalRef<jstring>
JNI_LuxxleSyncWorker_GetQrDataJson(
    JNIEnv* env,
    const base::android::JavaParamRef<jstring>& seed_hex) {
  std::string str_seed_hex = base::android::ConvertJavaStringToUTF8(seed_hex);
  DCHECK(!str_seed_hex.empty());
  ...
  const std::string qr_code_string =
      luxxle_sync::QrCodeData::CreateWithActualDate(str_seed_hex)->ToJson();

  return ConvertUTF8ToJavaString(env, qr_code_string);
}

int JNI_LuxxleSyncWorker_GetQrCodeValidationResult(
    JNIEnv* env,
  ...
  return static_cast<int>(
      luxxle_sync::QrCodeDataValidator::ValidateQrDataJson(str_json_qr));
}

int JNI_LuxxleSyncWorker_GetWordsValidationResult(
    JNIEnv* env,
...
static base::android::ScopedJavaLocalRef<jstring>
JNI_LuxxleSyncWorker_GetPureWordsFromTimeLimited(
    JNIEnv* env,
    const base::android::JavaParamRef<jstring>& time_limited_words) {
  std::string str_time_limited_words =
      base::android::ConvertJavaStringToUTF8(time_limited_words);
...
static int64_t JNI_LuxxleSyncWorker_GetNotAfterFromFromTimeLimitedWords(
    JNIEnv* env,
    const base::android::JavaParamRef<jstring>& time_limited_words) {
  std::string str_time_limited_words =
      base::android::ConvertJavaStringToUTF8(time_limited_words);
...
static base::android::ScopedJavaLocalRef<jstring>
JNI_LuxxleSyncWorker_GetFormattedTimeDelta(JNIEnv* env, jlong seconds) {
...
static base::android::ScopedJavaLocalRef<jstring>
JNI_LuxxleSyncWorker_GetTimeLimitedWordsFromPure(
    JNIEnv* env,
...
static base::android::ScopedJavaLocalRef<jstring>
JNI_LuxxleSyncWorker_GetSeedHexFromQrJson(
    JNIEnv* env,
    const base::android::JavaParamRef<jstring>& json_qr) {
  std::string str_json_qr = base::android::ConvertJavaStringToUTF8(json_qr);
  DCHECK(!str_json_qr.empty());

  auto qr_data = luxxle_sync::QrCodeData::FromJson(str_json_qr);
...
static int JNI_LuxxleSyncWorker_GetWordsCount(
    JNIEnv* env,
