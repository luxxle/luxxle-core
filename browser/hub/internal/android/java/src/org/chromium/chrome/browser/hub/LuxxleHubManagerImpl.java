...
/**
 * Luxxle's extension of {@link HubManagerImpl}. We need it to adjust bottom margin for the bottom
 * toolbar, when it is visible.
 */
public class LuxxleHubManagerImpl extends HubManagerImpl {
    private Activity mActivity;
    private int mBottomToolbarHeight;
    private boolean mIsTablet;
    private ComponentCallbacks mComponentCallbacks;

    public LuxxleHubManagerImpl(
    ...
    private void maybeUpdateBottomMarginForContainerView() {
        ...
        //      base.LuxxleReflectionUtil.invokeMethod
        //      browser.hub.LuxxleHubManagerImpl.maybeUpdateBottomMarginForContainerView
    ...
    private boolean isToolbarBottomAnchored() {
        return !ContextUtils.getAppSharedPreferences()
                .getBoolean(LuxxlePreferenceKeys.LUXXLE_TOOLBAR_TOP_ANCHORED, true);
    }
}
