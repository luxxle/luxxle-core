...
/**
 * Luxxle's extension for {@link HubToolbarView}. Here we control what elements should be visible in
 * tab switcher mode when bottom toolbar is visible.
 */
public class LuxxleHubToolbarView extends HubToolbarView {
    private Button mActionButton;
    private FrameLayout mMenuButton;

    public LuxxleHubToolbarView(Context context, AttributeSet attributeSet) {
    ...
    private void updateButtonsVisibility() {
        boolean shouldHideButtons =
                ContextUtils.getAppSharedPreferences()
                        ...
                        && ContextUtils.getAppSharedPreferences()
                                .getBoolean(LuxxlePreferenceKeys.LUXXLE_IS_MENU_FROM_BOTTOM, true);
