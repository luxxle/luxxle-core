...
#ifndef LUXXLE_BROWSER_DOWNLOAD_LUXXLE_DOWNLOAD_ITEM_MODEL_H_
#define LUXXLE_BROWSER_DOWNLOAD_LUXXLE_DOWNLOAD_ITEM_MODEL_H_
...
// extended functionality, LuxxleDownloadItemView will have this model as
// a member.
class DownloadUIModel;

class LuxxleDownloadItemModel {
 public:
  // Constructs a LuxxleDownloadItemModel that encapsulates DownloadItemModel.
  explicit LuxxleDownloadItemModel(DownloadUIModel* model);
  LuxxleDownloadItemModel(const LuxxleDownloadItemModel&) = delete;
  LuxxleDownloadItemModel& operator=(const LuxxleDownloadItemModel&) = delete;
  ~LuxxleDownloadItemModel();
...
#endif  // LUXXLE_BROWSER_DOWNLOAD_LUXXLE_DOWNLOAD_ITEM_MODEL_H_
