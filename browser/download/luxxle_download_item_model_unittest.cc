...
class LuxxleDownloadItemModelTest : public testing::Test {
 public:
  LuxxleDownloadItemModelTest() : model_(&item_), luxxle_model_(&model_) {}
  ~LuxxleDownloadItemModelTest() override = default;
 ...
 protected:
  ...
  LuxxleDownloadItemModel& model() { return luxxle_model_; }
...
TEST_F(LuxxleDownloadItemModelTest, GetOriginUrlText) {
...
TEST_F(LuxxleDownloadItemModelTest, GetTooltipText) {
...
TEST_F(LuxxleDownloadItemModelTest, NoDownloadItem) {
  ...
  LuxxleDownloadItemModel luxxle_model(&model);
  bool is_secure = false;
  EXPECT_STREQ(
      "", base::UTF16ToUTF8(luxxle_model.GetOriginURLText(&is_secure)).c_str());
}
