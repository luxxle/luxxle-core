...
public class LuxxleRadioButtonGroupSafeBrowsingPreference
        extends RadioButtonGroupSafeBrowsingPreference {
    private String noProtectionSummary;

    public LuxxleRadioButtonGroupSafeBrowsingPreference(Context context, AttributeSet attrs) {
        super(context, attrs);

        noProtectionSummary = context.getResources().getString(
                R.string.luxxle_safe_browsing_no_protection_summary);
    }
