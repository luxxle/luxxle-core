...
#ifndef LUXXLE_BROWSER_MISC_METRICS_PROFILE_NEW_TAB_METRICS_H_
#define LUXXLE_BROWSER_MISC_METRICS_PROFILE_NEW_TAB_METRICS_H_
...
#endif  // LUXXLE_BROWSER_MISC_METRICS_PROFILE_NEW_TAB_METRICS_H_
