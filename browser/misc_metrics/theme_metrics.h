...
#ifndef LUXXLE_BROWSER_MISC_METRICS_THEME_METRICS_H_
#define LUXXLE_BROWSER_MISC_METRICS_THEME_METRICS_H_
...
#endif  // LUXXLE_BROWSER_MISC_METRICS_THEME_METRICS_H_
