...
const localeStrings: Record<StringKey, string>  = {
  ...
  luxxleBackgroundLabel: 'Luxxle backgrounds',
  ...
  newsEnableButtonLabel: 'Turn on Luxxle News',
  newsEnableText: 'Turn on Luxxle News, and never miss a story',
  ...
  rewardsFeatureText1: 'Get paid for private ads you see in Luxxle',
  rewardsFeatureText2: 'Get special benefits and discounts',
  rewardsOnboardingButtonLabel: 'Start using Luxxle Rewards',
  ...
  searchBoxPlaceholderTextLuxxle: 'Ask Luxxle Search',
  ...
  showRewardsWidgetLabel: 'Luxxle Rewards',
  showSearchBoxLabel: 'Show search widget in new tabs',
  showSponsoredImagesEarningText: 'With $1Luxxle Rewards$2, you can earn for seeing new tab page ads.',
  showSponsoredImagesLabel: 'Show new tab page ads',
  showStatsLabel: 'Luxxle Stats',
  showTalkWidgetLabel: 'Luxxle Talk',
  showTopSitesLabel: 'Show top sites',
  showVpnWidgetLabel: 'Luxxle VPN',
  ...
  statsTitle: 'STATS',
  talkDescriptionText: 'Encrypted video calls with Luxxle Talk.',
