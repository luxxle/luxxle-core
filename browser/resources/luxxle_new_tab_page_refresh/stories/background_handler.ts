...
const sampleBackground =
    'https://luxxle.com/static-assets/images/luxxle-logo-sans-text.svg'
...
const sponsoredBackgrounds: Record<string, SponsoredImageBackground | null> = {
  image: {
    ...
    logo: {
      alt: 'Be Luxxle!',
      destinationUrl: 'https://luxxle.com',
      imageUrl: sampleBackground
    },
...
export function createBackgroundHandler(
  ...
  store.update({
    ...
    sponsoredRichMediaBaseUrl: 'https://luxxle.com'
  })
