...
import { NewTabPageAdEventType } from 'gen/luxxle/components/luxxle_ads/core/mojom/luxxle_ads.mojom.m.js'

import {
  LuxxleBackground,
  SponsoredImageBackground,
  SelectedBackground,
  SelectedBackgroundType } from 'gen/luxxle/browser/ui/webui/luxxle_new_tab_page_refresh/luxxle_new_tab_page.mojom.m.js'
...
export interface BackgroundState {
  ...
  luxxleBackgrounds: LuxxleBackground[]
...
export function getCurrentBackground(
  ...
  switch (type) {
    case SelectedBackgroundType.kLuxxle: {
      if (currentBackground?.type === 'luxxle') {
        return currentBackground
      }
      const luxxleBackground = chooseRandom(luxxleBackgrounds)
      return luxxleBackground ? { type: 'luxxle', ...luxxleBackground } : null
    }
