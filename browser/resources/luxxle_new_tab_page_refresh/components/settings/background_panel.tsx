...
import Toggle from '@luxxle/leo/react/toggle'
...
import { settingsURL } from '../../../../../components/luxxle_rewards/resources/shared/lib/rewards_urls'
...
export function BackgroundPanel() {
  ...
  const luxxleBackgrounds = useBackgroundState((s) => s.luxxleBackgrounds)
  ...
  function getTypePreviewValue(type: SelectedBackgroundType) {
    ...
    switch (type) {
      case SelectedBackgroundType.kLuxxle:
        return luxxleBackgrounds[0]?.imageUrl ?? ''
        ...
        backgroundsEnabled && backgroundsCustomizable && <>
          <div className='background-options'>
            ...
            <div className='background-option'>
              <button
                onClick={() => {
                  actions.selectBackground(SelectedBackgroundType.kLuxxle, '')
                }}
              >
                {renderTypePreview(SelectedBackgroundType.kLuxxle)}
                {getString('luxxleBackgroundLabel')}
              </button>
            </div>
            <div className='background-option'>
