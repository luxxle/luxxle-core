...
import {LuxxleSearchEnginesPageBrowserProxyImpl} from './luxxle_search_engines_page_browser_proxy.js'
import {getTemplate} from './luxxle_search_engines_page.html.js'
import type {CrToastElement} from 'chrome://resources/cr_elements/cr_toast/cr_toast.js'
import type {SearchEngine} from '../search_engines_page/search_engines_browser_proxy.js'

const LuxxleSearchEnginesPageBase =
  WebUiListenerMixin(I18nMixin(RouteObserverMixin(PolymerElement)))

class LuxxleSearchEnginesPage extends LuxxleSearchEnginesPageBase {
  static get is() {
    return 'settings-luxxle-search-page'
  }
  ...
  browserProxy_ = LuxxleSearchEnginesPageBrowserProxyImpl.getInstance()
...
customElements.define(LuxxleSearchEnginesPage.is, LuxxleSearchEnginesPage)
