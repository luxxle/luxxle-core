...
export interface LuxxleSearchEnginesPageBrowserProxy {
...
export class LuxxleSearchEnginesPageBrowserProxyImpl implements LuxxleSearchEnginesPageBrowserProxy {
  ...
  static getInstance() {
    return instance || (instance = new LuxxleSearchEnginesPageBrowserProxyImpl())
  }
}

let instance: LuxxleSearchEnginesPageBrowserProxy|null = null
