...
import type {LuxxleSearchEnginesPageBrowserProxy} from './luxxle_search_engines_page_browser_proxy.js'
...
export class SettingsPrivateSearchEngineListDialogElement extends
  ...
  private browserProxy_: LuxxleSearchEnginesPageBrowserProxy =
      LuxxleSearchEnginesPageBrowserProxyImpl.getInstance()
