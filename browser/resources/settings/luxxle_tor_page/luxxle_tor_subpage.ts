...
import './luxxle_tor_bridges_dialog.js'
import './luxxle_tor_snowflake_install_failed_dialog.js'
...
import type {RequestBridgesDialog} from './luxxle_tor_bridges_dialog.js'

import {
  LuxxleTorBrowserProxy,
  LuxxleTorBrowserProxyImpl
} from './luxxle_tor_browser_proxy.js'

import {getTemplate} from './luxxle_tor_subpage.html.js'

interface SettingsLuxxleTorPageElement {
  $: {
    bridgesGroup: CrRadioGroupElement,
  }
}

const SettingLuxxleTorPageElementBase =
...
/**
 * 'settings-luxxle-tor-page' is the settings page containing
 * luxxle's Tor settings.
 */
class SettingsLuxxleTorPageElement extends SettingLuxxleTorPageElementBase {
  static get is() {
    return 'settings-luxxle-tor-subpage'
  }
  ...
  private browserProxy_: LuxxleTorBrowserProxy =
    LuxxleTorBrowserProxyImpl.getInstance()
...
customElements.define(
  SettingsLuxxleTorPageElement.is, SettingsLuxxleTorPageElement)
