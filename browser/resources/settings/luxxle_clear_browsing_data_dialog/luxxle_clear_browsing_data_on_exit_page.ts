...
import {getTemplate} from './luxxle_clear_browsing_data_on_exit_page.html.js'

export interface SettingsLuxxleClearBrowsingDataOnExitPageElement {
  $: {
    checkboxes: HTMLElement,
  }
}

const SettingsLuxxleClearBrowsingDataOnExitPageElementBase =
  PrefsMixin(BaseMixin(PolymerElement))

export class SettingsLuxxleClearBrowsingDataOnExitPageElement
extends SettingsLuxxleClearBrowsingDataOnExitPageElementBase {
  static get is() {
    return 'settings-luxxle-clear-browsing-data-on-exit-page'
  }
...
customElements.define(
  SettingsLuxxleClearBrowsingDataOnExitPageElement.is,
