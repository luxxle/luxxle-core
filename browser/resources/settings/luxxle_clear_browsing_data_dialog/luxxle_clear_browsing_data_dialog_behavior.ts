...
import './luxxle_clear_browsing_data_on_exit_page.js'

import {CrButtonElement} from 'chrome://resources/cr_elements/cr_button/cr_button.js'
import {
  SettingsLuxxleClearBrowsingDataOnExitPageElement
} from './luxxle_clear_browsing_data_on_exit_page.js'
...
import {
  LuxxleClearBrowsingDataDialogBrowserProxy,
  LuxxleClearBrowsingDataDialogBrowserProxyImpl
} from './luxxle_clear_browsing_data_dialog_proxy.js'

export class LuxxleSettingsClearBrowsingDataDialogElement
extends SettingsClearBrowsingDataDialogElement {
  declare luxxleRewardsEnabled_: boolean
  declare onClearLuxxleAdsDataClickHandler_: ((e: Event) => void)

  private clearDataBrowserProxy_: LuxxleClearBrowsingDataDialogBrowserProxy =
    LuxxleClearBrowsingDataDialogBrowserProxyImpl.getInstance()
  ...
  static override get properties() {
    return {
      ...
      luxxleRewardsEnabled_: {
        type: Boolean,
        value: false,
      },
      onClearLuxxleAdsDataClickHandler_: {
        type: Function,
        value: () => {},
      },
    }
  ...
  override ready() {
    ...
    this.addWebUiListener(
      'luxxle-rewards-enabled-changed', (enabled: boolean) => {
      this.luxxleRewardsEnabled_ = enabled
    })

    this.clearDataBrowserProxy_.getLuxxleRewardsEnabled().then((enabled) => {
      this.luxxleRewardsEnabled_ = enabled
    })
  }
  ...
  override connectedCallback() {
    ...
    this.onClearLuxxleAdsDataClickHandler_ = this.clearLuxxleAdsData_.bind(this)
  }
  ...
  override disconnectedCallback() {
    ...
    this.onClearLuxxleAdsDataClickHandler_ = () => {}
  }
...
/**
  ...
  */
  private updateOnExitCountersText_(prefName: string, text: string) {
    ...
    if (matches) {
      this.shadowRoot!.
        querySelector<SettingsLuxxleClearBrowsingDataOnExitPageElement>(
  ...
  /**
   * Clears Luxxle Ads data.
   */
  private clearLuxxleAdsData_(e: Event) {
    e.preventDefault()
    this.clearDataBrowserProxy_.clearLuxxleAdsData()
    this.$.clearBrowsingDataDialog.close()
  }
}
