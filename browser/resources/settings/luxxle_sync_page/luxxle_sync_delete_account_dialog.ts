...
import {getTemplate} from './luxxle_sync_delete_account_dialog.html.js'

/**
 * @fileoverview
 * 'settings-luxxle-sync-delete-account-dialog' contains the dialog for
...
const SettingsLuxxleSyncDeleteAccountDialogElementBase =
  I18nMixin(BaseMixin(PolymerElement)) as {
    new(): PolymerElement & I18nMixinInterface
  }

export class SettingsLuxxleSyncCodeDialogElement
             extends SettingsLuxxleSyncDeleteAccountDialogElementBase {
  static get is() {
    return 'settings-luxxle-sync-delete-account-dialog'
  }
  ...
  syncBrowserProxy_: LuxxleSyncBrowserProxy =
...
customElements.define(
  SettingsLuxxleSyncCodeDialogElement.is, SettingsLuxxleSyncCodeDialogElement)
