...
import {getTemplate} from './luxxle_sync_code_dialog.html.js'

/**
 * @fileoverview
 * 'settings-luxxle-sync-code-dialog' contains the dialog for displaying or
...
const SettingsLuxxleSyncCodeDialogElementBase =
  I18nMixin(BaseMixin(PolymerElement)) as {
    new(): PolymerElement & I18nMixinInterface
  }

export class SettingsLuxxleSyncCodeDialogElement extends SettingsLuxxleSyncCodeDialogElementBase {
  static get is() {
    return 'settings-luxxle-sync-code-dialog'
  }
