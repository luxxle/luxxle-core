...
import './luxxle_extensions_manifest_v2_subpage.js';
...
import {LuxxleDefaultExtensionsBrowserProxyImpl} from './luxxle_default_extensions_browser_proxy.js'
import {getTemplate} from './luxxle_default_extensions_page.html.js'

const SettingLuxxleDefaultExtensionsPageElementBase =
...
export interface SettingLuxxleDefaultExtensionsPageElement {
  $: {
...
/**
 * 'settings-luxxle-default-extensions-page' is the settings page containing
 * luxxle's default extensions.
 */
export class SettingLuxxleDefaultExtensionsPageElement extends SettingLuxxleDefaultExtensionsPageElementBase {
  static get is() {
    return 'settings-luxxle-default-extensions-page'
  }
  ...
  private browserProxy_ = LuxxleDefaultExtensionsBrowserProxyImpl.getInstance()
  ...
  override ready() {
    ...
    this.addWebUiListener(
      'luxxle-needs-restart-changed', (needsRestart: boolean) => {
...
customElements.define(
  SettingLuxxleDefaultExtensionsPageElement.is, SettingLuxxleDefaultExtensionsPageElement)
