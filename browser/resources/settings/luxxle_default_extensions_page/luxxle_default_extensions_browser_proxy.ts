...
export interface LuxxleDefaultExtensionsBrowserProxy  {
...
export class LuxxleDefaultExtensionsBrowserProxyImpl implements LuxxleDefaultExtensionsBrowserProxy {
  ...
  static getInstance(): LuxxleDefaultExtensionsBrowserProxy {
    return instance || (instance = new LuxxleDefaultExtensionsBrowserProxyImpl())
  }
}

let instance: LuxxleDefaultExtensionsBrowserProxy|null = null
