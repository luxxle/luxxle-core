...
import {LuxxleDefaultExtensionsBrowserProxyImpl, ExtensionV2} from './luxxle_default_extensions_browser_proxy.js'
import {getTemplate} from './luxxle_extensions_manifest_v2_subpage.html.js'

const LuxxleExtensionsV2SubpageBase =
  WebUiListenerMixin(PrefsMixin(I18nMixin(BaseMixin(PolymerElement))))

class LuxxleExtensionsV2Subpage extends LuxxleExtensionsV2SubpageBase {
  static get is() {
    return 'luxxle-extensions-v2-subpage'
  }
  ...
  browserProxy_ = LuxxleDefaultExtensionsBrowserProxyImpl.getInstance()
  declare luxxleV2Extensions_: Array<ExtensionV2>
  ...
  override ready() {
    ...
    this.addWebUiListener('luxxle-extension-manifest-v2-changed',
  ...
  getExtensions_() {
    this.browserProxy_.getExtensionsManifestV2().then((extensions) => {
      this.luxxleV2Extensions_ = extensions
    })
  }
...
customElements.define(LuxxleExtensionsV2Subpage.is, LuxxleExtensionsV2Subpage)
