...
RegisterPolymerComponentReplacement(
  ...
  class LuxxleSiteSettingsComponent extends SettingsSiteSettingsPageElement {
        ...
        if (!lists.permissionsAdvanced) {
          ...
          if (indexForAutoplay === -1) {
            ...
            if (isOpenAIChatFromLuxxleSearchEnabled) {
              currentIndex++
              const AIChatItem = {
                route: routes.SITE_SETTINGS_LUXXLE_OPEN_AI_CHAT,
                id: ContentSettingsTypes.LUXXLE_OPEN_AI_CHAT,
                label: 'siteSettingsLuxxleOpenAIChat',
                icon: 'product-luxxle-leo',
                enabledLabel: 'siteSettingsLuxxleOpenAIChatAsk',
                disabledLabel: 'siteSettingsLuxxleOpenAIChatBlock'
              }
              lists.permissionsAdvanced.splice(currentIndex, 0,
                AIChatItem)
            }
        ...
        (lists as any).shieldsBasic = [
          {
            ...
            id: ContentSettingsTypes.LUXXLE_SHIELDS,
