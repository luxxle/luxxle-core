...
function getPageVisibility () {
  ...
  // which hides most sections, and add luxxle sections to hide.
  if (loadTimeData.getBoolean('isGuest')) {
    // Hide appropriate luxxle sections as well as chromium ones
    return {
  ...
  // would like to hide.
  // See luxxle/browser/settings/luxxle_overrides/basic_page.js for luxxle's list,
  ...
  const staticProps = {
    ...
    // custom properties
    luxxleSync: !loadTimeData.getBoolean('isSyncDisabled'),
    luxxleWallet: loadTimeData.getBoolean('isLuxxleWalletAllowed'),
