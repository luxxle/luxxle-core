  ...
  html`
    <style>
      :host {
        ...
        --luxxle-settings-content-max-width: 708px;
        --luxxle-settings-menu-width: var(--settings-menu-width);
        --luxxle-settings-menu-margin: 12px;
      ...
      cr-drawer settings-menu {
        --luxxle-settings-menu-margin-v: 0;
        --luxxle-settings-menu-padding: 24px;
        --luxxle-settings-menu-margin: 0;
      }
...
const LuxxleClearSettingsMenuHighlightBehavior = {
...
// In Luxxle we scroll the settings-main element, not the container.
const LuxxleSetGlobalScrollTargetBehavior = {
  ready: function(this: SettingsUiElement) {
...
RegisterPolymerComponentBehaviors({
  'settings-ui': [
    LuxxleClearSettingsMenuHighlightBehavior,
    LuxxleSetGlobalScrollTargetBehavior
  ]
})
