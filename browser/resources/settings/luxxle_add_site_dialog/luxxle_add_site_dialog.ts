...
export class LuxxleAddSiteDialogElement extends BaseElement {
  ...
  override ready() {
    super.ready()
    const is_luxxle_shields = this.category === 'luxxleShields'
    const resource_id = is_luxxle_shields ? 'luxxleShieldsExampleTemplate'
