...
import * as mojom from './luxxle_leo_assistant_browser_proxy.js'
...
export class ModelConfigUI extends ModelConfigUIBase {
  ...
  override ready() {
    super.ready()
    // If a user previously had --luxxle-ai-chat-allow-private-ips enabled, but
      ...
      sendWithPromise('validateModelEndpoint', { url })
        .then((response: any) => {
          ...
          this.invalidUrlErrorMessage =
            this.i18n('luxxleLeoAssistantEndpointError')
        })
    }
  }
  ...
  private computeButtonLabel_(isEditing: boolean) {
    return isEditing
      ? this.i18n('luxxleLeoAssistantSaveModelButtonLabel')
      : this.i18n('luxxleLeoAssistantAddModelButtonLabel')
  }
}
