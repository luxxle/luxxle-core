...
export interface LuxxleDataCollectionBrowserProxy {
...
export class LuxxleDataCollectionBrowserProxyImpl
implements LuxxleDataCollectionBrowserProxy
{
  static getInstance() {
    return instance || (instance = new LuxxleDataCollectionBrowserProxyImpl())
  }
...
let instance: LuxxleDataCollectionBrowserProxy|null = null
