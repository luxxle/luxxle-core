...
import {LuxxleDataCollectionBrowserProxyImpl} from './luxxle_data_collection_browser_proxy.js'
import {getTemplate} from './luxxle_data_collection_page.html.js'

import {MetricsReporting} from '/shared/settings/privacy_page/privacy_page_browser_proxy.js'

const SettingLuxxleDataCollectionPageElementBase =
  WebUiListenerMixin(PrefsMixin(PolymerElement))

interface SettingsLuxxleDataCollectionPageElement {
  $: {
...
/**
 * 'settings-luxxle-data-collection-page' is the settings page containing
 * Luxxle's data collection settings.
 */
class SettingsLuxxleDataCollectionPageElement
extends SettingLuxxleDataCollectionPageElementBase
{
  static get is() {
    return 'settings-luxxle-data-collection-subpage'
  }
  ...
  browserProxy_ = LuxxleDataCollectionBrowserProxyImpl.getInstance()
...
customElements.define(
  SettingsLuxxleDataCollectionPageElement.is,
  SettingsLuxxleDataCollectionPageElement)
