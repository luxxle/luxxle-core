...
import { getCss } from './luxxle_account_sign_in_dialog.css.js'
import { getHtml } from './luxxle_account_sign_in_dialog.html.js'
import { isEmailValid } from './luxxle_account_common.js'

// @ts-ignore
import { Login } from 'chrome://resources/luxxle/opaque_ke.bundle.js'

export class SettingsLuxxleAccountSignInDialogElement extends CrLitElement {
  static get is() {
    return 'settings-luxxle-account-sign-in-dialog'
  }
...
declare global {
  interface HTMLElementTagNameMap {
    ...
    SettingsLuxxleAccountSignInDialogElement
  }
}

customElements.define(
  SettingsLuxxleAccountSignInDialogElement.is,
  SettingsLuxxleAccountSignInDialogElement
)
