...
import {NetworkInfo, LuxxleWalletBrowserProxy, LuxxleWalletBrowserProxyImpl} from './luxxle_wallet_browser_proxy.js';
import {CrInputElement} from 'chrome://resources/cr_elements/cr_input/cr_input.js'
import {getTemplate} from './add_wallet_network_dialog.html.js'
import '../ui/searchable_drop_down_cros.js';

const SettingsLuxxleAddWalletNetworkDialogElementBase =
...
export class SettingsLuxxleAddWalletNetworkDialogElement extends SettingsLuxxleAddWalletNetworkDialogElementBase {
  static get is() {
  ...
  browserProxy_: LuxxleWalletBrowserProxy = LuxxleWalletBrowserProxyImpl.getInstance();
...
customElements.define(
  SettingsLuxxleAddWalletNetworkDialogElement.is, SettingsLuxxleAddWalletNetworkDialogElement)
