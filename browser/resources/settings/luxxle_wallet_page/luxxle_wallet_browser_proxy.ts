...
export interface LuxxleWalletBrowserProxy {
  resetWallet: () => void
...
export class LuxxleWalletBrowserProxyImpl implements LuxxleWalletBrowserProxy {
  resetWallet () {
  ...
  getWeb3ProviderList () {
    return new Promise<string>(
      resolve => chrome.luxxleWallet.getWeb3ProviderList(resolve))
  }

  isNativeWalletEnabled() {
    return new Promise<boolean>(
      resolve => chrome.luxxleWallet.isNativeWalletEnabled(resolve))
  }
  ...
  static getInstance() {
    return instance || (instance = new LuxxleWalletBrowserProxyImpl())
  }
}

let instance: LuxxleWalletBrowserProxy|null = null
