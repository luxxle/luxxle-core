...
export interface SettingsLuxxleContentContentElement {
  $: {
...
const SettingsLuxxleAppearanceContentElementBase =
    I18nMixin(PrefsMixin(BaseMixin(PolymerElement)));

export class SettingsLuxxleContentContentElement extends SettingsLuxxleAppearanceContentElementBase {
  static get is() {
    return 'settings-luxxle-content-content'
  }
...
customElements.define(SettingsLuxxleContentContentElement.is, SettingsLuxxleContentContentElement)
