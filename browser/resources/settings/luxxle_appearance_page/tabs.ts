...
const SettingsLuxxleAppearanceTabsElementBase = PrefsMixin(I18nMixin(PolymerElement)) as {
  new (): PolymerElement & I18nMixinInterface & PrefsMixinInterface
}

export class SettingsLuxxleAppearanceTabsElement extends SettingsLuxxleAppearanceTabsElementBase {
  static get is() {
    return 'settings-luxxle-appearance-tabs'
  }
...
customElements.define(SettingsLuxxleAppearanceTabsElement.is, SettingsLuxxleAppearanceTabsElement)
