...
const SettingsLuxxleAppearanceBookmarkBarElementBase =
...
const kAlwaysShowBookmarBarPrefName = 'luxxle.always_show_bookmark_bar_on_ntp'
const kShowOnAllTabsPrefName = 'bookmark_bar.show_on_all_tabs'

/**
 * 'settings-luxxle-appearance-bookmark-bar' is the settings page area containing
 * luxxle's bookmark bar visibility settings in appearance settings.
 */
export class SettingsLuxxleAppearanceBookmarkBarElement
    extends SettingsLuxxleAppearanceBookmarkBarElementBase {
  static get is() {
    return 'settings-luxxle-appearance-bookmark-bar'
  }
  ...
  static get observers() {
    return [
      ...
      ' prefs.luxxle.always_show_bookmark_bar_on_ntp.value)'
    ]
  }
...
customElements.define(SettingsLuxxleAppearanceBookmarkBarElement.is,
  SettingsLuxxleAppearanceBookmarkBarElement)
