...
const SettingsLuxxleAppearanceSuperReferralElementBase = I18nMixin(PolymerElement) as {
  new (): PolymerElement & I18nMixinInterface
}

/**
 * 'settings-luxxle-appearance-theme' is the settings page area containing
 * luxxle's themes settings.
 */

export class SettingsLuxxleAppearanceSuperReferralElement extends
    SettingsLuxxleAppearanceSuperReferralElementBase {
  static get is() {
    return 'settings-luxxle-appearance-super-referral'
  }
...
customElements.define(SettingsLuxxleAppearanceSuperReferralElement.is, SettingsLuxxleAppearanceSuperReferralElement)
