...
import './components/luxxle_adblock_editor.js'
import './components/luxxle_adblock_scriptlet_list.js'
import './components/luxxle_adblock_subscribe_dropdown.js'
...
import {
  LuxxleAdblockBrowserProxy,
  LuxxleAdblockBrowserProxyImpl,
  FilterList,
  Scriptlet,
  SubscriptionInfo
} from './luxxle_adblock_browser_proxy.js'

import {getTemplate} from './luxxle_adblock_subpage.html.js'
...
class AdBlockSubpage extends AdBlockSubpageBase {
  ...
  static get observers() {
    return [
      'updateState_(prefs.luxxle.ad_block.developer_mode.value, customFilters_, customScriptlets_)'
    ]
  }
  ...
  private browserProxy_: LuxxleAdblockBrowserProxy =
    LuxxleAdblockBrowserProxyImpl.getInstance()
  ...
  override ready() {
    ...
    this.browserProxy_.addWebUiListener(
      'luxxle_adblock.onGetListSubscriptions', (value: SubscriptionInfo[]) => {
        this.subscriptionList_ = value
    })
    this.browserProxy_.addWebUiListener(
      'luxxle_adblock.onCustomFiltersChanged',
      (value: string) => {
        this.customFilters_ = value
      }
    )
