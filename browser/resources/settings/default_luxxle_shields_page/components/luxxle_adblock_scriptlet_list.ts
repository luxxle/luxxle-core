...
import { getTemplate } from './luxxle_adblock_scriptlet_list.html.js'
...
import './luxxle_adblock_scriptlet_editor.js'
...
class AdblockScriptletList extends AdblockScriptletListBase {
  ...
  browserProxy_ = LuxxleAdblockBrowserProxyImpl.getInstance()
