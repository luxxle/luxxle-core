...
import './luxxle_adblock_subpage.js'
...
import {
  DefaultLuxxleShieldsBrowserProxy,
  DefaultLuxxleShieldsBrowserProxyImpl
} from './default_luxxle_shields_browser_proxy.js'

import {getTemplate} from './default_luxxle_shields_page.html.js'

interface LuxxleShieldsPage {
  $: {
...
const LuxxleShieldsPageBase =
  WebUiListenerMixin(I18nMixin(PrefsMixin(RouteObserverMixin(PolymerElement))))

/**
 * 'settings-default-luxxle-shields-page' is the settings page containing luxxle's
 * default shields.
 */
class LuxxleShieldsPage extends LuxxleShieldsPageBase {
  static get is () {
    return 'settings-default-luxxle-shields-page'
  }
  ...
  private browserProxy_: DefaultLuxxleShieldsBrowserProxy =
    DefaultLuxxleShieldsBrowserProxyImpl.getInstance()
  ...
  override ready () {
    ...
    this.addWebUiListener('luxxle-shields-settings-changed',
      () => { this.onShieldsSettingsChanged_() })
  }
...
customElements.define(
  LuxxleShieldsPage.is, LuxxleShieldsPage)
