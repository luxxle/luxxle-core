...
export interface DefaultLuxxleShieldsBrowserProxy {
...
export class DefaultLuxxleShieldsBrowserProxyImpl
implements DefaultLuxxleShieldsBrowserProxy {
  isAdControlEnabled () {
  ...
  static getInstance(): DefaultLuxxleShieldsBrowserProxy {
    return instance || (instance = new DefaultLuxxleShieldsBrowserProxyImpl())
  }
}

let instance: DefaultLuxxleShieldsBrowserProxy|null = null
