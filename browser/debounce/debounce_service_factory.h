...
#ifndef LUXXLE_BROWSER_DEBOUNCE_DEBOUNCE_SERVICE_FACTORY_H_
#define LUXXLE_BROWSER_DEBOUNCE_DEBOUNCE_SERVICE_FACTORY_H_
...
#endif  // LUXXLE_BROWSER_DEBOUNCE_DEBOUNCE_SERVICE_FACTORY_H_
