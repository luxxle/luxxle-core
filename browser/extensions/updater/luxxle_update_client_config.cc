...
#include "luxxle/browser/extensions/updater/luxxle_update_client_config.h"
...
std::string LuxxleUpdateClientConfig::GetChannel() const {
  return std::string("stable");
}

scoped_refptr<update_client::NetworkFetcherFactory>
LuxxleUpdateClientConfig::GetNetworkFetcherFactory() {
...
LuxxleUpdateClientConfig::~LuxxleUpdateClientConfig() = default;

// static
scoped_refptr<ChromeUpdateClientConfig> LuxxleUpdateClientConfig::Create(
    content::BrowserContext* context,
    std::optional<GURL> update_url_override) {
  FactoryCallback& factory = GetFactoryCallback();
  return factory.is_null() ? base::MakeRefCounted<LuxxleUpdateClientConfig>(
