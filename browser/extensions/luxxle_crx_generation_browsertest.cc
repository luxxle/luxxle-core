...
class LuxxleCrxGenerationTest : public InProcessBrowserTest {
 public:
  LuxxleCrxGenerationTest() { CHECK(temp_directory_.CreateUniqueTempDir()); }
...
IN_PROC_BROWSER_TEST_F(LuxxleCrxGenerationTest,
...
IN_PROC_BROWSER_TEST_F(LuxxleCrxGenerationTest,
  ...
  base::CommandLine::ForCurrentProcess()->AppendSwitchPath(
      "luxxle-extension-publisher-key", publisher_test_key_path);
  ...
  base::CommandLine::ForCurrentProcess()->AppendSwitchPath(
      "luxxle-extension-publisher-key-alt", alt_publisher_test_key_path);
  ...
  for (auto test_key : {publisher_test_key_path, alt_publisher_test_key_path}) {
    ...
    crx_file::SetLuxxlePublisherKeyHashForTesting(public_key_hash);
