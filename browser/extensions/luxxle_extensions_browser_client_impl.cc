...
#include "luxxle/browser/extensions/luxxle_extensions_browser_client_impl.h"
...
LuxxleExtensionsBrowserClientImpl::LuxxleExtensionsBrowserClientImpl() {
  AddAPIProvider(std::make_unique<LuxxleExtensionsBrowserAPIProvider>());
