...
#ifndef LUXXLE_BROWSER_EXTENSIONS_BRAVE_EXTENSIONS_BROWSER_API_PROVIDER_H_
#define LUXXLE_BROWSER_EXTENSIONS_BRAVE_EXTENSIONS_BROWSER_API_PROVIDER_H_
...
#endif  // LUXXLE_BROWSER_EXTENSIONS_BRAVE_EXTENSIONS_BROWSER_API_PROVIDER_H_
