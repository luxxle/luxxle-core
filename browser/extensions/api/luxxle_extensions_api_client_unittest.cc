...
class LuxxleExtensionsAPIClientTests : public ChromeRenderViewHostTestHarness {
 public:
  LuxxleExtensionsAPIClientTests(const LuxxleExtensionsAPIClientTests&) = delete;
  LuxxleExtensionsAPIClientTests& operator=(
      const LuxxleExtensionsAPIClientTests&) = delete;
 ...
 protected:
  LuxxleExtensionsAPIClientTests() = default;

 private:
  LuxxleExtensionsAPIClient client_;
};

TEST_F(LuxxleExtensionsAPIClientTests, IsLuxxleProtectedUrlUphold) {
  ...
  WebRequestInfo allowed3(create_request_params("https://luxxle.com/"));
