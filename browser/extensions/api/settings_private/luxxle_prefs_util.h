...
#ifndef LUXXLE_BROWSER_EXTENSIONS_API_SETTINGS_PRIVATE_LUXXLE_PREFS_UTIL_H_
#define LUXXLE_BROWSER_EXTENSIONS_API_SETTINGS_PRIVATE_LUXXLE_PREFS_UTIL_H_
...
class LuxxlePrefsUtil : public PrefsUtil {
 public:
...
#endif  // LUXXLE_BROWSER_EXTENSIONS_API_SETTINGS_PRIVATE_LUXXLE_PREFS_UTIL_H_
