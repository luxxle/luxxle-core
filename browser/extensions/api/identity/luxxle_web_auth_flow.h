...
#ifndef LUXXLE_BROWSER_EXTENSIONS_API_IDENTITY_LUXXLE_WEB_AUTH_FLOW_H_
#define LUXXLE_BROWSER_EXTENSIONS_API_IDENTITY_LUXXLE_WEB_AUTH_FLOW_H_
...
class LuxxleWebAuthFlow : public WebAuthFlow::Delegate {
 public:
...
#endif  // LUXXLE_BROWSER_EXTENSIONS_API_IDENTITY_LUXXLE_WEB_AUTH_FLOW_H_
