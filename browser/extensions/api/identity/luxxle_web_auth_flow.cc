...
LuxxleWebAuthFlow::LuxxleWebAuthFlow() {}
LuxxleWebAuthFlow::~LuxxleWebAuthFlow() {}

// static
std::optional<std::string> LuxxleWebAuthFlow::token_for_testing_;
// static
void LuxxleWebAuthFlow::SetTokenForTesting(const std::string& token) {
  token_for_testing_ = token;
}

void LuxxleWebAuthFlow::StartWebAuthFlow(
    Profile* profile,
...
void LuxxleWebAuthFlow::OnAuthFlowFailure(WebAuthFlow::Failure failure) {
...
void LuxxleWebAuthFlow::OnAuthFlowURLChange(const GURL& redirect_url) {
