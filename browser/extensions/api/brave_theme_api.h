...
#ifndef LUXXLE_BROWSER_EXTENSIONS_API_BRAVE_THEME_API_H_
#define LUXXLE_BROWSER_EXTENSIONS_API_BRAVE_THEME_API_H_
...
#endif  // LUXXLE_BROWSER_EXTENSIONS_API_BRAVE_THEME_API_H_
