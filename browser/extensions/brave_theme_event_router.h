...
#ifndef LUXXLE_BROWSER_EXTENSIONS_BRAVE_THEME_EVENT_ROUTER_H_
#define LUXXLE_BROWSER_EXTENSIONS_BRAVE_THEME_EVENT_ROUTER_H_
...
#endif  // LUXXLE_BROWSER_EXTENSIONS_BRAVE_THEME_EVENT_ROUTER_H_
