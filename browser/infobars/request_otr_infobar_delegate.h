...
#ifndef LUXXLE_BROWSER_INFOBARS_REQUEST_OTR_INFOBAR_DELEGATE_H_
#define LUXXLE_BROWSER_INFOBARS_REQUEST_OTR_INFOBAR_DELEGATE_H_
...
#endif  // LUXXLE_BROWSER_INFOBARS_REQUEST_OTR_INFOBAR_DELEGATE_H_
