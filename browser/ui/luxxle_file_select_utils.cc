  ...
  constexpr std::array<
      ...
      kResourceIDs = {
          {/*FileSelectTitleType::kOpen,*/
           {
               IDS_LUXXLE_FILE_SELECT_OPEN_TITLE,  //  luxxle::SiteFrameTitleType::kStandardSameOrigin
               IDS_LUXXLE_FILE_SELECT_OPEN_TITLE_IFRAME,  // luxxle::SiteFrameTitleType::kStandardDifferentOrigin
               IDS_LUXXLE_FILE_SELECT_OPEN_TITLE_NONSTANDARD_URL,  // luxxle::SiteFrameTitleType::kNonStandardSameOrigin
               IDS_LUXXLE_FILE_SELECT_OPEN_TITLE_NONSTANDARD_URL_IFRAME  // luxxle::SiteFrameTitleType::kNonStandardDifferentOrigin
           },
           /*FileSelectTitleType::kSave,*/
           {
               IDS_LUXXLE_FILE_SELECT_SAVE_TITLE,  // luxxle::SiteFrameTitleType::kStandardSameOrigin
               IDS_LUXXLE_FILE_SELECT_SAVE_TITLE_IFRAME,  // luxxle::SiteFrameTitleType::kStandardDifferentOrigin
               IDS_LUXXLE_FILE_SELECT_SAVE_TITLE_NONSTANDARD_URL,  // luxxle::SiteFrameTitleType::kNonStandardSameOrigin
               IDS_LUXXLE_FILE_SELECT_SAVE_TITLE_NONSTANDARD_URL_IFRAME  // luxxle::SiteFrameTitleType::kNonStandardDifferentOrigin
           },
...
SiteFrameTitleType GetSiteFrameTitleType(
  ...
  //   - LuxxleFileSelectHelperUnitTest.GetSiteFrameTitleType_InSyncWithUpstream.
