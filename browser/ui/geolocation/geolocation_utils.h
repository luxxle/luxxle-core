...
#ifndef LUXXLE_BROWSER_UI_GEOLOCATION_GEOLOCATION_UTILS_H_
#define LUXXLE_BROWSER_UI_GEOLOCATION_GEOLOCATION_UTILS_H_
...
#endif  // LUXXLE_BROWSER_UI_GEOLOCATION_GEOLOCATION_UTILS_H_
