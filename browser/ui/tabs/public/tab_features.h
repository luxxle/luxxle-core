...
#ifndef LUXXLE_BROWSER_UI_TABS_PUBLIC_TAB_FEATURES_H_
#define LUXXLE_BROWSER_UI_TABS_PUBLIC_TAB_FEATURES_H_
...
#endif  // LUXXLE_BROWSER_UI_TABS_PUBLIC_TAB_FEATURES_H_
