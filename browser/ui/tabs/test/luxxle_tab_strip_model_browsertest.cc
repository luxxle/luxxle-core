...
using LuxxleTabStripModelTest = InProcessBrowserTest;

IN_PROC_BROWSER_TEST_F(LuxxleTabStripModelTest, MRUCyclingBasic) {
...
IN_PROC_BROWSER_TEST_F(LuxxleTabStripModelTest, TabClosingWhileMRUCycling) {
  // Activate MRU cycling
  browser()->profile()->GetPrefs()->SetBoolean(kMRUCyclingEnabled, true);
