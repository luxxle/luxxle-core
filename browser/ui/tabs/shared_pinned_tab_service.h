...
#ifndef LUXXLE_BROWSER_UI_TABS_SHARED_PINNED_TAB_SERVICE_H_
#define LUXXLE_BROWSER_UI_TABS_SHARED_PINNED_TAB_SERVICE_H_
...
#endif  // LUXXLE_BROWSER_UI_TABS_SHARED_PINNED_TAB_SERVICE_H_
