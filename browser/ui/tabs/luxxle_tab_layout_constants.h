...
#ifndef LUXXLE_BROWSER_UI_TABS_LUXXLE_TAB_LAYOUT_CONSTANTS_H_
#define LUXXLE_BROWSER_UI_TABS_LUXXLE_TAB_LAYOUT_CONSTANTS_H_
...
#endif  // LUXXLE_BROWSER_UI_TABS_LUXXLE_TAB_LAYOUT_CONSTANTS_H_
