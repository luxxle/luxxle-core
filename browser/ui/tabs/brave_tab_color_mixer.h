...
#ifndef LUXXLE_BROWSER_UI_TABS_BRAVE_TAB_COLOR_MIXER_H_
#define LUXXLE_BROWSER_UI_TABS_BRAVE_TAB_COLOR_MIXER_H_
...
#endif  // LUXXLE_BROWSER_UI_TABS_BRAVE_TAB_COLOR_MIXER_H_
