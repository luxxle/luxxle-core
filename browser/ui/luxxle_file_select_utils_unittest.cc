...
TEST(LuxxleFileSelectUtilsUnitTest, GetSiteFrameTitle_InSyncWithUpstream) {
...
TEST(LuxxleFileSelectUtilsUnitTest, GetSiteFrameTitleForFileSelect_Open) {
  constexpr struct Case {
    // The name of the test case.
    const char* case_name;
  ...
  luxxle_l10n::test::ScopedDefaultLocale scoped_locale("en-US");
...
TEST(LuxxleFileSelectUtilsUnitTest, GetSiteFrameTitleForFileSelect_Save) {
  constexpr struct Case {
    // The name of the test case.
    const char* case_name;
