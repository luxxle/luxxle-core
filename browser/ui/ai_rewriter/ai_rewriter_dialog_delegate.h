...
#ifndef LUXXLE_BROWSER_UI_AI_REWRITER_AI_REWRITER_DIALOG_DELEGATE_H_
#define LUXXLE_BROWSER_UI_AI_REWRITER_AI_REWRITER_DIALOG_DELEGATE_H_
...
#endif  // LUXXLE_BROWSER_UI_AI_REWRITER_AI_REWRITER_DIALOG_DELEGATE_H_
