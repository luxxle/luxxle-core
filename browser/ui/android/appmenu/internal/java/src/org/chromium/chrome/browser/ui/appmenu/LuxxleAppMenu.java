...
class LuxxleAppMenu extends AppMenu {
    ...
    LuxxleAppMenu(int itemRowHeight, AppMenuHandlerImpl handler, Resources res) {
    ...
    public static boolean isMenuFromBottom() {
        return ContextUtils.getAppSharedPreferences()
                .getBoolean(LuxxlePreferenceKeys.LUXXLE_IS_MENU_FROM_BOTTOM, false);
    }
    ...
    public void updatePopup(PopupWindow popup, boolean isByPermanentButton) {
        if (!SysUtils.isLowEndDevice() && !isByPermanentButton) {
            popup.setAnimationStyle(LuxxleAppMenu.getAnimationStyle());
        }
