...
class LuxxleBottomControlsMediator extends BottomControlsMediator {
    ...
    public int getHeight() {
        if (bothBottomControlsVisible()) {
            // Factor in the height of the Luxxle navigation bottom controls when they are visible.
