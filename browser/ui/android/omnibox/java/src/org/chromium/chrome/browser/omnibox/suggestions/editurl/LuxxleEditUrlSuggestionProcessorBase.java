...
public abstract class LuxxleEditUrlSuggestionProcessorBase extends BaseSuggestionViewProcessor {
    public LuxxleEditUrlSuggestionProcessorBase(
            Context context,
     ...
     * See comment to `LuxxleEditUrlSuggestionProcessor.maybeUpdateSuggestionForCopyLink` for more details on why it may be changed.
     */
    ...
    public AutocompleteMatch maybeUpdateSuggestionForCopyLink(AutocompleteMatch suggestion) {
        assert false : "This method should be overridden by LuxxleEditUrlSuggestionProcessor";
        return suggestion;
    }
}
