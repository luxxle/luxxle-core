...
package org.chromium.chrome.browser.omnibox.suggestions.luxxle_leo;
...
import org.chromium.chrome.browser.omnibox.suggestions.LuxxleLeoAutocompleteDelegate;
...
/** A class that handles model and view creation for the Luxxle Leo suggestion. */
public class LuxxleLeoSuggestionProcessor extends BaseSuggestionViewProcessor {
    private final UrlBarEditingTextStateProvider mUrlBarEditingTextProvider;
    private final LuxxleLeoAutocompleteDelegate mDelegate;
    private final String mAskLeo;
    private @NonNull Supplier<Tab> mActivityTabSupplier;

    public LuxxleLeoSuggestionProcessor(
            Context context,
            SuggestionHost suggestionHost,
            UrlBarEditingTextStateProvider editingTextProvider,
            @NonNull Optional<OmniboxImageSupplier> imageSupplier,
            LuxxleLeoAutocompleteDelegate delegate,
    ...
    public void populateModel(final PropertyModel model) {
        model.set(
                ...
                OmniboxDrawableState.forSmallIcon(
                        mContext, R.drawable.ic_luxxle_ai_color, /* allowTint= */ false));
        model.set(
    ...
    public int getViewTypeId() {
        return LuxxleOmniboxSuggestionUiType.LUXXLE_LEO_SUGGESTION;
    }
