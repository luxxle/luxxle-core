...
class LuxxleVersionUpdaterMacTest : public testing::Test {
 protected:
  bool UsesSparkle() {
...
TEST_F(LuxxleVersionUpdaterMacTest, UsesSparkleByDefault) {
  EXPECT_TRUE(UsesSparkle());
}

TEST_F(LuxxleVersionUpdaterMacTest, UsesOmaha4WhenEnabled) {
  scoped_feature_list_.InitAndEnableFeature(luxxle::kLuxxleUseOmaha4Alpha);
