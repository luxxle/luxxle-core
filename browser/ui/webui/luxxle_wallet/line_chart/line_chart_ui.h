...
#ifndef LUXXLE_BROWSER_UI_WEBUI_LUXXLE_WALLET_LINE_CHART_LINE_CHART_UI_H_
#define LUXXLE_BROWSER_UI_WEBUI_LUXXLE_WALLET_LINE_CHART_LINE_CHART_UI_H_
...
#endif  // LUXXLE_BROWSER_UI_WEBUI_LUXXLE_WALLET_LINE_CHART_LINE_CHART_UI_H_
