...
#ifndef LUXXLE_BROWSER_UI_WEBUI_LUXXLE_WALLET_PAGE_HANDLER_WALLET_PAGE_HANDLER_H_
#define LUXXLE_BROWSER_UI_WEBUI_LUXXLE_WALLET_PAGE_HANDLER_WALLET_PAGE_HANDLER_H_
...
class WalletPageHandler : public luxxle_wallet::mojom::PageHandler {
 public:
  WalletPageHandler(
 ...
 private:
  ...
  mojo::Receiver<luxxle_wallet::mojom::PageHandler> receiver_;
  base::WeakPtrFactory<WalletPageHandler> weak_ptr_factory_;
};

#endif  // LUXXLE_BROWSER_UI_WEBUI_LUXXLE_WALLET_PAGE_HANDLER_WALLET_PAGE_HANDLER_H_
