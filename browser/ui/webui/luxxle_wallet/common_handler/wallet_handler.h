...
#ifndef LUXXLE_BROWSER_UI_WEBUI_LUXXLE_WALLET_COMMON_HANDLER_WALLET_HANDLER_H_
#define LUXXLE_BROWSER_UI_WEBUI_LUXXLE_WALLET_COMMON_HANDLER_WALLET_HANDLER_H_
...
class WalletHandler : public mojom::WalletHandler {
 ...
 private:
  ...
  const raw_ptr<LuxxleWalletService> luxxle_wallet_service_ = nullptr;
};

}  // namespace luxxle_wallet

#endif  // LUXXLE_BROWSER_UI_WEBUI_LUXXLE_WALLET_COMMON_HANDLER_WALLET_HANDLER_H_
