...
class RewardsInternalsDOMHandler : public content::WebUIMessageHandler {
 ...
 private:
  ...
  void OnGetRewardsInternalsInfo(
      luxxle_rewards::mojom::RewardsInternalsInfoPtr info);
  void GetBalance(const base::Value::List& args);
  void OnGetBalance(luxxle_rewards::mojom::BalancePtr balance);
  void GetContributions(const base::Value::List& args);
  void OnGetContributions(
      std::vector<luxxle_rewards::mojom::ContributionInfoPtr> contributions);
  ...
  void OnGetEventLogs(std::vector<luxxle_rewards::mojom::EventLogPtr> logs);
  ...
  void OnGetEnvironment(luxxle_rewards::mojom::Environment environment);

  raw_ptr<luxxle_rewards::RewardsService> rewards_service_ =
      nullptr;                                            // NOT OWNED
  raw_ptr<luxxle_ads::AdsService> ads_service_ = nullptr;  // NOT OWNED
...
void RewardsInternalsDOMHandler::Init() {
  ...
  rewards_service_ =
      luxxle_rewards::RewardsServiceFactory::GetForProfile(profile_);
...
void RewardsInternalsDOMHandler::OnGetRewardsInternalsInfo(
  ...
  if (info) {
    ...
    const std::string declared_geo =
        prefs->GetString(::luxxle_rewards::prefs::kDeclaredGeo);
    const int wallet_creation_environment =
        prefs->GetInteger(::luxxle_rewards::prefs::kWalletCreationEnvironment);
  ...
  CallJavascriptFunction("luxxle_rewards_internals.onGetRewardsInternalsInfo",
                         info_dict);
}
...
void RewardsInternalsDOMHandler::OnGetBalance(
  ...
  CallJavascriptFunction("luxxle_rewards_internals.balance", std::move(data));
}
...
void RewardsInternalsDOMHandler::OnGetContributions(
  ...
  CallJavascriptFunction("luxxle_rewards_internals.contributions", list);
}
...
void RewardsInternalsDOMHandler::OnGetPartialLog(const std::string& log) {
  ...
  CallJavascriptFunction("luxxle_rewards_internals.partialLog",
                         base::Value(log));
}
...
void RewardsInternalsDOMHandler::OnGetFulllLog(const std::string& log) {
  ...
  CallJavascriptFunction("luxxle_rewards_internals.fullLog", base::Value(log));
}
...
void RewardsInternalsDOMHandler::OnClearLog(const bool success) {
  ...
  CallJavascriptFunction("luxxle_rewards_internals.partialLog", base::Value(""));
}
...
void RewardsInternalsDOMHandler::OnGetExternalWallet(
  ...
  if (!wallet) {
    CallJavascriptFunction("luxxle_rewards_internals.onGetExternalWallet");
    return;
  }
  ...
  CallJavascriptFunction("luxxle_rewards_internals.onGetExternalWallet", data);
}
...
void RewardsInternalsDOMHandler::OnGetEventLogs(
    std::vector<luxxle_rewards::mojom::EventLogPtr> logs) {
  if (!IsJavascriptAllowed()) {
    return;
  }
  ...
  CallJavascriptFunction("luxxle_rewards_internals.eventLogs", data);
}
...
void RewardsInternalsDOMHandler::OnGetAdDiagnostics(
  ...
  const std::string& diagnostic_id =
      prefs->GetString(luxxle_ads::prefs::kDiagnosticId);
  ...
  CallJavascriptFunction("luxxle_rewards_internals.adDiagnostics", diagnostics);
}
...
void RewardsInternalsDOMHandler::SetAdDiagnosticId(
  ...
  prefs->SetString(luxxle_ads::prefs::kDiagnosticId, args[0].GetString());
}
...
void RewardsInternalsDOMHandler::OnGetEnvironment(
    luxxle_rewards::mojom::Environment environment) {
  if (!IsJavascriptAllowed()) {
    return;
  }

  CallJavascriptFunction("luxxle_rewards_internals.environment",
                         base::Value(static_cast<int>(environment)));
}

}  // namespace

LuxxleRewardsInternalsUI::LuxxleRewardsInternalsUI(content::WebUI* web_ui,
                                                 const std::string& name)
    : WebUIController(web_ui) {
  CreateAndAddWebUIDataSource(web_ui, name, kRewardsInternalsGenerated,
                              /* REMOVED: IDR_LUXXLE_REWARDS_INTERNALS_HTML */ 0);
...
LuxxleRewardsInternalsUI::~LuxxleRewardsInternalsUI() = default;
