...
#ifndef LUXXLE_BROWSER_UI_WEBUI_LUXXLE_NEW_TAB_PAGE_REFRESH_BACKGROUND_FACADE_H_
#define LUXXLE_BROWSER_UI_WEBUI_LUXXLE_NEW_TAB_PAGE_REFRESH_BACKGROUND_FACADE_H_
...
class BackgroundFacade {
 public:
  ...
  std::vector<mojom::LuxxleBackgroundPtr> GetLuxxleBackgrounds();
...
#endif  // LUXXLE_BROWSER_UI_WEBUI_LUXXLE_NEW_TAB_PAGE_REFRESH_BACKGROUND_FACADE_H_
