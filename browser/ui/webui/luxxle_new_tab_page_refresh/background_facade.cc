...
std::vector<mojom::LuxxleBackgroundPtr> BackgroundFacade::GetLuxxleBackgrounds() {
...
mojom::SelectedBackgroundPtr BackgroundFacade::GetSelectedBackground() {
  ...
  switch (bg_prefs.GetType()) {
    case NTPBackgroundPrefs::Type::kLuxxle:
      background->type = mojom::SelectedBackgroundType::kLuxxle;
      break;
...
void BackgroundFacade::SelectBackground(
  ...
  switch (background->type) {
    case mojom::SelectedBackgroundType::kLuxxle:
      bg_prefs.SetType(NTPBackgroundPrefs::Type::kLuxxle);
      break;
