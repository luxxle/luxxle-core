...
#include "luxxle/browser/resources/luxxle_new_tab_page_refresh/grit/luxxle_new_tab_page_refresh_generated_map.h"
...
void NewTabPageInitializer::Initialize() {
  ...
  if (luxxle::ShouldNewTabShowBlankpage(GetProfile())) {
    source_->SetDefaultResource(/* REMOVED: IDR_LUXXLE_BLANK_NEW_TAB_HTML */ 0);
  } else {
    webui::SetupWebUIDataSource(source_, kLuxxleNewTabPageRefreshGenerated,
                                /* REMOVED: IDR_LUXXLE_NEW_TAB_PAGE_HTML */ 0);
  }
...
#if BUILDFLAG(ENABLE_LUXXLE_VPN)
  bool vpn_feature_enabled = luxxle_vpn::IsLuxxleVPNEnabled(profile->GetPrefs());
#else
...
void NewTabPageInitializer::AddStrings() {
  static constexpr webui::LocalizedString kStrings[] = {
      ...
      {"luxxleBackgroundLabel", IDS_NEW_TAB_LUXXLE_BACKGROUND_LABEL},
      ...
      {"newsAddSourcesButtonLabel", IDS_LUXXLE_NEWS_NO_CONTENT_ACTION_LABEL},
      {"newsBackButtonLabel", IDS_LUXXLE_NEWS_BACK_BUTTON},
      {"newsCaughtUpText", IDS_LUXXLE_NEWS_CAUGHT_UP},
      {"newsChannelLuxxle", IDS_LUXXLE_NEWS_CHANNEL_LUXXLE},
      {"newsChannelBusiness", IDS_LUXXLE_NEWS_CHANNEL_BUSINESS},
      {"newsChannelCars", IDS_LUXXLE_NEWS_CHANNEL_CARS},
      {"newsChannelCelebrities", IDS_LUXXLE_NEWS_CHANNEL_CELEBRITIES},
      {"newsChannelCrypto", IDS_LUXXLE_NEWS_CHANNEL_CRYPTO},
      {"newsChannelCulture", IDS_LUXXLE_NEWS_CHANNEL_CULTURE},
      {"newsChannelEducation", IDS_LUXXLE_NEWS_CHANNEL_EDUCATION},
      {"newsChannelEntertainment", IDS_LUXXLE_NEWS_CHANNEL_ENTERTAINMENT},
      {"newsChannelFashion", IDS_LUXXLE_NEWS_CHANNEL_FASHION},
      {"newsChannelFilmAndTV", IDS_LUXXLE_NEWS_CHANNEL_FILM_AND_TV},
      {"newsChannelFood", IDS_LUXXLE_NEWS_CHANNEL_FOOD},
      {"newsChannelFun", IDS_LUXXLE_NEWS_CHANNEL_FUN},
      {"newsChannelGaming", IDS_LUXXLE_NEWS_CHANNEL_GAMING},
      {"newsChannelHealth", IDS_LUXXLE_NEWS_CHANNEL_HEALTH},
      {"newsChannelHome", IDS_LUXXLE_NEWS_CHANNEL_HOME},
      {"newsChannelLifestyle", IDS_LUXXLE_NEWS_CHANNEL_LIFESTYLE},
      {"newsChannelMusic", IDS_LUXXLE_NEWS_CHANNEL_MUSIC},
      {"newsChannelPolitics", IDS_LUXXLE_NEWS_CHANNEL_POLITICS},
      {"newsChannelRegionalNews", IDS_LUXXLE_NEWS_CHANNEL_REGIONAL_NEWS},
      {"newsChannelScience", IDS_LUXXLE_NEWS_CHANNEL_SCIENCE},
      {"newsChannelSports", IDS_LUXXLE_NEWS_CHANNEL_SPORTS},
      {"newsChannelTravel", IDS_LUXXLE_NEWS_CHANNEL_TRAVEL},
      {"newsChannelTechnology", IDS_LUXXLE_NEWS_CHANNEL_TECHNOLOGY},
      {"newsChannelTopNews", IDS_LUXXLE_NEWS_CHANNEL_TOP_NEWS},
      {"newsChannelTopSources", IDS_LUXXLE_NEWS_CHANNEL_TOP_SOURCES},
      {"newsChannelUKNews", IDS_LUXXLE_NEWS_CHANNEL_UK_NEWS},
      {"newsChannelUSNews", IDS_LUXXLE_NEWS_CHANNEL_US_NEWS},
      {"newsChannelWeather", IDS_LUXXLE_NEWS_CHANNEL_WEATHER},
      {"newsChannelWorldNews", IDS_LUXXLE_NEWS_CHANNEL_WORLD_NEWS},
      {"newsConnectionErrorText", IDS_LUXXLE_NEWS_OFFLINE_MESSAGE},
      {"newsConnectionErrorTitle", IDS_LUXXLE_NEWS_OFFLINE_TITLE},
      {"newsContentAvailableButtonLabel", IDS_LUXXLE_NEWS_NEW_CONTENT_AVAILABLE},
      {"newsDiscoverTitle", IDS_LUXXLE_NEWS_SOURCES_RECOMMENDATION},
      {"newsEnableButtonLabel", IDS_LUXXLE_NEWS_OPT_IN_ACTION_LABEL},
      {"newsEnableText", IDS_LUXXLE_NEWS_INTRO_TITLE},
      {"newsFeedAllTitle", IDS_LUXXLE_NEWS_FOR_YOU_FEED},
      {"newsFeedChannelsTitle", IDS_LUXXLE_NEWS_BROWSE_CHANNELS_HEADER},
      {"newsFeedFollowingTitle", IDS_LUXXLE_NEWS_FEEDS_HEADING},
      {"newsFeedPublishersTitle", IDS_LUXXLE_NEWS_PUBLISHERS_HEADING},
      {"newsHidePublisherLabel", IDS_LUXXLE_NEWS_HIDE_CONTENT_FROM},
      {"newsNoArticlesText", IDS_LUXXLE_NEWS_NO_ARTICLES_MESSAGE},
      {"newsNoArticlesTitle", IDS_LUXXLE_NEWS_NO_ARTICLES_TITLE},
      {"newsNoFeedsText", IDS_LUXXLE_NEWS_NO_CONTENT_MESSAGE},
      {"newsNoFeedsTitle", IDS_LUXXLE_NEWS_NO_CONTENT_HEADING},
      {"newsNoMatchingFeedsText", IDS_LUXXLE_NEWS_DIRECT_SEARCH_NO_RESULTS},
      {"newsQueryTooShortText", IDS_LUXXLE_NEWS_SEARCH_QUERY_TOO_SHORT},
      {"newsRefreshButtonLabel", IDS_LUXXLE_NEWS_REFRESH_FEED},
      {"newsSearchFeedsButtonLabel", IDS_LUXXLE_NEWS_DIRECT_SEARCH_BUTTON},
      {"newsSettingsChannelsTitle", IDS_LUXXLE_NEWS_BROWSE_CHANNELS_HEADER},
      {"newsSettingsDiscoverTitle", IDS_LUXXLE_NEWS_DISCOVER_TITLE},
      {"newsSettingsFollowingTitle", IDS_LUXXLE_NEWS_FEEDS_HEADING},
      {"newsSettingsPopularTitle", IDS_LUXXLE_NEWS_POPULAR_TITLE},
      {"newsSettingsQueryPlaceholder", IDS_LUXXLE_NEWS_SEARCH_PLACEHOLDER_LABEL},
      {"newsSettingsSourcesTitle", IDS_LUXXLE_NEWS_ALL_SOURCES_HEADER},
      {"newsSettingsSuggestionsText", IDS_LUXXLE_NEWS_SUGGESTIONS_SUBTITLE},
      {"newsSettingsSuggestionsTitle", IDS_LUXXLE_NEWS_SUGGESTIONS_TITLE},
      {"newsSettingsTitle", IDS_LUXXLE_NEWS_SETTINGS_TITLE},
      {"newsUnfollowButtonLabel", IDS_LUXXLE_NEWS_FOLLOW_BUTTON_FOLLOWING},
      {"newsViewAllButtonLabel", IDS_LUXXLE_NEWS_VIEW_ALL_BUTTON},
      ...
      {"searchBoxPlaceholderTextLuxxle",
       IDS_NEW_TAB_SEARCH_BOX_PLACEHOLDER_TEXT_LUXXLE},
