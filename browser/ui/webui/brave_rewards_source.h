...
#ifndef LUXXLE_BROWSER_UI_WEBUI_BRAVE_REWARDS_SOURCE_H_
#define LUXXLE_BROWSER_UI_WEBUI_BRAVE_REWARDS_SOURCE_H_
...
#endif  // LUXXLE_BROWSER_UI_WEBUI_BRAVE_REWARDS_SOURCE_H_
