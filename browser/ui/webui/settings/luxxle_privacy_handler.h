...
#ifndef LUXXLE_BROWSER_UI_WEBUI_SETTINGS_LUXXLE_PRIVACY_HANDLER_H_
#define LUXXLE_BROWSER_UI_WEBUI_SETTINGS_LUXXLE_PRIVACY_HANDLER_H_
...
class LuxxlePrivacyHandler : public settings::SettingsPageUIHandler {
 public:
  LuxxlePrivacyHandler();
  LuxxlePrivacyHandler(const LuxxlePrivacyHandler&) = delete;
  LuxxlePrivacyHandler& operator=(const LuxxlePrivacyHandler&) = delete;
  ~LuxxlePrivacyHandler() override;
...
#endif  // LUXXLE_BROWSER_UI_WEBUI_SETTINGS_LUXXLE_PRIVACY_HANDLER_H_
