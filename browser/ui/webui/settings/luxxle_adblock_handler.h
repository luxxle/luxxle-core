...
#ifndef LUXXLE_BROWSER_UI_WEBUI_SETTINGS_LUXXLE_ADBLOCK_HANDLER_H_
#define LUXXLE_BROWSER_UI_WEBUI_SETTINGS_LUXXLE_ADBLOCK_HANDLER_H_
...
class Profile;
using luxxle_shields::AdBlockSubscriptionServiceManager;
using luxxle_shields::AdBlockSubscriptionServiceManagerObserver;

class LuxxleAdBlockHandler : public settings::SettingsPageUIHandler,
                            public AdBlockSubscriptionServiceManagerObserver {
 public:
  LuxxleAdBlockHandler();
  LuxxleAdBlockHandler(const LuxxleAdBlockHandler&) = delete;
  LuxxleAdBlockHandler& operator=(const LuxxleAdBlockHandler&) = delete;
  ~LuxxleAdBlockHandler() override;
 ...
 private:
  ...
  base::WeakPtrFactory<LuxxleAdBlockHandler> weak_factory_{this};
};

#endif  // LUXXLE_BROWSER_UI_WEBUI_SETTINGS_LUXXLE_ADBLOCK_HANDLER_H_
