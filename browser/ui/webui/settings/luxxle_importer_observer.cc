...
LuxxleImporterObserver::LuxxleImporterObserver(
...
void LuxxleImporterObserver::ImportStarted() {
...
void LuxxleImporterObserver::ImportItemStarted(importer::ImportItem item) {
  base::Value::Dict data;
  data.Set("importer_name", source_profile_.importer_name);
  data.Set("importer_type", source_profile_.importer_type);
  data.Set("items_to_import", imported_items_);
...
void LuxxleImporterObserver::ImportItemEnded(importer::ImportItem item) {
  base::Value::Dict data;
  data.Set("importer_name", source_profile_.importer_name);
  data.Set("importer_type", source_profile_.importer_type);
  data.Set("items_to_import", imported_items_);
...
void LuxxleImporterObserver::ImportEnded() {
  base::Value::Dict data;
  data.Set("importer_name", source_profile_.importer_name);
  data.Set("importer_type", source_profile_.importer_type);
  data.Set("items_to_import", imported_items_);
...
LuxxleImporterObserver::GetImporterHostForTesting() {
