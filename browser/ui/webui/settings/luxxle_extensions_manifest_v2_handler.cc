...
LuxxleExtensionsManifestV2Handler::LuxxleExtensionsManifestV2Handler() {
  // NoScript
...
LuxxleExtensionsManifestV2Handler::~LuxxleExtensionsManifestV2Handler() = default;

void LuxxleExtensionsManifestV2Handler::RegisterMessages() {
  web_ui()->RegisterMessageCallback(
      "getExtensionsManifestV2",
      base::BindRepeating(
          &LuxxleExtensionsManifestV2Handler::GetExtensionsManifestV2,
          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "enableExtensionManifestV2",
      base::BindRepeating(
          &LuxxleExtensionsManifestV2Handler::EnableExtensionManifestV2,
          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "removeExtensionManifestV2",
      base::BindRepeating(
          &LuxxleExtensionsManifestV2Handler::RemoveExtensionManifestV2,
          base::Unretained(this)));

  observation_.Observe(GetExtensionRegistry());
}

void LuxxleExtensionsManifestV2Handler::OnExtensionLoaded(
...
void LuxxleExtensionsManifestV2Handler::OnExtensionUnloaded(
    content::BrowserContext* browser_context,
    const extensions::Extension* extension,
...
void LuxxleExtensionsManifestV2Handler::OnExtensionInstalled(
    content::BrowserContext* browser_context,
    const extensions::Extension* extension,
    bool is_update) {
  DCHECK(extension);
...
void LuxxleExtensionsManifestV2Handler::OnExtensionUninstalled(
    content::BrowserContext* browser_context,
    const extensions::Extension* extension,
...
void LuxxleExtensionsManifestV2Handler::NotifyExtensionManifestV2Changed(
    content::BrowserContext* browser_context,
    const std::string& id) {
  ...
  FireWebUIListener("luxxle-extension-manifest-v2-changed");
}

extensions::ExtensionRegistry*
LuxxleExtensionsManifestV2Handler::GetExtensionRegistry() {
  return extensions::ExtensionRegistry::Get(
      web_ui()->GetWebContents()->GetBrowserContext());
}

void LuxxleExtensionsManifestV2Handler::EnableExtensionManifestV2(
  ...
  if (enable) {
    if (!installed) {
      installer_ = base::MakeRefCounted<ExtensionWebstoreInstaller>(
          ...
          base::BindOnce(
              &LuxxleExtensionsManifestV2Handler::OnExtensionManifestV2Installed,
...
void LuxxleExtensionsManifestV2Handler::RemoveExtensionManifestV2(
    const base::Value::List& args) {
...
void LuxxleExtensionsManifestV2Handler::GetExtensionsManifestV2(
    const base::Value::List& args) {
...
void LuxxleExtensionsManifestV2Handler::OnExtensionManifestV2Installed(
