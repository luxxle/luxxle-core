...
#ifndef LUXXLE_BROWSER_UI_WEBUI_SETTINGS_LUXXLE_IMPORTER_OBSERVER_H_
#define LUXXLE_BROWSER_UI_WEBUI_SETTINGS_LUXXLE_IMPORTER_OBSERVER_H_
...
class LuxxleImporterObserver : public importer::ImporterProgressObserver {
 public:
  using ReportProgressCallback = base::RepeatingCallback<void(
      const importer::SourceProfile& source_profile,
      const base::Value::Dict&)>;

  LuxxleImporterObserver(ExternalProcessImporterHost* host,
                        const importer::SourceProfile& source_profile,
                        uint16_t imported_items,
                        ReportProgressCallback callback);
  ~LuxxleImporterObserver() override;
...
#endif  // LUXXLE_BROWSER_UI_WEBUI_SETTINGS_LUXXLE_IMPORTER_OBSERVER_H_
