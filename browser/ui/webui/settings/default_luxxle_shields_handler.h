...
#ifndef LUXXLE_BROWSER_UI_WEBUI_SETTINGS_DEFAULT_LUXXLE_SHIELDS_HANDLER_H_
#define LUXXLE_BROWSER_UI_WEBUI_SETTINGS_DEFAULT_LUXXLE_SHIELDS_HANDLER_H_
...
class DefaultLuxxleShieldsHandler
    : public settings::SettingsPageUIHandler,
      public content_settings::Observer,
      public content_settings::CookieSettings::Observer {
 public:
  DefaultLuxxleShieldsHandler();
  DefaultLuxxleShieldsHandler(const DefaultLuxxleShieldsHandler&) = delete;
  DefaultLuxxleShieldsHandler& operator=(const DefaultLuxxleShieldsHandler&) =
      delete;
  ~DefaultLuxxleShieldsHandler() override;
 ...
 private:
  ...
  base::WeakPtrFactory<DefaultLuxxleShieldsHandler> weak_ptr_factory_{this};
};

#endif  // LUXXLE_BROWSER_UI_WEBUI_SETTINGS_DEFAULT_LUXXLE_SHIELDS_HANDLER_H_
