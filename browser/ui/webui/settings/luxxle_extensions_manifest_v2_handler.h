...
#ifndef LUXXLE_BROWSER_UI_WEBUI_SETTINGS_LUXXLE_EXTENSIONS_MANIFEST_V2_HANDLER_H_
#define LUXXLE_BROWSER_UI_WEBUI_SETTINGS_LUXXLE_EXTENSIONS_MANIFEST_V2_HANDLER_H_
...
class LuxxleExtensionsManifestV2Handler
    : public settings::SettingsPageUIHandler,
      public extensions::ExtensionRegistryObserver {
 public:
  LuxxleExtensionsManifestV2Handler();
  LuxxleExtensionsManifestV2Handler(const LuxxleExtensionsManifestV2Handler&) =
      delete;
  LuxxleExtensionsManifestV2Handler& operator=(
      const LuxxleExtensionsManifestV2Handler&) = delete;
  ~LuxxleExtensionsManifestV2Handler() override;
 ...
 private:
  ...
  base::WeakPtrFactory<LuxxleExtensionsManifestV2Handler> weak_factory_{this};
};

#endif  // LUXXLE_BROWSER_UI_WEBUI_SETTINGS_LUXXLE_EXTENSIONS_MANIFEST_V2_HANDLER_H_
