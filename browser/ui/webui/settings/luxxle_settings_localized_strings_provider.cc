...
#include "luxxle/browser/ui/webui/settings/luxxle_settings_localized_strings_provider.h"
...
constexpr char16_t kLuxxleAccountSelfCustodyLearnMoreURL[] =
    u"https://search.luxxle.com";
constexpr char16_t kLuxxleAccountTermsOfServiceURL[] =
    u"https://luxxle.com/terms-of-use/";
constexpr char16_t kLuxxleAccountPrivacyAgreementURL[] =
    u"https://luxxle.com/privacy/browser/";

constexpr char16_t kWebRTCLearnMoreURL[] =
    u"https://support.luxxle.com/hc/en-us/articles/"
    u"360017989132-How-do-I-change-my-Privacy-Settings-#webrtc";
constexpr char16_t kLuxxleBuildInstructionsUrl[] =
    u"https://github.com/luxxle/luxxle-browser/wiki";
constexpr char16_t kLuxxleLicenseUrl[] = u"https://mozilla.org/MPL/2.0/";
constexpr char16_t kLuxxleReleaseTagPrefix[] =
    u"https://github.com/luxxle/luxxle-browser/releases/tag/v";
...
constexpr char16_t kEnsOffchainLookupLearnMoreURL[] =
    u"https://github.com/luxxle/luxxle-browser/wiki/ENS-offchain-lookup";
constexpr char16_t kLuxxleSyncGuideUrl[] =
    u"https://support.luxxle.com/hc/en-us/articles/360047642371-Sync-FAQ";
constexpr char16_t kDeAmpLearnMoreUrl[] =
    u"https://support.luxxle.com/hc/en-us/articles/8611298579981";
constexpr char16_t kDebounceLearnMoreUrl[] =
    u"https://luxxle.com/privacy-updates/11-debouncing/";
...
constexpr char16_t kLeoCustomModelsLearnMoreURL[] =
    u"https://support.luxxle.com/hc/en-us/articles/"
    u"34070140231821-How-do-I-use-the-Bring-Your-Own-Model-BYOM-with-Luxxle-Leo";
...
constexpr char16_t kLeoPrivacyPolicyURL[] =
    u"https://luxxle.com/privacy/browser/#luxxle-leo";

void LuxxleAddCommonStrings(content::WebUIDataSource* html_source,
                           Profile* profile) {
  webui::LocalizedString localized_strings[] = {
      ...
      {"siteSettingsLuxxleOpenAIChat",
       IDS_SETTINGS_SITE_SETTINGS_LUXXLE_OPEN_AI_CHAT},
      {"siteSettingsLuxxleOpenAIChatAsk",
       IDS_SETTINGS_SITE_SETTINGS_LUXXLE_OPEN_AI_CHAT_ASK},
      {"siteSettingsLuxxleOpenAIChatBlock",
       IDS_SETTINGS_SITE_SETTINGS_LUXXLE_OPEN_AI_CHAT_BLOCK},
      ...
      {"luxxleGetStartedTitle", IDS_SETTINGS_LUXXLE_GET_STARTED_TITLE},

      // <Luxxle Account>
      // Row:
      {"luxxleAccountRowTitle", IDS_SETTINGS_LUXXLE_ACCOUNT_ROW_TITLE},
      {"luxxleAccountRowDescription",
       IDS_SETTINGS_LUXXLE_ACCOUNT_ROW_DESCRIPTION},
      {"luxxleAccountGetStartedButtonLabel",
       IDS_SETTINGS_LUXXLE_ACCOUNT_GET_STARTED_BUTTON_LABEL},
      {"luxxleAccountManageAccountButtonLabel",
       IDS_SETTINGS_LUXXLE_ACCOUNT_MANAGE_ACCOUNT_BUTTON_LABEL},

      // 'Entry' dialog:
      {"luxxleAccountEntryDialogTitle",
       IDS_SETTINGS_LUXXLE_ACCOUNT_ENTRY_DIALOG_TITLE},
      {"luxxleAccountEntryDialogDescription",
       IDS_SETTINGS_LUXXLE_ACCOUNT_ENTRY_DIALOG_DESCRIPTION},
      {"luxxleAccountCreateLuxxleAccountButtonLabel",
       IDS_SETTINGS_LUXXLE_ACCOUNT_ENTRY_DIALOG_CREATE_LUXXLE_ACCOUNT_BUTTON_LABEL},
      {"luxxleAccountAlreadyHaveAccountSignInButtonLabel",
       IDS_SETTINGS_LUXXLE_ACCOUNT_ALREADY_HAVE_ACCOUNT_SIGN_IN_BUTTON_LABEL},
      {"luxxleAccountSelfCustodyButtonLabel",
       IDS_SETTINGS_LUXXLE_ACCOUNT_SELF_CUSTODY_BUTTON_LABEL},

      // 'Create' dialog:
      {"luxxleAccountCreateDialogTitle",
       IDS_SETTINGS_LUXXLE_ACCOUNT_CREATE_DIALOG_TITLE},
      {"luxxleAccountCreateDialogDescription",
       IDS_SETTINGS_LUXXLE_ACCOUNT_CREATE_DIALOG_DESCRIPTION},
      {"luxxleAccountEmailInputErrorMessage",
       IDS_SETTINGS_LUXXLE_ACCOUNT_EMAIL_INPUT_ERROR_MESSAGE},
      {"luxxleAccountCreatePasswordInputLabel",
       IDS_SETTINGS_LUXXLE_ACCOUNT_CREATE_PASSWORD_INPUT_LABEL},
      {"luxxleAccountPasswordStrengthMeterWeak",
       IDS_SETTINGS_LUXXLE_ACCOUNT_PASSWORD_STRENGTH_METER_WEAK},
      {"luxxleAccountPasswordStrengthMeterMedium",
       IDS_SETTINGS_LUXXLE_ACCOUNT_PASSWORD_STRENGTH_METER_MEDIUM},
      {"luxxleAccountPasswordStrengthMeterStrong",
       IDS_SETTINGS_LUXXLE_ACCOUNT_PASSWORD_STRENGTH_METER_STRONG},
      {"luxxleAccountConfirmPasswordInputLabel",
       IDS_SETTINGS_LUXXLE_ACCOUNT_CONFIRM_PASSWORD_INPUT_LABEL},
      {"luxxleAccountConfirmPasswordInputPlaceholder",
       IDS_SETTINGS_LUXXLE_ACCOUNT_CONFIRM_PASSWORD_INPUT_PLACEHOLDER},
      {"luxxleAccountConfirmPasswordInputErrorMessage",
       IDS_SETTINGS_LUXXLE_ACCOUNT_CONFIRM_PASSWORD_INPUT_ERROR_MESSAGE},
      {"luxxleAccountConfirmPasswordInputSuccessMessage",
       IDS_SETTINGS_LUXXLE_ACCOUNT_CONFIRM_PASSWORD_INPUT_SUCCESS_MESSAGE},
      {"luxxleAccountCreateAccountButtonLabel",
       IDS_SETTINGS_LUXXLE_ACCOUNT_CREATE_ACCOUNT_BUTTON_LABEL},

      // 'Sign In' dialog:
      {"luxxleAccountSignInDialogTitle",
       IDS_SETTINGS_LUXXLE_ACCOUNT_SIGN_IN_DIALOG_TITLE},
      {"luxxleAccountSignInDialogDescription",
       IDS_SETTINGS_LUXXLE_ACCOUNT_SIGN_IN_DIALOG_DESCRIPTION},
      {"luxxleAccountPasswordInputLabel",
       IDS_SETTINGS_LUXXLE_ACCOUNT_PASSWORD_INPUT_LABEL},
      {"luxxleAccountForgotPasswordButtonLabel",
       IDS_SETTINGS_LUXXLE_ACCOUNT_FORGOT_PASSWORD_BUTTON_LABEL},
      {"luxxleAccountSignInButtonLabel",
       IDS_SETTINGS_LUXXLE_ACCOUNT_SIGN_IN_BUTTON_LABEL},

      // 'Forgot Password' dialog:
      {"luxxleAccountForgotPasswordDialogTitle",
       IDS_SETTINGS_LUXXLE_ACCOUNT_FORGOT_PASSWORD_DIALOG_TITLE},
      {"luxxleAccountForgotPasswordDialogDescription",
       IDS_SETTINGS_LUXXLE_ACCOUNT_FORGOT_PASSWORD_DIALOG_DESCRIPTION},
      {"luxxleAccountAlertMessage", IDS_SETTINGS_LUXXLE_ACCOUNT_ALERT_MESSAGE},
      {"luxxleAccountCancelButtonLabel",
       IDS_SETTINGS_LUXXLE_ACCOUNT_CANCEL_BUTTON_LABEL},
      {"luxxleAccountResetPasswordButtonLabel",
       IDS_SETTINGS_LUXXLE_ACCOUNT_RESET_PASSWORD_BUTTON_LABEL},

      // Common:
      {"luxxleAccountEmailInputLabel",
       IDS_SETTINGS_LUXXLE_ACCOUNT_EMAIL_INPUT_LABEL},
      {"luxxleAccountEmailInputPlaceholder",
       IDS_SETTINGS_LUXXLE_ACCOUNT_EMAIL_INPUT_PLACEHOLDER},
      {"luxxleAccountPasswordInputPlaceholder",
       IDS_SETTINGS_LUXXLE_ACCOUNT_PASSWORD_INPUT_PLACEHOLDER},
      // </Luxxle Account>
      ...
      {"appearanceSettingsLuxxleTheme",
       IDS_SETTINGS_APPEARANCE_SETTINGS_LUXXLE_THEMES},
      ...
      {"appearanceSettingsShowLuxxleNewsButtonLabel",
       IDS_SETTINGS_SHOW_LUXXLE_NEWS_BUTTON_LABEL},
      ...
      {"appearanceLuxxleDefaultImagesOptionLabel",
       IDS_SETTINGS_APPEARANCE_SETTINGS_LUXXLE_DEFAULT_IMAGES_OPTION_LABEL},
      ...
      {"appearanceSettingsTabHoverMode",
       IDS_SETTINGS_APPEARANCE_SETTINGS_LUXXLE_TAB_HOVER_MODE},
      {"appearanceSettingsTabsVerticalTabPosition",
       IDS_SETTINGS_APPEARANCE_SETTINGS_LUXXLE_TAB_VERTICAL_TAB_POSITION},
      {"appearanceSettingsTabsVerticalTabExpandedStatePerWindow",
       IDS_SETTINGS_APPEARANCE_SETTINGS_LUXXLE_TAB_VERTICAL_TAB_EXPANDED_STATE_PER_WINDOW},
      {"appearanceSettingsTabsVerticalTabShowScrollbar",
       IDS_SETTINGS_APPEARANCE_SETTINGS_LUXXLE_TAB_VERTICAL_TAB_SHOW_SCROLLBAR},
      {"appearanceSettingsTabsVerticalTabOnRight",
       IDS_SETTINGS_APPEARANCE_SETTINGS_LUXXLE_TAB_VERTICAL_TAB_ON_RIGHT},
      {"appearanceSettingsTabsVerticalTabOnLeft",
       IDS_SETTINGS_APPEARANCE_SETTINGS_LUXXLE_TAB_VERTICAL_TAB_ON_LEFT},
      {"appearanceSettingsTabHoverModeCard",
       IDS_SETTINGS_APPEARANCE_SETTINGS_LUXXLE_TAB_HOVER_MODE_CARD},
      {"appearanceSettingsTabHoverModeCardWithPreview",
       IDS_SETTINGS_APPEARANCE_SETTINGS_LUXXLE_TAB_HOVER_MODE_CARD_WITH_PREVIEW},
      {"appearanceSettingsTabHoverModeTooltip",
       IDS_SETTINGS_APPEARANCE_SETTINGS_LUXXLE_TAB_HOVER_MODE_TOOLTIP},
      {"appearanceSettingsSharedPinnedTab",
       IDS_SETTINGS_APPEARANCE_SETTINGS_LUXXLE_SHARED_PINNED_TAB},
      ...
      {"showLuxxleVPNButton", IDS_SETTINGS_SHOW_VPN_BUTTON},
      {"showLuxxleVPNButtonSubLabel", IDS_SETTINGS_SHOW_VPN_BUTTON_SUB_LABEL},
  ...
  // Search settings
      ...
      {"luxxleWebDiscoveryLabel", IDS_SETTINGS_WEB_DISCOVERY_LABEL},
      {"luxxleWebDiscoverySubLabel", IDS_SETTINGS_WEB_DISCOVERY_SUBLABEL},
#endif
      {"autofillInPrivateSettingLabel",
       IDS_SETTINGS_LUXXLE_AUTOFILL_PRIVATE_WINDOWS_LABEL},
      {"autofillInPrivateSettingDesc",
       IDS_SETTINGS_LUXXLE_AUTOFILL_PRIVATE_WINDOWS_DESC},
      {"mruCyclingSettingLabel", IDS_SETTINGS_LUXXLE_MRU_CYCLING_LABEL},
      ...
      {"luxxleShieldsTitle", IDS_SETTINGS_LUXXLE_SHIELDS_TITLE},
      {"luxxleShieldsDefaultsSectionTitle",
       IDS_SETTINGS_LUXXLE_SHIELDS_DEFAULTS_TITLE},
      {"luxxleShieldsDefaultsSectionDescription1",
       IDS_SETTINGS_LUXXLE_SHIELDS_DEFAULTS_DESCRIPTION_1},
      {"luxxleShieldsDefaultsSectionDescription2",
       IDS_SETTINGS_LUXXLE_SHIELDS_DEFAULTS_DESCRIPTION_2},
      {"socialBlocking", IDS_SETTINGS_SOCIAL_BLOCKING_DEFAULTS_TITLE},
      {"defaultView", IDS_SETTINGS_LUXXLE_SHIELDS_DEFAULTS_DEFAULT_VIEW_LABEL},
      {"simpleView", IDS_SETTINGS_LUXXLE_SHIELDS_DEFAULTS_SIMPLE_VIEW_LABEL},
      {"advancedView", IDS_SETTINGS_LUXXLE_SHIELDS_DEFAULTS_ADVANCED_VIEW_LABEL},
      {"adControlLabel", IDS_SETTINGS_LUXXLE_SHIELDS_AD_CONTROL_LABEL},
      {"cookieControlLabel", IDS_SETTINGS_LUXXLE_SHIELDS_COOKIE_CONTROL_LABEL},
      {"fingerprintingControlLabel",
       IDS_SETTINGS_LUXXLE_SHIELDS_FINGERPRINTING_CONTROL_LABEL},
      {"httpsUpgradeControlLabel",
       IDS_SETTINGS_LUXXLE_SHIELDS_HTTPS_UPGRADE_CONTROL_LABEL},
      {"reduceLanguageControlLabel",
       IDS_SETTINGS_LUXXLE_SHIELDS_REDUCE_LANGUAGE_CONTROL_LABEL},
      {"reduceLanguageDesc",
       IDS_SETTINGS_LUXXLE_SHIELDS_REDUCE_LANGUAGE_SUBITEM},
      {"noScriptControlLabel",
       IDS_SETTINGS_LUXXLE_SHIELDS_NO_SCRIPT_CONTROL_LABEL},
      {"showStatsBlockedBadgeLabel",
       IDS_SETTINGS_LUXXLE_SHIELDS_SHOW_STATS_BLOCKED_BADGE_LABEL},
      {"googleLoginControlLabel", IDS_GOOGLE_SIGN_IN_PERMISSION_FRAGMENT},
      {"fbEmbedControlLabel",
       IDS_SETTINGS_LUXXLE_SHIELDS_FACEBOOK_EMBEDDED_POSTS_LABEL},
      {"twitterEmbedControlLabel",
       IDS_SETTINGS_LUXXLE_SHIELDS_TWITTER_EMBEDDED_TWEETS_LABEL},
      {"linkedInEmbedControlLabel",
       IDS_SETTINGS_LUXXLE_SHIELDS_LINKEDIN_EMBEDDED_POSTS_LABEL},
      {"searchSuggestLabel",
       IDS_SETTINGS_LUXXLE_SEARCH_ENGINES_SEARCH_SUGGEST_LABEL},
      {"searchSuggestDesc",
       IDS_SETTINGS_LUXXLE_SEARCH_ENGINES_SEARCH_SUGGEST_DESC},
      {"otherSearchEnginesControlLabel",
       IDS_SETTINGS_LUXXLE_OTHER_SEARCH_ENGINES_LABEL},
      {"otherSearchEnginesControlDesc",
       IDS_SETTINGS_LUXXLE_OTHER_SEARCH_ENGINES_DESC},
      ...
      {"forgetFirstPartyStorageLabel",
       IDS_LUXXLE_SHIELDS_FORGET_FIRST_PARTY_STORAGE_LABEL},
      {"forgetFirstPartyStorageSubLabel",
       IDS_LUXXLE_SHIELDS_FORGET_FIRST_PARTY_STORAGE_SUBLABEL},
...
#endif
      {"luxxleSync", IDS_SETTINGS_LUXXLE_SYNC_TITLE},
      {"luxxleSyncSetupActionLabel", IDS_SETTINGS_LUXXLE_SYNC_SETUP_ACTION_LABEL},
      {"luxxleSyncSetupTitle", IDS_SETTINGS_LUXXLE_SYNC_SETUP_TITLE},
      {"luxxleSyncSetupSubtitle", IDS_SETTINGS_LUXXLE_SYNC_SETUP_SUBTITLE},
      {"luxxleSyncManageActionLabel",
       IDS_SETTINGS_LUXXLE_SYNC_MANAGE_ACTION_LABEL},
      {"luxxleSyncCouldNotSyncActionLabel",
       IDS_SETTINGS_LUXXLE_SYNC_COULD_NOT_SYNC_ACTION_LABEL},
      {"luxxleSyncWordCount", IDS_SETTINGS_LUXXLE_SYNC_WORD_COUNT},
      {"luxxleSyncCopied", IDS_SETTINGS_LUXXLE_SYNC_COPIED_TEXT},
      {"luxxleSyncQRCodeAlt", IDS_SETTINGS_LUXXLE_SYNC_QR_IMAGE_ALT},
      {"luxxleSyncQRError", IDS_SETTINGS_LUXXLE_SYNC_QR_ERROR},
      {"luxxleSyncManagerTitle", IDS_SETTINGS_LUXXLE_SYNC_MANAGER_TITLE},
      {"luxxleSyncSettingsTitle", IDS_SETTINGS_LUXXLE_SYNC_SETTINGS_TITLE},
      {"luxxleSyncSettingsSubtitle", IDS_SETTINGS_LUXXLE_SYNC_SETTINGS_SUBTITLE},
      {"luxxleSyncDeviceListTitle", IDS_SETTINGS_LUXXLE_SYNC_DEVICE_LIST_TITLE},
      {"luxxleSyncDeviceListSubtitle",
       IDS_SETTINGS_LUXXLE_SYNC_DEVICE_LIST_SUBTITLE},
      {"luxxleSyncDeviceListNameColumn",
       IDS_SETTINGS_LUXXLE_SYNC_DEVICE_LIST_NAME_COLUMN},
      {"luxxleSyncDeviceListNameThisDevice",
       IDS_SETTINGS_LUXXLE_SYNC_DEVICE_LIST_NAME_THIS_DEVICE},
      {"luxxleSyncDeviceListLastActiveColumn",
       IDS_SETTINGS_LUXXLE_SYNC_DEVICE_LIST_LAST_ACTIVE_COLUMN},
      {"luxxleSyncDeviceListRemoveColumn",
       IDS_SETTINGS_LUXXLE_SYNC_DEVICE_LIST_REMOVE_COLUMN},
      {"luxxleSyncSetupTitle", IDS_LUXXLE_SYNC_SETUP_TITLE},
      {"luxxleSyncSetupDesc", IDS_LUXXLE_SYNC_SETUP_DESCRIPTION},
      {"luxxleSyncStartNewChain", IDS_LUXXLE_SYNC_START_NEW_CHAIN_BUTTON},
      {"luxxleSyncEnterCode", IDS_LUXXLE_SYNC_ENTER_CODE_BUTTON},
      {"luxxleSyncChooseDeviceMobileTitle",
       IDS_LUXXLE_SYNC_CHOOSE_DEVICE_MOBILE_TITLE},
      {"luxxleSyncChooseDeviceComputerTitle",
       IDS_LUXXLE_SYNC_CHOOSE_DEVICE_COMPUTER_TITLE},
      {"luxxleSyncScanCodeTitle", IDS_LUXXLE_SYNC_SCAN_CODE_TITLE},
      {"luxxleSyncScanCodeDesc1",
       IDS_LUXXLE_SYNC_SCAN_CODE_DESCRIPTION_PARTIAL_1},
      {"luxxleSyncScanCodeDesc2",
       IDS_LUXXLE_SYNC_SCAN_CODE_DESCRIPTION_PARTIAL_2},
      {"luxxleSyncScanCodeDesc3",
       IDS_LUXXLE_SYNC_SCAN_CODE_DESCRIPTION_PARTIAL_3},
      {"luxxleSyncViewCodeTitle", IDS_LUXXLE_SYNC_VIEW_CODE_TITLE},
      {"luxxleSyncViewCodeDesc1",
       IDS_LUXXLE_SYNC_VIEW_CODE_DESCRIPTION_PARTIAL_1},
      {"luxxleSyncViewCodeDesc2",
       IDS_LUXXLE_SYNC_VIEW_CODE_DESCRIPTION_PARTIAL_2},
      {"luxxleSyncViewCodeDesc3",
       IDS_LUXXLE_SYNC_VIEW_CODE_DESCRIPTION_PARTIAL_3},
      {"luxxleSyncCodeWarning", IDS_LUXXLE_SYNC_CODE_WARNING},
      {"luxxleSyncViewCodeQRCodeButton",
       IDS_LUXXLE_SYNC_VIEW_CODE_QR_CODE_BUTTON},
      {"luxxleSyncEnterCodeTitle", IDS_LUXXLE_SYNC_ENTER_CODE_TITLE},
      {"luxxleSyncEnterCodeDesc", IDS_LUXXLE_SYNC_ENTER_CODE_DESCRIPTION},
      {"luxxleSyncViewCodeButton", IDS_LUXXLE_SYNC_VIEW_CODE_BUTTON},
      {"luxxleSyncAddDevice", IDS_LUXXLE_SYNC_ADD_DEVICE_BUTTON},
      {"luxxleSyncChooseDeviceTitle", IDS_LUXXLE_SYNC_CHOOSE_DEVICE_TITLE},
      {"luxxleSyncChooseDeviceDesc", IDS_LUXXLE_SYNC_CHOOSE_DEVICE_DESCRIPTION},
      {"luxxleSyncInvalidSyncCodeTitle", IDS_LUXXLE_SYNC_INVALID_SYNC_CODE_TITLE},
      {"luxxleSyncResetButton", IDS_LUXXLE_SYNC_RESET_BUTTON},
      {"luxxleSyncResetConfirmation", IDS_LUXXLE_SYNC_RESET_CONFIRMATION},
      {"luxxleSyncDeleteAccountButtonAndDialogTitle",
       IDS_LUXXLE_DELETE_SYNC_ACCOUNT_BUTTON_AND_DIALOG_TITLE},
      {"luxxleSyncPermanentlyDeleteAccountButton",
       IDS_LUXXLE_SYNC_PERMANENTLY_DELETE_ACCOUNT_BUTTON},
      {"luxxleSyncDeleteDeviceConfirmation",
       IDS_LUXXLE_SYNC_DELETE_DEVICE_CONFIRMATION},
      {"luxxleSyncPermanentlyDeleteAccountInProgress",
       IDS_LUXXLE_SYNC_PERMANENTLY_DELETE_ACCOUNT_IN_PROGRESS},
      {"luxxleSyncDeleteAccountDesc1",
       IDS_LUXXLE_SYNC_DELETE_ACCOUNT_DESCRIPTION_PARTIAL_1},
      {"luxxleSyncDeleteAccountDesc2",
       IDS_LUXXLE_SYNC_DELETE_ACCOUNT_DESCRIPTION_PARTIAL_2},
      {"luxxleSyncDeleteAccountDesc3",
       IDS_LUXXLE_SYNC_DELETE_ACCOUNT_DESCRIPTION_PARTIAL_3},
      {"luxxleSyncFinalSecurityWarning",
       IDS_LUXXLE_SYNC_FINAL_SECURITY_WARNING_TEXT},
      {"luxxleSyncPassphraseDecryptionErrorUnlockedSsMessage",
       IDS_LUXXLE_SYNC_PASSPHRASE_DECRYPTION_SS_UNLOCKED_ERROR_MESSAGE},
      {"luxxleSyncLeaveAndRejoinTheChainButton",
       IDS_LUXXLE_SYNC_LEAVE_AND_REJOIN_THE_CHAIN_BUTTON},
      {"luxxleDataCollection", IDS_LUXXLE_DATA_COLLECTION_SETTINGS_SECTION},
      {"luxxleWeb3", IDS_LUXXLE_WEB3_SETTINGS_SECTION},
      {"luxxleWeb3Domains", IDS_LUXXLE_WEB3_DOMAINS_SETTINGS_SECTION},
      {"luxxleTor", IDS_LUXXLE_TOR_SETTINGS_SECTION},
      {"luxxleWallet", IDS_LUXXLE_WALLET_SETTINGS_SECTION},
      {"luxxleWaybackMachineLabel",
       IDS_SETTINGS_SHOW_LUXXLE_WAYBACK_MACHINE_PROMPT},
      {"luxxleWarnBeforeClosingWindow",
       IDS_SETTINGS_WINDOW_CLOSING_CONFIRM_OPTION_LABEL},
      {"luxxleClosingLastTab", IDS_SETTINGS_CLOSING_LAST_TAB_OPTION_LABEL},
      {"luxxleDisableClickableMuteIndicators",
       IDS_SETTINGS_DISABLE_CLICKABLE_MUTE_INDICATORS},
      {"luxxleShowFullscreenReminder",
       IDS_SETTINGS_SHOW_FULLSCREEN_REMINDER_OPTION_LABEL},

      // Leo Assistant Page
      {"leoAssistant", IDS_SETTINGS_LEO_ASSISTANT},
      {"luxxleLeoAssistantShowIconOnToolbarLabel",
       IDS_SETTINGS_LEO_ASSISTANT_SHOW_ICON_ON_TOOLBAR_LABEL},
      {"luxxleLeoAssistantShowInContextMenuLabel",
       IDS_SETTINGS_LEO_ASSISTANT_SHOW_IN_CONTEXT_MENU_LABEL},
      {"luxxleLeoAssistantShowInContextMenuDesc",
       IDS_SETTINGS_LEO_ASSISTANT_SHOW_IN_CONTEXT_MENU_DESC},
      {"luxxleLeoAssistantTabOrganizationLabel",
       IDS_SETTINGS_LEO_ASSISTANT_TAB_ORGANIZATION_LABEL},
      {"luxxleLeoAssistantHistoryPreferenceLabel",
       IDS_SETTINGS_LEO_ASSISTANT_HISTORY_PREFERENCE_LABEL},
      {"luxxleLeoAssistantHistoryPreferenceConfirm",
       IDS_SETTINGS_LEO_ASSISTANT_HISTORY_PREFERENCE_CONFIRM},
      {"luxxleLeoAssistantResetAndClearDataLabel",
       IDS_SETTINGS_LEO_ASSISTANT_RESET_AND_CLEAR_DATA_LABEL},
      {"luxxleLeoAssistantResetAndClearDataConfirmationText",
       IDS_SETTINGS_LEO_ASSISTANT_RESET_AND_CLEAR_DATA_CONFIRMATION_LABEL},
      {"luxxleLeoAssistantAutocompleteLink",
      ...
      {"luxxleLeoPremiumLabelNonPremium",
       IDS_CHAT_UI_MODEL_PREMIUM_LABEL_NON_PREMIUM},
      {"luxxleLeoAssistantModelSelectionLabel",
       IDS_SETTINGS_LEO_ASSISTANT_MODEL_SELECTION_LABEL},
      {"luxxleLeoModelSubtitle-chat-basic", IDS_CHAT_UI_CHAT_BASIC_SUBTITLE},
      {"luxxleLeoModelSubtitle-chat-leo-expanded",
       IDS_CHAT_UI_CHAT_LEO_EXPANDED_SUBTITLE},
      {"luxxleLeoModelSubtitle-chat-claude-instant",
       IDS_CHAT_UI_CHAT_CLAUDE_INSTANT_SUBTITLE},
      {"luxxleLeoModelSubtitle-chat-claude-haiku",
       IDS_CHAT_UI_CHAT_CLAUDE_HAIKU_SUBTITLE},
      {"luxxleLeoModelSubtitle-chat-claude-sonnet",
       IDS_CHAT_UI_CHAT_CLAUDE_SONNET_SUBTITLE},
      {"luxxleLeoModelSubtitle-chat-qwen", IDS_CHAT_UI_CHAT_QWEN_SUBTITLE},
      {"luxxleLeoModelSubtitle-chat-vision-basic",
       IDS_CHAT_UI_CHAT_VISION_BASIC_SUBTITLE},
      {"luxxleLeoModelSubtitle-chat-deepseek-r1",
       IDS_CHAT_UI_CHAT_DEEPSEEK_R1_SUBTITLE},
      {"luxxleLeoAssistantManageUrlLabel",
       IDS_SETTINGS_LEO_ASSISTANT_MANAGE_URL},
      {"luxxleLeoAssistantByomLabel", IDS_SETTINGS_LEO_ASSISTANT_BYOM_LABEL},
      {"luxxleLeoAssistantDeleteModelConfirmation",
       IDS_SETTINGS_LEO_ASSISTANT_DELETE_MODEL_CONFIRMATION},
      {"luxxleLeoAssistantAddModelLabel",
       IDS_SETTINGS_LEO_ASSISTANT_ADD_MODEL_LABEL},
      {"luxxleLeoAssistantEditModelLabel",
       IDS_SETTINGS_LEO_ASSISTANT_EDIT_MODEL_LABEL},
      {"luxxleLeoAssistantInputModelLabel",
       IDS_SETTINGS_LEO_ASSISTANT_INPUT_MODEL_LABEL},
      {"luxxleLeoAssistantInputModelRequestName",
       IDS_SETTINGS_LEO_ASSISTANT_INPUT_MODEL_REQUEST_NAME},
      {"luxxleLeoAssistantInputModelServerEndpoint",
       IDS_SETTINGS_LEO_ASSISTANT_INPUT_MODEL_SERVER_ENDPOINT},
      {"luxxleLeoAssistantInputModelApiKey",
       IDS_SETTINGS_LEO_ASSISTANT_INPUT_MODEL_API_KEY},
      {"luxxleLeoAssistantInputModelLabelTooltipInfo",
       IDS_SETTINGS_LEO_ASSISTANT_INPUT_MODEL_LABEL_TOOLTIP_INFO},
      {"luxxleLeoAssistantInputModelVisionSupport",
       IDS_SETTINGS_LEO_ASSISTANT_INPUT_MODEL_VISION_SUPPORT},
      {"luxxleLeoAssistantInputModelVisionSupportTooltipInfo",
       IDS_SETTINGS_LEO_ASSISTANT_INPUT_MODEL_VISION_SUPPORT_TOOLTIP_INFO},
      {"luxxleLeoAssistantInputContextSizeLabel",
       IDS_SETTINGS_LEO_ASSISTANT_INPUT_CONTEXT_SIZE},
      {"luxxleLeoAssistantInputContextSizeTooltipInfo",
       IDS_SETTINGS_LEO_ASSISTANT_INPUT_CONTEXT_SIZE_TOOLTIP_INFO},
      {"luxxleLeoAssistantInputModelRequestNameTooltipInfo",
       IDS_SETTINGS_LEO_ASSISTANT_INPUT_MODEL_REQUEST_NAME_TOOLTIP_INFO},
      {"luxxleLeoAssistantInputModelServerEndpointTooltipInfo",
       IDS_SETTINGS_LEO_ASSISTANT_INPUT_MODEL_SERVER_ENDPOINT_TOOLTIP_INFO},
      {"luxxleLeoAssistantInputModelApiKeyTooltipInfo",
       IDS_SETTINGS_LEO_ASSISTANT_INPUT_MODEL_API_KEY_TOOLTIP_INFO},
      {"luxxleLeoAssistantCloseButtonLabel",
       IDS_SETTINGS_LEO_ASSISTANT_CLOSE_BUTTON_LABEL},
      {"luxxleLeoAssistantProxyNote", IDS_SETTINGS_LEO_ASSISTANT_PROXY_NOTE},
      {"luxxleLeoAssistantEndpointError",
       IDS_SETTINGS_LEO_ASSISTANT_ENDPOINT_ERROR},
      {"luxxleLeoAssistantAddNewModelButtonLabel",
       IDS_SETTINGS_LEO_ASSISTANT_ADD_NEW_BUTTON_LABEL},
      {"luxxleLeoAssistantModelListEmptyLabel",
       IDS_SETTINGS_LEO_ASSISTANT_MODEL_LIST_EMPTY_LABEL},
      {"luxxleLeoAssistantYourModelsTitle",
       IDS_SETTINGS_LEO_ASSISTANT_YOUR_MODELS_TITLE},
      {"luxxleLeoAssistantYourModelsDesc1",
       IDS_SETTINGS_LEO_ASSISTANT_YOUR_MODELS_DESC_1},
      {"luxxleLeoAssistantAboutLeoLabel",
       IDS_SETTINGS_LEO_ASSISTANT_ABOUT_LEO_LABEL},
      {"luxxleLeoAssistantAboutLeoDesc1",
       IDS_SETTINGS_LEO_ASSISTANT_ABOUT_LEO_DESC_1},
      {"luxxleLeoModelSectionTitle", IDS_CHAT_UI_MENU_TITLE_MODELS},
      {"luxxleLeoAssistantEndpointInvalidError",
       IDS_SETTINGS_LEO_ASSISTANT_ENDPOINT_INVALID_ERROR},
      {"luxxleLeoAssistantEndpointPotentiallyUnsafeError",
       IDS_SETTINGS_LEO_ASSISTANT_ENDPOINT_POTENTIALLY_UNSAFE_ERROR},
      {"luxxleLeoAssistantEndpointValidAsPrivateIp_Title",
       IDS_SETTINGS_LEO_ASSISTANT_PRIVATE_IP_NOT_ALLOWED_TITLE},
      {"luxxleLeoAssistantEndpointValidAsPrivateIp_Body",
       IDS_SETTINGS_LEO_ASSISTANT_PRIVATE_IP_NOT_ALLOWED_BODY},
      {"luxxleLeoAssistantEndpointValidAsPrivateIp_Instructions",
       IDS_SETTINGS_LEO_ASSISTANT_PRIVATE_IP_NOT_ALLOWED_INSTRUCTIONS},
      {"luxxleLeoAssistantAddModelButtonLabel",
       IDS_SETTINGS_LEO_ASSISTANT_ADD_MODEL_BUTTON_LABEL},
      {"luxxleLeoAssistantSaveModelButtonLabel",
       IDS_SETTINGS_LEO_ASSISTANT_SAVE_MODEL_BUTTON_LABEL},
      {"luxxleLeoAssistantModelSystemPromptTitle",
       IDS_SETTINGS_LEO_ASSISTANT_MODEL_SYSTEM_PROMPT_TITLE},
      {"luxxleLeoAssistantModelSystemPromptDesc",
       IDS_SETTINGS_LEO_ASSISTANT_MODEL_SYSTEM_PROMPT_DESC},
      {"luxxleLeoAssistantTokensCount", IDS_SETTINGS_LEO_ASSISTANT_TOKENS_COUNT},

      // New Tab Page
      {"luxxleNewTab", IDS_SETTINGS_NEW_TAB},
      {"luxxleNewTabLuxxleRewards", IDS_SETTINGS_NEW_TAB_LUXXLE_REWARDS},
      {"luxxleNewTabNewTabPageShows", IDS_SETTINGS_NEW_TAB_NEW_TAB_PAGE_SHOWS},
      {"luxxleNewTabNewTabCustomizeWidgets",
  ...
  // Pin shortcut page
...
#endif
      // Rewards page
      {"luxxleRewards", IDS_SETTINGS_LUXXLE_REWARDS_TITLE},
      {"luxxleRewardsDisabledLabel", IDS_SETTINGS_LUXXLE_REWARDS_DISABLED_LABEL},
      {"luxxleRewardsDisabledSubLabel",
       IDS_SETTINGS_LUXXLE_REWARDS_DISABLED_SUB_LABEL},
      {"luxxleRewardsPageLabel", IDS_SETTINGS_LUXXLE_REWARDS_PAGE_LABEL},
      {"luxxleRewardsShowLuxxleRewardsButtonLabel",
       IDS_SETTINGS_LUXXLE_REWARDS_SHOW_LUXXLE_REWARDS_BUTTON_LABEL},

      // Delete browsing data settings
      {"clearLuxxleAdsData", IDS_SETTINGS_CLEAR_LUXXLE_ADS_DATA},
      {"resetRewardsData", IDS_SETTINGS_RESET_REWARDS_DATA},

      // Misc (TODO: Organize this)
      {"showSearchTabsBtn", IDS_SETTINGS_TABS_SEARCH_SHOW},
      {"onExitPageTitle", IDS_SETTINGS_LUXXLE_ON_EXIT},
      {"luxxleDefaultExtensions", IDS_SETTINGS_LUXXLE_DEFAULT_EXTENSIONS_TITLE},
      ...
      {"showLuxxlewalletIconOnToolbar",
       IDS_SETTINGS_SHOW_LUXXLE_WALLET_ICON_ON_TOOLBAR},
      ...
      {"enablePrivateWindowsLabel",
       IDS_SETTINGS_ENABLE_LUXXLE_WALLET_IN_PRIVATE_WINDOWS_LABEL},
      {"enablePrivateWindowsDesc",
       IDS_SETTINGS_ENABLE_LUXXLE_WALLET_IN_PRIVATE_WINDOWS_DESC},
      {"showLuxxlewalletTestNetworks",
       IDS_SETTINGS_SHOW_LUXXLE_WALLET_TEST_NETWORKS},
      ...
      {"getMoreExtensionsLabel", IDS_LUXXLE_SETTINGS_GET_MORE_EXTENSIONS_LABEL},
      {"getMoreExtensionsSubLabel",
       IDS_LUXXLE_SETTINGS_GET_MORE_EXTENSIONS_SUBLABEL},
      {"statsUsagePingEnabledTitle", IDS_LUXXLE_STATS_USAGE_PING_SETTING},
      {"statsUsagePingEnabledDesc", IDS_LUXXLE_STATS_USAGE_PING_SETTING_SUBITEM},
      {"p3aEnableTitle", IDS_LUXXLE_P3A_ENABLE_SETTING},
      {"p3aEnabledDesc", IDS_LUXXLE_P3A_ENABLE_SETTING_SUBITEM},
      ...
      {"walletNetworkEdit", IDS_LUXXLE_WALLET_NETWORK_EDIT},
      {"walletNetworkRemove", IDS_LUXXLE_WALLET_NETWORK_REMOVE},
      {"walletNetworkReset", IDS_LUXXLE_WALLET_NETWORK_RESET},
      {"walletNetworkSetAsDefault", IDS_LUXXLE_WALLET_NETWORK_SET_AS_DEFAULT},
      {"adblockContentFilteringLabel",
       IDS_LUXXLE_ADBLOCK_CONTENT_FILTERING_LABEL},
      {"adblockAddCustomFiltersListsLabel",
       IDS_LUXXLE_ADBLOCK_ADD_CUSTOM_FILTERS_LISTS_LABEL},
      {"adblockContentFilterLabelDesc",
       IDS_LUXXLE_ADBLOCK_CONTENT_FILTER_LABEL_DESCRIPTION},
      {"adblockAddCustomFiltersListsDesc",
       IDS_LUXXLE_ADBLOCK_ADD_CUSTOM_FILTERS_LISTS_DESC},
      {"adblockAddCustomFiltersListsNote",
       IDS_LUXXLE_ADBLOCK_ADD_CUSTOM_FILTERS_LISTS_NOTE},
      {"adblockCustomFiltersLabel", IDS_LUXXLE_ADBLOCK_CUSTOM_FILTERS_LABEL},
      {"adblockCustomFiltersDesc", IDS_LUXXLE_ADBLOCK_CUSTOM_FILTERS_DESC},
      {"adblockAddListsButtonLabel", IDS_LUXXLE_ADBLOCK_ADD_LISTS_BUTTON_LABEL},
      {"adblockShowFullListsButtonLabel",
       IDS_LUXXLE_ADBLOCK_SHOW_FULL_LISTS_BUTTON_LABEL},
      {"adblockUpdateListsButtonLabel",
       IDS_LUXXLE_ADBLOCK_UPDATE_LISTS_BUTTON_LABEL},
      {"adblockUpdateListsRetryButtonLabel",
       IDS_LUXXLE_ADBLOCK_UPDATE_LISTS_RETRY_BUTTON_LABEL},
      {"adblockUpdateListsUpdatedButtonLabel",
       IDS_LUXXLE_ADBLOCK_UPDATE_LISTS_UPDATED_BUTTON_LABEL},
      {"adblockUpdateListsUpdatingButtonLabel",
       IDS_LUXXLE_ADBLOCK_UPDATE_LISTS_UPDATING_BUTTON_LABEL},
      {"adblockFilterListsInputURLPlaceholder",
       IDS_LUXXLE_ADBLOCK_CUSTOM_FILTER_LISTS_INPUT_PLACEHOLDER},
      {"adblockContentFiltersLabel", IDS_LUXXLE_ADBLOCK_CONTENT_FILTERS},
      {"adblockFilterListsInputPlaceHolder",
       IDS_LUXXLE_ADBLOCK_FILTER_LISTS_INPUT_PLACEHOLDER},
      {"adblockFilterListsTableTitleHeader",
       IDS_LUXXLE_ADBLOCK_FILTER_LISTS_TABLE_TITLE_HEADER},
      {"adblockFilterListsTableUpdatedHeader",
       IDS_LUXXLE_ADBLOCK_FILTER_LISTS_TABLE_UPDATED_HEADER},
      {"adblockUpdateNowButtonLabel",
       IDS_LUXXLE_ADBLOCK_UPDATE_NOW_BUTTON_LABEL},
      {"adblockViewSourceButtonLabel",
       IDS_LUXXLE_ADBLOCK_VIEW_SOURCE_BUTTON_LABEL},
      {"adblockUnsubscribeButtonLabel",
       IDS_LUXXLE_ADBLOCK_UNSUBSCRIBE_BUTTON_LABEL},
      {"adblockSaveChangesButtonLabel", IDS_LUXXLE_ADBLOCK_SAVE_BUTTON_LABEL},
      {"adblockTrackingFiltersLabel", IDS_LUXXLE_ADBLOCK_TRACKING_FILTERS_LABEL},
      {"adblockTrackingFiltersDesc", IDS_LUXXLE_ADBLOCK_TRACKING_FILTERS_DESC},
      {"adblockSubscribeUrlDownloadFailed",
       IDS_LUXXLE_ADBLOCK_SUBSCRIBE_URL_DOWNLOAD_FAILED},
      {"adblockSubscribeUrlUpdateFailed",
       IDS_LUXXLE_ADBLOCK_SUBSCRIBE_URL_UPDATE_FAILED},
      {"adblockCustomListsLabel", IDS_LUXXLE_ADBLOCK_CUSTOM_LISTS_LABEL},
      {"adblockDeveloperModeLabel", IDS_LUXXLE_ADBLOCK_DEVELOPER_MODE_LABEL},
      {"adblockDeveloperModeDesc", IDS_LUXXLE_ADBLOCK_DEVELOPER_MODE_DESC},
      {"adblockCustomSciptletsListLabel",
       IDS_LUXXLE_ADBLOCK_CUSTOM_SCRIPTLETS_LIST_LABEL},
      {"adblockAddCustomScriptletButton",
       IDS_LUXXLE_ADBLOCK_ADD_CUSTOM_SCRIPTLET_BUTTON},
      {"adblockAddCustomScriptletDialogTitle",
       IDS_LUXXLE_ADBLOCK_ADD_CUSTOM_SCRIPTLET_DIALOG_TITLE},
      {"adblockEditCustomScriptletDialogTitle",
       IDS_LUXXLE_ADBLOCK_EDIT_CUSTOM_SCRIPTLET_DIALOG_TITLE},
      {"adblockCustomSciptletDialogNameLabel",
       IDS_LUXXLE_ADBLOCK_CUSTOM_SCRIPTLET_DIALOG_NAME_LABEL},
      {"adblockCustomScriptletDialogContentLabel",
       IDS_LUXXLE_ADBLOCK_CUSTOM_SCRIPTLET_DIALOG_CONTENT_LABEL},
      {"adblockCustomScriptletDialogCancelButton",
       IDS_LUXXLE_ADBLOCK_CUSTOM_SCRIPTLET_DIALOG_CANCEL_BUTTON},
      {"adblockCustomScriptletDialogSaveButton",
       IDS_LUXXLE_ADBLOCK_CUSTOM_SCRIPTLET_DIALOG_SAVE_BUTTON},
      {"adblockCustomScriptletDeleteConfirmation",
       IDS_LUXXLE_ADBLOCK_CUSTOM_SCRIPTLET_DELETE_CONFIRMATION},
      {"adblockCustomScriptletAlreadyExistsError",
       IDS_LUXXLE_ADBLOCK_CUSTOM_SCRIPTLET_ALREADY_EXISTS_ERROR},
      {"adblockCustomScriptletInvalidNameError",
       IDS_LUXXLE_ADBLOCK_CUSTOM_SCRIPTLET_INVALID_NAME_ERROR},
      {"adblockCustomScriptletNotFoundError",
       IDS_LUXXLE_ADBLOCK_CUSTOM_SCRIPTLET_NOT_FOUND_ERROR},
      {"adblockCustomScriptletWarning",
       IDS_LUXXLE_ADBLOCK_CUSTOM_SCRIPTLET_WARNING},

      {"luxxleShortcutsPage", IDS_SETTINGS_LUXXLE_SHORTCUTS_TITLE},
      ...
      {"luxxleShieldsSaveContactInfo",
       IDS_LUXXLE_SHIELDS_SAVE_CONTACT_INFO_LABEL},
      {"luxxleShieldsSaveContactInfoSublabel",
       IDS_LUXXLE_SHIELDS_SAVE_CONTACT_INFO_LABEL_SUBLABEL},
  ...
  html_source->AddString(
      "luxxleAccountSelfCustodyDescription",
      l10n_util::GetStringFUTF16(
          IDS_SETTINGS_LUXXLE_ACCOUNT_SELF_CUSTODY_DESCRIPTION,
          kLuxxleAccountSelfCustodyLearnMoreURL));
  html_source->AddString(
      "luxxleAccountConsentCheckboxLabel",
      l10n_util::GetStringFUTF16(
          IDS_SETTINGS_LUXXLE_ACCOUNT_CONSENT_CHECKBOX_LABEL,
          kLuxxleAccountTermsOfServiceURL, kLuxxleAccountPrivacyAgreementURL));
  // </Luxxle Account>
  html_source->AddString("luxxleShieldsExampleTemplate", "example.com");
  ...
  html_source->AddString(
      "luxxleLeoAssistantModelSystemPromptPlaceholder",
  ...
  html_source->AddString(
      ...
      l10n_util::GetStringFUTF16(
          ...
          confirmation_phrase));
  html_source->AddString(
      "luxxleLeoAssistantInputDefaultContextSize",
      base::NumberToString16(ai_chat::kDefaultCustomModelContextSize));

  html_source->AddString("luxxleLeoAssistantTabOrganizationDesc",
                         l10n_util::GetStringFUTF16(
                             IDS_SETTINGS_LEO_ASSISTANT_TAB_ORGANIZATION_DESC,
                             kTabOrganizationLearnMoreURL));

  html_source->AddString("luxxleLeoAssistantTabOrganizationLearnMoreURL",
                         kTabOrganizationLearnMoreURL);
  ...
  html_source->AddString("autoLockMinutesValue",
                         std::to_string(profile->GetPrefs()->GetInteger(
                             kLuxxleWalletAutoLockMinutes)));

  html_source->AddString(
      "transactionSimulationDesc",
      l10n_util::GetStringFUTF16(IDS_LUXXLE_WALLET_TRANSACTION_SIMULATIONS_DESC,
  ...
  html_source->AddString(
      ...
      l10n_util::GetStringFUTF16(
          IDS_SETTINGS_LUXXLE_SHIELDS_COOKIE_CONTROL_BLOCK_ALL_DEPRECATED_LABEL,
          kBlockAllCookiesLearnMoreUrl));

  html_source->AddString(
      "luxxleLeoAssistantYourModelsDesc2",
      l10n_util::GetStringFUTF16(IDS_SETTINGS_LEO_ASSISTANT_YOUR_MODELS_DESC_2,
                                 kLeoCustomModelsLearnMoreURL));

  html_source->AddString(
      "luxxleLeoAssistantAboutLeoDesc2",
      l10n_util::GetStringFUTF16(IDS_SETTINGS_LEO_ASSISTANT_ABOUT_LEO_DESC_2,
                                 kLeoPrivacyPolicyURL));
}  // NOLINT(readability/fn_size)

void LuxxleAddResources(content::WebUIDataSource* html_source,
                       Profile* profile) {
  LuxxleSettingsUI::AddResources(html_source, profile);
}

void LuxxleAddAboutStrings(content::WebUIDataSource* html_source,
                          Profile* profile) {
  std::u16string license = l10n_util::GetStringFUTF16(
      IDS_LUXXLE_VERSION_UI_LICENSE, kLuxxleLicenseUrl,
      chrome::kChromeUICreditsURL16, kLuxxleBuildInstructionsUrl,
      kLuxxleReleaseTagPrefix +
          base::UTF8ToUTF16(
              version_info::GetLuxxleVersionWithoutChromiumMajorVersion()));
  html_source->AddString("aboutProductLicense", license);
}

void LuxxleAddSyncStrings(content::WebUIDataSource* html_source) {
  std::u16string passphraseDecryptionErrorMessage = l10n_util::GetStringFUTF16(
      IDS_LUXXLE_SYNC_PASSPHRASE_DECRYPTION_ERROR_MESSAGE, kLuxxleSyncGuideUrl);
  html_source->AddString("luxxleSyncPassphraseDecryptionErrorMessage",
                         passphraseDecryptionErrorMessage);
}

void LuxxleAddEmailAliasesStrings(content::WebUIDataSource* html_source) {
  ...
  webui::LocalizedString localized_strings[] = {
      ...
      {"emailAliasesConnectingToLuxxleAccount",
       IDS_SETTINGS_EMAIL_ALIASES_CONNECTING_TO_LUXXLE_ACCOUNT},
      {"emailAliasesLuxxleAccount", IDS_SETTINGS_EMAIL_ALIASES_LUXXLE_ACCOUNT},
...
void LuxxleAddLocalizedStrings(content::WebUIDataSource* html_source,
                              Profile* profile) {
  LuxxleAddCommonStrings(html_source, profile);
  LuxxleAddResources(html_source, profile);
  LuxxleAddAboutStrings(html_source, profile);
  LuxxlePrivacyHandler::AddLoadTimeData(html_source, profile);
  LuxxleAddSyncStrings(html_source);
  LuxxleAddEmailAliasesStrings(html_source);

  // Load time data for luxxle://settings/extensions
  ...
  html_source->AddBoolean(
      ...
      base::FeatureList::IsEnabled(net::features::kLuxxleHttpsByDefault));
