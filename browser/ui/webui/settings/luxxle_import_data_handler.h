...
#ifndef LUXXLE_BROWSER_UI_WEBUI_SETTINGS_LUXXLE_IMPORT_DATA_HANDLER_H_
#define LUXXLE_BROWSER_UI_WEBUI_SETTINGS_LUXXLE_IMPORT_DATA_HANDLER_H_
...
// This class checks whether Luxxle has full disk access permission to import
// safari data on macOS. ImportDataHandler::StartImport() will be run after
// checking disk access permission. If Luxxle doesn't have that permission, this
...
class LuxxleImportDataHandler : public ImportDataHandler,
                                      content::WebContentsObserver {
 public:
  LuxxleImportDataHandler();
  ~LuxxleImportDataHandler() override;

  LuxxleImportDataHandler(const LuxxleImportDataHandler&) = delete;
  LuxxleImportDataHandler& operator=(const LuxxleImportDataHandler&) = delete;
...
#endif
 private:
  std::unordered_map<base::FilePath, std::unique_ptr<LuxxleImporterObserver>>
      import_observers_;
  base::WeakPtrFactory<LuxxleImportDataHandler> weak_factory_{this};
};

}  // namespace settings

#endif  // LUXXLE_BROWSER_UI_WEBUI_SETTINGS_LUXXLE_IMPORT_DATA_HANDLER_H_
