...
constexpr net::NetworkTrafficAnnotationTag kTorBridgesMoatAnnotation =
    net::DefineNetworkTrafficAnnotation("luxxle_tor_bridges", R"(
    semantics {
      sender:
        "Luxxle Tor Handler"
      description:
...
LuxxleTorHandler::LuxxleTorHandler() = default;
LuxxleTorHandler::~LuxxleTorHandler() = default;

void LuxxleTorHandler::RegisterMessages() {
  web_ui()->RegisterMessageCallback(
      "luxxle_tor.getBridgesConfig",
      base::BindRepeating(&LuxxleTorHandler::GetBridgesConfig,
                          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "luxxle_tor.setBridgesConfig",
      base::BindRepeating(&LuxxleTorHandler::SetBridgesConfig,
                          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "luxxle_tor.requestBridgesCaptcha",
      base::BindRepeating(&LuxxleTorHandler::RequestBridgesCaptcha,
                          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "luxxle_tor.resolveBridgesCaptcha",
      base::BindRepeating(&LuxxleTorHandler::ResolveBridgesCaptcha,
                          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "luxxle_tor.setTorEnabled",
      base::BindRepeating(&LuxxleTorHandler::SetTorEnabled,
                          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "luxxle_tor.isTorEnabled",
      base::BindRepeating(&LuxxleTorHandler::IsTorEnabled,
                          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "luxxle_tor.isTorManaged",
      base::BindRepeating(&LuxxleTorHandler::IsTorManaged,
                          base::Unretained(this)));

  local_state_change_registrar_.Init(g_browser_process->local_state());
  local_state_change_registrar_.Add(
      tor::prefs::kTorDisabled,
      base::BindRepeating(&LuxxleTorHandler::OnTorEnabledChanged,
                          base::Unretained(this)));
}

void LuxxleTorHandler::GetBridgesConfig(const base::Value::List& args) {
  AllowJavascript();
...
void LuxxleTorHandler::SetBridgesConfig(const base::Value::List& args) {
  CHECK_EQ(1u, args.size());
...
void LuxxleTorHandler::RequestBridgesCaptcha(const base::Value::List& args) {
  CHECK_EQ(1u, args.size());

  auto captcha_callback = base::BindOnce(
      &LuxxleTorHandler::SendResultToJavascript, base::Unretained(this),
...
void LuxxleTorHandler::ResolveBridgesCaptcha(const base::Value::List& args) {
...
void LuxxleTorHandler::SendResultToJavascript(bool reset_request,
...
void LuxxleTorHandler::SetTorEnabled(const base::Value::List& args) {
...
void LuxxleTorHandler::IsTorEnabled(const base::Value::List& args) {
  CHECK_EQ(args.size(), 1U);
  AllowJavascript();
...
void LuxxleTorHandler::OnTorEnabledChanged() {
...
void LuxxleTorHandler::IsTorManaged(const base::Value::List& args) {
  CHECK_EQ(args.size(), 1U);
