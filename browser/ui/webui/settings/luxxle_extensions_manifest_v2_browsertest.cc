...
class LuxxleExtensionsManifestV2BrowserTest : public InProcessBrowserTest {
 public:
  LuxxleExtensionsManifestV2BrowserTest() {
    feature_list_.InitAndEnableFeature(kExtensionsManifestV2);
    LuxxleSettingsUI::ShouldExposeElementsForTesting() = true;
  }

  ~LuxxleExtensionsManifestV2BrowserTest() override {
    LuxxleSettingsUI::ShouldExposeElementsForTesting() = false;
  }
...
IN_PROC_BROWSER_TEST_F(LuxxleExtensionsManifestV2BrowserTest, InstallFail) {
  ASSERT_TRUE(ui_test_utils::NavigateToURL(
      browser(), GURL("luxxle://settings/extensions/v2")));
...
IN_PROC_BROWSER_TEST_F(LuxxleExtensionsManifestV2BrowserTest,
