...
LuxxleTorSnowflakeExtensionHandler::LuxxleTorSnowflakeExtensionHandler() =
    default;
LuxxleTorSnowflakeExtensionHandler::~LuxxleTorSnowflakeExtensionHandler() =
    default;

void LuxxleTorSnowflakeExtensionHandler::RegisterMessages() {
  web_ui()->RegisterMessageCallback(
      "luxxle_tor.isSnowflakeExtensionAllowed",
      base::BindRepeating(
          &LuxxleTorSnowflakeExtensionHandler::IsSnowflakeExtensionAllowed,
          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "luxxle_tor.isSnowflakeExtensionEnabled",
      base::BindRepeating(
          &LuxxleTorSnowflakeExtensionHandler::IsSnowflakeExtensionEnabled,
          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "luxxle_tor.enableSnowflakeExtension",
      base::BindRepeating(
          &LuxxleTorSnowflakeExtensionHandler::EnableSnowflakeExtension,
          base::Unretained(this)));

  observation_.Observe(GetExtensionRegistry());
}

void LuxxleTorSnowflakeExtensionHandler::OnExtensionLoaded(
...
void LuxxleTorSnowflakeExtensionHandler::OnExtensionUnloaded(
    content::BrowserContext* browser_context,
    const extensions::Extension* extension,
...
void LuxxleTorSnowflakeExtensionHandler::OnExtensionInstalled(
    content::BrowserContext* browser_context,
    const extensions::Extension* extension,
    bool is_update) {
...
void LuxxleTorSnowflakeExtensionHandler::OnExtensionUninstalled(
    content::BrowserContext* browser_context,
    const extensions::Extension* extension,
...
LuxxleTorSnowflakeExtensionHandler::GetExtensionRegistry() {
  return extensions::ExtensionRegistry::Get(
      web_ui()->GetWebContents()->GetBrowserContext());
}

bool LuxxleTorSnowflakeExtensionHandler::IsTorAllowedByPolicy() {
...
void LuxxleTorSnowflakeExtensionHandler::IsSnowflakeExtensionAllowed(
...
void LuxxleTorSnowflakeExtensionHandler::IsSnowflakeExtensionEnabled(
    const base::Value::List& args) {
  CHECK_EQ(args.size(), 1U);
...
void LuxxleTorSnowflakeExtensionHandler::EnableSnowflakeExtension(
    const base::Value::List& args) {
  ...
  if (enable) {
    if (!installed) {
      installer_ = base::MakeRefCounted<SnowflakeWebstoreInstaller>(
          ...
          base::BindOnce(
              &LuxxleTorSnowflakeExtensionHandler::OnSnowflakeExtensionInstalled,
...
void LuxxleTorSnowflakeExtensionHandler::OnSnowflakeExtensionInstalled(
