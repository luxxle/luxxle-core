...
class LuxxleEducationPageUIBrowserTest : public testing::Test {
 protected:
  void SetUp() override {
  ...
  std::unique_ptr<LuxxleEducationServerChecker> CreateChecker() {
    return std::make_unique<LuxxleEducationServerChecker>(
...
TEST_F(LuxxleEducationPageUIBrowserTest, SuccessResponse) {
...
TEST_F(LuxxleEducationPageUIBrowserTest, BadResponse) {
