...
#ifndef LUXXLE_BROWSER_UI_WEBUI_LUXXLE_VPN_VPN_PANEL_UI_H_
#define LUXXLE_BROWSER_UI_WEBUI_LUXXLE_VPN_VPN_PANEL_UI_H_
...
class VPNPanelUI : public ui::UntrustedWebUIController,
                   public luxxle_vpn::mojom::PanelHandlerFactory {
 public:
  ...
  void BindInterface(
      mojo::PendingReceiver<luxxle_vpn::mojom::PanelHandlerFactory> receiver);
 ...
 private:
  // luxxle_vpn::mojom::PanelHandlerFactory:
  void CreatePanelHandler(
      mojo::PendingRemote<luxxle_vpn::mojom::Page> page,
      mojo::PendingReceiver<luxxle_vpn::mojom::PanelHandler> panel_receiver,
  ...
  mojo::Receiver<luxxle_vpn::mojom::PanelHandlerFactory> panel_factory_receiver_{
      this};
  // From TopChromeWebUIController
...
#endif  // LUXXLE_BROWSER_UI_WEBUI_LUXXLE_VPN_VPN_PANEL_UI_H_
