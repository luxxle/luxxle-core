...
#include "luxxle/browser/ui/webui/luxxle_shields/cookie_list_opt_in_page_handler.h"
#include "luxxle/components/luxxle_shields/core/common/features.h"
#include "luxxle/components/luxxle_shields/resources/cookie_list_opt_in/grit/cookie_list_opt_in_generated_map.h"
...
static constexpr webui::LocalizedString kStrings[] = {
    {"cookieListTitle", IDS_LUXXLE_SHIELDS_COOKIE_LIST_TITLE},
    {"cookieListHeader", IDS_LUXXLE_SHIELDS_COOKIE_LIST_HEADER},
    {"cookieListText", IDS_LUXXLE_SHIELDS_COOKIE_LIST_TEXT},
    {"cookieListButtonText", IDS_LUXXLE_SHIELDS_COOKIE_LIST_BUTTON_TEXT},
    {"cookieListNoThanks", IDS_LUXXLE_SHIELDS_COOKIE_LIST_NO_THANKS}};
...
CookieListOptInUI::CookieListOptInUI(content::WebUI* web_ui)
  ...
  DCHECK(base::FeatureList::IsEnabled(
      luxxle_shields::features::kLuxxleAdblockCookieListOptIn));
...
void CookieListOptInUI::CreatePageHandler(
    mojo::PendingReceiver<luxxle_shields::mojom::CookieListOptInPageHandler>
        receiver) {
