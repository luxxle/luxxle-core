...
#ifndef LUXXLE_BROWSER_UI_WEBUI_LUXXLE_SHIELDS_SHIELDS_PANEL_UI_H_
#define LUXXLE_BROWSER_UI_WEBUI_LUXXLE_SHIELDS_SHIELDS_PANEL_UI_H_

#include <memory>
#include <string>

#include "luxxle/browser/ui/webui/luxxle_shields/shields_panel_data_handler.h"
#include "luxxle/browser/ui/webui/luxxle_shields/shields_panel_handler.h"
...
class ShieldsPanelUI : public TopChromeWebUIController,
                       public luxxle_shields::mojom::PanelHandlerFactory {
 public:
  ...
  void BindInterface(
      mojo::PendingReceiver<luxxle_shields::mojom::PanelHandlerFactory>
          receiver);
 ...
 private:
  ...
  mojo::Receiver<luxxle_shields::mojom::PanelHandlerFactory>
...
#endif  // LUXXLE_BROWSER_UI_WEBUI_LUXXLE_SHIELDS_SHIELDS_PANEL_UI_H_
