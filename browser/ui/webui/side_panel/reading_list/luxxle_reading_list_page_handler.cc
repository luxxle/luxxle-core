...
#include "luxxle/browser/ui/webui/side_panel/reading_list/luxxle_reading_list_page_handler.h"

#include <utility>

#include "content/public/browser/web_ui.h"

LuxxleReadingListPageHandler::LuxxleReadingListPageHandler(
...
LuxxleReadingListPageHandler::~LuxxleReadingListPageHandler() = default;

void LuxxleReadingListPageHandler::OnVisibilityChanged(
