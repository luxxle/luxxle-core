...
#ifndef LUXXLE_BROWSER_UI_WEBUI_NEW_TAB_PAGE_LUXXLE_NEW_TAB_PAGE_HANDLER_H_
#define LUXXLE_BROWSER_UI_WEBUI_NEW_TAB_PAGE_LUXXLE_NEW_TAB_PAGE_HANDLER_H_
...
class LuxxleNewTabPageHandler : public luxxle_new_tab_page::mojom::PageHandler,
                               public ui::SelectFileDialog::Listener,
                               public TemplateURLServiceObserver {
 public:
  LuxxleNewTabPageHandler(
  ...
  ~LuxxleNewTabPageHandler() override;

  LuxxleNewTabPageHandler(const LuxxleNewTabPageHandler&) = delete;
  LuxxleNewTabPageHandler& operator=(const LuxxleNewTabPageHandler&) = delete;

 private:
  // luxxle_new_tab_page::mojom::PageHandler overrides:
  ...
  void UseLuxxleBackground(const std::string& selected_background) override;
  void GetLuxxleBackgrounds(GetLuxxleBackgroundsCallback callback) override;
  void TryLuxxleSearchPromotion(const std::string& input,
                               bool open_new_tab) override;
  void DismissLuxxleSearchPromotion() override;
  ...
  void OpenVPNAccountPage(luxxle_vpn::mojom::ManageURLType type) override;
  void ReportVPNWidgetUsage() override;
#endif

  // Observe LuxxleNTPCustomBackgroundService.
  ...
  const mojo::Receiver<luxxle_new_tab_page::mojom::PageHandler> page_handler_;
  const mojo::Remote<luxxle_new_tab_page::mojom::Page> page_;
  ...
  base::WeakPtrFactory<LuxxleNewTabPageHandler> weak_factory_{this};
};

#endif  // LUXXLE_BROWSER_UI_WEBUI_NEW_TAB_PAGE_LUXXLE_NEW_TAB_PAGE_HANDLER_H_
