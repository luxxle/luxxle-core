...
#ifndef LUXXLE_BROWSER_UI_WEBUI_WELCOME_PAGE_WELCOME_DOM_HANDLER_H_
#define LUXXLE_BROWSER_UI_WEBUI_WELCOME_PAGE_WELCOME_DOM_HANDLER_H_
...
class WelcomeDOMHandler : public content::WebUIMessageHandler {
 ...
 private:
  ...
  luxxle_education::LuxxleEducationServerChecker luxxle_education_server_checker_;
  base::WeakPtrFactory<WelcomeDOMHandler> weak_ptr_factory_{this};
};

#endif  // LUXXLE_BROWSER_UI_WEBUI_WELCOME_PAGE_WELCOME_DOM_HANDLER_H_
