...
content::WebUIDataSource* CreateWebUIDataSource(
  ...
  // Some parts of Luxxle's UI pages are not yet migrated to work without doing
  // assignments of strings directly into |innerHTML| elements (i.e. see usage
  // of |dangerouslySetInnerHTML| in .tsx files). This will break Luxxle due to
...
void AddBackgroundColorToSource(content::WebUIDataSource* source,
  ...
  // here because it does not include LuxxlePrivateWindowThemeSupplier. This
