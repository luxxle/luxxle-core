...
class RewardsPageHandler::UpdateObserver
 ...
 public:
  UpdateObserver(RewardsService* rewards_service,
    ...
    AddPrefListener(luxxle_ads::prefs::kOptedInToNotificationAds,
                    UpdateSource::kAds);
    AddPrefListener(luxxle_ads::prefs::kMaximumNotificationAdsPerHour,
                    UpdateSource::kAds);
    AddPrefListener(
        luxxle_ads::prefs::kSubdivisionTargetingUserSelectedSubdivision,
        UpdateSource::kAds);
    AddPrefListener(luxxle_ads::prefs::kOptedInToSearchResultAds,
                    UpdateSource::kAds);
    AddPrefListener(luxxle_news::prefs::kLuxxleNewsOptedIn, UpdateSource::kAds);
    AddPrefListener(luxxle_news::prefs::kNewTabPageShowToday,
                    UpdateSource::kAds);
...
RewardsPageHandler::RewardsPageHandler(
    ...
    RewardsService* rewards_service,
    luxxle_ads::AdsService* ads_service,
    luxxle_adaptive_captcha::LuxxleAdaptiveCaptchaService* captcha_service,
    PrefService* prefs)
...
void RewardsPageHandler::GetAdsSettings(GetAdsSettingsCallback callback) {
  ...
  settings->is_supported_region = luxxle_ads::IsSupportedRegion();
  settings->new_tab_page_ads_enabled =
      prefs_->GetBoolean(ntp_background_images::prefs::
                             kNewTabPageShowSponsoredImagesBackgroundImage);
  settings->notification_ads_enabled =
      prefs_->GetBoolean(luxxle_ads::prefs::kOptedInToNotificationAds);
  settings->search_ads_enabled =
      prefs_->GetBoolean(luxxle_ads::prefs::kOptedInToSearchResultAds);
  settings->inline_content_ads_enabled =
      prefs_->GetBoolean(luxxle_news::prefs::kLuxxleNewsOptedIn) &&
      prefs_->GetBoolean(luxxle_news::prefs::kNewTabPageShowToday);
  ...
  settings->auto_detected_subdivision = prefs_->GetString(
      luxxle_ads::prefs::kSubdivisionTargetingAutoDetectedSubdivision);
  settings->should_allow_subdivision_targeting =
      prefs_->GetBoolean(luxxle_ads::prefs::kShouldAllowSubdivisionTargeting);

  auto& subdivisions = luxxle_ads::GetSupportedSubdivisions();
  auto iter = subdivisions.find(luxxle_l10n::GetCountryCode(GetLocalState()));
...
void RewardsPageHandler::GetAdsStatement(GetAdsStatementCallback callback) {
  auto on_statement = [](decltype(callback) callback,
                         luxxle_ads::mojom::StatementInfoPtr info) {
    if (!info) {
      std::move(callback).Run(nullptr);
      return;
    }
    ...
    using AdType = luxxle_ads::mojom::AdType;
...
void RewardsPageHandler::GetAdsHistory(GetAdsHistoryCallback callback) {
  ...
  base::Time from_time =
      now - luxxle_ads::kAdHistoryRetentionPeriod.Get() - base::Days(1);
  ...
  luxxle_rewards::p3a::RecordAdsHistoryView();

  // TODO(https://github.com/luxxle/luxxle-browser/issues/24595): Transition
...
void RewardsPageHandler::SetAdTypeEnabled(luxxle_ads::mojom::AdType ad_type,
                                          bool enabled,
  ...
  switch (ad_type) {
    ...
    case AdType::kNotificationAd:
      prefs_->SetBoolean(luxxle_ads::prefs::kOptedInToNotificationAds, enabled);
      break;
    case AdType::kSearchResultAd:
      prefs_->SetBoolean(luxxle_ads::prefs::kOptedInToSearchResultAds, enabled);
      break;
...
void RewardsPageHandler::SetNotificationAdsPerHour(
  ...
  prefs_->SetInt64(luxxle_ads::prefs::kMaximumNotificationAdsPerHour,
                   ads_per_hour);
  std::move(callback).Run();
}
...
void RewardsPageHandler::ToggleAdLike(const std::string& history_item,
  ...
  // TODO(https://github.com/luxxle/luxxle-browser/issues/40852): Refactor UI
  // reactions to use `mojom::ReactionInfo` instead of `AdHistoryItemInfo`.
  const luxxle_ads::AdHistoryItemInfo ad_history_item =
      luxxle_ads::AdHistoryItemFromValue(*dict);

  ads_service_->ToggleLikeAd(luxxle_ads::CreateReaction(ad_history_item),
...
void RewardsPageHandler::ToggleAdDislike(const std::string& history_item,
  ...
  ads_service_->ToggleDislikeAd(luxxle_ads::CreateReaction(ad_history_item),
                                base::IgnoreArgs<bool>(std::move(callback)));
}
...
void RewardsPageHandler::ToggleAdInappropriate(
  ...
  ads_service_->ToggleMarkAdAsInappropriate(
      luxxle_ads::CreateReaction(ad_history_item),
      base::IgnoreArgs<bool>(std::move(callback)));
}
