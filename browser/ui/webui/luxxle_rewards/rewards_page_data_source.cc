...
#include "luxxle/components/luxxle_adaptive_captcha/server_util.h"
...
static constexpr webui::ResourcePath kResources[] = {
    {"favicon.ico", /* REMOVED: IDR_LUXXLE_REWARDS_FAVICON */ 0}};
...
static constexpr webui::LocalizedString kStrings[] = {
    ...
    {"closeButtonLabel", IDS_LUXXLE_REWARDS_ONBOARDING_CLOSE},
    ...
    {"continueButtonLabel", IDS_LUXXLE_REWARDS_ONBOARDING_CONTINUE},
    ...
    {"countrySelectPlaceholder", IDS_LUXXLE_REWARDS_ONBOARDING_SELECT_COUNTRY},
    {"countrySelectTitle", IDS_REWARDS_COUNTRY_SELECT_TITLE},
    {"countrySelectText", IDS_REWARDS_COUNTRY_SELECT_TEXT},
    {"doneButtonLabel", IDS_LUXXLE_REWARDS_ONBOARDING_DONE},
    ...
    {"onboardingErrorCountryDeclaredText",
     IDS_LUXXLE_REWARDS_ONBOARDING_ERROR_TEXT_DECLARE_COUNTRY},
    {"onboardingErrorDisabledText",
     IDS_LUXXLE_REWARDS_ONBOARDING_ERROR_TEXT_DISABLED},
    {"onboardingErrorDisabledTitle",
     IDS_LUXXLE_REWARDS_ONBOARDING_ERROR_HEADER_DISABLED},
    {"onboardingErrorText", IDS_LUXXLE_REWARDS_ONBOARDING_ERROR_TEXT},
    {"onboardingErrorTitle", IDS_LUXXLE_REWARDS_ONBOARDING_ERROR_HEADER},
    {"onboardingLearnMoreLabel", IDS_REWARDS_WIDGET_HOW_DOES_IT_WORK},
    {"onboardingSuccessLearnMoreLabel",
     IDS_LUXXLE_REWARDS_ONBOARDING_HOW_DOES_IT_WORK},
    {"onboardingSuccessText", IDS_LUXXLE_REWARDS_ONBOARDING_GEO_SUCCESS_TEXT},
    {"onboardingSuccessTitle", IDS_LUXXLE_REWARDS_ONBOARDING_GEO_SUCCESS_HEADER},
    ...
    {"resetButtonLabel", IDS_LUXXLE_UI_RESET},
    {"resetConsentText", IDS_LUXXLE_UI_REWARDS_RESET_CONSENT},
    {"resetRewardsButtonLabel", IDS_REWARDS_RESET_REWARDS_BUTTON_LABEL},
    {"resetRewardsText", IDS_LUXXLE_UI_REWARDS_RESET_TEXT},
    {"resetRewardsTitle", IDS_LUXXLE_UI_RESET_WALLET},
    ...
    {"unsupportedRegionText1",
     IDS_LUXXLE_REWARDS_UNSUPPORTED_REGION_NOTICE_SUBHEADER},
    {"unsupportedRegionText2",
     IDS_LUXXLE_REWARDS_UNSUPPORTED_REGION_NOTICE_TEXT_1},
    {"unsupportedRegionText3",
     IDS_LUXXLE_REWARDS_UNSUPPORTED_REGION_NOTICE_TEXT_2},
    {"unsupportedRegionTitle",
     IDS_LUXXLE_REWARDS_UNSUPPORTED_REGION_NOTICE_HEADER},
...
void CreateAndAddRewardsPageDataSource(content::WebUI& web_ui,
  ...
  webui::SetupWebUIDataSource(source, kRewardsPageGenerated,
                              IDR_NEW_LUXXLE_REWARDS_PAGE_HTML);
  ...
  source->OverrideContentSecurityPolicy(
      ...
      "frame-src 'self' " +
          luxxle_adaptive_captcha::ServerUtil::GetInstance()->GetServerUrl("/") +
          ";");
