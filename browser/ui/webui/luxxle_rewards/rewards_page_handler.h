...
#ifndef LUXXLE_BROWSER_UI_WEBUI_LUXXLE_REWARDS_REWARDS_PAGE_HANDLER_H_
#define LUXXLE_BROWSER_UI_WEBUI_LUXXLE_REWARDS_REWARDS_PAGE_HANDLER_H_
...
namespace luxxle_adaptive_captcha {
class LuxxleAdaptiveCaptchaService;
}
...
class RewardsPageHandler : public mojom::RewardsPageHandler {
 public:
  ...
  void SetAdTypeEnabled(luxxle_ads::mojom::AdType ad_type,
                        bool enabled,
 ...
 private:
  ...
  raw_ptr<luxxle_adaptive_captcha::LuxxleAdaptiveCaptchaService>
...
#endif  // LUXXLE_BROWSER_UI_WEBUI_LUXXLE_REWARDS_REWARDS_PAGE_HANDLER_H_
