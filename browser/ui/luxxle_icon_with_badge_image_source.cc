...
LuxxleIconWithBadgeImageSource::LuxxleIconWithBadgeImageSource(
    const gfx::Size& size,
...
// static
gfx::Size LuxxleIconWithBadgeImageSource::GetMaxBadgeSize() {
  return gfx::Size(kBadgeMaxWidth, kBadgeHeight);
}

void LuxxleIconWithBadgeImageSource::SetAllowEmptyText(bool v) {
  allow_empty_text_ = v;
}

void LuxxleIconWithBadgeImageSource::PaintBadge(gfx::Canvas* canvas) {
  if (!badge_) {
    return;
  }
...
void LuxxleIconWithBadgeImageSource::PaintBadgeWithText(gfx::Canvas* canvas) {
  ...
  // LOG(ERROR) << "LuxxleAction badge text size initial, "
  //            << "w:"
  //            << text_width
  //            << " h:"
  //            << text_height;
...
void LuxxleIconWithBadgeImageSource::PaintBadgeWithoutText(
...
gfx::Rect LuxxleIconWithBadgeImageSource::GetBadgeRect(
...
gfx::Rect LuxxleIconWithBadgeImageSource::GetIconAreaRect() const {
  return gfx::Rect(size());
}

std::optional<int> LuxxleIconWithBadgeImageSource::GetCustomGraphicSize() {
  return content_image_size_;
}

std::optional<int> LuxxleIconWithBadgeImageSource::GetCustomGraphicXOffset() {
  return std::floor(
      (image_left_margin_extra_ + size().width() - content_image_size_) / 2.0);
}

std::optional<int> LuxxleIconWithBadgeImageSource::GetCustomGraphicYOffset() {
