...
LuxxleJavaScriptTabModalDialogViewViews::LuxxleJavaScriptTabModalDialogViewViews(
  ...
  widget->widget_delegate()->set_desired_position_delegate(base::BindRepeating(
      [](base::WeakPtr<LuxxleJavaScriptTabModalDialogViewViews> dialog_view) {
        if (!dialog_view) {
          return gfx::Point();
        }
...
LuxxleJavaScriptTabModalDialogViewViews::
    ~LuxxleJavaScriptTabModalDialogViewViews() = default;
...
JavaScriptTabModalDialogManagerDelegateDesktop::CreateNewDialog(
  ...
  return (new LuxxleJavaScriptTabModalDialogViewViews(
...
LuxxleJavaScriptTabModalDialogViewViews::GetModalDialogHost() {
...
void LuxxleJavaScriptTabModalDialogViewViews::UpdateWidgetBounds() {
  auto* widget = GetWidget();
  CHECK(widget);
...
gfx::Point LuxxleJavaScriptTabModalDialogViewViews::
...
BEGIN_METADATA(LuxxleJavaScriptTabModalDialogViewViews)
END_METADATA
