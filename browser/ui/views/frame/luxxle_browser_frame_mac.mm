...
LuxxleBrowserFrameMac::LuxxleBrowserFrameMac(BrowserFrame* browser_frame,
                                           BrowserView* browser_view)
    : BrowserFrameMac(browser_frame, browser_view),
      browser_(browser_view->browser()),
      browser_view_(browser_view) {}

LuxxleBrowserFrameMac::~LuxxleBrowserFrameMac() = default;

void LuxxleBrowserFrameMac::GetWindowFrameTitlebarHeight(
...
void LuxxleBrowserFrameMac::ValidateUserInterfaceItem(
    int32_t tag,
...
bool LuxxleBrowserFrameMac::ExecuteCommand(
    int32_t command,
