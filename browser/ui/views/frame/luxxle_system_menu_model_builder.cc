...
#include "luxxle/browser/ui/views/frame/luxxle_system_menu_model_builder.h"
...
LuxxleSystemMenuModelBuilder::~LuxxleSystemMenuModelBuilder() = default;

void LuxxleSystemMenuModelBuilder::InsertLuxxleSystemMenuForBrowserWindow(
...
void LuxxleSystemMenuModelBuilder::BuildSystemMenuForBrowserWindow(
    ui::SimpleMenuModel* model) {
  SystemMenuModelBuilder::BuildSystemMenuForBrowserWindow(model);
  InsertLuxxleSystemMenuForBrowserWindow(model);
}
