...
#ifndef LUXXLE_BROWSER_UI_VIEWS_FRAME_BRAVE_WINDOW_FRAME_GRAPHIC_H_
#define LUXXLE_BROWSER_UI_VIEWS_FRAME_BRAVE_WINDOW_FRAME_GRAPHIC_H_
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_FRAME_BRAVE_WINDOW_FRAME_GRAPHIC_H_
