...
#ifndef LUXXLE_BROWSER_UI_VIEWS_FRAME_LUXXLE_BROWSER_VIEW_LAYOUT_H_
#define LUXXLE_BROWSER_UI_VIEWS_FRAME_LUXXLE_BROWSER_VIEW_LAYOUT_H_
...
class LuxxleBrowserViewLayout : public BrowserViewLayout {
 public:
  LuxxleBrowserViewLayout(std::unique_ptr<BrowserViewLayoutDelegate> delegate,
  ...
  ~LuxxleBrowserViewLayout() override;
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_FRAME_LUXXLE_BROWSER_VIEW_LAYOUT_H_
