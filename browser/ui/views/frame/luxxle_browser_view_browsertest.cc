...
class LuxxleBrowserViewTest : public InProcessBrowserTest {
 public:
  LuxxleBrowserViewTest() = default;
  ~LuxxleBrowserViewTest() override = default;

  LuxxleBrowserViewTest(const LuxxleBrowserViewTest&) = delete;
  LuxxleBrowserViewTest& operator=(const LuxxleBrowserViewTest&) = delete;
...
// active.
IN_PROC_BROWSER_TEST_F(LuxxleBrowserViewTest, ScrimForTabModalDisabledTest) {
...
#if !BUILDFLAG(IS_MAC)
IN_PROC_BROWSER_TEST_F(LuxxleBrowserViewTest,
