...
LuxxleWindowFrameGraphic::LuxxleWindowFrameGraphic(
    content::BrowserContext* context)
    : is_tor_window_(context->IsTor()) {}

LuxxleWindowFrameGraphic::~LuxxleWindowFrameGraphic() = default;

void LuxxleWindowFrameGraphic::Paint(gfx::Canvas* canvas,
