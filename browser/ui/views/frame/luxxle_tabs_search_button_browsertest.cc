...
class LuxxleTabsSearchButtonTest : public InProcessBrowserTest,
                                  public ::testing::WithParamInterface<bool> {
 public:
  LuxxleTabsSearchButtonTest() = default;
  ~LuxxleTabsSearchButtonTest() override = default;
};

#if BUILDFLAG(IS_WIN)
IN_PROC_BROWSER_TEST_P(LuxxleTabsSearchButtonTest, HideShowSettingTest) {
#else
IN_PROC_BROWSER_TEST_F(LuxxleTabsSearchButtonTest, HideShowSettingTest) {
#endif
...
#if BUILDFLAG(IS_WIN)
INSTANTIATE_TEST_SUITE_P(LuxxleTabsSearchButtonTest,
                         LuxxleTabsSearchButtonTest,
                         ::testing::Bool());
#endif
