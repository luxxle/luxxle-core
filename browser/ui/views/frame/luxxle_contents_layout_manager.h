...
#ifndef LUXXLE_BROWSER_UI_VIEWS_FRAME_LUXXLE_CONTENTS_LAYOUT_MANAGER_H_
#define LUXXLE_BROWSER_UI_VIEWS_FRAME_LUXXLE_CONTENTS_LAYOUT_MANAGER_H_

#include "chrome/browser/ui/views/frame/contents_layout_manager.h"

class LuxxleContentsLayoutManager : public ContentsLayoutManager {
 public:
  static LuxxleContentsLayoutManager* GetLayoutManagerForView(views::View* host);

  LuxxleContentsLayoutManager(views::View* devtools_view,
  ...
  ~LuxxleContentsLayoutManager() override;
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_FRAME_LUXXLE_CONTENTS_LAYOUT_MANAGER_H_
