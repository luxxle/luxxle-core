...
#ifndef LUXXLE_BROWSER_UI_VIEWS_FRAME_LUXXLE_CONTENTS_VIEW_UTIL_H_
#define LUXXLE_BROWSER_UI_VIEWS_FRAME_LUXXLE_CONTENTS_VIEW_UTIL_H_
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_FRAME_LUXXLE_CONTENTS_VIEW_UTIL_H_
