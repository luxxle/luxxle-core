...
#ifndef LUXXLE_BROWSER_UI_VIEWS_FRAME_LUXXLE_BROWSER_FRAME_VIEW_LINUX_NATIVE_H_
#define LUXXLE_BROWSER_UI_VIEWS_FRAME_LUXXLE_BROWSER_FRAME_VIEW_LINUX_NATIVE_H_
...
class LuxxleBrowserFrameViewLinuxNative : public BrowserFrameViewLinuxNative {
  METADATA_HEADER(LuxxleBrowserFrameViewLinuxNative, BrowserFrameViewLinuxNative)
 public:

  LuxxleBrowserFrameViewLinuxNative(
      BrowserFrame* frame,
      BrowserView* browser_view,
      BrowserFrameViewLayoutLinuxNative* layout,
      std::unique_ptr<ui::NavButtonProvider> nav_button_provider);
  ~LuxxleBrowserFrameViewLinuxNative() override;
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_FRAME_LUXXLE_BROWSER_FRAME_VIEW_LINUX_NATIVE_H_
