...
// static
LuxxleContentsLayoutManager* LuxxleContentsLayoutManager::GetLayoutManagerForView(
    views::View* host) {
  return static_cast<LuxxleContentsLayoutManager*>(host->GetLayoutManager());
}

LuxxleContentsLayoutManager::LuxxleContentsLayoutManager(
...
LuxxleContentsLayoutManager::~LuxxleContentsLayoutManager() = default;

void LuxxleContentsLayoutManager::SetWebContentsBorderInsets(
    const gfx::Insets& insets) {
  border_insets_ = insets;
  InvalidateHost(true);
}

views::ProposedLayout LuxxleContentsLayoutManager::CalculateProposedLayout(
