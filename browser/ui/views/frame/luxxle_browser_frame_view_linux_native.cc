...
LuxxleBrowserFrameViewLinuxNative::LuxxleBrowserFrameViewLinuxNative(
    BrowserFrame* frame,
...
LuxxleBrowserFrameViewLinuxNative::~LuxxleBrowserFrameViewLinuxNative() = default;

void LuxxleBrowserFrameViewLinuxNative::MaybeUpdateCachedFrameButtonImages() {
...
void LuxxleBrowserFrameViewLinuxNative::Layout(PassKey) {
  LayoutSuperclass<BrowserFrameViewLinuxNative>(this);

  UpdateLeadingTrailingCaptionButtonWidth();
}

views::Button* LuxxleBrowserFrameViewLinuxNative::FrameButtonToButton(
...
void LuxxleBrowserFrameViewLinuxNative::
    UpdateLeadingTrailingCaptionButtonWidth() {
  auto* browser = browser_view()->browser();
  DCHECK(browser);
...
BEGIN_METADATA(LuxxleBrowserFrameViewLinuxNative)
END_METADATA
