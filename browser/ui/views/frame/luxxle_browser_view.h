...
#ifndef LUXXLE_BROWSER_UI_VIEWS_FRAME_LUXXLE_BROWSER_VIEW_H_
#define LUXXLE_BROWSER_UI_VIEWS_FRAME_LUXXLE_BROWSER_VIEW_H_
...
class LuxxleBrowser;
class LuxxleHelpBubbleHostView;
...
class LuxxleBrowserView : public BrowserView,
                         public commands::AcceleratorService::Observer {
  METADATA_HEADER(LuxxleBrowserView, BrowserView)
 public:
  explicit LuxxleBrowserView(std::unique_ptr<Browser> browser);
  LuxxleBrowserView(const LuxxleBrowserView&) = delete;
  LuxxleBrowserView& operator=(const LuxxleBrowserView&) = delete;
  ~LuxxleBrowserView() override;

  static LuxxleBrowserView* From(BrowserView* view);
  ...
  void ShowLuxxleVPNBubble(bool show_select = false);
  ...
  views::View* GetAnchorViewForLuxxleVPNPanel();
  ...
  bool ShowLuxxleHelpBubbleView(const std::string& text) override;
 ...
 private:
  ...
  raw_ptr<LuxxleHelpBubbleHostView> luxxle_help_bubble_host_view_ = nullptr;
...
#if BUILDFLAG(ENABLE_LUXXLE_VPN)
  LuxxleVPNPanelController vpn_panel_controller_{this};
#endif
  ...
  base::WeakPtrFactory<LuxxleBrowserView> weak_ptr_{this};
};

#endif  // LUXXLE_BROWSER_UI_VIEWS_FRAME_LUXXLE_BROWSER_VIEW_H_
