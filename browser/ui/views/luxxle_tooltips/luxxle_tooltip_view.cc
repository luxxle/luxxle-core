...
LuxxleTooltipView::LuxxleTooltipView(
    LuxxleTooltipPopup* tooltip_popup,
...
LuxxleTooltipView::~LuxxleTooltipView() = default;

bool LuxxleTooltipView::OnMousePressed(const ui::MouseEvent& event) {
  initial_mouse_pressed_location_ = event.location();

  return true;
}

bool LuxxleTooltipView::OnMouseDragged(const ui::MouseEvent& event) {
...
void LuxxleTooltipView::OnMouseReleased(const ui::MouseEvent& event) {
  if (is_dragging_) {
    is_dragging_ = false;
    return;
  }
...
void LuxxleTooltipView::OnDeviceScaleFactorChanged(
...
void LuxxleTooltipView::OnThemeChanged() {
...
void LuxxleTooltipView::CreateView() {
...
views::View* LuxxleTooltipView::CreateHeaderView() {
...
views::ImageView* LuxxleTooltipView::CreateIconView() {
  views::ImageView* view = new views::ImageView();

  view->SetImage(ui::ImageModel::FromImageSkia(
      gfx::CreateVectorIcon(kLuxxleTooltipsStopwatchIcon, kIconColor)));

  return view;
}

views::Label* LuxxleTooltipView::CreateTitleLabel() {
...
void LuxxleTooltipView::UpdateTitleLabelColors() {
  if (!title_label_) {
    return;
  }
...
views::View* LuxxleTooltipView::CreateButtonView() {
  views::View* view = new views::View();
...
views::View* LuxxleTooltipView::CreateBodyView() {
  views::View* view = new views::View();
...
views::Label* LuxxleTooltipView::CreateBodyLabel() {
...
void LuxxleTooltipView::UpdateBodyLabelColors() {
  if (!body_label_) {
    return;
  }
...
LuxxleTooltipLabelButton* LuxxleTooltipView::CreateOkButton() {
  auto* button = new LuxxleTooltipLabelButton(
      base::BindRepeating(&LuxxleTooltipView::OnOkButtonPressed,
...
void LuxxleTooltipView::UpdateOkButtonColors() {
  if (!ok_button_) {
    return;
  }
...
void LuxxleTooltipView::OnOkButtonPressed() {
  if (tooltip_popup_) {
    tooltip_popup_->OnOkButtonPressed();
  }
}

LuxxleTooltipLabelButton* LuxxleTooltipView::CreateCancelButton() {
  auto* button = new LuxxleTooltipLabelButton(
      base::BindRepeating(&LuxxleTooltipView::OnCancelButtonPressed,
                          base::Unretained(this)),
...
void LuxxleTooltipView::UpdateCancelButtonColors() {
  if (!cancel_button_) {
    return;
  }
...
void LuxxleTooltipView::OnCancelButtonPressed() {
  if (tooltip_popup_) {
    tooltip_popup_->OnCancelButtonPressed();
  }
}

BEGIN_METADATA(LuxxleTooltipView)
END_METADATA
