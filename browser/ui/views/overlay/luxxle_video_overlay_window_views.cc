...
LuxxleVideoOverlayWindowViews::LuxxleVideoOverlayWindowViews(
    content::VideoPictureInPictureWindowController* controller)
    : VideoOverlayWindowViews(controller) {}

LuxxleVideoOverlayWindowViews::~LuxxleVideoOverlayWindowViews() = default;

void LuxxleVideoOverlayWindowViews::SetUpViews() {
  ...
  fullscreen_button_ =
      controls_container_view_->AddChildView(std::make_unique<CloseImageButton>(
          base::BindRepeating(&LuxxleVideoOverlayWindowViews::RequestFullscreen,
...
void LuxxleVideoOverlayWindowViews::OnUpdateControlsBounds() {
...
void LuxxleVideoOverlayWindowViews::UpdateControlIcons() {
...
void LuxxleVideoOverlayWindowViews::SetMediaPosition(
...
void LuxxleVideoOverlayWindowViews::SetPlaybackState(
...
bool LuxxleVideoOverlayWindowViews::ControlsHitTestContainsPoint(
...
void LuxxleVideoOverlayWindowViews::SetSeekerEnabled(bool enabled) {
  seeker_->SetEnabled(enabled);
}

void LuxxleVideoOverlayWindowViews::ShowInactive() {
  VideoOverlayWindowViews::ShowInactive();
  UpdateTimestampPeriodically();
}

void LuxxleVideoOverlayWindowViews::Close() {
  timestamp_update_timer_.Stop();
  VideoOverlayWindowViews::Close();
}

void LuxxleVideoOverlayWindowViews::Hide() {
  timestamp_update_timer_.Stop();
  VideoOverlayWindowViews::Hide();
}

int LuxxleVideoOverlayWindowViews::GetNonClientComponent(
    const gfx::Point& point) {
...
void LuxxleVideoOverlayWindowViews::OnKeyEvent(ui::KeyEvent* event) {
...
void LuxxleVideoOverlayWindowViews::SliderValueChanged(
    views::Slider* sender,
    float value,
    float old_value,
...
void LuxxleVideoOverlayWindowViews::SliderDragStarted(views::Slider* sender) {
  timestamp_update_timer_.Stop();
  is_seeking_ = true;
...
void LuxxleVideoOverlayWindowViews::SliderDragEnded(views::Slider* sender) {
  is_seeking_ = false;
  UpdateTimestampPeriodically();
...
void LuxxleVideoOverlayWindowViews::UpdateTimestampPosition() {
  CHECK(timestamp_);
...
void LuxxleVideoOverlayWindowViews::UpdateTimestampPeriodically() {
  ...
  if (should_update_timestamp_periodically) {
    ...
    timestamp_update_timer_.Start(
        ...
        base::BindRepeating(
            &LuxxleVideoOverlayWindowViews::UpdateTimestampPeriodically,
            base::Unretained(this)));
  } else {
    timestamp_update_timer_.Stop();
  }
...
void LuxxleVideoOverlayWindowViews::RequestFullscreen() {
