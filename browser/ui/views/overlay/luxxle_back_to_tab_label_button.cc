...
LuxxleBackToTabLabelButton::LuxxleBackToTabLabelButton(PressedCallback callback)
...
LuxxleBackToTabLabelButton::~LuxxleBackToTabLabelButton() = default;

void LuxxleBackToTabLabelButton::OnThemeChanged() {
...
BEGIN_METADATA(LuxxleBackToTabLabelButton)
END_METADATA
