...
LuxxleHelpBubbleDelegateView::LuxxleHelpBubbleDelegateView(
    View* anchor_view,
  ...
  SetUpLabel(view_label,
             l10n_util::GetStringUTF16(
                 IDS_LUXXLE_SHIELDS_ONBOARDING_CLICK_TO_VIEW_LABEL),
             14, gfx::Font::Weight::NORMAL);

  AddChildView(view_label);
}

LuxxleHelpBubbleDelegateView::~LuxxleHelpBubbleDelegateView() = default;

std::unique_ptr<NonClientFrameView>
LuxxleHelpBubbleDelegateView::CreateNonClientFrameView(views::Widget* widget) {
...
void LuxxleHelpBubbleDelegateView::SetUpLabel(views::Label* label,
...
BEGIN_METADATA(LuxxleHelpBubbleDelegateView)
END_METADATA
