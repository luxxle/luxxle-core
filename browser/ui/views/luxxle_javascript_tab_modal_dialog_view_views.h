...
#ifndef LUXXLE_BROWSER_UI_VIEWS_LUXXLE_JAVASCRIPT_TAB_MODAL_DIALOG_VIEW_VIEWS_H_
#define LUXXLE_BROWSER_UI_VIEWS_LUXXLE_JAVASCRIPT_TAB_MODAL_DIALOG_VIEW_VIEWS_H_
...
class LuxxleJavaScriptTabModalDialogViewViews
    : public JavaScriptTabModalDialogViewViews,
      public views::WidgetObserver {
  METADATA_HEADER(LuxxleJavaScriptTabModalDialogViewViews,
 ...
 public:
  ...
  ~LuxxleJavaScriptTabModalDialogViewViews() override;
 ...
 private:
  ...
  base::WeakPtrFactory<LuxxleJavaScriptTabModalDialogViewViews>
      weak_ptr_factory_{this};
};

#endif  // LUXXLE_BROWSER_UI_VIEWS_LUXXLE_JAVASCRIPT_TAB_MODAL_DIALOG_VIEW_VIEWS_H_
