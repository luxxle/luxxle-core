...
#ifndef LUXXLE_BROWSER_UI_VIEWS_SIDE_PANEL_LUXXLE_SIDE_PANEL_RESIZE_WIDGET_H_
#define LUXXLE_BROWSER_UI_VIEWS_SIDE_PANEL_LUXXLE_SIDE_PANEL_RESIZE_WIDGET_H_
...
// LuxxleSidePanel owns this widget.
class SidePanelResizeWidget : public views::ViewObserver,
                              public views::WidgetDelegate {
 public:
  SidePanelResizeWidget(LuxxleSidePanel* panel,
 ...
 private:
  raw_ptr<LuxxleSidePanel> panel_ = nullptr;
  std::unique_ptr<views::Widget> widget_;
  base::ScopedMultiSourceObservation<views::View, views::ViewObserver>
      observations_{this};
};

#endif  // LUXXLE_BROWSER_UI_VIEWS_SIDE_PANEL_LUXXLE_SIDE_PANEL_RESIZE_WIDGET_H_
