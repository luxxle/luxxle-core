...
#include "luxxle/browser/ui/views/side_panel/luxxle_read_later_side_panel_view.h"
  ...
  gfx::Size CalculatePreferredSize(
    ...
    if (available_size.is_fully_bounded()) {
      return {available_size.width().value(),
              LuxxleSidePanelViewBase::kHeaderHeight};
    }
...
LuxxleReadLaterSidePanelView::LuxxleReadLaterSidePanelView(
    Browser* browser,
...
LuxxleReadLaterSidePanelView::~LuxxleReadLaterSidePanelView() = default;

BEGIN_METADATA(LuxxleReadLaterSidePanelView)
END_METADATA
