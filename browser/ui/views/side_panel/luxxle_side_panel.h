...
#ifndef LUXXLE_BROWSER_UI_VIEWS_SIDE_PANEL_LUXXLE_SIDE_PANEL_H_
#define LUXXLE_BROWSER_UI_VIEWS_SIDE_PANEL_LUXXLE_SIDE_PANEL_H_
...
// unique inset and border style compared to Luxxle.
// SidebarContainerView controls this panel's visibility.
class LuxxleSidePanel : public views::View,
                       public views::ViewObserver,
                       public views::ResizeAreaDelegate {
  METADATA_HEADER(LuxxleSidePanel, views::View)
 public:
  ...
  explicit LuxxleSidePanel(
      BrowserView* browser_view,
      HorizontalAlignment horizontal_alignment = HorizontalAlignment::kLeft);
  LuxxleSidePanel(const LuxxleSidePanel&) = delete;
  LuxxleSidePanel& operator=(const LuxxleSidePanel&) = delete;
  ~LuxxleSidePanel() override;
  ...
  // panel. `animated` is ignored in Luxxle entirely.
...
// `LuxxleSidePanel` is a complete replacement of the upstream class.
using SidePanel = LuxxleSidePanel;

#endif  // LUXXLE_BROWSER_UI_VIEWS_SIDE_PANEL_LUXXLE_SIDE_PANEL_H_
