...
#ifndef LUXXLE_BROWSER_UI_VIEWS_SIDE_PANEL_LUXXLE_SIDE_PANEL_COORDINATOR_H_
#define LUXXLE_BROWSER_UI_VIEWS_SIDE_PANEL_LUXXLE_SIDE_PANEL_COORDINATOR_H_
...
class LuxxleSidePanelCoordinator : public SidePanelCoordinator {
 public:
  using SidePanelCoordinator::SidePanelCoordinator;
  ~LuxxleSidePanelCoordinator() override;
 ...
 private:
  ...
  LuxxleBrowserView* GetLuxxleBrowserView();
};

#endif  // LUXXLE_BROWSER_UI_VIEWS_SIDE_PANEL_LUXXLE_SIDE_PANEL_COORDINATOR_H_
