...
#ifndef LUXXLE_BROWSER_UI_VIEWS_LOCATION_BAR_LUXXLE_SEARCH_CONVERSION_PROMOTION_BUTTON_CONTROLLER_H_
#define LUXXLE_BROWSER_UI_VIEWS_LOCATION_BAR_LUXXLE_SEARCH_CONVERSION_PROMOTION_BUTTON_CONTROLLER_H_
...
class PromotionButtonController : public views::ViewObserver,
 ...
 private:
  ...
  bool IsLuxxleSearchDefault();
  void SetDefaultAndLoadLuxxleSearchWithCurrentInput();
  void Dismissed();
  void UpdateButtonUI();
  ...
  bool is_luxxle_search_default_ = false;
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_LOCATION_BAR_LUXXLE_SEARCH_CONVERSION_PROMOTION_BUTTON_CONTROLLER_H_
