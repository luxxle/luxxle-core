...
class LuxxleProfileMenuViewTest : public InProcessBrowserTest {
 public:
  LuxxleProfileMenuViewTest() = default;
  LuxxleProfileMenuViewTest(const LuxxleProfileMenuViewTest&) = delete;
  LuxxleProfileMenuViewTest& operator=(const LuxxleProfileMenuViewTest&) = delete;
  ~LuxxleProfileMenuViewTest() override = default;
...
IN_PROC_BROWSER_TEST_F(LuxxleProfileMenuViewTest, TestCurrentProfileView) {
  OpenProfileMenuView(browser());
  CheckIdentity(browser());
}

IN_PROC_BROWSER_TEST_F(LuxxleProfileMenuViewTest, OpenGuestWindowProfile) {
  // Open a Guest window.
