...
#ifndef LUXXLE_BROWSER_UI_VIEWS_OMNIBOX_LUXXLE_SEARCH_CONVERSION_PROMOTION_VIEW_H_
#define LUXXLE_BROWSER_UI_VIEWS_OMNIBOX_LUXXLE_SEARCH_CONVERSION_PROMOTION_VIEW_H_
...
class LuxxleSearchConversionPromotionView : public views::View {
  METADATA_HEADER(LuxxleSearchConversionPromotionView, views::View)
 public:
  LuxxleSearchConversionPromotionView(LuxxleOmniboxResultView* result_view,
                                     PrefService* local_state,
                                     PrefService* profile_prefs,
                                     TemplateURLService* template_url_service);
  LuxxleSearchConversionPromotionView(
      const LuxxleSearchConversionPromotionView&) = delete;
  LuxxleSearchConversionPromotionView& operator=(
      const LuxxleSearchConversionPromotionView&) = delete;
  ~LuxxleSearchConversionPromotionView() override;

  void SetTypeAndInput(luxxle_search_conversion::ConversionType type,
 ...
 private:
  ...
  raw_ptr<LuxxleOmniboxResultView> result_view_ = nullptr;
  ...
  luxxle_search_conversion::ConversionType type_ =
      luxxle_search_conversion::ConversionType::kNone;
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_OMNIBOX_LUXXLE_SEARCH_CONVERSION_PROMOTION_VIEW_H_
