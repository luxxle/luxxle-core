...
#include "luxxle/browser/ui/views/omnibox/luxxle_search_conversion_promotion_view.h"
...
#include "luxxle/browser/ui/views/omnibox/luxxle_omnibox_result_view.h"
...
using luxxle_search_conversion::SetDismissed;
using luxxle_search_conversion::SetMaybeLater;
 ...
 public:
  explicit CloseButton(PressedCallback callback = PressedCallback())
    ...
    GetViewAccessibility().SetRoleDescription(l10n_util::GetStringUTF16(
        IDS_ACC_LUXXLE_SEARCH_CONVERSION_DISMISS_BUTTON));
  }
...
class LuxxleOmniboxResultSelectionIndicator : public views::View {
  METADATA_HEADER(LuxxleOmniboxResultSelectionIndicator, views::View)
 public:

  static constexpr int kStrokeThickness = 3;

  explicit LuxxleOmniboxResultSelectionIndicator(
      LuxxleSearchConversionPromotionView* parent_view)
 ...
 private:
  ...
  const raw_ptr<LuxxleSearchConversionPromotionView> parent_view_;
...
BEGIN_METADATA(LuxxleOmniboxResultSelectionIndicator)
END_METADATA

}  // namespace

LuxxleSearchConversionPromotionView::LuxxleSearchConversionPromotionView(
    LuxxleOmniboxResultView* result_view,
    PrefService* local_state,
    PrefService* profile_prefs,
    TemplateURLService* template_url_service)
    : result_view_(result_view),
      mouse_enter_exit_handler_(base::BindRepeating(
          &LuxxleSearchConversionPromotionView::UpdateHoverState,
...
void LuxxleSearchConversionPromotionView::SetTypeAndInput(
    luxxle_search_conversion::ConversionType type,
  ...
  luxxle_search_conversion::p3a::RecordPromoShown(local_state_, type);
}

void LuxxleSearchConversionPromotionView::OnSelectionStateChanged(
    bool selected) {
  selected_ = selected;
  UpdateState();
}

void LuxxleSearchConversionPromotionView::OpenMatch() {
  luxxle_search_conversion::p3a::RecordPromoTrigger(local_state_, type_);
  result_view_->OpenMatch();
}

void LuxxleSearchConversionPromotionView::Dismiss() {
  SetDismissed(profile_prefs_);
  result_view_->RefreshOmniboxResult();
}

void LuxxleSearchConversionPromotionView::MaybeLater() {
  SetMaybeLater(profile_prefs_);
  result_view_->RefreshOmniboxResult();
}

void LuxxleSearchConversionPromotionView::UpdateState() {
...
void LuxxleSearchConversionPromotionView::ConfigureForBannerType() {
  if (banner_type_container_) {
    return;
  }
  ...
  auto* close_button = banner_type_container_->AddChildView(
      std::make_unique<CloseButton>(views::Button::PressedCallback(
          base::BindRepeating(&LuxxleSearchConversionPromotionView::Dismiss,
                              base::Unretained(this)))));
  ...
  close_button->SetTooltipText(l10n_util::GetStringUTF16(
      IDS_LUXXLE_SEARCH_CONVERSION_CLOSE_BUTTON_TOOLTIP));
}

std::unique_ptr<views::View>
LuxxleSearchConversionPromotionView::GetPrimaryButton() {
  auto primary_button = std::make_unique<CustomMdTextButton>(
      views::Button::PressedCallback(base::BindRepeating(
          &LuxxleSearchConversionPromotionView::OnPrimaryButtonPressed,
          base::Unretained(this))));
  ...
  primary_button->SetText(l10n_util::GetStringUTF16(
      UseDDG() ? IDS_LUXXLE_SEARCH_CONVERSION_SET_AS_DEFAULT_BUTTON_LABEL
               : IDS_LUXXLE_SEARCH_CONVERSION_TRY_BUTTON_LABEL));
...
std::unique_ptr<views::View>
LuxxleSearchConversionPromotionView::GetSecondaryButton() {
  auto secondary_button = std::make_unique<CustomMdTextButton>(
      views::Button::PressedCallback(base::BindRepeating(
          &LuxxleSearchConversionPromotionView::OnSecondaryButtonPressed,
          base::Unretained(this))));
  ...
  secondary_button->SetText(l10n_util::GetStringUTF16(
      UseDDG() ? IDS_LUXXLE_SEARCH_CONVERSION_TRY_BUTTON_LABEL
               : IDS_LUXXLE_SEARCH_CONVERSION_MAYBE_LATER_BUTTON_LABEL));
  ...
  secondary_button->SetTooltipText(l10n_util::GetStringUTF16(
      UseDDG() ? IDS_LUXXLE_SEARCH_CONVERSION_TRY_BUTTON_LABEL
               : IDS_LUXXLE_SEARCH_CONVERSION_MAYBE_LATER_BUTTON_TOOLTIP));
  return secondary_button;
}

void LuxxleSearchConversionPromotionView::OnPrimaryButtonPressed() {
  if (UseDDG()) {
    SetLuxxleAsDefault();
  }
...
void LuxxleSearchConversionPromotionView::OnSecondaryButtonPressed() {
  if (UseDDG()) {
    OpenMatch();
    return;
  }
...
void LuxxleSearchConversionPromotionView::SetLuxxleAsDefault() {
...
SkColor LuxxleSearchConversionPromotionView::GetCloseButtonColor() const {
...
gfx::Size LuxxleSearchConversionPromotionView::CalculatePreferredSize(
...
void LuxxleSearchConversionPromotionView::OnThemeChanged() {
  View::OnThemeChanged();

  UpdateState();
}

int LuxxleSearchConversionPromotionView::
...
void LuxxleSearchConversionPromotionView::UpdateHoverState() {
  UpdateState();
}

int LuxxleSearchConversionPromotionView::GetBannerTypeTitleStringResourceId() {
  switch (type_) {
    case ConversionType::kBannerTypeA:
      NOTREACHED();
    case ConversionType::kBannerTypeB:
      return IDS_LUXXLE_SEARCH_CONVERSION_PROMOTION_BANNER_TYPE_B_TITLE;
    case ConversionType::kBannerTypeC:
      return IDS_LUXXLE_SEARCH_CONVERSION_PROMOTION_BANNER_TYPE_C_TITLE;
    case ConversionType::kBannerTypeD:
      return IDS_LUXXLE_SEARCH_CONVERSION_PROMOTION_BANNER_TYPE_D_TITLE;
    case ConversionType::kDDGBannerTypeC:
      return IDS_LUXXLE_SEARCH_CONVERSION_PROMOTION_BANNER_TYPE_C_DDG_TITLE;
    case ConversionType::kDDGBannerTypeD:
      return IDS_LUXXLE_SEARCH_CONVERSION_PROMOTION_BANNER_TYPE_D_DDG_TITLE;
...
int LuxxleSearchConversionPromotionView::GetBannerTypeDescStringResourceId() {
  switch (type_) {
    case ConversionType::kBannerTypeA:
      NOTREACHED();
    case ConversionType::kBannerTypeB:
      return IDS_LUXXLE_SEARCH_CONVERSION_PROMOTION_BANNER_TYPE_B_DESC;
    case ConversionType::kBannerTypeC:
      return IDS_LUXXLE_SEARCH_CONVERSION_PROMOTION_BANNER_TYPE_C_DESC;
    case ConversionType::kBannerTypeD:
      return IDS_LUXXLE_SEARCH_CONVERSION_PROMOTION_BANNER_TYPE_D_DESC;
    case ConversionType::kDDGBannerTypeC:
      return IDS_LUXXLE_SEARCH_CONVERSION_PROMOTION_BANNER_TYPE_C_DDG_DESC;
    case ConversionType::kDDGBannerTypeD:
      return IDS_LUXXLE_SEARCH_CONVERSION_PROMOTION_BANNER_TYPE_D_DDG_DESC;
    case ConversionType::kNone:
    case ConversionType::kButton:
    case ConversionType::kNTP:
      break;
...
bool LuxxleSearchConversionPromotionView::UseDDG() const {
  return (type_ == ConversionType::kDDGBannerTypeC ||
          type_ == ConversionType::kDDGBannerTypeD);
}

bool LuxxleSearchConversionPromotionView::ShouldDrawGraphic() const {
  if (!UseDDG()) {
    return true;
  }
...
std::optional<int> LuxxleSearchConversionPromotionView::GetBackgroundGraphic()
    const {
  if (!ShouldDrawGraphic()) {
    return std::nullopt;
  }
  ...
  if (!UseDDG()) {
    return use_dark ? /* REMOVED: IDR_LUXXLE_SEARCH_CONVERSION_BANNER_GRAPHIC_DARK */ 0
                    : /* REMOVED: IDR_LUXXLE_SEARCH_CONVERSION_BANNER_GRAPHIC */ 0;
  }

  return use_dark ? /* REMOVED: IDR_LUXXLE_SEARCH_CONVERSION_BANNER_GRAPHIC_DDG_DARK */ 0
                  : /* REMOVED: IDR_LUXXLE_SEARCH_CONVERSION_BANNER_GRAPHIC_DDG */ 0;
}

BEGIN_METADATA(LuxxleSearchConversionPromotionView)
END_METADATA
