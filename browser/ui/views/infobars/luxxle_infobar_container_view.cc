...
LuxxleInfoBarContainerView::LuxxleInfoBarContainerView(
...
LuxxleInfoBarContainerView::~LuxxleInfoBarContainerView() = default;

BEGIN_METADATA(LuxxleInfoBarContainerView)
END_METADATA
