...
#ifndef LUXXLE_BROWSER_UI_VIEWS_BRAVE_TAB_SEARCH_BUBBLE_HOST_H_
#define LUXXLE_BROWSER_UI_VIEWS_BRAVE_TAB_SEARCH_BUBBLE_HOST_H_
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_BRAVE_TAB_SEARCH_BUBBLE_HOST_H_
