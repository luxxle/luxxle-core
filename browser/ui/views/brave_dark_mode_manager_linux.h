...
#ifndef LUXXLE_BROWSER_UI_VIEWS_BRAVE_DARK_MODE_MANAGER_LINUX_H_
#define LUXXLE_BROWSER_UI_VIEWS_BRAVE_DARK_MODE_MANAGER_LINUX_H_
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_BRAVE_DARK_MODE_MANAGER_LINUX_H_
