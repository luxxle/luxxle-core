...
#ifndef LUXXLE_BROWSER_UI_VIEWS_PLAYLIST_THUMBNAIL_VIEW_H_
#define LUXXLE_BROWSER_UI_VIEWS_PLAYLIST_THUMBNAIL_VIEW_H_
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_PLAYLIST_THUMBNAIL_VIEW_H_
