...
#ifndef LUXXLE_BROWSER_UI_VIEWS_LUXXLE_ADS_NOTIFICATION_AD_VIEW_FACTORY_H_
#define LUXXLE_BROWSER_UI_VIEWS_LUXXLE_ADS_NOTIFICATION_AD_VIEW_FACTORY_H_
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_LUXXLE_ADS_NOTIFICATION_AD_VIEW_FACTORY_H_
