...
#include "luxxle/browser/ui/views/luxxle_ads/notification_ad_popup.h"

#include <string>

#include "base/check_is_test.h"
#include "base/time/time.h"
#include "luxxle/browser/ui/luxxle_ads/notification_ad_delegate.h"
#include "luxxle/browser/ui/views/luxxle_ads/bounds_util.h"
#include "luxxle/browser/ui/views/luxxle_ads/color_util.h"
#include "luxxle/browser/ui/views/luxxle_ads/notification_ad_popup_collection.h"
#include "luxxle/browser/ui/views/luxxle_ads/notification_ad_popup_widget.h"
...
NotificationAdPopup::NotificationAdPopup(
  ...
  GetViewAccessibility().SetRoleDescription(
      l10n_util::GetStringUTF8(IDS_LUXXLE_ADS_NOTIFICATION_AD_ACCESSIBLE_NAME));
