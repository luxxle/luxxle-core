...
#include "luxxle/browser/ui/views/luxxle_ads/notification_ad_control_buttons_view.h"

#include <memory>

#include "base/functional/bind.h"
#include "luxxle/app/vector_icons/vector_icons.h"
#include "luxxle/browser/ui/views/luxxle_ads/notification_ad_view.h"
#include "luxxle/browser/ui/views/luxxle_ads/padded_image_button.h"
#include "luxxle/browser/ui/views/luxxle_ads/padded_image_view.h"
...
void NotificationAdControlButtonsView::UpdateInfoButton() {
  ...
  const gfx::ImageSkia image_skia = gfx::CreateVectorIcon(
      should_use_dark_colors ? kLuxxleAdsDarkModeInfoButtonIcon
                             : kLuxxleAdsLightModeInfoButtonIcon,
...
void NotificationAdControlButtonsView::CreateCloseButton() {
  ...
  close_button_->SetAccessibleName(
      l10n_util::GetStringUTF16(IDS_LUXXLE_ADS_NOTIFICATION_AD_CLOSE_BUTTON));
}
...
void NotificationAdControlButtonsView::UpdateCloseButton() {
  ...
  close_button_->SetImageModel(
      ...
      ui::ImageModel::FromVectorIcon(kLuxxleAdsCloseButtonIcon,
