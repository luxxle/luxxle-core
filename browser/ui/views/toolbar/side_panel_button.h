...
#ifndef LUXXLE_BROWSER_UI_VIEWS_TOOLBAR_SIDE_PANEL_BUTTON_H_
#define LUXXLE_BROWSER_UI_VIEWS_TOOLBAR_SIDE_PANEL_BUTTON_H_
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_TOOLBAR_SIDE_PANEL_BUTTON_H_
