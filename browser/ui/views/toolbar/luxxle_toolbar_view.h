...
#ifndef LUXXLE_BROWSER_UI_VIEWS_TOOLBAR_LUXXLE_TOOLBAR_VIEW_H_
#define LUXXLE_BROWSER_UI_VIEWS_TOOLBAR_LUXXLE_TOOLBAR_VIEW_H_
...
class LuxxleVPNButton;
#endif

class LuxxleBookmarkButton;
class SidePanelButton;
class WalletButton;

class LuxxleToolbarView : public ToolbarView,
                         public ProfileAttributesStorage::Observer {
  METADATA_HEADER(LuxxleToolbarView, ToolbarView)
 public:
  explicit LuxxleToolbarView(Browser* browser, BrowserView* browser_view);
  ~LuxxleToolbarView() override;

  LuxxleBookmarkButton* bookmark_button() const { return bookmark_; }
...
#if BUILDFLAG(ENABLE_LUXXLE_VPN)
  LuxxleVPNButton* luxxle_vpn_button() const { return luxxle_vpn_; }
 ...
 private:
  FRIEND_TEST_ALL_PREFIXES(LuxxleToolbarViewTest, ToolbarDividerNotShownTest);
  ...
  raw_ptr<LuxxleBookmarkButton> bookmark_ = nullptr;
...
#if BUILDFLAG(ENABLE_LUXXLE_VPN)
  raw_ptr<LuxxleVPNButton> luxxle_vpn_ = nullptr;
  BooleanPrefMember show_luxxle_vpn_button_;
  BooleanPrefMember hide_luxxle_vpn_button_by_policy_;
#endif
  ...
  bool luxxle_initialized_ = false;
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_TOOLBAR_LUXXLE_TOOLBAR_VIEW_H_
