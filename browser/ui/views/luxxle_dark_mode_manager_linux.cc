...
#include "luxxle/browser/ui/views/luxxle_dark_mode_manager_linux.h"
...
LuxxleDarkModeManagerLinux::LuxxleDarkModeManagerLinux()
...
LuxxleDarkModeManagerLinux::~LuxxleDarkModeManagerLinux() = default;

void LuxxleDarkModeManagerLinux::SetColorScheme(bool prefer_dark_theme,
                                               bool from_toolkit_theme) {
  dark_mode::CacheSystemDarkModePrefs(prefer_dark_theme);
  if (dark_mode::GetLuxxleDarkModeType() ==
    ...
    // Make |prefer_dark_theme_| stores latest system theme even luxxle theme(
