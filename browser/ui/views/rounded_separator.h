...
#ifndef LUXXLE_BROWSER_UI_VIEWS_ROUNDED_SEPARATOR_H_
#define LUXXLE_BROWSER_UI_VIEWS_ROUNDED_SEPARATOR_H_
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_ROUNDED_SEPARATOR_H_
