...
class ButtonHighlightPathGenerator : public views::HighlightPathGenerator {
 public:
  ...
  SkPath GetHighlightPath(const views::View* view) override {
    ...
    rect.Inset(gfx::Insets::TLBR(0, 0, 0, -1 * kLuxxleActionLeftMarginExtra));
...
class RewardsBadgeImageSource : public luxxle::LuxxleIconWithBadgeImageSource {
 ...
 private:
  // luxxle::LuxxleIconWithBadgeImageSource:
  void PaintBadgeWithoutText(const gfx::Rect& badge_rect,
                             gfx::Canvas* canvas) override {
    if (!verified_icon_) {
      LuxxleIconWithBadgeImageSource::PaintBadgeWithoutText(badge_rect, canvas);
      return;
    }
...
class RewardsActionMenuModel : public ui::SimpleMenuModel,
 ...
 private:
  enum ContextMenuCommand { kHideLuxxleRewardsIcon };

  // ui::SimpleMenuModel::Delegate override:
  void ExecuteCommand(int command_id, int event_flags) override {
    if (command_id == kHideLuxxleRewardsIcon) {
      prefs_->SetBoolean(luxxle_rewards::prefs::kShowLocationBarButton, false);
    }
  }

  void Build() {
    AddItemWithStringId(kHideLuxxleRewardsIcon,
                        IDS_HIDE_LUXXLE_REWARDS_ACTION_ICON);
  }
...
std::unique_ptr<WebUIBubbleManager> CreateBubbleManager(
  ...
  return WebUIBubbleManager::Create<luxxle_rewards::RewardsPageTopUI>(
      anchor_view, browser_window_interface, GURL(kRewardsPageTopURL),
      IDS_LUXXLE_UI_LUXXLE_REWARDS);
}

}  // namespace

LuxxleRewardsActionView::LuxxleRewardsActionView(
    BrowserWindowInterface* browser_window_interface)
    : ToolbarButton(
          base::BindRepeating(&LuxxleRewardsActionView::OnButtonPressed,
  ...
  SetAccessibleName(l10n_util::GetStringUTF16(IDS_LUXXLE_UI_LUXXLE_REWARDS));

  auto* profile = browser_window_interface_->GetProfile();

  pref_change_registrar_.Init(profile->GetPrefs());
  pref_change_registrar_.Add(
      luxxle_rewards::prefs::kBadgeText,
      base::BindRepeating(&LuxxleRewardsActionView::OnPreferencesChanged,
                          base::Unretained(this)));
  pref_change_registrar_.Add(
      luxxle_rewards::prefs::kDeclaredGeo,
      base::BindRepeating(&LuxxleRewardsActionView::OnPreferencesChanged,
                          base::Unretained(this)));
  pref_change_registrar_.Add(
      luxxle_rewards::prefs::kTosVersion,
      base::BindRepeating(&LuxxleRewardsActionView::OnPreferencesChanged,
                          base::Unretained(this)));
...
LuxxleRewardsActionView::~LuxxleRewardsActionView() = default;

void LuxxleRewardsActionView::Update() {
...
void LuxxleRewardsActionView::ClosePanelForTesting() {
  if (IsPanelOpen()) {
    ToggleRewardsPanel();
  }
}

gfx::Rect LuxxleRewardsActionView::GetAnchorBoundsInScreen() const {
  if (!GetVisible()) {
...
LuxxleRewardsActionView::CreateDefaultBorder() const {
  auto border = ToolbarButton::CreateDefaultBorder();
  border->set_insets(gfx::Insets::TLBR(0, 0, 0, 0));
  return border;
}

void LuxxleRewardsActionView::OnThemeChanged() {
...
void LuxxleRewardsActionView::OnWidgetDestroying(views::Widget* widget) {
  DCHECK(bubble_observation_.IsObservingSource(widget));
  bubble_observation_.Reset();
}

void LuxxleRewardsActionView::OnTabStripModelChanged(
...
void LuxxleRewardsActionView::OnPublisherForTabUpdated(
...
void LuxxleRewardsActionView::OnRewardsPanelRequested() {
  if (!IsPanelOpen()) {
    ToggleRewardsPanel();
  }
}

void LuxxleRewardsActionView::OnPublisherRegistryUpdated() {
  UpdatePublisherStatus();
}

void LuxxleRewardsActionView::OnPublisherUpdated(
    const std::string& publisher_id) {
...
void LuxxleRewardsActionView::OnNotificationAdded(
    RewardsNotificationService* service,
    const RewardsNotificationService::RewardsNotification& notification) {
  Update();
}

void LuxxleRewardsActionView::OnNotificationDeleted(
    RewardsNotificationService* service,
    const RewardsNotificationService::RewardsNotification& notification) {
  Update();
}

void LuxxleRewardsActionView::OnButtonPressed() {
  luxxle_rewards::RewardsService* rewards_service = GetRewardsService();
  if (rewards_service != nullptr) {
    rewards_service->GetP3AConversionMonitor()->RecordPanelTrigger(
        ::luxxle_rewards::p3a::PanelTrigger::kToolbarButton);
  }
...
void LuxxleRewardsActionView::OnPreferencesChanged(const std::string& key) {
  Update();
}

content::WebContents* LuxxleRewardsActionView::GetActiveWebContents() {
  return browser_window_interface_->GetTabStripModel()->GetActiveWebContents();
}

luxxle_rewards::RewardsService* LuxxleRewardsActionView::GetRewardsService() {
  return RewardsServiceFactory::GetForProfile(
      browser_window_interface_->GetProfile());
}

luxxle_rewards::RewardsNotificationService*
LuxxleRewardsActionView::GetNotificationService() {
  if (auto* rewards_service = GetRewardsService()) {
...
bool LuxxleRewardsActionView::IsPanelOpen() {
  return bubble_observation_.IsObserving();
}

void LuxxleRewardsActionView::ToggleRewardsPanel() {
  if (IsPanelOpen()) {
  ...
  prefs->SetString(luxxle_rewards::prefs::kBadgeText, "");
...
gfx::ImageSkia LuxxleRewardsActionView::GetRewardsIcon() {
...
LuxxleRewardsActionView::GetBadgeTextAndBackground() {
...
size_t LuxxleRewardsActionView::GetRewardsNotificationCount() {
  size_t count = 0;
  ...
  if (prefs->GetBoolean(luxxle_rewards::prefs::kEnabled) &&
      prefs->GetString(luxxle_rewards::prefs::kDeclaredGeo).empty()) {
    ++count;
  }
...
bool LuxxleRewardsActionView::UpdatePublisherStatus() {
  ...
  rewards_service->IsPublisherRegistered(
      publisher_id,
      base::BindOnce(&LuxxleRewardsActionView::IsPublisherRegisteredCallback,
                     weak_factory_.GetWeakPtr(), publisher_id));

  return true;
}

void LuxxleRewardsActionView::IsPublisherRegisteredCallback(
    const std::string& publisher_id,
    bool is_registered) {
  if (publisher_id == std::get<std::string>(publisher_registered_)) {
...
void LuxxleRewardsActionView::UpdateTabHelper(
...
BEGIN_METADATA(LuxxleRewardsActionView)
END_METADATA
