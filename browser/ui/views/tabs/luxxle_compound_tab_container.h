...
#ifndef LUXXLE_BROWSER_UI_VIEWS_TABS_LUXXLE_COMPOUND_TAB_CONTAINER_H_
#define LUXXLE_BROWSER_UI_VIEWS_TABS_LUXXLE_COMPOUND_TAB_CONTAINER_H_
...
class LuxxleCompoundTabContainer : public CompoundTabContainer {
  METADATA_HEADER(LuxxleCompoundTabContainer, CompoundTabContainer)
 public:

  LuxxleCompoundTabContainer(TabContainerController& controller,
                            TabHoverCardController* hover_card_controller,
                            TabDragContextBase* drag_context,
                            TabSlotController& tab_slot_controller,
                            views::View* scroll_contents_view);
  ~LuxxleCompoundTabContainer() override;
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_TABS_LUXXLE_COMPOUND_TAB_CONTAINER_H_
