...
LuxxleTabSearchButton::LuxxleTabSearchButton(
...
LuxxleTabSearchButton::~LuxxleTabSearchButton() = default;

void LuxxleTabSearchButton::UpdateColors() {
...
int LuxxleTabSearchButton::GetCornerRadius() const {
  return TabStripControlButton::GetCornerRadius();
}

BEGIN_METADATA(LuxxleTabSearchButton)
END_METADATA
