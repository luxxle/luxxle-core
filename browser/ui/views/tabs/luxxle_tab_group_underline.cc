...
LuxxleTabGroupUnderline::LuxxleTabGroupUnderline(
    TabGroupViews* tab_group_views,
    const tab_groups::TabGroupId& group,
    const TabGroupStyle& style)
    : TabGroupUnderline(tab_group_views, group, style) {}

LuxxleTabGroupUnderline::~LuxxleTabGroupUnderline() = default;

void LuxxleTabGroupUnderline::UpdateBounds(const views::View* leading_view,
...
gfx::Insets LuxxleTabGroupUnderline::GetInsetsForUnderline(
  ...
  int horizontal_inset =
      TabGroupUnderline::kStrokeThickness + luxxle_tabs::kHorizontalTabInset;

  return gfx::Insets::VH(0, horizontal_inset);
}

gfx::Rect LuxxleTabGroupUnderline::CalculateTabGroupUnderlineBounds(
  ...
  if (trailing_bounds.height()) {
    trailing_bounds.set_height(trailing_bounds.height() +
                               LuxxleTabGroupHeader::kPaddingForGroup);
  }
...
void LuxxleTabGroupUnderline::OnPaint(gfx::Canvas* canvas) {
  if (!tabs::features::HorizontalTabsUpdateEnabled()) {
...
bool LuxxleTabGroupUnderline::ShouldShowVerticalTabs() const {
  return tabs::utils::ShouldShowVerticalTabs(tab_group_views_->GetBrowser());
}

// static
int LuxxleTabGroupUnderline::GetStrokeInset() {
  if (!tabs::features::HorizontalTabsUpdateEnabled()) {
    return TabGroupUnderline::GetStrokeInset();
  }
  return luxxle_tabs::kHorizontalTabInset;
}

BEGIN_METADATA(LuxxleTabGroupUnderline)
END_METADATA
