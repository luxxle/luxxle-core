...
LuxxleTabHoverCardController::~LuxxleTabHoverCardController() = default;

void LuxxleTabHoverCardController::SetIsVerticalTabs(bool is_vertical_tabs) {
...
void LuxxleTabHoverCardController::UpdateHoverCardArrow() {
  if (hover_card_) {
...
void LuxxleTabHoverCardController::CreateHoverCard(Tab* tab) {
  hover_card_image_previews_enabled_ =
      AreHoverCardImagesEnabled() ||
      luxxle_tabs::AreCardPreviewsEnabled(
...
void LuxxleTabHoverCardController::OnHovercardImagesEnabledChanged() {
  hover_card_image_previews_enabled_ =
      AreHoverCardImagesEnabled() ||
      luxxle_tabs::AreCardPreviewsEnabled(
