...
class LuxxleTabHoverTest : public InProcessBrowserTest {
 public:
  LuxxleTabHoverTest()
  ...
  LuxxleTabHoverTest(const LuxxleTabHoverTest&) = delete;
  LuxxleTabHoverTest& operator=(const LuxxleTabHoverTest&) = delete;
...
IN_PROC_BROWSER_TEST_F(LuxxleTabHoverTest, ThumbnailHelperIsAlwaysAttached) {
  browser()->profile()->GetPrefs()->SetInteger(luxxle_tabs::kTabHoverMode,
                                               luxxle_tabs::TabHoverMode::CARD);
  ...
  browser()->profile()->GetPrefs()->SetInteger(
      luxxle_tabs::kTabHoverMode, luxxle_tabs::TabHoverMode::CARD_WITH_PREVIEW);
  data_list = {};
  data_list.emplace_back(0, TabRendererData());
  ...
  browser()->profile()->GetPrefs()->SetInteger(
      luxxle_tabs::kTabHoverMode, luxxle_tabs::TabHoverMode::TOOLTIP);
...
#endif
IN_PROC_BROWSER_TEST_F(LuxxleTabHoverTest,
...
IN_PROC_BROWSER_TEST_F(LuxxleTabHoverTest, ChromeFeatureDisabledByDefault) {
  EXPECT_FALSE(base::FeatureList::IsEnabled(features::kTabHoverCardImages));
}

class LuxxleTabHoverTestWithChromeFlag : public LuxxleTabHoverTest {
 public:
  LuxxleTabHoverTestWithChromeFlag() {
...
#endif
IN_PROC_BROWSER_TEST_F(LuxxleTabHoverTestWithChromeFlag,
