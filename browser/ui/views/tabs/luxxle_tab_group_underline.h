...
#ifndef LUXXLE_BROWSER_UI_VIEWS_TABS_LUXXLE_TAB_GROUP_UNDERLINE_H_
#define LUXXLE_BROWSER_UI_VIEWS_TABS_LUXXLE_TAB_GROUP_UNDERLINE_H_
...
class LuxxleTabGroupUnderline : public TabGroupUnderline {
  METADATA_HEADER(LuxxleTabGroupUnderline, TabGroupUnderline)
 public:
  LuxxleTabGroupUnderline(TabGroupViews* tab_group_views,
                         const tab_groups::TabGroupId& group,
                         const TabGroupStyle& style);
  ~LuxxleTabGroupUnderline() override;
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_TABS_LUXXLE_TAB_GROUP_UNDERLINE_H_
