...
#ifndef LUXXLE_BROWSER_UI_VIEWS_TABS_LUXXLE_TAB_H_
#define LUXXLE_BROWSER_UI_VIEWS_TABS_LUXXLE_TAB_H_
...
class LuxxleTab : public Tab {
 public:
  using Tab::Tab;
  LuxxleTab(const LuxxleTab&) = delete;
  LuxxleTab& operator=(const LuxxleTab&) = delete;
  ~LuxxleTab() override;
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_TABS_LUXXLE_TAB_H_
