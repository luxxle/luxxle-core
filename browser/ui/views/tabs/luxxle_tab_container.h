...
#ifndef LUXXLE_BROWSER_UI_VIEWS_TABS_LUXXLE_TAB_CONTAINER_H_
#define LUXXLE_BROWSER_UI_VIEWS_TABS_LUXXLE_TAB_CONTAINER_H_
...
class LuxxleTabContainer : public TabContainerImpl,
                          public SplitViewBrowserDataObserver {
  METADATA_HEADER(LuxxleTabContainer, TabContainerImpl)
 public:
  LuxxleTabContainer(TabContainerController& controller,
                    TabHoverCardController* hover_card_controller,
                    TabDragContextBase* drag_context,
                    TabSlotController& tab_slot_controller,
                    views::View* scroll_contents_view);
  ~LuxxleTabContainer() override;
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_TABS_LUXXLE_TAB_CONTAINER_H_
