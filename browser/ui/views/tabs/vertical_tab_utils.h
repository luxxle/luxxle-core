...
#ifndef LUXXLE_BROWSER_UI_VIEWS_TABS_VERTICAL_TAB_UTILS_H_
#define LUXXLE_BROWSER_UI_VIEWS_TABS_VERTICAL_TAB_UTILS_H_
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_TABS_VERTICAL_TAB_UTILS_H_
