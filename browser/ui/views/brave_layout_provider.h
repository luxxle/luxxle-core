...
#ifndef LUXXLE_BROWSER_UI_VIEWS_BRAVE_LAYOUT_PROVIDER_H_
#define LUXXLE_BROWSER_UI_VIEWS_BRAVE_LAYOUT_PROVIDER_H_
...
#endif  // LUXXLE_BROWSER_UI_VIEWS_BRAVE_LAYOUT_PROVIDER_H_
