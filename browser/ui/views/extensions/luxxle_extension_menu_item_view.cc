...
LuxxleExtensionMenuItemView::LuxxleExtensionMenuItemView(
    Browser* browser,
    bool is_enterprise,
...
LuxxleExtensionMenuItemView::~LuxxleExtensionMenuItemView() = default;

void LuxxleExtensionMenuItemView::UpdateContextMenuButton(
...
void LuxxleExtensionMenuItemView::UpdatePinButton(bool is_force_pinned,
                                                 bool is_pinned) {
...
void LuxxleExtensionMenuItemView::OnThemeChanged() {
...
void LuxxleExtensionMenuItemView::UpdatePinButtonIcon() {
  CHECK(pin_button_);
    ...
    for (auto state : views::Button::kButtonStates) {
      pin_button_->SetImageModel(
          state, ui::ImageModel::FromVectorIcon(
                     kLeoPinIcon, cp->GetColor(kColorLuxxleExtensionMenuIcon)));
    }
  }
}

BEGIN_METADATA(LuxxleExtensionMenuItemView)
END_METADATA
