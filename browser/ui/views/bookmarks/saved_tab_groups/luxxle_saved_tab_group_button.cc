...
LuxxleSavedTabGroupButton::~LuxxleSavedTabGroupButton() = default;

void LuxxleSavedTabGroupButton::PaintButtonContents(gfx::Canvas* canvas) {
...
void LuxxleSavedTabGroupButton::Initialize() {
  views::InstallRoundRectHighlightPathGenerator(this, gfx::Insets(0),
                                                kBorderRadius);
}

void LuxxleSavedTabGroupButton::UpdateButtonLayout() {
...
BEGIN_METADATA(LuxxleSavedTabGroupButton)
END_METADATA
