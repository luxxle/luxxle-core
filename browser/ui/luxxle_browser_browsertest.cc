...
using LuxxleBrowserBrowserTest = InProcessBrowserTest;
...
IN_PROC_BROWSER_TEST_F(LuxxleBrowserBrowserTest, NTPFaviconTest) {
...
IN_PROC_BROWSER_TEST_F(LuxxleBrowserBrowserTest, LoadWebUIURLWithBadSchemeTest) {
  ASSERT_TRUE(
      ui_test_utils::NavigateToURL(browser(), GURL("http://settings/")));
}

IN_PROC_BROWSER_TEST_F(LuxxleBrowserBrowserTest, DisabledFeatureURLLoadTest) {
...
IN_PROC_BROWSER_TEST_F(LuxxleBrowserBrowserTest, OpenNewTabWhenTabStripIsEmpty) {
...
IN_PROC_BROWSER_TEST_F(LuxxleBrowserBrowserTest,
