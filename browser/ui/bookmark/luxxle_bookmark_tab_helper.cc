...
LuxxleBookmarkTabHelper::LuxxleBookmarkTabHelper(
    content::WebContents* web_contents)
    : content::WebContentsUserData<LuxxleBookmarkTabHelper>(*web_contents) {}

LuxxleBookmarkTabHelper::~LuxxleBookmarkTabHelper() = default;

void LuxxleBookmarkTabHelper::AddObserver(BookmarkTabHelperObserver* observer) {
  BookmarkTabHelper::FromWebContents(&GetWebContents())->AddObserver(observer);
}

void LuxxleBookmarkTabHelper::RemoveObserver(
    BookmarkTabHelperObserver* observer) {
  BookmarkTabHelper::FromWebContents(&GetWebContents())
      ->RemoveObserver(observer);
}

bool LuxxleBookmarkTabHelper::ShouldShowBookmarkBar() {
...
WEB_CONTENTS_USER_DATA_KEY_IMPL(LuxxleBookmarkTabHelper);
