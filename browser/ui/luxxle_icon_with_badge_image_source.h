...
#ifndef LUXXLE_BROWSER_UI_LUXXLE_ICON_WITH_BADGE_IMAGE_SOURCE_H_
#define LUXXLE_BROWSER_UI_LUXXLE_ICON_WITH_BADGE_IMAGE_SOURCE_H_
...
// - Paint the LuxxleAction badge in a custom location and with a different size
//   to regular BrowserAction extensions.
class LuxxleIconWithBadgeImageSource : public IconWithBadgeImageSource {
 public:
  ...
  LuxxleIconWithBadgeImageSource(const LuxxleIconWithBadgeImageSource&) = delete;
  LuxxleIconWithBadgeImageSource& operator=(
      const LuxxleIconWithBadgeImageSource&) = delete;
...
#endif  // LUXXLE_BROWSER_UI_LUXXLE_ICON_WITH_BADGE_IMAGE_SOURCE_H_
