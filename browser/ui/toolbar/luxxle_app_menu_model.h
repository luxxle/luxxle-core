...
#ifndef LUXXLE_BROWSER_UI_TOOLBAR_LUXXLE_APP_MENU_MODEL_H_
#define LUXXLE_BROWSER_UI_TOOLBAR_LUXXLE_APP_MENU_MODEL_H_
...
class LuxxleAppMenuModel : public AppMenuModel {
 public:
  LuxxleAppMenuModel(ui::AcceleratorProvider* provider,
                    Browser* browser,
                    AppMenuIconController* app_menu_icon_controller = nullptr,
                    AlertMenuItem alert_item = AlertMenuItem::kNone);
  ~LuxxleAppMenuModel() override;

  LuxxleAppMenuModel(const LuxxleAppMenuModel&) = delete;
  LuxxleAppMenuModel& operator=(const LuxxleAppMenuModel&) = delete;
 ...
 private:
  FRIEND_TEST_ALL_PREFIXES(LuxxleAppMenuModelBrowserTest, LuxxleIpfsMenuTest);
  ...
  void BuildLuxxleProductsSection();
  size_t GetNextIndexOfLuxxleProductsSection() const;
  ...
  // About luxxle, help center and report broken site items.
...
#endif  // LUXXLE_BROWSER_UI_TOOLBAR_LUXXLE_APP_MENU_MODEL_H_
