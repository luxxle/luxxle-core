...
#ifndef LUXXLE_BROWSER_UI_LUXXLE_BROWSER_WINDOW_H_
#define LUXXLE_BROWSER_UI_LUXXLE_BROWSER_WINDOW_H_
...
class LuxxleBrowserWindow : public BrowserWindow {
 public:
  ~LuxxleBrowserWindow() override {}

  static LuxxleBrowserWindow* From(BrowserWindow*);
  ...
  virtual bool ShowLuxxleHelpBubbleView(const std::string& text);
#endif
...
#endif  // LUXXLE_BROWSER_UI_LUXXLE_BROWSER_WINDOW_H_
