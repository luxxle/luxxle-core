...
typedef InProcessBrowserTest LuxxleAutoplayBlockedImageModelTest;

IN_PROC_BROWSER_TEST_F(LuxxleAutoplayBlockedImageModelTest, CreateBubbleModel) {
  ...
  auto model = std::make_unique<LuxxleAutoplayBlockedImageModel>();
