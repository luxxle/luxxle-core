...
#ifndef LUXXLE_BROWSER_UI_PLAYLIST_PLAYLIST_BROWSER_FINDER_H_
#define LUXXLE_BROWSER_UI_PLAYLIST_PLAYLIST_BROWSER_FINDER_H_
...
#endif  // LUXXLE_BROWSER_UI_PLAYLIST_PLAYLIST_BROWSER_FINDER_H_
