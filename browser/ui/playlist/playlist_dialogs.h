...
#ifndef LUXXLE_BROWSER_UI_PLAYLIST_PLAYLIST_DIALOGS_H_
#define LUXXLE_BROWSER_UI_PLAYLIST_PLAYLIST_DIALOGS_H_
...
#endif  // LUXXLE_BROWSER_UI_PLAYLIST_PLAYLIST_DIALOGS_H_
