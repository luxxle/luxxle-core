...
#ifndef LUXXLE_BROWSER_UI_SPEEDREADER_SPEEDREADER_BUBBLE_VIEW_H_
#define LUXXLE_BROWSER_UI_SPEEDREADER_SPEEDREADER_BUBBLE_VIEW_H_
...
#endif  // LUXXLE_BROWSER_UI_SPEEDREADER_SPEEDREADER_BUBBLE_VIEW_H_
