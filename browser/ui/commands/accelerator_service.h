...
#ifndef LUXXLE_BROWSER_UI_COMMANDS_ACCELERATOR_SERVICE_H_
#define LUXXLE_BROWSER_UI_COMMANDS_ACCELERATOR_SERVICE_H_
...
#endif  // LUXXLE_BROWSER_UI_COMMANDS_ACCELERATOR_SERVICE_H_
