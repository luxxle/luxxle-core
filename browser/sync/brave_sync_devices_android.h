...
#ifndef LUXXLE_BROWSER_SYNC_BRAVE_SYNC_DEVICES_ANDROID_H_
#define LUXXLE_BROWSER_SYNC_BRAVE_SYNC_DEVICES_ANDROID_H_
...
#endif  // LUXXLE_BROWSER_SYNC_BRAVE_SYNC_DEVICES_ANDROID_H_
