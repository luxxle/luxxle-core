...
#include "luxxle/browser/sync/luxxle_sync_devices_android.h"
...
#include "chrome/android/chrome_jni_headers/LuxxleSyncDevices_jni.h"
...
LuxxleSyncDevicesAndroid::LuxxleSyncDevicesAndroid(
    JNIEnv* env, const base::android::JavaRef<jobject>& obj) :
    weak_java_luxxle_sync_worker_(env, obj) {
  Java_LuxxleSyncDevices_setNativePtr(env, obj,
...
void LuxxleSyncDevicesAndroid::Destroy(JNIEnv* env) {
  delete this;
}

void LuxxleSyncDevicesAndroid::OnDeviceInfoChange() {
  // Notify Java code
  JNIEnv* env = base::android::AttachCurrentThread();
  Java_LuxxleSyncDevices_deviceInfoChanged(env,
      weak_java_luxxle_sync_worker_.get(env));
}

base::Value::List LuxxleSyncDevicesAndroid::GetSyncDeviceList() {
...
LuxxleSyncDevicesAndroid::GetSyncDeviceListJson(JNIEnv* env) {
...
// TODO(AlexeyBarabash): duplicate with LuxxleSyncWorker?
syncer::LuxxleSyncServiceImpl* LuxxleSyncDevicesAndroid::GetSyncService() const {
...
void LuxxleSyncDevicesAndroid::DeleteDevice(
    JNIEnv* env,
  ...
  luxxle_sync::DeleteDevice(sync_service, device_info_sync_service,
                           str_device_guid);
}

static void JNI_LuxxleSyncDevices_Init(
    JNIEnv* env,
    const base::android::JavaParamRef<jobject>& jcaller) {
  new LuxxleSyncDevicesAndroid(env, jcaller);
}
