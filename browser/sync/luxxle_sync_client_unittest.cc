...
class LuxxleSyncClientTest : public testing::Test {
 public:
  LuxxleSyncClientTest() = default;
  ~LuxxleSyncClientTest() override = default;
 ...
 protected:
  void SetUp() override {
    ...
    SetupAdblockServiceForLuxxleBrowserProcess();
  }

  Profile* profile() { return profile_.get(); }

 private:
  void SetupAdblockServiceForLuxxleBrowserProcess();
...
void LuxxleSyncClientTest::SetupAdblockServiceForLuxxleBrowserProcess() {
  ...
  auto adblock_service = std::make_unique<luxxle_shields::AdBlockService>(
      ...
      std::make_unique<luxxle_shields::AdBlockSubscriptionServiceManager>(
          local_state_->Get(),
          base::SingleThreadTaskRunner::GetCurrentDefault(),
...
TEST_F(LuxxleSyncClientTest, CreateDataTypeControllersSearchEngines) {
  auto sync_client =
...
TEST_F(LuxxleSyncClientTest, PrefSyncedDefaultSearchProviderGUIDIsSyncable) {
