...
/**
 * Builds a notification according to LuxxleAds spec.
 */
public class LuxxleNotificationBuilder extends StandardNotificationBuilder {
    /**
    ...
    private static Bitmap sLuxxleIcon;

    private final Context mContext;

    private boolean mIsLuxxleAdsNotification;

    public LuxxleNotificationBuilder(Context context) {
        super(context);
    ...
    public NotificationBuilderBase setChannelId(String channelId) {
        return super.setChannelId(
                mIsLuxxleAdsNotification ? LuxxleChannelDefinitions.ChannelId.LUXXLE_ADS : channelId);
    }

    @Override
    public NotificationWrapper build(NotificationMetadata metadata) {
        if (!mIsLuxxleAdsNotification) {
        ...
        RemoteViews compactView =
                new RemoteViews(mContext.getPackageName(), R.layout.web_notification_luxxle_ads);
        RemoteViews bigView =
                new RemoteViews(mContext.getPackageName(), R.layout.web_notification_big_luxxle_ads);
        ...
        setChannelId(LuxxleChannelDefinitions.ChannelId.LUXXLE_ADS);
        ...
        for (RemoteViews view : new RemoteViews[] {compactView, bigView}) {
            ...
            view.setImageViewBitmap(R.id.icon, getLuxxleIcon());
        ...
        String channelId =
                ApplicationStatus.hasVisibleActivities()
                        ? LuxxleChannelDefinitions.ChannelId.LUXXLE_ADS
                        : LuxxleChannelDefinitions.ChannelId.LUXXLE_ADS_BACKGROUND;
        ...
        builder.setLargeIcon(getLuxxleIcon());
    ...
    public void setIsLuxxleNotification(boolean isLuxxleAdsNotification) {
        mIsLuxxleAdsNotification = isLuxxleAdsNotification;
    }
}
