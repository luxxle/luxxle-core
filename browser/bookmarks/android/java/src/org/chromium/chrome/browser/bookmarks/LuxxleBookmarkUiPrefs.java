...
/** Luxxle's extension for BookmarkUiPrefs. */
public class LuxxleBookmarkUiPrefs extends BookmarkUiPrefs {
    private final SharedPreferencesManager mPrefsManager;

    public LuxxleBookmarkUiPrefs(SharedPreferencesManager prefsManager) {
        super(prefsManager);
