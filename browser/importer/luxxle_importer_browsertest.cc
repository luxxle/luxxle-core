...
class LuxxleImporterBrowserTest : public InProcessBrowserTest {
 public:
...
IN_PROC_BROWSER_TEST_F(LuxxleImporterBrowserTest, ImportExtensions) {
  ...
  for (int i = 0; i < 3; ++i) {
    ...
    // Deletes itself.
    auto* host = new LuxxleExternalProcessImporterHost;
