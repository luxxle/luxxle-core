...
class BrowsingDataRemovalWatcher
 ...
 public:
  ...
  void ClearBrowsingDataForLoadedProfiles(
      LuxxleClearBrowsingData::OnExitTestingCallback* testing_callback);
...
bool BrowsingDataRemovalWatcher::GetClearBrowsingDataOnExitSettings(
  ...
  *origin_mask = 0;
  ...
  // Note: this will also delete Luxxle Shields site-specific settings.
  ...
  if (prefs->GetBoolean(browsing_data::prefs::kDeleteLuxxleLeoHistoryOnExit)) {
...
LuxxleClearBrowsingData::OnExitTestingCallback*
    LuxxleClearBrowsingData::on_exit_testing_callback_ = nullptr;

// static
void LuxxleClearBrowsingData::ClearOnExit() {
  TRACE_EVENT0("browser", "LuxxleClearBrowsingData::ClearOnExit");
...
// static
void LuxxleClearBrowsingData::SetOnExitTestingCallback(
