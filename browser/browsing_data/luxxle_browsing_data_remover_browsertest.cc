...
class LuxxleBrowsingDataRemoverBrowserTest : public InProcessBrowserTest {
 public:
  LuxxleBrowsingDataRemoverBrowserTest() = default;
...
IN_PROC_BROWSER_TEST_F(LuxxleBrowsingDataRemoverBrowserTest,
