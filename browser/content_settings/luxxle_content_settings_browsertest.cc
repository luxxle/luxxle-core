...
class LuxxleContentSettingsBrowserTest : public InProcessBrowserTest {
 public:
  LuxxleContentSettingsBrowserTest()
  ...
  ~LuxxleContentSettingsBrowserTest() override = default;
...
IN_PROC_BROWSER_TEST_F(LuxxleContentSettingsBrowserTest,
