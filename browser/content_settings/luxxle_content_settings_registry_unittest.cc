...
class LuxxleContentSettingsRegistryTest : public testing::Test {
 protected:
  LuxxleContentSettingsRegistryTest() = default;
...
TEST_F(LuxxleContentSettingsRegistryTest, Properties) {
  // The cookies type should be registered.
  const ContentSettingsInfo* info =
      registry()->Get(ContentSettingsType::LUXXLE_COOKIES);
  ASSERT_TRUE(info);
  ...
  EXPECT_EQ(
      website_settings_registry()->Get(ContentSettingsType::LUXXLE_COOKIES),
...
TEST_F(LuxxleContentSettingsRegistryTest, Inheritance) {
  ...
  const ContentSettingsType safe_types[] = {
      ContentSettingsType::LUXXLE_ADS,
      ContentSettingsType::LUXXLE_COSMETIC_FILTERING,
      ContentSettingsType::LUXXLE_TRACKERS,
      ...
      ContentSettingsType::LUXXLE_REFERRERS,
      ContentSettingsType::LUXXLE_COOKIES,
      ContentSettingsType::LUXXLE_SPEEDREADER,
      ...
      ContentSettingsType::LUXXLE_WEBCOMPAT_NONE,
      ContentSettingsType::LUXXLE_WEBCOMPAT_AUDIO,
      ...
      ContentSettingsType::LUXXLE_WEBCOMPAT_ALL,
  };
  ...
  for (const ContentSettingsInfo* info : *registry()) {
    ...
    if (info->website_settings_info()->type() <
        ContentSettingsType::LUXXLE_START)
      continue;
...
TEST_F(LuxxleContentSettingsRegistryTest, GetInitialDefaultSetting) {
  const ContentSettingsInfo* info = nullptr;
  {
    SCOPED_TRACE("Content setting: LUXXLE_ADS");
    info = registry()->Get(ContentSettingsType::LUXXLE_ADS);
    EXPECT_EQ(CONTENT_SETTING_BLOCK, info->GetInitialDefaultSetting());
  }

  {
    SCOPED_TRACE("Content setting: LUXXLE_TRACKERS");
    info = registry()->Get(ContentSettingsType::LUXXLE_TRACKERS);
    EXPECT_EQ(CONTENT_SETTING_BLOCK, info->GetInitialDefaultSetting());
  }

  {
    SCOPED_TRACE("Content setting: LUXXLE_HTTP_UPGRADABLE_RESOURCES");
    info =
        registry()->Get(ContentSettingsType::LUXXLE_HTTP_UPGRADABLE_RESOURCES);
    EXPECT_EQ(CONTENT_SETTING_BLOCK, info->GetInitialDefaultSetting());
  }

  {
    SCOPED_TRACE("Content setting: LUXXLE_SHIELDS");
    info = registry()->Get(ContentSettingsType::LUXXLE_SHIELDS);
    EXPECT_EQ(CONTENT_SETTING_ALLOW, info->GetInitialDefaultSetting());
  }

  {
    SCOPED_TRACE("Content setting: LUXXLE_REFERRERS");
    info = registry()->Get(ContentSettingsType::LUXXLE_REFERRERS);
    EXPECT_EQ(CONTENT_SETTING_BLOCK, info->GetInitialDefaultSetting());
  }

  {
    SCOPED_TRACE("Content setting: LUXXLE_ETHEREUM");
    info = registry()->Get(ContentSettingsType::LUXXLE_ETHEREUM);
    EXPECT_EQ(CONTENT_SETTING_ASK, info->GetInitialDefaultSetting());
  }

  {
    SCOPED_TRACE("Content setting: LUXXLE_SOLANA");
    info = registry()->Get(ContentSettingsType::LUXXLE_SOLANA);
    EXPECT_EQ(CONTENT_SETTING_ASK, info->GetInitialDefaultSetting());
  }

  {
    SCOPED_TRACE("Content setting: LUXXLE_CARDANO");
    info = registry()->Get(ContentSettingsType::LUXXLE_CARDANO);
    EXPECT_EQ(CONTENT_SETTING_ASK, info->GetInitialDefaultSetting());
  }
  ...
  // {
  //   SCOPED_TRACE("Content setting: LUXXLE_FINGERPRINTING_V2");
  //   info = registry()->Get(ContentSettingsType::LUXXLE_FINGERPRINTING_V2);
  //   EXPECT_EQ(CONTENT_SETTING_DEFAULT, info->GetInitialDefaultSetting());
  // }

  // {
  //   SCOPED_TRACE("Content setting: LUXXLE_COSMETIC_FILTERING");
  //   info = registry()->Get(ContentSettingsType::LUXXLE_COSMETIC_FILTERING);
  //   EXPECT_EQ(CONTENT_SETTING_DEFAULT, info->GetInitialDefaultSetting());
  // }

  // {
  //   SCOPED_TRACE("Content setting: LUXXLE_COOKIES");
  //   info = registry()->Get(ContentSettingsType::LUXXLE_COOKIES);
  //   EXPECT_EQ(CONTENT_SETTING_DEFAULT, info->GetInitialDefaultSetting());
  // }

  // {
  //   SCOPED_TRACE("Content setting: LUXXLE_SPEEDREADER");
  //   info = registry()->Get(ContentSettingsType::LUXXLE_SPEEDREADER);
  //   EXPECT_EQ(CONTENT_SETTING_DEFAULT, info->GetInitialDefaultSetting());
  // }
}
