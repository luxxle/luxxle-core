...
class LuxxleContentSettingsDefaultProviderTest : public testing::Test {
 public:
  LuxxleContentSettingsDefaultProviderTest()
      : provider_(profile_.GetPrefs(), false, false) {}
  ~LuxxleContentSettingsDefaultProviderTest() override {
...
TEST_F(LuxxleContentSettingsDefaultProviderTest, DiscardObsoleteAutoplayAsk) {
