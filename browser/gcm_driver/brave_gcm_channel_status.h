...
#ifndef LUXXLE_BROWSER_GCM_DRIVER_BRAVE_GCM_CHANNEL_STATUS_H_
#define LUXXLE_BROWSER_GCM_DRIVER_BRAVE_GCM_CHANNEL_STATUS_H_
...
#endif  // LUXXLE_BROWSER_GCM_DRIVER_BRAVE_GCM_CHANNEL_STATUS_H_
