...
LuxxleSpellingOptionsSubMenuObserver::LuxxleSpellingOptionsSubMenuObserver(
...
void LuxxleSpellingOptionsSubMenuObserver::InitMenu(
    const content::ContextMenuParams& params) {
  // Let Chromium build the submenu.
  SpellingOptionsSubMenuObserver::InitMenu(params);

  // Assumptions:
  // 1. Use of spelling service is disabled in Luxxle profile preferences.
...
void LuxxleSpellingOptionsSubMenuObserver::SetGtestMode(
    LuxxleSpellingOptionsSubMenuObserver::GtestMode mode) {
  gtest_mode_ = mode;
}
