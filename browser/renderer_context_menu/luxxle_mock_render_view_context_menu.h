...
#ifndef LUXXLE_BROWSER_RENDERER_CONTEXT_MENU_LUXXLE_MOCK_RENDER_VIEW_CONTEXT_MENU_H_
#define LUXXLE_BROWSER_RENDERER_CONTEXT_MENU_LUXXLE_MOCK_RENDER_VIEW_CONTEXT_MENU_H_
...
class LuxxleMockRenderViewContextMenu;
class PrefService;
class Profile;
...
// MenuObserver class.
class LuxxleMockRenderViewContextMenu : public ui::SimpleMenuModel::Delegate,
 ...
 public:
  ...
  explicit LuxxleMockRenderViewContextMenu(Profile* profile);
  LuxxleMockRenderViewContextMenu(const LuxxleMockRenderViewContextMenu&) =
      delete;
  LuxxleMockRenderViewContextMenu& operator=(
      const LuxxleMockRenderViewContextMenu&) = delete;
  ~LuxxleMockRenderViewContextMenu() override;
...
#endif  // LUXXLE_BROWSER_RENDERER_CONTEXT_MENU_LUXXLE_MOCK_RENDER_VIEW_CONTEXT_MENU_H_
