...
// accesses resources.
class LuxxleSpellingMenuObserverTest : public InProcessBrowserTest {
 public:
  LuxxleSpellingMenuObserverTest();
  LuxxleSpellingMenuObserverTest(const LuxxleSpellingMenuObserverTest&) = delete;
  LuxxleSpellingMenuObserverTest& operator=(
      const LuxxleSpellingMenuObserverTest&) = delete;
  ...
  ~LuxxleSpellingMenuObserverTest() override;
...
#if BUILDFLAG(IS_WIN) && BUILDFLAG(USE_BROWSER_SPELLCHECKER)
LuxxleSpellingMenuObserverTest::LuxxleSpellingMenuObserverTest() {
  feature_list_.InitAndDisableFeature(
      spellcheck::kWinDelaySpellcheckServiceInit);
}
#else
LuxxleSpellingMenuObserverTest::LuxxleSpellingMenuObserverTest() = default;
#endif
...
// Tests that right-clicking not add "Ask Luxxle for suggestions".
IN_PROC_BROWSER_TEST_F(LuxxleSpellingMenuObserverTest,
