...
using LuxxleSessionRestoreBrowserTest = InProcessBrowserTest;

IN_PROC_BROWSER_TEST_F(LuxxleSessionRestoreBrowserTest,
  ...
  SessionCookiesCleanupOnSessionRestoreBrowserTest() {
    if (ShouldCleanupSessionCookies()) {
      scoped_feature_list_.InitAndEnableFeature(
          features::kLuxxleCleanupSessionCookiesOnSessionRestore);
    } else {
