...
class LuxxleSiteHacksNetworkDelegateBrowserTest : public InProcessBrowserTest {
 public:
  LuxxleSiteHacksNetworkDelegateBrowserTest()
  ...
  void SetUpOnMainThread() override {
    ...
    https_server_.RegisterRequestMonitor(base::BindRepeating(
        &LuxxleSiteHacksNetworkDelegateBrowserTest::HandleRequest,
...
IN_PROC_BROWSER_TEST_F(LuxxleSiteHacksNetworkDelegateBrowserTest,
...
IN_PROC_BROWSER_TEST_F(LuxxleSiteHacksNetworkDelegateBrowserTest,
  ...
  for (auto input : kInputs) {
    ...
    luxxle_shields::SetLuxxleShieldsEnabled(content_settings(), false, dest_url);
