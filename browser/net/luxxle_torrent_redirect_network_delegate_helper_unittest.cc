...
class LuxxleTorrentRedirectNetworkDelegateHelperTest : public testing::Test {
 public:
  LuxxleTorrentRedirectNetworkDelegateHelperTest() {
    ...
    torrent_extension_url_ = GURL(
        ...
        "luxxle_webtorrent2.html?https://webtorrent.io/torrents/sintel.torrent");
    ...
    non_torrent_extension_url_ = GURL(
        "chrome-extension://lgjmpdmojkpocjcopdikifhejkkjglho/extension/"
        "luxxle_webtorrent2.html?https://webtorrent.io/torrents/sintel");
  }
...
TEST_F(LuxxleTorrentRedirectNetworkDelegateHelperTest,
  ...
  auto request_info = std::make_shared<luxxle::LuxxleRequestInfo>(torrent_url());
...
TEST_F(LuxxleTorrentRedirectNetworkDelegateHelperTest,
  ...
  GURL allowed_unsafe_redirect_url;
  auto request_info =
      std::make_shared<luxxle::LuxxleRequestInfo>(non_torrent_url());
  request_info->resource_type = blink::mojom::ResourceType::kMainFrame;
...
TEST_F(LuxxleTorrentRedirectNetworkDelegateHelperTest, MimeTypeNoRedirect) {
  scoped_refptr<net::HttpResponseHeaders> orig_response_headers =
      new net::HttpResponseHeaders(std::string());
...
TEST_F(LuxxleTorrentRedirectNetworkDelegateHelperTest,
  ...
  GURL allowed_unsafe_redirect_url;
  auto request_info =
      std::make_shared<luxxle::LuxxleRequestInfo>(torrent_viewer_url());
  request_info->initiator_url = torrent_extension_url();
  request_info->resource_type = blink::mojom::ResourceType::kMainFrame;
