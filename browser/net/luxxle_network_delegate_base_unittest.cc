...
class LuxxleNetworkDelegateBaseTest : public testing::Test {
 public:
  LuxxleNetworkDelegateBaseTest()
      : task_environment_(content::BrowserTaskEnvironment::IO_MAINLOOP) {}
  ~LuxxleNetworkDelegateBaseTest() override = default;
  void SetUp() override {
...
TEST_F(LuxxleNetworkDelegateBaseTest, RemoveTrackableSecurityHeaders) {
...
TEST_F(LuxxleNetworkDelegateBaseTest, RemoveTrackableSecurityHeadersMixedCase) {
  net::TestDelegate test_delegate;
  GURL request_url(kThirdPartyDomain);
  GURL tab_url(kFirstPartyDomain);
...
TEST_F(LuxxleNetworkDelegateBaseTest, RetainTrackableSecurityHeaders) {
  net::TestDelegate test_delegate;
