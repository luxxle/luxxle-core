...
class LuxxleAcceptHeaderBrowserTest : public InProcessBrowserTest {
 public:
  LuxxleAcceptHeaderBrowserTest()
  ...
  void SetUpOnMainThread() override {
    ...
    https_server_.RegisterRequestMonitor(base::BindRepeating(
        &LuxxleAcceptHeaderBrowserTest::HandleRequest, base::Unretained(this)));
...
IN_PROC_BROWSER_TEST_F(LuxxleAcceptHeaderBrowserTest,
