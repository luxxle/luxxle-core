...
#include "luxxle/components/luxxle_shields/content/browser/adblock_stub_response.h"
...
LuxxleProxyingURLLoaderFactory::InProgressRequest::FollowRedirectParams::
    FollowRedirectParams() = default;
LuxxleProxyingURLLoaderFactory::InProgressRequest::FollowRedirectParams::
    ~FollowRedirectParams() = default;

LuxxleProxyingURLLoaderFactory::InProgressRequest::InProgressRequest(
    LuxxleProxyingURLLoaderFactory& factory,
    uint64_t request_id,
  ...
  target_client_.set_disconnect_handler(base::BindOnce(
      &LuxxleProxyingURLLoaderFactory::InProgressRequest::OnRequestError,
...
void LuxxleProxyingURLLoaderFactory::InProgressRequest::Restart() {
  UpdateRequestInfo();
  RestartInternal();
}

void LuxxleProxyingURLLoaderFactory::InProgressRequest::UpdateRequestInfo() {
  // TODO(iefremov): Update |ctx_| here and get rid of multiple spots where
  // it is refilled.
}

void LuxxleProxyingURLLoaderFactory::InProgressRequest::RestartInternal() {
  ...
  base::RepeatingCallback<void(int)> continuation =
      base::BindRepeating(&InProgressRequest::ContinueToBeforeSendHeaders,
                          weak_factory_.GetWeakPtr());
  redirect_url_ = GURL();
  ctx_ = luxxle::LuxxleRequestInfo::MakeCTX(request_, frame_tree_node_id_,
...
void LuxxleProxyingURLLoaderFactory::InProgressRequest::FollowRedirect(
...
void LuxxleProxyingURLLoaderFactory::InProgressRequest::SetPriority(
...
void LuxxleProxyingURLLoaderFactory::InProgressRequest::OnReceiveEarlyHints(
    network::mojom::EarlyHintsPtr early_hints) {}

void LuxxleProxyingURLLoaderFactory::InProgressRequest::OnReceiveResponse(
...
void LuxxleProxyingURLLoaderFactory::InProgressRequest::OnReceiveRedirect(
...
void LuxxleProxyingURLLoaderFactory::InProgressRequest::OnUploadProgress(
...
void LuxxleProxyingURLLoaderFactory::InProgressRequest::OnTransferSizeUpdated(
    int32_t transfer_size_diff) {
  target_client_->OnTransferSizeUpdated(transfer_size_diff);
}

void LuxxleProxyingURLLoaderFactory::InProgressRequest::OnComplete(
    const network::URLLoaderCompletionStatus& status) {
  UMA_HISTOGRAM_TIMES("Luxxle.ProxyingURLLoader.TotalRequestTime",
...
void LuxxleProxyingURLLoaderFactory::InProgressRequest::
...
void LuxxleProxyingURLLoaderFactory::InProgressRequest::
  ...
  if (ctx_->blocked_by != luxxle::kNotBlocked) {
    ...
    luxxle_shields::MakeStubResponse(ctx_->mock_data_url, request_, &response,
                                    &response_data);
  ...
  if (request_.url.SchemeIsHTTPOrHTTPS()) {
    ...
    ctx_ = luxxle::LuxxleRequestInfo::MakeCTX(
...
void LuxxleProxyingURLLoaderFactory::InProgressRequest::ContinueToStartRequest(
    int error_code) {
  if (error_code != net::OK) {
    OnRequestError(network::URLLoaderCompletionStatus(error_code));
    return;
...
void LuxxleProxyingURLLoaderFactory::InProgressRequest::ContinueToSendHeaders(
    int error_code) {
  if (error_code != net::OK) {
    OnRequestError(network::URLLoaderCompletionStatus(error_code));
    return;
...
void LuxxleProxyingURLLoaderFactory::InProgressRequest::ContinueToBeforeRedirect(
    const net::RedirectInfo& redirect_info,
    int error_code) {
  if (error_code != net::OK) {
    OnRequestError(network::URLLoaderCompletionStatus(error_code));
...
void LuxxleProxyingURLLoaderFactory::InProgressRequest::OnRequestError(
    const network::URLLoaderCompletionStatus& status) {
  if (!request_completed_) {
    ...
    if (base::FeatureList::IsEnabled(
            ::luxxle_shields::features::kLuxxleAdblockCollapseBlockedElements) &&
...
LuxxleProxyingURLLoaderFactory::LuxxleProxyingURLLoaderFactory(
    LuxxleRequestHandler& request_handler,
    content::BrowserContext* browser_context,
    content::FrameTreeNodeId frame_tree_node_id,
  ...
  target_factory_.set_disconnect_handler(
      base::BindOnce(&LuxxleProxyingURLLoaderFactory::OnTargetFactoryError,
                     base::Unretained(this)));

  proxy_receivers_.Add(this, std::move(receiver),
                       navigation_response_task_runner_);
  proxy_receivers_.set_disconnect_handler(
      base::BindRepeating(&LuxxleProxyingURLLoaderFactory::OnProxyBindingError,
                          base::Unretained(this)));
}

LuxxleProxyingURLLoaderFactory::~LuxxleProxyingURLLoaderFactory() = default;

// static
void LuxxleProxyingURLLoaderFactory::MaybeProxyRequest(
    content::BrowserContext* browser_context,
...
void LuxxleProxyingURLLoaderFactory::CreateLoaderAndStart(
    mojo::PendingReceiver<network::mojom::URLLoader> loader_receiver,
    int32_t request_id,
    uint32_t options,
    const network::ResourceRequest& request,
  ...
  const uint64_t luxxle_request_id = request_id_generator_->Generate();

  auto result = requests_.emplace(std::make_unique<InProgressRequest>(
      *this, luxxle_request_id, request_id, frame_tree_node_id_, options,
...
void LuxxleProxyingURLLoaderFactory::Clone(
    mojo::PendingReceiver<network::mojom::URLLoaderFactory> loader_receiver) {
  proxy_receivers_.Add(this, std::move(loader_receiver));
}

void LuxxleProxyingURLLoaderFactory::OnTargetFactoryError() {
...
void LuxxleProxyingURLLoaderFactory::OnProxyBindingError() {
...
void LuxxleProxyingURLLoaderFactory::RemoveRequest(InProgressRequest* request) {
...
void LuxxleProxyingURLLoaderFactory::MaybeRemoveProxy() {
