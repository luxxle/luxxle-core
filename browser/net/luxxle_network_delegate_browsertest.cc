...
class LuxxleNetworkDelegateBrowserTest : public InProcessBrowserTest {
 public:
  LuxxleNetworkDelegateBrowserTest()
  ...
  void SetUpOnMainThread() override {
    ...
    https_server_.RegisterRequestMonitor(base::BindRepeating(
        &LuxxleNetworkDelegateBrowserTest::MonitorHTTPRequest,
  ...
  void DefaultBlockThirdPartyCookies() {
    luxxle_shields::SetCookieControlType(
        content_settings(), browser()->profile()->GetPrefs(),
        luxxle_shields::ControlType::BLOCK_THIRD_PARTY, GURL());
  }
  ...
  void ShieldsDown(const GURL& url) {
    luxxle_shields::SetLuxxleShieldsEnabled(content_settings(), false, url);
  }
...
IN_PROC_BROWSER_TEST_F(LuxxleNetworkDelegateBrowserTest, Iframe3PCookieBlocked) {
...
IN_PROC_BROWSER_TEST_F(LuxxleNetworkDelegateBrowserTest, Iframe3PCookieAllowed) {
...
IN_PROC_BROWSER_TEST_F(LuxxleNetworkDelegateBrowserTest, Iframe3PShieldsDown) {
...
IN_PROC_BROWSER_TEST_F(LuxxleNetworkDelegateBrowserTest,
...
IN_PROC_BROWSER_TEST_F(LuxxleNetworkDelegateBrowserTest, DefaultCookiesBlocked) {
