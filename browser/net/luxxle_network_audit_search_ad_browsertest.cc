...
#include "luxxle/browser/net/luxxle_network_audit_allowed_lists.h"
...
constexpr char kEmbeddedTestServerDirectory[] = "luxxle_ads";
constexpr char kDomain[] = "search.luxxle.com";
constexpr char kLuxxleSearchPath[] = "/search_result_ad_click.html";
...
class LuxxleNetworkAuditSearchAdTest : public InProcessBrowserTest {
 public:
  LuxxleNetworkAuditSearchAdTest() = default;

  LuxxleNetworkAuditSearchAdTest(const LuxxleNetworkAuditSearchAdTest&) = delete;
  LuxxleNetworkAuditSearchAdTest& operator=(
      const LuxxleNetworkAuditSearchAdTest&) = delete;
  ...
  void TearDownInProcessBrowserTestFixture() override {
    ...
    // Luxxle search
    // The test simulation has a pattern https://search.luxxle.com:<port>
    // port is changed dynamically
    static constexpr char kAllowedLuxxleSearchTemplate[] =
        "https://search.luxxle.com:%s/";
    allowed_prefixes.push_back(
        base::StringPrintf(kAllowedLuxxleSearchTemplate, port.c_str()));
...
IN_PROC_BROWSER_TEST_F(LuxxleNetworkAuditSearchAdTest, SearchAdTest) {
  WaitForTimeout(kMaxTimeoutForAdsServiceInit);
  GURL url = https_server()->GetURL(kDomain, kLuxxleSearchPath);
