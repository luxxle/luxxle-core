...
#include "luxxle/browser/net/brave_service_key_network_delegate_helper.h"
...
static bool IsInternalScheme(std::shared_ptr<luxxle::BraveRequestInfo> ctx) {
  DCHECK(ctx);
...
void BraveRequestHandler::SetupCallbacks() {
  ...
  start_transaction_callback =
      base::BindRepeating(luxxle::OnBeforeStartTransaction_BraveServiceKey);
  before_start_transaction_callbacks_.push_back(start_transaction_callback);
