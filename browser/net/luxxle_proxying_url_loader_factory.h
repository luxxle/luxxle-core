...
#ifndef LUXXLE_BROWSER_NET_LUXXLE_PROXYING_URL_LOADER_FACTORY_H_
#define LUXXLE_BROWSER_NET_LUXXLE_PROXYING_URL_LOADER_FACTORY_H_
...
class LuxxleProxyingURLLoaderFactory
 ...
 public:
  using DisconnectCallback =
      base::OnceCallback<void(LuxxleProxyingURLLoaderFactory*)>;
  ...
  class InProgressRequest : public network::mojom::URLLoader,
   ...
   private:
    ...
    std::shared_ptr<luxxle::LuxxleRequestInfo> ctx_;
    const raw_ref<LuxxleProxyingURLLoaderFactory> factory_;
  ...
  LuxxleProxyingURLLoaderFactory(
  ...
  LuxxleProxyingURLLoaderFactory(const LuxxleProxyingURLLoaderFactory&) = delete;
  LuxxleProxyingURLLoaderFactory& operator=(
      const LuxxleProxyingURLLoaderFactory&) = delete;

  ~LuxxleProxyingURLLoaderFactory() override;
 ...
 private:
  friend class base::DeleteHelper<LuxxleProxyingURLLoaderFactory>;
  friend class base::RefCountedDeleteOnSequence<LuxxleProxyingURLLoaderFactory>;
  ...
  const raw_ref<LuxxleRequestHandler> request_handler_;
  raw_ptr<content::BrowserContext> browser_context_ = nullptr;
  const content::FrameTreeNodeId frame_tree_node_id_;
  ...
  base::WeakPtrFactory<LuxxleProxyingURLLoaderFactory> weak_factory_;
};

#endif  // LUXXLE_BROWSER_NET_LUXXLE_PROXYING_URL_LOADER_FACTORY_H_
