...
#include "luxxle/components/geolocation/luxxle_geolocation_buildflags.h"
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, NoModifyTypicalURL) {
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, ModifyGeoURL) {
  const GURL url(
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, ModifyCRLSet1) {
  const GURL url(
      "https://dl.google.com/release2/chrome_component/AJ4r388iQSJq_4819/"
      "4819_all_crl-set-5934829738003798040.data.crx3");
  const GURL expected_url(
      "https://redirector.luxxle.com/release2/chrome_component/"
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, ModifyCRLSet2) {
  const GURL url(
      "https://r2---sn-8xgp1vo-qxoe.gvt1.com/edgedl/release2/"
      "chrome_component/AJ4r388iQSJq_4819/4819_all_crl-set-5934829738003798040"
      ".data.crx3");
  const GURL expected_url(
      "https://redirector.luxxle.com/edgedl/release2/chrome_compone"
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, ModifyCRLSet3) {
  const GURL url(
      "https://www.google.com/dl/release2/chrome_component/"
      "LLjIBPPmveI_4988/"
      "4988_all_crl-set-6296993568184466307.data.crx3");
  const GURL expected_url(
      "https://redirector.luxxle.com/dl/release2/chrome_component/"
      "LLjIBPPmveI_4988/"
      "4988_all_crl-set-6296993568184466307.data.crx3");
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, ModifyCRXDownload) {
  const GURL url(
      ...
      "3_0.crx");
  const GURL expected_url(
      "https://crxdownload.luxxle.com/crx/blobs/QgAAAC6"
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, ModifyCRLSet1_http) {
  const GURL url(
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, ModifyCRLSet2_http) {
  const GURL url(
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, ModifyCRLSet3_http) {
  const GURL url(
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, ModifyCRLSet5_http) {
  const GURL url(
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, ModifyCRXDownload_http) {
  const GURL url(
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, ModifySafeBrowsingURLV4) {
  luxxle::SetSafeBrowsingEndpointForTesting(true);
  const GURL url(
      "https://safebrowsing.googleapis.com/v4/"
      "threatListUpdates:fetch?$req=ChkKCGNocm9taXVtEg02Ni");
  GURL::Replacements replacements;
  replacements.SetHostStr(luxxle::kSafeBrowsingTestingEndpoint);
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, ModifySafeBrowsingURLV5) {
  luxxle::SetSafeBrowsingEndpointForTesting(true);
  const GURL url(
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, ModifyGvt1) {
  const GURL url(
      "http://redirector.gvt1.com/edgedl/release2/"
      "NfaZYtcKdtFc0LUvFkcNFA_0.3/AKveSIjhHAm2K09XAMovFEQ");
  const GURL expected_url(
      "https://redirector.luxxle.com/edgedl/release2/"
      "NfaZYtcKdtFc0LUvFkcNFA_0.3/AKveSIjhHAm2K09XAMovFEQ");
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, ModifyGoogleDl) {
  const GURL url(
      "http://dl.google.com/release2/"
      "NfaZYtcKdtFc0LUvFkcNFA_0.3/AKveSIjhHAm2K09XAMovFEQ");
  const GURL expected_url(
      "https://redirector.luxxle.com/release2/"
      "NfaZYtcKdtFc0LUvFkcNFA_0.3/AKveSIjhHAm2K09XAMovFEQ");
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, DontModifyGvt1ForWidevine) {
  const GURL url(
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest, DontModifyGvt1ForWidevine2) {
  const GURL url(
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest,
...
TEST(LuxxleStaticRedirectNetworkDelegateHelperTest,
  ...
  const GURL url(
      ...
      "key=DUMMY_KEY");
  GURL expected_url(
      "https://sb-ssl.luxxle.com/safebrowsing/clientreport/download?"
      "key=DUMMY_KEY");
