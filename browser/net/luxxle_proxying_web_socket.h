...
#ifndef LUXXLE_BROWSER_NET_LUXXLE_PROXYING_WEB_SOCKET_H_
#define LUXXLE_BROWSER_NET_LUXXLE_PROXYING_WEB_SOCKET_H_
...
// Ensures that all web socket requests go through Luxxle network request
...
class LuxxleProxyingWebSocket
 ...
 public:
  ...
  using DisconnectCallback =
      base::OnceCallback<void(LuxxleProxyingWebSocket*)>;

  LuxxleProxyingWebSocket(
  ...
  LuxxleProxyingWebSocket(const LuxxleProxyingWebSocket&) = delete;
  LuxxleProxyingWebSocket& operator=(const LuxxleProxyingWebSocket&) = delete;
  ~LuxxleProxyingWebSocket() override;

  static LuxxleProxyingWebSocket* ProxyWebSocket(
 ...
 private:
  ...
  base::WeakPtrFactory<LuxxleProxyingWebSocket> weak_factory_{this};
};

#endif  // LUXXLE_BROWSER_NET_LUXXLE_PROXYING_WEB_SOCKET_H_
