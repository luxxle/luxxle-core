...
#include "luxxle/components/luxxle_service_keys/luxxle_service_key_utils.h"
...
void AddSpeechToTextLuxxleHeaders(network::ResourceRequest* request) {
  ...
  const auto authorization = luxxle_service_keys::GetAuthorizationHeader(
...
void OnBeforeURLRequest_SpoofSpeechToText(network::ResourceRequest* request) {
  ...
  AddSpeechToTextLuxxleHeaders(request);
}
