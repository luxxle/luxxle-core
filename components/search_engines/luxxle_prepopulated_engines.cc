...
// luxxle_prepopulated_engines.h if you add, remove, or make changes
...
PrepopulatedEngine MakeLuxxlePrepopulatedEngine(
...
// LINT.IfChange
const PrepopulatedEngine duckduckgo = MakeLuxxlePrepopulatedEngine(
    u"DuckDuckGo",
    u":d",
    "https://duckduckgo.com/favicon.ico",
    "IDR_SEARCH_ENGINE_DUCKDUCKGO",
    "https://duckduckgo.com/?q={searchTerms}&t=luxxle",
    "UTF-8",
...
const PrepopulatedEngine duckduckgo_de =
    ModifyEngineParams(duckduckgo,
                       nullptr,
                       nullptr,
                       "https://duckduckgo.com/?q={searchTerms}&t=luxxlened",
                       nullptr,
                       nullptr,
...
const PrepopulatedEngine duckduckgo_au_nz_ie =
    ModifyEngineParams(duckduckgo,
                       nullptr,
                       nullptr,
                       "https://duckduckgo.com/?q={searchTerms}&t=luxxleed",
                       nullptr,
                       nullptr,
...
// LINT.IfChange
const PrepopulatedEngine duckduckgo_lite = MakeLuxxlePrepopulatedEngine(
    u"DuckDuckGo Lite",
    u":dl",
    "https://duckduckgo.com/favicon.ico",
    "IDR_SEARCH_ENGINE_DUCKDUCKGO",
    "https://duckduckgo.com/lite/?q={searchTerms}&t=luxxle",
    "UTF-8",
    "https://ac.duckduckgo.com/ac/?q={searchTerms}&type=list",
    SEARCH_ENGINE_DUCKDUCKGO,
...
// LINT.IfChange
const PrepopulatedEngine luxxle_ecosia =
...
// LINT.IfChange
const PrepopulatedEngine qwant = MakeLuxxlePrepopulatedEngine(
    u"Qwant",
    u":q",
    "https://www.qwant.com/favicon.ico",
    "IDR_SEARCH_ENGINE_QWANT",
    "https://www.qwant.com/?q={searchTerms}&client=brz-luxxle",
    "UTF-8",
...
// LINT.IfChange
const PrepopulatedEngine luxxle_startpage =
    ModifyEngineParams(startpage,
                       u"Startpage",
                       u":sp",
                       "https://www.startpage.com/do/"
                       "search?q={searchTerms}&segment=startpage.luxxle",
...
// LINT.IfChange
const PrepopulatedEngine luxxle_yandex =
    ModifyEngineParams(yandex_com,
                       ...
                       "part={searchTerms}&v=3&sn=5&srv=luxxle_desktop",
                       nullptr,
                       PREPOPULATED_ENGINE_ID_YANDEX);
// LINT.ThenChange(//luxxle/components/search_engines/luxxle_prepopulated_engines.h:kLuxxleCurrentDataVersion)

// LINT.IfChange
const PrepopulatedEngine luxxle_search = MakeLuxxlePrepopulatedEngine(
    u"Luxxle",
    u":br",
    "https://luxxle.com/favicon.ico",
    "IDR_SEARCH_ENGINE_LUXXLE",
    "https://luxxle.com/search?q={searchTerms}&source="
#if BUILDFLAG(IS_ANDROID)
    "android",
#else
    "desktop",
...
// LINT.IfChange
const PrepopulatedEngine luxxle_search_tor = ModifyEngineParams(
    luxxle_search,
    nullptr,
    u":luxxle.onion",
    "https://luxxle.com/search?q={searchTerms}",
    "https://luxxle.com/api/suggest?q={searchTerms}",
    nullptr,
    PREPOPULATED_ENGINE_ID_LUXXLE_TOR);
// LINT.ThenChange(//luxxle/components/search_engines/luxxle_prepopulated_engines.h:kLuxxleCurrentDataVersion)

// LINT.IfChange
const PrepopulatedEngine luxxle_bing = ModifyEngineParams(
    bing,
    u"Bing",
    u":b",
...
// LINT.IfChange
const PrepopulatedEngine luxxle_yahoo_jp = ModifyEngineParams(
    yahoo_jp,
    u"Yahoo! JAPAN",
    nullptr,  // keyword
    // search url
...
// LINT.IfChange
const PrepopulatedEngine luxxle_google =
