...
// Ensure that when the original default_search_manager.cc includes 
// template_url_prepopulate_data.h, it gets our Luxxle override
#include "luxxle/chromium_src/components/search_engines/template_url_prepopulate_data.h"
...
// clang-format off
#define LOADDEFAULTSEARCHENGINEFROMPREFS_LUXXLE                      \
...
#undef LOADDEFAULTSEARCHENGINEFROMPREFS_LUXXLE