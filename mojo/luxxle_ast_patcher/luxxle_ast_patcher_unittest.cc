...
#include "luxxle/mojo/luxxle_ast_patcher/test_module.mojom.h"
...
namespace luxxle_ast_patcher::mojom {
...
TEST(LuxxleAstPatcherTest, OriginalTypes) {
...
TEST(LuxxleAstPatcherTest, NewTypes) {
...
TEST(LuxxleAstPatcherTest, ExtendedTypes) {
...
TEST(LuxxleAstPatcherTest, InterfaceInstantiations) {
