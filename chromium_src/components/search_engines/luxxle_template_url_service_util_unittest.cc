...
extern void LocalizeEngineList(country_codes::CountryId country_id,
                               std::vector<LuxxlePrepopulatedEngineID>* engines);
}
...
class LuxxleTemplateURLServiceUtilTest : public testing::Test {
 public:
  LuxxleTemplateURLServiceUtilTest() = default;
...
TEST_F(LuxxleTemplateURLServiceUtilTest, GetSearchProvidersUsingKeywordResult) {
...
TEST_F(LuxxleTemplateURLServiceUtilTest,
