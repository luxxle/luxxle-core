...
#if defined(OFFICIAL_BUILD)
  return std::wstring(L"Software\\LuxxleSoftware\\Update\\Clients\\")
      .append(app_guid);
#else
...
#if defined(OFFICIAL_BUILD)
  return std::wstring(L"Software\\LuxxleSoftware\\Update\\ClientState\\")
      .append(app_guid);
#else
  return GetUnregisteredKeyPathForProduct();
#endif
...
#if defined(OFFICIAL_BUILD)
  return std::wstring(L"Software\\LuxxleSoftware\\Update\\ClientStateMedium\\")
      .append(app_guid);
#else
  return GetUnregisteredKeyPathForProduct();
#endif
