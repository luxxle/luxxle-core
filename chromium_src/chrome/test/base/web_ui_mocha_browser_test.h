...
#ifndef LUXXLE_CHROMIUM_SRC_CHROME_TEST_BASE_WEB_UI_MOCHA_BROWSER_TEST_H_
#define LUXXLE_CHROMIUM_SRC_CHROME_TEST_BASE_WEB_UI_MOCHA_BROWSER_TEST_H_
...
#endif  // LUXXLE_CHROMIUM_SRC_CHROME_TEST_BASE_WEB_UI_MOCHA_BROWSER_TEST_H_
