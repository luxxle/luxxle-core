...
const wchar_t kGoogleUpdateSetupExe[] = L"LuxxleUpdateSetup.exe";
const wchar_t kRegPathClients[] = L"Software\\LuxxleSoftware\\Update\\Clients";
const wchar_t kRegPathClientState[] =
    L"Software\\LuxxleSoftware\\Update\\ClientState";
const wchar_t kRegPathClientStateMedium[] =
    L"Software\\LuxxleSoftware\\Update\\ClientStateMedium";
const wchar_t kRegPathGoogleUpdate[] = L"Software\\LuxxleSoftware\\Update";
