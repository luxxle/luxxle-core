...
#ifndef LUXXLE_CHROMIUM_SRC_CHROME_INSTALLER_MINI_INSTALLER_APPID_H_
#define LUXXLE_CHROMIUM_SRC_CHROME_INSTALLER_MINI_INSTALLER_APPID_H_
...
#endif  // LUXXLE_CHROMIUM_SRC_CHROME_INSTALLER_MINI_INSTALLER_APPID_H_
