...
#ifndef LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_BROWSER_H_
#define LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_BROWSER_H_
...
#endif  // LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_BROWSER_H_
