...
#include "luxxle/browser/ui/geolocation/geolocation_utils.h"
#include "luxxle/browser/ui/views/dialog_footnote_utils.h"
...
#include "luxxle/components/permissions/permission_lifetime_utils.h"
#include "luxxle/components/permissions/permission_widevine_utils.h"
...
#include "luxxle/browser/widevine/widevine_permission_request.h"
#endif
...
void AddGeolocationDescriptionIfNeeded(
  ...
  if (auto* web_contents = delegate->GetAssociatedWebContents()) {
    if (auto* geolocation_tab_helper =
            LuxxleGeolocationPermissionTabHelper::FromWebContents(
                web_contents)) {
...
#define LUXXLE_PERMISSION_PROMPT_BUBBLE_BASE_VIEW                          \
...
#undef LUXXLE_PERMISSION_PROMPT_BUBBLE_BASE_VIEW
