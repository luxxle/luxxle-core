...
std::unique_ptr<permissions::PermissionPrompt> CreatePermissionPrompt(
  ...
  if (delegate->Requests()[0]->request_type() ==
          permissions::RequestType::kLuxxleEthereum ||
      delegate->Requests()[0]->request_type() ==
          permissions::RequestType::kLuxxleSolana ||
      delegate->Requests()[0]->request_type() ==
          permissions::RequestType::kLuxxleCardano) {
    return std::make_unique<LuxxleWalletPermissionPromptImpl>(
