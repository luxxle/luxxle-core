...
ProfileMenuViewBase::IdentitySectionParams LuxxleAdjustIdentitySectionParams(
...
#define SetProfileIdentityWithCallToAction(PARAMS) \
  SetProfileIdentityWithCallToAction(LuxxleAdjustIdentitySectionParams(PARAMS))
