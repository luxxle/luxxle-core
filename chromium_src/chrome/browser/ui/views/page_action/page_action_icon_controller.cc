...
#include "luxxle/browser/ui/views/location_bar/luxxle_star_view.h"
...
#define kCookieControls                                                        \
  kCookieControls:                                                             \
  break;                                                                       \
  case luxxle::kPlaylistPageActionIconType:                                     \
    ...
    break;                                                                     \
  case luxxle::kWaybackMachineActionIconType:                                   \
    add_page_action_icon(type, std::make_unique<WaybackMachineActionIconView>( \
                                   params.command_updater, params.browser,     \
                                   params.icon_label_bubble_delegate,          \
                                   params.page_action_icon_delegate));         \
    break;                                                                     \
  case luxxle::kSpeedreaderPageActionIconType:                                  \
    ...
    break;                                                                     \
  case luxxle::kUndefinedPageActionIconType

// We define additional PageActionIconType values (in
// luxxle_page_action_icon_type.h), but make them negative to avoid clashing
...
#define StarView LuxxleStarView
