...
// unintentional redefinitions of Button into LuxxleDownloadItemViewButton.
...
// and relays them to LuxxleDownloadItemView to make decisions on when to hide
// the download item's URL (i.e. default) and when to show it (i.e. on hover).
class LuxxleDownloadItemViewButton : public Button {
  METADATA_HEADER(LuxxleDownloadItemViewButton, Button)
 public:
  using Button::Button;
...
BEGIN_METADATA(LuxxleDownloadItemViewButton)
END_METADATA
...
#define Button LuxxleDownloadItemViewButton
