...
#ifndef LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_HOVER_CARD_BUBBLE_VIEW_H_
#define LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_HOVER_CARD_BUBBLE_VIEW_H_
...
#define LUXXLE_TAB_HOVER_CARD_BUBBLE_VIEW_H_ \
  bool has_thumbnail_view() {               \
    return thumbnail_view_;                 \
  }                                         \
                                            \
 protected:                                 \
  void LuxxleUpdateCardContent(const Tab* tab);
...
#undef LUXXLE_TAB_HOVER_CARD_BUBBLE_VIEW_H_
...
#endif  // LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_HOVER_CARD_BUBBLE_VIEW_H_
