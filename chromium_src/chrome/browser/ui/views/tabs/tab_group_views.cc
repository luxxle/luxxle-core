...
#define TabGroupHeader LuxxleTabGroupHeader
#define TabGroupUnderline LuxxleTabGroupUnderline
#define TabGroupHighlight LuxxleTabGroupHighlight

// TabGroupViews destructor is not virtual, so we can't override the method.
#define LUXXLE_TAB_GROUP_VIEWS_GET_LEADING_TRAILING_GROUP_VIEWS                 \
...
#undef LUXXLE_TAB_GROUP_VIEWS_GET_LEADING_TRAILING_GROUP_VIEWS
