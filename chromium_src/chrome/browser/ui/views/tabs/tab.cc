...
// within the tab.
#define LUXXLE_UI_VIEWS_TABS_TAB_LAYOUT_ADJUST_ICON_POSITION \
...
#define LUXXLE_UI_VIEWS_TABS_TAB_ALERT_INDICATOR_POSITION           \
...
#define LUXXLE_UI_VIEWS_TABS_TAB_UPDATE_ICON_VISIBILITY \
...
#undef LUXXLE_UI_VIEWS_TABS_TAB_UPDATE_ICON_VISIBILITY
#undef LUXXLE_UI_VIEWS_TABS_TAB_ALERT_INDICATOR_POSITION
#undef LUXXLE_UI_VIEWS_TABS_TAB_LAYOUT_ADJUST_ICON_POSITION
