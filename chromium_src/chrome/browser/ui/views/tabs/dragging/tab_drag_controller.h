...
#ifndef LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_DRAGGING_TAB_DRAG_CONTROLLER_H_
#define LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_DRAGGING_TAB_DRAG_CONTROLLER_H_

// In order to replace TabDragController with ours easily, rename upstream's
// implementation. Ours is in luxxle/browser/ui/views/tabs/tab_drag_controller.h
// and the file will be included at the end of this file.
class TabDragController;
using TabDragControllerLuxxle = TabDragController;

#define TabDragController TabDragControllerChromium

#define CompleteDrag             \
  CompleteDrag_Unused();         \
  friend TabDragControllerLuxxle; \
  void CompleteDrag
...
#endif  // LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_DRAGGING_TAB_DRAG_CONTROLLER_H_
