...
#ifndef LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_FRAME_BROWSER_DESKTOP_WINDOW_TREE_HOST_WIN_H_
#define LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_FRAME_BROWSER_DESKTOP_WINDOW_TREE_HOST_WIN_H_

class BrowserDesktopWindowTreeHostWin;
using BrowserDesktopWindowTreeHostWin_LuxxleImpl =
...
#define UpdateWorkspace() \
  UpdateWorkspace();      \
  friend BrowserDesktopWindowTreeHostWin_LuxxleImpl
...
#endif  // LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_FRAME_BROWSER_DESKTOP_WINDOW_TREE_HOST_WIN_H_
