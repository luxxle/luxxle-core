...
class LuxxleLocationBarViewColorOverridesTest : public InProcessBrowserTest {
 public:
  LuxxleLocationBarViewColorOverridesTest() = default;
  LuxxleLocationBarViewColorOverridesTest(
      const LuxxleLocationBarViewColorOverridesTest&) = delete;
  LuxxleLocationBarViewColorOverridesTest& operator=(
      const LuxxleLocationBarViewColorOverridesTest&) = delete;
  ~LuxxleLocationBarViewColorOverridesTest() override = default;
...
IN_PROC_BROWSER_TEST_F(LuxxleLocationBarViewColorOverridesTest,
