...
#include "luxxle/browser/infobars/dev_channel_deprecation_infobar_delegate.h"
...
class LuxxleGoogleKeysInfoBarDelegate {
 public:
...
#define ShowIfNotOffTheRecordProfile ShowIfNotOffTheRecordProfileLuxxle
#define GoogleApiKeysInfoBarDelegate LuxxleGoogleKeysInfoBarDelegate
#define AddInfoBarsIfNecessary AddInfoBarsIfNecessary_ChromiumImpl

#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC)
#define ObsoleteSystemInfoBarDelegate LuxxleObsoleteSystemInfoBarDelegate
#endif
