...
void LuxxleToggleBookmarkBarState(content::BrowserContext* browser_context) {
  ...
  luxxle::SetBookmarkState(always_show ? luxxle::BookmarkBarState::kAlways
...
#define ToggleBookmarkBarWhenVisible                                       \
  ToggleBookmarkBarWhenVisible(content::BrowserContext* browser_context) { \
    LuxxleToggleBookmarkBarState(browser_context);                          \
  }                                                                        \
  void ToggleBookmarkBarWhenVisible_ChromiumImpl
...
ui::ImageModel GetBookmarkFolderIcon(BookmarkFolderIconType icon_type,
  ...
  int default_id =
#if BUILDFLAG(IS_WIN)
      IDR_LUXXLE_BOOKMARK_FOLDER_CLOSED_WIN_LIGHT;
#elif BUILDFLAG(IS_LINUX)
      IDR_LUXXLE_BOOKMARK_FOLDER_CLOSED_LIN_LIGHT;
#else
      IDR_LUXXLE_BOOKMARK_FOLDER_CLOSED_LIGHT;
#endif
...
#if BUILDFLAG(IS_WIN)
                                ? IDR_LUXXLE_BOOKMARK_FOLDER_CLOSED_WIN_LIGHT
                                : IDR_LUXXLE_BOOKMARK_FOLDER_CLOSED_WIN_DARK;
#elif BUILDFLAG(IS_LINUX)
                                ? IDR_LUXXLE_BOOKMARK_FOLDER_CLOSED_LIN_LIGHT
                                : IDR_LUXXLE_BOOKMARK_FOLDER_CLOSED_LIN_DARK;
#else
                                ? IDR_LUXXLE_BOOKMARK_FOLDER_CLOSED_LIGHT
                                : IDR_LUXXLE_BOOKMARK_FOLDER_CLOSED_DARK;
#endif
