...
#define LUXXLE_ICON_WITH_BADGE_IMAGE_SOURCE_DRAW_1 \
  true ? ScaleImageSkiaRep(rep,                             \
                           GetCustomGraphicSize().value_or( \
                               extensions::ExtensionAction::ActionIconSize()), \
                           canvas->image_scale()) :

#define LUXXLE_ICON_WITH_BADGE_IMAGE_SOURCE_DRAW_2 \
...
#undef LUXXLE_ICON_WITH_BADGE_IMAGE_SOURCE_DRAW_2
#undef LUXXLE_ICON_WITH_BADGE_IMAGE_SOURCE_DRAW_1
