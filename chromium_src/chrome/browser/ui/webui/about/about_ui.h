...
#ifndef LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_WEBUI_ABOUT_ABOUT_UI_H_
#define LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_WEBUI_ABOUT_ABOUT_UI_H_
...
#endif  //  LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_WEBUI_ABOUT_ABOUT_UI_H_
