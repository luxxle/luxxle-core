...
#ifndef LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_WEBUI_TAB_SEARCH_TAB_SEARCH_PAGE_HANDLER_H_
#define LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_WEBUI_TAB_SEARCH_TAB_SEARCH_PAGE_HANDLER_H_
...
using TabSearchPageHandler_LuxxleImpl = TabSearchPageHandler;

#define TabSearchPageHandler TabSearchPageHandler_ChromiumImpl
#define MaybeShowUI                      \
  NotUsed();                             \
  friend TabSearchPageHandler_LuxxleImpl; \
  void MaybeShowUI
...
// Overrides TabSearchPageHandler to provide Luxxle-specific functionality.
...
#endif  // LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_WEBUI_TAB_SEARCH_TAB_SEARCH_PAGE_HANDLER_H_
