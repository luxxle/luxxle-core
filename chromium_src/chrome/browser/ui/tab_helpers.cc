...
#include "luxxle/browser/luxxle_tab_helpers.h"
...
#define kWebUITabStrip kWebUITabStrip) || base::FeatureList::IsEnabled(tabs::features::kLuxxleSharedPinnedTabs
#define LUXXLE_TAB_HELPERS luxxle::AttachTabHelpers(web_contents);
