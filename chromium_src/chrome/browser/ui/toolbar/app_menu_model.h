...
#ifndef LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_TOOLBAR_APP_MENU_MODEL_H_
#define LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_TOOLBAR_APP_MENU_MODEL_H_
...
#define BookmarkSubMenuModel LuxxleBookmarkSubMenuModel
#include "src/chrome/browser/ui/toolbar/app_menu_model.h"  // IWYU pragma: export
#undef BookmarkSubMenuModel
#undef CreateZoomMenu

#endif  // LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_UI_TOOLBAR_APP_MENU_MODEL_H_
