...
// Disabling these tests because they refer to g_luxxle_browser_process which is
...
#define LUXXLE_RECENT_TABS_SUB_MENU_MODEL_TEST           \
...
#undef LUXXLE_RECENT_TABS_SUB_MENU_MODEL_TEST
