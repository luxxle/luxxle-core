...
class LuxxleChromeAutofillClient : public ChromeAutofillClient {
 public:
  ...
  bool IsAutocompleteEnabled() const override {
    ...
    enabled = enabled && GetPrefs()->GetBoolean(kLuxxleAutofillPrivateWindows);
    return enabled;
  }
...
#define WrapUnique WrapUnique(new autofill::LuxxleChromeAutofillClient(web_contents))); \
