...
#ifndef LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_CHROME_BROWSER_MAIN_H_
#define LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_CHROME_BROWSER_MAIN_H_
...
#endif  // LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_CHROME_BROWSER_MAIN_H_
