...
// clang-format off
#define LUXXLE_START_MINT_TOKEN_FLOW_IF \
  if (google_apis::IsGoogleChromeAPIKeyUsed()) {
#define LUXXLE_START_MINT_TOKEN_FLOW_ELSE       \
  } else {                                     \
...
#undef LUXXLE_START_MINT_TOKEN_FLOW_ELSE
#undef LUXXLE_START_MINT_TOKEN_FLOW_IF
#undef LUXXLE_RUN
