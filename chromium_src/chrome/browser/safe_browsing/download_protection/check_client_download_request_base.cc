...
#define LUXXLE_ON_REQUEST_BUILT_FILTER \
  LuxxleFilterRequest(client_download_request_.get());

namespace safe_browsing {

void LuxxleFilterRequest(ClientDownloadRequest* request) {
...
#undef LUXXLE_ON_REQUEST_BUILT_FILTER
