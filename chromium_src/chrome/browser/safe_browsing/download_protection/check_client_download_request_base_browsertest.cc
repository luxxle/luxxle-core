...
class LuxxleCheckClientDownloadRequestBaseBrowserTest
    : public InProcessBrowserTest {
 public:
  LuxxleCheckClientDownloadRequestBaseBrowserTest()
...
IN_PROC_BROWSER_TEST_F(LuxxleCheckClientDownloadRequestBaseBrowserTest,
                       FilterRequest) {
