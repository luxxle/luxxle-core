...
// especially because it is likely that Luxxle is just downloading an update in
...
#define LUXXLE_UPGRADE_DETECTOR_IMPL_START_OUTDATED_BUILD_DETECTOR \
...
#undef LUXXLE_UPGRADE_DETECTOR_IMPL_START_OUTDATED_BUILD_DETECTOR
