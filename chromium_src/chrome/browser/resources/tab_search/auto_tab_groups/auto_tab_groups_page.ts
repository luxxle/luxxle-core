...
import {LuxxleTabSearchApiProxy, TabSearchApiProxyImpl} from '../tab_search_api_proxy.js'
...
export class AutoTabGroupsPageElement extends CrLitElement {
  ...
  private apiProxy_: LuxxleTabSearchApiProxy =
      TabSearchApiProxyImpl.getInstance() as LuxxleTabSearchApiProxy
