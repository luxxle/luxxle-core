...
import {RegisterPolymerTemplateModifications, RegisterStyleOverride} from '//resources/luxxle/polymer_overriding.js'
...
RegisterPolymerTemplateModifications({
  'password-manager-side-bar': (templateContent) => {
    ...
    if (!checkupMenuItem) {
      console.log(
        `[Luxxle Password Manager Overrides] Could not find menu item 'checkup'`)
    } else {
