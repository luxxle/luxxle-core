...
#ifndef LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_FAVICON_FAVICON_UTILS_H_
#define LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_FAVICON_FAVICON_UTILS_H_
...
#endif  // LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_FAVICON_FAVICON_UTILS_H_
