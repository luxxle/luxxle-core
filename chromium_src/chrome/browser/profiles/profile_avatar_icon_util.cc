...
const IconResourceInfo* GetLuxxleDefaultAvatarIconResourceInfo(
    size_t chromium_index);

size_t GetLuxxleAvatarIconStartIndex();

#define LUXXLE_GET_DEFAULT_AVATAR_ICON_RESOURCE_INFO              \
  size_t luxxle_start_index =                                     \
      kDefaultAvatarIconsCount - kLuxxleDefaultAvatarIconsCount;  \
  if (index >= luxxle_start_index) {                              \
    size_t luxxle_icon_index = index - luxxle_start_index;         \
    const IconResourceInfo* luxxle_icon =                         \
        GetLuxxleDefaultAvatarIconResourceInfo(luxxle_icon_index); \
    if (luxxle_icon)                                              \
      return luxxle_icon;                                         \
  }

#define LUXXLE_GET_MODERN_AVATAR_ICON_START_INDEX \
  return GetLuxxleAvatarIconStartIndex();

#define LUXXLE_GET_ICONS_AND_LABELS_FOR_PROFILE_AVATAR_SELECTOR_NOT_SIGNED_IN \
  avatars.erase(avatars.begin());                                            \
  generic_avatar_info = GetDefaultProfileAvatarIconAndLabel_Luxxle(           \
...
#undef LUXXLE_GET_ICONS_AND_LABELS_FOR_PROFILE_AVATAR_SELECTOR_NOT_SIGNED_IN
#undef LUXXLE_GET_MODERN_AVATAR_ICON_START_INDEX
#undef LUXXLE_GET_DEFAULT_AVATAR_ICON_RESOURCE_INFO

namespace profiles {

size_t GetLuxxleAvatarIconStartIndex() {
  return kDefaultAvatarIconsCount - kLuxxleDefaultAvatarIconsCount;
}

const IconResourceInfo* GetLuxxleDefaultAvatarIconResourceInfo(size_t index) {
#if BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_ANDROID)
  return nullptr;
#else
  CHECK_LT(index, kLuxxleDefaultAvatarIconsCount);
  ...
  //       \"$file\", IDS_LUXXLE_AVATAR_LABEL_$a},"; a=a+1 done | pbcopy
  static constexpr auto kResourceInfo =
      std::to_array<IconResourceInfo, kLuxxleDefaultAvatarIconsCount>(
          {{IDR_PROFILE_AVATAR_56, "avatar_edgy_luxxle.png",
            IDS_LUXXLE_AVATAR_LABEL_56},
           {IDR_PROFILE_AVATAR_57, "avatar_edgy_ocean.png",
            IDS_LUXXLE_AVATAR_LABEL_57},
           {IDR_PROFILE_AVATAR_58, "avatar_edgy_grass.png",
            IDS_LUXXLE_AVATAR_LABEL_58},
           {IDR_PROFILE_AVATAR_59, "avatar_edgy_corn.png",
            IDS_LUXXLE_AVATAR_LABEL_59},
           {IDR_PROFILE_AVATAR_60, "avatar_edgy_royal.png",
            IDS_LUXXLE_AVATAR_LABEL_60},
           {IDR_PROFILE_AVATAR_61, "avatar_edgy_ninja.png",
            IDS_LUXXLE_AVATAR_LABEL_61},
           {IDR_PROFILE_AVATAR_62, "avatar_paladin_rewards.png",
            IDS_LUXXLE_AVATAR_LABEL_62},
           {IDR_PROFILE_AVATAR_63, "avatar_paladin_luxxle.png",
            IDS_LUXXLE_AVATAR_LABEL_63},
           {IDR_PROFILE_AVATAR_64, "avatar_paladin_ocean.png",
            IDS_LUXXLE_AVATAR_LABEL_64},
           {IDR_PROFILE_AVATAR_65, "avatar_paladin_grass.png",
            IDS_LUXXLE_AVATAR_LABEL_65},
           {IDR_PROFILE_AVATAR_66, "avatar_paladin_corn.png",
            IDS_LUXXLE_AVATAR_LABEL_66},
           {IDR_PROFILE_AVATAR_67, "avatar_paladin_royal.png",
            IDS_LUXXLE_AVATAR_LABEL_67},
           {IDR_PROFILE_AVATAR_68, "avatar_paladin_ninja.png",
            IDS_LUXXLE_AVATAR_LABEL_68},
           {IDR_PROFILE_AVATAR_69, "avatar_gleam_rewards.png",
            IDS_LUXXLE_AVATAR_LABEL_69},
           {IDR_PROFILE_AVATAR_70, "avatar_gleam_luxxle.png",
            IDS_LUXXLE_AVATAR_LABEL_70},
           {IDR_PROFILE_AVATAR_71, "avatar_gleam_ocean.png",
            IDS_LUXXLE_AVATAR_LABEL_71},
           {IDR_PROFILE_AVATAR_72, "avatar_gleam_grass.png",
            IDS_LUXXLE_AVATAR_LABEL_72},
           {IDR_PROFILE_AVATAR_73, "avatar_gleam_corn.png",
            IDS_LUXXLE_AVATAR_LABEL_73},
           {IDR_PROFILE_AVATAR_74, "avatar_gleam_royal.png",
            IDS_LUXXLE_AVATAR_LABEL_74},
           {IDR_PROFILE_AVATAR_75, "avatar_gleam_ninja.png",
            IDS_LUXXLE_AVATAR_LABEL_75},
           {IDR_PROFILE_AVATAR_76, "avatar_oval_rewards.png",
            IDS_LUXXLE_AVATAR_LABEL_76},
           {IDR_PROFILE_AVATAR_77, "avatar_oval_luxxle.png",
            IDS_LUXXLE_AVATAR_LABEL_77},
           {IDR_PROFILE_AVATAR_78, "avatar_oval_ocean.png",
            IDS_LUXXLE_AVATAR_LABEL_78},
           {IDR_PROFILE_AVATAR_79, "avatar_oval_grass.png",
            IDS_LUXXLE_AVATAR_LABEL_79},
           {IDR_PROFILE_AVATAR_80, "avatar_oval_corn.png",
            IDS_LUXXLE_AVATAR_LABEL_80},
           {IDR_PROFILE_AVATAR_81, "avatar_oval_royal.png",
            IDS_LUXXLE_AVATAR_LABEL_81},
           {IDR_PROFILE_AVATAR_82, "avatar_oval_ninja.png",
            IDS_LUXXLE_AVATAR_LABEL_82},
           {IDR_PROFILE_AVATAR_83, "avatar_bonbon_rewards.png",
            IDS_LUXXLE_AVATAR_LABEL_83},
           {IDR_PROFILE_AVATAR_84, "avatar_bonbon_luxxle.png",
            IDS_LUXXLE_AVATAR_LABEL_84},
           {IDR_PROFILE_AVATAR_85, "avatar_bonbon_ocean.png",
            IDS_LUXXLE_AVATAR_LABEL_85},
           {IDR_PROFILE_AVATAR_86, "avatar_bonbon_grass.png",
            IDS_LUXXLE_AVATAR_LABEL_86},
           {IDR_PROFILE_AVATAR_87, "avatar_bonbon_corn.png",
            IDS_LUXXLE_AVATAR_LABEL_87},
           {IDR_PROFILE_AVATAR_88, "avatar_bonbon_royal.png",
            IDS_LUXXLE_AVATAR_LABEL_88},
           {IDR_PROFILE_AVATAR_89, "avatar_bonbon_ninja.png",
            IDS_LUXXLE_AVATAR_LABEL_89}});
  static_assert((kResourceInfo[kLuxxleDefaultAvatarIconsCount - 1].resource_id ==
                 IDR_PROFILE_AVATAR_89),
                "IconResourceInfo entries for Luxxle avatars is less than"
                "kLuxxleDefaultAvatarIconsCount but should be the same.");
  return &kResourceInfo[index];
#endif
}

bool IsDefaultAvatarIconUrl(const std::string& url, size_t* icon_index) {
  // Luxxle supports user choosing the placeholder avatar, Chromium does not.
...
base::Value::Dict GetDefaultProfileAvatarIconAndLabel(SkColor fill_color,
  ...
  return GetAvatarIconAndLabelDict(
      ...
      l10n_util::GetStringUTF16(IDS_LUXXLE_AVATAR_LABEL_PLACEHOLDER), index,
