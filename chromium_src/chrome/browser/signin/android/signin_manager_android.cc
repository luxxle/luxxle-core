...
#include "luxxle/build/android/jni_headers/LuxxleSigninManager_jni.h"
...
#define Java_SigninManagerImpl_create Java_LuxxleSigninManager_create
#define Java_SigninManagerImpl_destroy Java_LuxxleSigninManager_destroy
