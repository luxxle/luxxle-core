...
#ifndef LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_LIFETIME_BROWSER_CLOSE_MANAGER_H_
#define LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_LIFETIME_BROWSER_CLOSE_MANAGER_H_
...
#endif  // LUXXLE_CHROMIUM_SRC_CHROME_BROWSER_LIFETIME_BROWSER_CLOSE_MANAGER_H_
