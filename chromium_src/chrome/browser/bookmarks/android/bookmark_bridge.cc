...
#define LuxxleBookmarkBridge BookmarkBridge
#include "chrome/android/chrome_jni_headers/LuxxleBookmarkBridge_jni.h"
#undef LuxxleBookmarkBridge
...
void OnExportFinished(ScopedJavaGlobalRef<jobject> obj,
  ...
  Java_LuxxleBookmarkBridge_bookmarksExported(
...
void BookmarkBridge::ImportBookmarksImpl(
  ...
  Java_LuxxleBookmarkBridge_bookmarksImported(env, obj, !bookmarks.empty());
}
