...
#ifndef LUXXLE_CHROMIUM_SRC_CHROME_ELEVATION_SERVICE_ELEVATOR_H_
#define LUXXLE_CHROMIUM_SRC_CHROME_ELEVATION_SERVICE_ELEVATOR_H_
...
#endif  // LUXXLE_CHROMIUM_SRC_CHROME_ELEVATION_SERVICE_ELEVATOR_H_
