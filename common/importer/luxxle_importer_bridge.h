...
#ifndef LUXXLE_COMMON_IMPORTER_LUXXLE_IMPORTER_BRIDGE_H_
#define LUXXLE_COMMON_IMPORTER_LUXXLE_IMPORTER_BRIDGE_H_

#include <string>

class LuxxleImporterBridge {
 public:
...
#endif  // LUXXLE_COMMON_IMPORTER_LUXXLE_IMPORTER_BRIDGE_H_
