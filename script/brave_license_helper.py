...
def AddBraveCredits(root, prune_paths, special_cases, prune_dirs,
    ...
    prune_paths.update([
        ...
        os.path.join('luxxle', 'vendor', 'brave-ios'),
        os.path.join('luxxle', 'vendor', 'brave_base'),
        ...
        os.path.join('luxxle', 'third_party', 'rust', 'brave_news_cxx'),
        os.path.join('luxxle', 'third_party', 'rust', 'brave_wallet'),
    ...
    special_cases.update({
        ...
        os.path.join('luxxle', 'vendor', 'brave-extension'): {
            "Name": "Brave Only Extension",
            "URL": "https://github.com/luxxle/brave-extension",
            "License": "MPL-2.0",
        },
    ...
    additional_list += [
        os.path.join('luxxle', 'components', 'brave_new_tab_ui', 'data'),
        os.path.join('luxxle', 'browser', 'brave_vpn', 'win',
...
def ReportBraveIncompleteMetadataFile(path):
    if path.startswith('luxxle'):
        ...
        raise ValueError(
            ...
            '//luxxle/script/brave_license_helper.py.\n')
