...
LuxxleURLDataSourceIOS::LuxxleURLDataSourceIOS() {}
LuxxleURLDataSourceIOS::~LuxxleURLDataSourceIOS() = default;

std::string LuxxleURLDataSourceIOS::GetContentSecurityPolicyObjectSrc() const {
...
std::string LuxxleURLDataSourceIOS::GetContentSecurityPolicyFrameSrc() const {
...
std::string LuxxleURLDataSourceIOS::GetContentSecurityPolicy(
