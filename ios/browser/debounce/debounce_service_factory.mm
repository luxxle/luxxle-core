...
#include "luxxle/ios/browser/debounce/debounce_service_factory.h"
...
#include "luxxle/ios/browser/api/debounce/debounce_service+private.h"
...
std::unique_ptr<KeyedService> DebounceServiceFactory::BuildServiceInstanceFor(
  ...
  std::unique_ptr<debounce::DebounceService> service =
      std::make_unique<debounce::DebounceService>(
          luxxleContext->debounce_component_installer(),
