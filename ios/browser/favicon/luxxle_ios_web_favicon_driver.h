...
#ifndef LUXXLE_IOS_BROWSER_FAVICON_LUXXLE_IOS_WEB_FAVICON_DRIVER_H_
#define LUXXLE_IOS_BROWSER_FAVICON_LUXXLE_IOS_WEB_FAVICON_DRIVER_H_
...
class LuxxleIOSWebFaviconDriver
    : public web::WebStateObserver,
      public web::WebStateUserData<LuxxleIOSWebFaviconDriver>,
      public favicon::FaviconDriverImpl {
 public:
  LuxxleIOSWebFaviconDriver(const LuxxleIOSWebFaviconDriver&) = delete;
  LuxxleIOSWebFaviconDriver& operator=(const LuxxleIOSWebFaviconDriver&) = delete;

  ~LuxxleIOSWebFaviconDriver() override;
 ...
 private:
  friend class web::WebStateUserData<LuxxleIOSWebFaviconDriver>;
  LuxxleIOSWebFaviconDriver(web::WebState* web_state,
...
#endif  // LUXXLE_IOS_BROWSER_FAVICON_LUXXLE_IOS_WEB_FAVICON_DRIVER_H_
