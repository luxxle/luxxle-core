...
void LuxxleIOSWebFaviconDriver::SetMaximumFaviconImageSize(
...
gfx::Image LuxxleIOSWebFaviconDriver::GetFavicon() const {
  DCHECK(web_state_);
  return web_state_->GetFaviconStatus().image;
}

bool LuxxleIOSWebFaviconDriver::FaviconIsValid() const {
  DCHECK(web_state_);
  return web_state_->GetFaviconStatus().valid;
}

GURL LuxxleIOSWebFaviconDriver::GetActiveURL() {
  DCHECK(web_state_);
...
int LuxxleIOSWebFaviconDriver::DownloadImage(const GURL& url,
                                            int max_image_size,
...
void LuxxleIOSWebFaviconDriver::DownloadManifest(
    const GURL& url,
...
bool LuxxleIOSWebFaviconDriver::IsOffTheRecord() {
  DCHECK(web_state_);
  return web_state_->GetBrowserState()->IsOffTheRecord();
}

void LuxxleIOSWebFaviconDriver::OnFaviconUpdated(
    const GURL& page_url,
...
void LuxxleIOSWebFaviconDriver::OnFaviconDeleted(
    const GURL& page_url,
...
LuxxleIOSWebFaviconDriver::LuxxleIOSWebFaviconDriver(
...
void LuxxleIOSWebFaviconDriver::FaviconUrlUpdated(
    web::WebState* web_state,
...
void LuxxleIOSWebFaviconDriver::WebStateDestroyed(web::WebState* web_state) {
  DCHECK_EQ(web_state_, web_state);
  web_state_->RemoveObserver(this);
  web_state_ = nullptr;
}

void LuxxleIOSWebFaviconDriver::SetFaviconStatus(
    const GURL& page_url,
