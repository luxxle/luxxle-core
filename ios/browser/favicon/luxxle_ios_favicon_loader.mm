...
LuxxleFaviconLoader::LuxxleFaviconLoader(favicon::FaviconService* favicon_service)
    : favicon_service_(favicon_service) {}
LuxxleFaviconLoader::~LuxxleFaviconLoader() {}

void LuxxleFaviconLoader::FaviconForPageUrlOrHost(
    const GURL& page_url,
...
void LuxxleFaviconLoader::CancellAllRequests() {
  cancelable_task_tracker_.TryCancelAll();
}

base::WeakPtr<LuxxleFaviconLoader> LuxxleFaviconLoader::AsWeakPtr() {
