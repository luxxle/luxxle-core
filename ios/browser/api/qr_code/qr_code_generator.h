...
#ifndef LUXXLE_IOS_BROWSER_API_QR_CODE_QR_CODE_GENERATOR_H_
#define LUXXLE_IOS_BROWSER_API_QR_CODE_QR_CODE_GENERATOR_H_
...
#endif  // LUXXLE_IOS_BROWSER_API_QR_CODE_QR_CODE_GENERATOR_H_
