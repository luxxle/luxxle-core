...
#include "luxxle/ios/browser/api/opentabs/sendtab_model_listener_ios.h"
...
#pragma mark - LuxxleSendTabAPI

@interface LuxxleSendTabAPI () {
...
@implementation LuxxleSendTabAPI
