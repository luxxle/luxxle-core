...
#ifndef LUXXLE_IOS_BROWSER_API_OPENTABS_LUXXLE_OPENTABS_API_H_
#define LUXXLE_IOS_BROWSER_API_OPENTABS_LUXXLE_OPENTABS_API_H_
...
NS_SWIFT_NAME(LuxxleOpenTabsAPI)
OBJC_EXPORT
@interface LuxxleOpenTabsAPI : NSObject
...
#endif  // LUXXLE_IOS_BROWSER_API_OPENTABS_LUXXLE_OPENTABS_API_H_
