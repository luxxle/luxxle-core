...
#ifndef LUXXLE_IOS_BROWSER_API_OPENTABS_LUXXLE_SENDTAB_API_H_
#define LUXXLE_IOS_BROWSER_API_OPENTABS_LUXXLE_SENDTAB_API_H_
...
NS_SWIFT_NAME(LuxxleSendTabAPI)
OBJC_EXPORT
@interface LuxxleSendTabAPI : NSObject
...
#endif  // LUXXLE_IOS_BROWSER_API_OPENTABS_LUXXLE_SENDTAB_API_H_
