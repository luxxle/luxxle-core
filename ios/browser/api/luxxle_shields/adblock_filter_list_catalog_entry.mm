...
- (instancetype)initWithFilterListCatalogEntry:
  ...
  if ((self = [super init])) {
    ...
    self.languages = luxxle::vector_to_ns<std::string>(entry.langs);
    ...
    self.platforms = luxxle::vector_to_ns<std::string>(entry.platforms);
...
- (luxxle_shields::FilterListCatalogEntry)entry {
  return luxxle_shields::FilterListCatalogEntry(
      ...
      luxxle::ns_to_vector<std::string>(self.platforms),
