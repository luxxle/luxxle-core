...
#ifndef LUXXLE_IOS_BROWSER_API_BOOKMARKS_LUXXLE_BOOKMARKS_API_H_
#define LUXXLE_IOS_BROWSER_API_BOOKMARKS_LUXXLE_BOOKMARKS_API_H_
...
NS_SWIFT_NAME(LuxxleBookmarksAPI)
OBJC_EXPORT
@interface LuxxleBookmarksAPI : NSObject
...
#endif  // LUXXLE_IOS_BROWSER_API_BOOKMARKS_LUXXLE_BOOKMARKS_API_H_
