...
#ifndef LUXXLE_IOS_BROWSER_API_LUXXLE_REWARDS_REWARDS_CLIENT_IOS_H_
#define LUXXLE_IOS_BROWSER_API_LUXXLE_REWARDS_REWARDS_CLIENT_IOS_H_
...
class RewardsClientIOS : public luxxle_rewards::mojom::RewardsEngineClient {
 public:
  explicit RewardsClientIOS(id<RewardsClientBridge> bridge);
  ~RewardsClientIOS() override;

  mojo::PendingAssociatedRemote<luxxle_rewards::mojom::RewardsEngineClient>
  MakeRemote();

 private:
  __unsafe_unretained id<RewardsClientBridge> bridge_;
  mojo::AssociatedReceiver<luxxle_rewards::mojom::RewardsEngineClient> receiver_;
  ...
  void OnReconcileComplete(
      luxxle_rewards::mojom::Result result,
      luxxle_rewards::mojom::ContributionInfoPtr contribution) override;
  void PublisherListNormalized(
      std::vector<luxxle_rewards::mojom::PublisherInfoPtr> list) override;
...
#endif  // LUXXLE_IOS_BROWSER_API_LUXXLE_REWARDS_REWARDS_CLIENT_IOS_H_
