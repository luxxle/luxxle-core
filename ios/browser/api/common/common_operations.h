...
#ifndef LUXXLE_IOS_BROWSER_API_COMMON_COMMON_OPERATIONS_H_
#define LUXXLE_IOS_BROWSER_API_COMMON_COMMON_OPERATIONS_H_
...
#endif  // LUXXLE_IOS_BROWSER_API_COMMON_COMMON_OPERATIONS_H_
