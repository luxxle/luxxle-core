...
#ifndef LUXXLE_IOS_BROWSER_API_QUERY_FILTER_UTILS_H_
#define LUXXLE_IOS_BROWSER_API_QUERY_FILTER_UTILS_H_
...
#endif  // LUXXLE_IOS_BROWSER_API_QUERY_FILTER_UTILS_H_
