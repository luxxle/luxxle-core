...
#ifndef LUXXLE_IOS_BROWSER_API_ADS_LUXXLE_ADS_H_
#define LUXXLE_IOS_BROWSER_API_ADS_LUXXLE_ADS_H_

#import <Foundation/Foundation.h>
#import <UserNotifications/UserNotifications.h>
#import "luxxle_ads.mojom.objc.h"
...
OBJC_EXPORT
@protocol LuxxleAdsNotificationHandler
@required
...
OBJC_EXPORT
@protocol LuxxleAdsCaptchaHandler
@required
...
OBJC_EXPORT
@interface LuxxleAds : NSObject

/// The notifications handler.
///
/// @see LuxxleAdsNotificationHandler
@property(nonatomic, weak, nullable) id<LuxxleAdsNotificationHandler>
    notificationsHandler;

/// An object to handle adaptive captcha requests
///
/// @see LuxxleAdsCaptchaHandler
@property(nonatomic, weak, nullable) id<LuxxleAdsCaptchaHandler> captchaHandler;
...
/// Returns `true` if always run the ads service, even if Luxxle Private Ads are
/// disabled.
...
/// Whether or not Luxxle Ads is enabled and the user should receive
...
// See `components/luxxle_ads/core/internal/ads_impl.h`.
...
// See `components/luxxle_ads/core/public/ads_client/ads_client_notifier.h`.
...
#endif  // LUXXLE_IOS_BROWSER_API_ADS_LUXXLE_ADS_H_
