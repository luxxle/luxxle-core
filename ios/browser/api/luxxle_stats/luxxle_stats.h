...
#ifndef LUXXLE_IOS_BROWSER_API_LUXXLE_STATS_LUXXLE_STATS_H_
#define LUXXLE_IOS_BROWSER_API_LUXXLE_STATS_LUXXLE_STATS_H_

#import <Foundation/Foundation.h>

NS_ASSUME_NONNULL_BEGIN

OBJC_EXPORT NSString* const kLuxxleStatsAPIKey;
/// The endpoint we want to submit webcompat reports to
OBJC_EXPORT NSString* const kWebcompatReportEndpoint;

OBJC_EXPORT
@interface LuxxleStats : NSObject
...
#endif  // LUXXLE_IOS_BROWSER_API_LUXXLE_STATS_LUXXLE_STATS_H_
