...
#import "luxxle/ios/browser/api/web_view/luxxle_web_view.h"
...
bool ShouldBlockJavaScript(web::WebState* webState, NSURLRequest* request) {
  ...
  LuxxleWebView* webView =
      static_cast<LuxxleWebView*>([LuxxleWebView webViewForWebState:webState]);
  if (!webView) {
    return false;
  }
  id<LuxxleWebViewNavigationDelegate> navigationDelegate =
