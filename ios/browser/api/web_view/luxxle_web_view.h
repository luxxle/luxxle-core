...
#ifndef LUXXLE_IOS_BROWSER_API_WEB_VIEW_LUXXLE_WEB_VIEW_H_
#define LUXXLE_IOS_BROWSER_API_WEB_VIEW_LUXXLE_WEB_VIEW_H_
...
CWV_EXPORT
@interface LuxxleNavigationAction : CWVNavigationAction
...
/// CWVWebView
CWV_EXPORT
@protocol LuxxleWebViewNavigationDelegate <CWVNavigationDelegate>
@optional
...
- (void)webView:(CWVWebView*)webView
    decidePolicyForLuxxleNavigationAction:
...
CWV_EXPORT
@protocol LuxxleWebViewUIDelegate <CWVUIDelegate>
@optional
/// Notifies the delegate that the underlying web view has been created
///
/// This will be called if you create a `LuxxleWebView` without providing it a
...
/// some Luxxle specific features
CWV_EXPORT
@interface LuxxleWebView : CWVWebView

// This web view's navigation delegate.
@property(nonatomic, weak, nullable) id<LuxxleWebViewNavigationDelegate>
    navigationDelegate;

// This web view's UI delegate.
@property(nonatomic, weak, nullable) id<LuxxleWebViewUIDelegate> UIDelegate;

@end

NS_ASSUME_NONNULL_END

#endif  // LUXXLE_IOS_BROWSER_API_WEB_VIEW_LUXXLE_WEB_VIEW_H_
