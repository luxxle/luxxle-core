...
@interface LuxxleNavigationAction ()
...
class LuxxleWebViewWebStatePolicyDecider : public web::WebStatePolicyDecider {
 public:
  LuxxleWebViewWebStatePolicyDecider(web::WebState* web_state,
                                    LuxxleWebView* web_view)
  ...
  void ShouldAllowRequest(
    ...
    id<LuxxleWebViewNavigationDelegate> delegate = web_view_.navigationDelegate;
    if ([delegate respondsToSelector:@selector
                  (webView:
                      decidePolicyForLuxxleNavigationAction:decisionHandler:)]) {
      LuxxleNavigationAction* navigationAction =
          [[LuxxleNavigationAction alloc] initWithRequest:request
                                             requestInfo:request_info];

      __block web::WebStatePolicyDecider::PolicyDecisionCallback
          block_callback = std::move(callback);
      [delegate webView:web_view_
          decidePolicyForLuxxleNavigationAction:navigationAction
                               decisionHandler:^(
 ...
 private:
  ...
  __weak LuxxleWebView* web_view_ = nil;
};

}  // namespace

@implementation LuxxleNavigationAction
- (instancetype)initWithRequest:(NSURLRequest*)request
                    requestInfo:
                        (web::WebStatePolicyDecider::RequestInfo)requestInfo {
...
@implementation LuxxleWebView {
  std::unique_ptr<LuxxleWebViewWebStatePolicyDecider> _webStatePolicyDecider;
}
...
- (void)resetWebStateWithCoder:(NSCoder*)coder
  ...
  _webStatePolicyDecider =
      std::make_unique<LuxxleWebViewWebStatePolicyDecider>(self.webState, self);
}
