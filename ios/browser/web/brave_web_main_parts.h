...
#ifndef LUXXLE_IOS_BROWSER_WEB_BRAVE_WEB_MAIN_PARTS_H_
#define LUXXLE_IOS_BROWSER_WEB_BRAVE_WEB_MAIN_PARTS_H_
...
#endif  // LUXXLE_IOS_BROWSER_WEB_BRAVE_WEB_MAIN_PARTS_H_
