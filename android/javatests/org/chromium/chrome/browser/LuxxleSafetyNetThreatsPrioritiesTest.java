...
import org.chromium.components.safe_browsing.LuxxleSafeBrowsingUtils;
import org.chromium.components.safe_browsing.LuxxleSafeBrowsingUtils.SafetyNetJavaThreatType;
...
public class LuxxleSafetyNetThreatsPrioritiesTest {
    ...
    public void testPriorities() throws Exception {
        ...
        Assert.assertEquals(
                ...
                LuxxleSafeBrowsingUtils.getHighestPriorityThreat(new ArrayList<>()));

        // Single input must return the same value
        Assert.assertEquals(
                SafetyNetJavaThreatType.SOCIAL_ENGINEERING,
                LuxxleSafeBrowsingUtils.getHighestPriorityThreat(
