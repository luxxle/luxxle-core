...
public class LuxxlePrivacySettingsTest {
    ...
    private static final int LUXXLE_PRIVACY_SETTINGS_NUMBER_OF_ITEMS = 30;
    ...
    @Rule
    public SettingsActivityTestRule<LuxxlePrivacySettings> mSettingsActivityTestRule =
            new SettingsActivityTestRule<>(LuxxlePrivacySettings.class);
    private LuxxlePrivacySettings mFragment;

    @Before
    public void setUp() {
        mSettingsActivityTestRule.startSettingsActivity();
        mFragment = (LuxxlePrivacySettings) mSettingsActivityTestRule.getFragment();
    ...
    public void testParentItems() {
        ...
        assertEquals(LUXXLE_PRIVACY_SETTINGS_NUMBER_OF_ITEMS, mItemsLeft);
    }
