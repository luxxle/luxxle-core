...
/** Tests for LuxxleManageSyncSettings. */
@RunWith(ChromeJUnit4ClassRunner.class)
@CommandLineFlags.Add({ChromeSwitches.DISABLE_FIRST_RUN_EXPERIENCE})
@DoNotBatch(reason = "TODO(crbug.com/40743432): SyncTestRule doesn't support batching.")
public class LuxxleManageSyncSettingsTest {
    private SettingsActivity mSettingsActivity;

    private final SettingsActivityTestRule<LuxxleManageSyncSettings> mSettingsActivityTestRule =
            new SettingsActivityTestRule<>(LuxxleManageSyncSettings.class);
    ...
    void syncEverythingOrPasswordsOverridden(
        ...
        // Support the legacy state is the case for Luxxle Sync
        ...
        LuxxleManageSyncSettings.setIsRunningOnChromeOSForTesting(isChromeOS);
        LuxxleManageSyncSettings fragment = startManageSyncPreferences();
    ...
    private LuxxleManageSyncSettings startManageSyncPreferences() {
