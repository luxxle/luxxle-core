...
public class LuxxleHomepageSettingsUnitTest {
    ...
    private LuxxleRadioButtonGroupHomepagePreference mRadioGroupPreference;
    ...
    public void setUp() {
        ...
        mActivityScenario.onActivity(
                activity -> {
                    mActivity = activity;
                    // Needed for LuxxleHomepageSettings to inflate correctly.
    ...
    private void launchLuxxleHomepageSettings() {
        FragmentManager fragmentManager = mActivity.getSupportFragmentManager();
        LuxxleHomepageSettings fragment =
                (LuxxleHomepageSettings)
                        fragmentManager
                                .getFragmentFactory()
                                .instantiate(
                                        LuxxleHomepageSettings.class.getClassLoader(),
                                        LuxxleHomepageSettings.class.getName());
    ...
    public void testMobileBookmarksClick() throws Exception {
        ...
        Assert.assertEquals(
                ...
                LuxxleRadioButtonGroupHomepagePreference.MOBILE_BOOKMARKS_PATH);
