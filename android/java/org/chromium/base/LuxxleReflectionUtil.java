...
@NullMarked
public class LuxxleReflectionUtil {
    private static final String TAG = "LuxxleReflectionUtil";

    // NOTE: For each method for invocation add appropriate test to `testMethodsForInvocationExist`
    // method in 'luxxle/android/javatests/org/chromium/chrome/browser/BytecodeTest.java' file with
