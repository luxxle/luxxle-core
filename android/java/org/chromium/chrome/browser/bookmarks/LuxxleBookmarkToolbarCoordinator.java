...
class LuxxleBookmarkToolbarCoordinator extends BookmarkToolbarCoordinator {
    // Overridden Chromium's BookmarkToolbarCoordinator.mToolbar
    private BookmarkToolbar mToolbar;

    LuxxleBookmarkToolbarCoordinator(
            Context context,
            Profile profile,
        ...
        if (mToolbar instanceof LuxxleBookmarkToolbar) {
            ((LuxxleBookmarkToolbar) mToolbar).setLuxxleBookmarkDelegate(bookmarkDelegateSupplier);
        }
    }
}
