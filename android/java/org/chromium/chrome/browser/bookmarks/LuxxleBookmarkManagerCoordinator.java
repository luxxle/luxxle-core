...
public class LuxxleBookmarkManagerCoordinator extends BookmarkManagerCoordinator {
    // Overridden Chromium's BookmarkManagerCoordinator.mMediator
    private BookmarkManagerMediator mMediator;

    public LuxxleBookmarkManagerCoordinator(
    ...
    public void setWindow(ActivityWindowAndroid window) {
        if (mMediator instanceof LuxxleBookmarkManagerMediator) {
            ((LuxxleBookmarkManagerMediator) mMediator).setWindow(window);
        }
    }
}
