 ...
 */
public class LuxxleBookmarkUtils extends BookmarkUtils {
    private static final String TAG = "LuxxleBookmarkUtils";
    ...
    public static void showBookmarkImportExportDialog(
        ...
        try {
            LuxxleBookmarkImportExportDialogFragment dialogFragment =
                    LuxxleBookmarkImportExportDialogFragment.newInstance(
                            isImport, isSuccess, exportFilePath);
            dialogFragment.show(appCompatActivity.getSupportFragmentManager(),
                    "LuxxleBookmarkImportExportDialogFragment");
