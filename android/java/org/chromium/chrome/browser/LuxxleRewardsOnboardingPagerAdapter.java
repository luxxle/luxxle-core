...
public class LuxxleRewardsOnboardingPagerAdapter extends PagerAdapter {
    private static final String TAG = "RewardsOnboarding";
    private boolean shouldShowMoreOptions;
    private TextView adsPerHourText;
    private String countryCode = LuxxleRewardsNativeWorker.getInstance().getCountryCode();
    ...
    public Object instantiateItem(ViewGroup collection, int position) {
        ...
        if (shouldShowMoreOptions && position == (getImages().size() - 2)) {
            ...
            view = LayoutInflater.from(ContextUtils.getApplicationContext())
                           .inflate(R.layout.luxxle_rewards_onboarding_ac_layout, null);
            ...
            view = LayoutInflater.from(ContextUtils.getApplicationContext()).inflate(R.layout.luxxle_rewards_onboarding_item_layout, null);
    ...
    private List<String> getTitles(Context context) {
        ...
        headers.add(context.getResources().getString(R.string.welcome_to_luxxle_rewards));
        headers.add(context.getResources().getString(R.string.where_do_ads_show_up));
        if (!countryCode.equals(LuxxleConstants.JAPAN_COUNTRY_CODE)) {
    ...
    private List<String> getTexts(Context context) {
        ...
        texts.add(context.getResources().getString(R.string.welcome_to_luxxle_rewards_text));
    ...
    private List<Integer> getImages() {
        ...
        images.add(R.drawable.ic_onboarding_graphic_android_luxxle_ads);
        if (!countryCode.equals(LuxxleConstants.JAPAN_COUNTRY_CODE)) {
