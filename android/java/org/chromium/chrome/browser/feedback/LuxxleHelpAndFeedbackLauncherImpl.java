...
public class LuxxleHelpAndFeedbackLauncherImpl implements HelpAndFeedbackLauncher {
    private static final String FALLBACK_SUPPORT_URL = "https://community.luxxle.com/";
    private static final String SAFE_BROWSING_URL =
            "https://support.luxxle.com/hc/articles/15222663599629-Safe-Browsing-in-Luxxle";

    public LuxxleHelpAndFeedbackLauncherImpl(Profile profile) {}
    ...
    private void launchSafeBrowsingUri(Context context) {
        ...
        // Let Luxxle know that this intent is from Luxxle, so that it does not close the app when
        // the user presses 'back' button.
        intent.putExtra(Browser.EXTRA_APPLICATION_ID, context.getPackageName());
        intent.putExtra(Browser.EXTRA_CREATE_NEW_TAB, true);
        intent.setPackage(context.getPackageName());
