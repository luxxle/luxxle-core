...
/**
 * Luxxle Wallet network preference hosted by {@link LuxxleWalletNetworksPreferenceFragment}. It shows
 * all the networks available and let the user add, edit, or remove them.
 */
public class LuxxleWalletNetworksPreference extends Preference
        implements ConnectionErrorHandler, NetworkPreferenceAdapter.ItemClickListener {

    private AppCompatButton mAddNetwork;
    private RecyclerView mRecyclerView;
    @Nullable private LuxxleWalletAddNetworksFragment.Listener mListener;
    private JsonRpcService mJsonRpcService;
    private Fragment mPreferenceFragment;

    public LuxxleWalletNetworksPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        initJsonRpcService();
    }
    ...
    public void onConnectionError(MojoException e) {
        ...
        if (mPreferenceFragment != null) {
            // TODO: remove when https://github.com/luxxle/luxxle-browser/issues/27887
            // will be resolved.
    ...
    public void setListener(@Nullable LuxxleWalletAddNetworksFragment.Listener listener) {
        mListener = listener;
    }
     ...
     * to Luxxle activity so it's not possible to retrieve activity models.
     */
