...
public class LuxxleWebrtcPolicyPreference
    ...
    protected static final String FALLBACK_SUPPORT_URL =
            "https://support.luxxle.com/hc/en-us/articles/360017989132-How-do-I-change-my-Privacy-Settings-#webrtc";

    @SuppressLint("WrongConstant")
    public LuxxleWebrtcPolicyPreference(Context context, AttributeSet attrs) {
        super(context, attrs);

        setLayoutResource(R.layout.luxxle_webrtc_policy_preference);
