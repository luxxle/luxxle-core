...
public class LuxxleSearchEnginesPreferences extends LuxxlePreferenceFragment
    ...
    private static final String PREF_ADD_OPEN_SEARCH_ENGINES = "luxxle.other_search_engines_enabled";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPageTitle.set(getString(R.string.luxxle_search_engines));
        SettingsUtils.addPreferencesFromResource(this, R.xml.luxxle_search_engines_preferences);
    }
    ...
    private void updateSearchEnginePreference() {
        ...
        searchEnginePreference.setSummary(
                LuxxleSearchEngineUtils.getDSEShortName(getProfile(), false));

        searchEnginePreference = findPreference(PREF_PRIVATE_SEARCH_ENGINE);
        searchEnginePreference.setEnabled(true);
        searchEnginePreference.setSummary(
                LuxxleSearchEngineUtils.getDSEShortName(
        ...
        boolean autocompleteEnabled =
                UserPrefs.get(getProfile()).getBoolean(LuxxlePref.AUTOCOMPLETE_ENABLED);
        ...
        mAutocompleteTopSuggestions.setChecked(
                UserPrefs.get(getProfile()).getBoolean(LuxxlePref.TOP_SUGGESTIONS_ENABLED));
        ...
        mAddOpenSearchEngines.setChecked(
                UserPrefs.get(getProfile()).getBoolean(LuxxlePref.ADD_OPEN_SEARCH_ENGINES));

        if (LuxxleConfig.WEB_DISCOVERY_ENABLED) {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (PREF_SEARCH_SUGGESTIONS.equals(key)) {
            ...
            mAutocompleteTopSuggestions.setVisible(autocompleteEnabled);
            UserPrefs.get(getProfile())
                    .setBoolean(LuxxlePref.AUTOCOMPLETE_ENABLED, autocompleteEnabled);
        } else if (PREF_AUTOCOMPLETE_TOP_SUGGESTIONS.equals(key)) {
            UserPrefs.get(getProfile())
                    .setBoolean(LuxxlePref.TOP_SUGGESTIONS_ENABLED, (boolean) newValue);
        } else if (PREF_ADD_OPEN_SEARCH_ENGINES.equals(key)) {
            UserPrefs.get(getProfile())
                    .setBoolean(LuxxlePref.ADD_OPEN_SEARCH_ENGINES, (boolean) newValue);
