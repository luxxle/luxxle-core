...
public class LuxxleWalletAutoLockPreferences
        extends Preference implements Preference.OnPreferenceClickListener, ConnectionErrorHandler {
    private String TAG = "LuxxleWalletAutoLockPreferences";

    public static final int WALLET_AUTOLOCK_DEFAULT_TIME = 5;

    private KeyringService mKeyringService;

    public LuxxleWalletAutoLockPreferences(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean onPreferenceClick(Preference preference) {
        showLuxxleWalletAutoLockDialog();
        return true;
    }
    ...
    private void showLuxxleWalletAutoLockDialog() {
        LayoutInflater inflater =
                (LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.luxxle_wallet_autolock_layout, null);
        final EditText input = (EditText) view.findViewById(R.id.luxxle_wallet_autolock_edittext);
        ...
        AlertDialog alertDialog =
                alert.setTitle(R.string.luxxle_wallet_settings_autolock_option)
                        .setView(view)
