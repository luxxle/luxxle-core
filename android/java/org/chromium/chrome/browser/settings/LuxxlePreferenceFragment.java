...
import org.chromium.chrome.browser.settings.developer.LuxxleRewardsDebugPreferences;

public abstract class LuxxlePreferenceFragment extends ChromeBaseSettingsFragment {
    ...
    public void onResume() {
        ...
        if (luxxleRewardsNativeWorker == null || !luxxleRewardsNativeWorker.isSupported()) {
            ...
            Preference luxxleRewardsDebugPreference =
                    getPreferenceScreen().findPreference(LuxxleRewardsDebugPreferences.KEY);
            if (luxxleRewardsDebugPreference != null) {
                getPreferenceScreen().removePreference(luxxleRewardsDebugPreference);
            }
        }
    }
