...
public class LuxxleLeoRadioButtonGroupDefaultModelPreference extends Preference
        implements RadioGroup.OnCheckedChangeListener {
    /** This is a delegate that is implemented in LuxxleLeoDefaultModelPreferences */
    ...
    public LuxxleLeoRadioButtonGroupDefaultModelPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        setLayoutResource(R.xml.luxxle_leo_radio_button_group_default_model_preference);
    }
