...
public class LuxxleWalletNetworksPreferenceFragment extends LuxxlePreferenceFragment
        implements FragmentSettingsNavigation, LuxxleWalletAddNetworksFragment.Listener {
    // Preference key from R.xml.luxxle_wallet_networks_preference.
    private static final String PREF_LUXXLE_WALLET_NETWORKS_ADD = "pref_luxxle_wallet_networks_add";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPageTitle.set(getString(R.string.luxxle_wallet_networks_title));
                ...
                registerForActivityResult(
                        ...
                        result -> {
                            if (result.getResultCode() == Activity.RESULT_OK) {
                                LuxxleWalletNetworksPreference addNetworkPreference =
                                        findPreference(PREF_LUXXLE_WALLET_NETWORKS_ADD);
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, String rootKey) {
        SettingsUtils.addPreferencesFromResource(this, R.xml.luxxle_wallet_networks_preference);

        LuxxleWalletNetworksPreference luxxleWalletNetworksPreference =
                findPreference(PREF_LUXXLE_WALLET_NETWORKS_ADD);
        if (luxxleWalletNetworksPreference != null) {
            luxxleWalletNetworksPreference.setListener(this);
            luxxleWalletNetworksPreference.setPreferenceFragment(this);
        }
    }
    ...
    public void onDestroy() {
        ...
        if (luxxleWalletNetworksPreference != null) {
            ...
            luxxleWalletNetworksPreference.destroy();
        }
    }
    ...
    private void launchIntent(@Nullable final String chainId, boolean activeNetwork) {
        ...
        Intent intent =
                mSettingsLauncher.createSettingsIntent(
                        requireContext(), LuxxleWalletAddNetworksFragment.class, fragmentArgs);
