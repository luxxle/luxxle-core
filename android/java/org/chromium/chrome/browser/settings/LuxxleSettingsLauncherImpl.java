...
import org.chromium.chrome.browser.download.settings.LuxxleDownloadSettings;
import org.chromium.chrome.browser.download.settings.DownloadSettings;
import org.chromium.chrome.browser.safe_browsing.settings.LuxxleStandardProtectionSettingsFragment;
import org.chromium.chrome.browser.safe_browsing.settings.StandardProtectionSettingsFragment;

public class LuxxleSettingsLauncherImpl extends SettingsNavigationImpl {
    public LuxxleSettingsLauncherImpl() {
        super();
    }
    ...
    public void startSettings(
        ...
        if (fragment != null) {
            ...
            if (fragment.equals(StandardProtectionSettingsFragment.class)) {
                fragment = LuxxleStandardProtectionSettingsFragment.class;
            } else if (fragment.equals(DownloadSettings.class)) {
                fragment = LuxxleDownloadSettings.class;
            } else if (fragment.equals(ClearBrowsingDataFragment.class)) {
                fragment = LuxxleClearBrowsingDataFragment.class;
            }
        }
    ...
    public Intent createSettingsIntent(
        ...
        intent.setClass(context, LuxxleSettingsActivity.class);
