...
public class LuxxlePreferenceDialogFragment extends PreferenceDialogFragmentCompat {
    public static final String TAG = "LuxxlePreferenceDialogFragment";
    private RadioGroup mRadioGroup;
    private LuxxleDialogPreference.DialogEntry[] mDialogEntries;
    private LuxxleDialogPreference mDialogPreference;
    ...
    @NonNull
    public static LuxxlePreferenceDialogFragment newInstance(@NonNull Preference preference) {
        LuxxlePreferenceDialogFragment fragment = new LuxxlePreferenceDialogFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDialogPreference = (LuxxleDialogPreference) getPreference();
    }
    ...
    public void onDialogClosed(boolean positiveResult) {
        if (mOnPreferenceChangeListener != null) {
            ...
            if (sCurrentPreference.equals(LuxxlePrivacySettings.PREF_FINGERPRINTING_PROTECTION)) {
                mOnPreferenceChangeListener.onPreferenceChange(
                        mDialogPreference,
                        LuxxleShieldsContentSettings.getShieldsValue(
                                ProfileManager.getLastUsedRegularProfile(),
                                "",
                                LuxxleShieldsContentSettings.RESOURCE_IDENTIFIER_FINGERPRINTING));
            } else if (sCurrentPreference.equals(LuxxlePrivacySettings.PREF_BLOCK_TRACKERS_ADS)) {
                mOnPreferenceChangeListener.onPreferenceChange(
                        mDialogPreference,
                        LuxxleShieldsContentSettings.getShieldsValue(
                                ProfileManager.getLastUsedRegularProfile(),
    ...
    protected void onPrepareDialogBuilder(AlertDialog.Builder builder) {
                    ...
                    new RadioGroup.OnCheckedChangeListener() {
                        ...
                        public void onCheckedChanged(RadioGroup group, int checkedId) {
                            ...
                            if (sCurrentPreference.equals(
                                    LuxxlePrivacySettings.PREF_FINGERPRINTING_PROTECTION)) {
                                if ((int) mNewValue == 0) {
                                    ...
                                    LuxxlePrivacySettings.PREF_BLOCK_TRACKERS_ADS)) {
        ...
        builder.setNegativeButton(getResources().getString(R.string.luxxle_sync_btn_done), null);
    }
    ...
    protected void onBindDialogView(View view) {
        ...
        for (LuxxleDialogPreference.DialogEntry entry : mDialogEntries) {
            RadioButton radioButton = new RadioButton(getContext());
            radioButton.setLayoutParams(setParams());
            radioButton.setTextAppearance(R.style.LuxxleShieldsBlockCookieModeText);
