...
public class LuxxleTabCreator extends ChromeTabCreator {
    public LuxxleTabCreator(
            Activity activity,
    ...
    public Tab launchUrl(String url, @TabLaunchType int type) {
        if (url.equals(UrlConstants.NTP_URL)
            ...
            registerPageView();
            ChromeTabbedActivity chromeTabbedActivity = LuxxleActivity.getChromeTabbedActivity();
