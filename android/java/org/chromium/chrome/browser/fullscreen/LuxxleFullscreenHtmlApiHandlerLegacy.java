...
public class LuxxleFullscreenHtmlApiHandlerLegacy extends FullscreenHtmlApiHandlerLegacy {
     ...
     */
    public LuxxleFullscreenHtmlApiHandlerLegacy(
            Activity activity,
    ...
    public void exitPersistentFullscreenMode() {
        if (!mActivity.isInPictureInPictureMode()
                || LuxxleFullscreenHtmlApiHandlerBase.class.cast(this).mTabHiddenByChangedTabs) {
