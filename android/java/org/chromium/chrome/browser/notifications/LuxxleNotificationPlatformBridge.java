...
public class LuxxleNotificationPlatformBridge {
    ...
    public static boolean dispatchNotificationEvent(Intent intent) {
        if (NotificationPlatformBridge.dispatchNotificationEvent(intent)) {
            ...
            if (notificationType == NotificationType.LUXXLE_ADS
    ...
    public static NotificationBuilderBase prepareNotificationBuilder(
            ...
            boolean silent,
            ActionInfo[] actions) {
        if (identifyingAttributes.notificationType == NotificationType.LUXXLE_ADS) {
        ...
        assert result instanceof LuxxleNotificationBuilder
                : "Bytecode changes for LuxxleNotificationBuilder were not applied!";
        if (result instanceof LuxxleNotificationBuilder) {
            ((LuxxleNotificationBuilder) result)
                    .setIsLuxxleNotification(
                            identifyingAttributes.notificationType == NotificationType.LUXXLE_ADS);
        }
