 ...
 */
public class LuxxlePermissionUtils {
    ...
    public static boolean isLuxxleAdsNotificationPermissionBlocked(Context context) {
        return channeGroupIsBlocked(context, LuxxleChannelDefinitions.ChannelGroupId.LUXXLE_ADS);
    }

    public static boolean isGeneralNotificationPermissionBlocked(Context context) {
        return channeGroupIsBlocked(context, LuxxleChannelDefinitions.ChannelGroupId.GENERAL);
    }

    public static void requestPermission(Activity activity) {
        LuxxlePermissionUtils.notificationSettingPage(activity);
    }
