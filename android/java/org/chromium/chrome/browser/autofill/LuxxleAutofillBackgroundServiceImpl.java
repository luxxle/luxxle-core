...
public class LuxxleAutofillBackgroundServiceImpl extends ChromeBackgroundServiceImpl {
    ...
    public LuxxleAutofillBackgroundServiceImpl(
                ...
                if (autofillDataMap != null && !autofillDataMap.isEmpty()) {
                    ...
                    for (Map.Entry<AutofillId, String> autofillData : autofillDataMap.entrySet()) {
                        ...
                        RemoteViews presentation =
                                new RemoteViews(mPackageName, R.layout.luxxle_autofill_service_item);
                        if (title.isEmpty()) {
                            title = subtitle;
                            subtitle = "";
                        }
