...
public class LuxxleRewardsOnboardingFragment extends Fragment {
    ...
    public LuxxleRewardsOnboardingFragment() {
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.fragment_luxxle_rewards_onboarding, container, false);
    ...
    private void initializeViews(View root) {
        ...
        LuxxleTouchUtils.ensureMinTouchTarget(btnSkip);
    }
    ...
    private void setActions() {
        ...
        String luxxleRewardsText = "<b>"
                + String.format(getResources().getString(R.string.earn_tokens),
                        getResources().getString(R.string.token))
                + "</b> " + getResources().getString(R.string.luxxle_rewards_onboarding_text);
        Spanned textToInsert = LuxxleRewardsHelper.spannedFromHtmlString(luxxleRewardsText);
        ...
        Spanned textToAgree = LuxxleRewardsHelper.spannedFromHtmlString(termsText);
                ...
                new ClickableSpan() {
                    ...
                    public void onClick(@NonNull View textView) {
                        CustomTabActivity.showInfoPage(
                                getActivity(), LuxxleActivity.LUXXLE_TERMS_PAGE);
                    }
