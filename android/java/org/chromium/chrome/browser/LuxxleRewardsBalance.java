...
@NullMarked
public class LuxxleRewardsBalance {
    public static final String WALLET_BLINDED = "blinded";

    /** matching consts in src/luxxle/components/luxxle_rewards/content/balance.h */
    ...
    LuxxleRewardsBalance(String jsonBalance) throws JSONException {
