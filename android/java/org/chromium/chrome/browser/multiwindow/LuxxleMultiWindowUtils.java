...
@NullMarked
public class LuxxleMultiWindowUtils extends MultiWindowUtils {

    private static final String TAG = "MultiWindowUtils";

    public LuxxleMultiWindowUtils() {
        super();
    }
    ...
    public static boolean shouldEnableMultiWindows() {
        return ChromeSharedPreferences.getInstance()
                .readBoolean(LuxxlePreferenceKeys.ENABLE_MULTI_WINDOWS, false);
    }

    public static void updateEnableMultiWindows(boolean isEnable) {
        ChromeSharedPreferences.getInstance()
                .writeBoolean(LuxxlePreferenceKeys.ENABLE_MULTI_WINDOWS, isEnable);
    }

    public static boolean isCheckUpgradeEnableMultiWindows() {
        return ChromeSharedPreferences.getInstance()
                .readBoolean(LuxxlePreferenceKeys.ENABLE_MULTI_WINDOWS_UPGRADE, false);
    }

    public static void setCheckUpgradeEnableMultiWindows(boolean isUpgradeCheck) {
        ChromeSharedPreferences.getInstance()
                .writeBoolean(LuxxlePreferenceKeys.ENABLE_MULTI_WINDOWS_UPGRADE, isUpgradeCheck);
    }

    public static void mergeWindows(Activity activity) {
        try {
            MultiInstanceManager multiInstanceManager =
                    LuxxleActivity.getLuxxleActivityFromTaskId(activity.getTaskId())
    ...
    public static void closeWindows() {
        try {
            MultiInstanceManager multiInstanceManager =
                    LuxxleActivity.getLuxxleActivity().getMultiInstanceManager();
