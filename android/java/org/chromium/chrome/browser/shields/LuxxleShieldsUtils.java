...
public class LuxxleShieldsUtils {
    ...
    public static final String WEBCOMPAT_UI_SOURCE_HISTOGRAM_NAME = "Luxxle.Webcompat.UISource";
    public static final String WEBCOMPAT_REPORT_LUXXLE_VERSION = "version";
    public static final String WEBCOMPAT_REPORT_LUXXLE_CHANNEL = "channel";
    ...
    public interface LuxxleShieldsCallback {
        void luxxleShieldsSubmitted();
    }
    ...
    public static class LuxxleShieldsWorkerTask extends AsyncTask<Void> {
        private String mDomain;
        private String mApiKey;
        private byte[] mScreenshotBytes;

        public LuxxleShieldsWorkerTask(String domain, String apiKey, byte[] pngBytes) {
            mDomain = domain;
            mApiKey = apiKey;
        ...
        protected Void doInBackground() {
            sendLuxxleShieldsFeedback(mDomain, mApiKey, mScreenshotBytes);
            return null;
        }
    ...
    private static void sendLuxxleShieldsFeedback(
            String domain, String apiKey, byte[] screenshotPngBytes) {
        assert LuxxleConfig.WEBCOMPAT_REPORT_ENDPOINT != null
                && !LuxxleConfig.WEBCOMPAT_REPORT_ENDPOINT.isEmpty();
        ...
        try {
            URL url = new URL(LuxxleConfig.WEBCOMPAT_REPORT_ENDPOINT);
            urlConnection =
                    (HttpURLConnection)
            ...
            jsonParam.put(WEBCOMPAT_REPORT_LUXXLE_VERSION, LuxxleVersionConstants.VERSION);
            jsonParam.put(WEBCOMPAT_REPORT_LUXXLE_CHANNEL, LuxxleVersionConstants.CHANNEL);
