...
public class LuxxleSearchEngineAdapter extends SearchEngineAdapter {
    private static final String TAG = "LuxxleSearchEngineAdapter";
    ...
    public LuxxleSearchEngineAdapter(Context context, Profile profile) {
    ...
    public static String getDSEShortName(
        ...
        if (!readJavaPrefOnly) {
            ...
            // overwrite.
            if (LuxxleSearchEnginePrefHelper.getInstance().getFetchSEFromNative()) {
                // Set it for normal tab only
                setDSEPrefs(dseTemplateUrl, ProfileManager.getLastUsedRegularProfile());
                LuxxleSearchEnginePrefHelper.getInstance().setFetchSEFromNative(false);
            }
        }
    ...
    public void onClick(View view) {
        ...
        ChromeSharedPreferences.getInstance()
                .writeBoolean(LuxxlePreferenceKeys.DEFAULT_SEARCH_ENGINE_CHANGED, true);
    }
    ...
    public void onTemplateUrlServiceLoaded() {
        ...
        // once from lambda at LuxxleSearchEngineUtils.initializeLuxxleSearchEngineStates)
