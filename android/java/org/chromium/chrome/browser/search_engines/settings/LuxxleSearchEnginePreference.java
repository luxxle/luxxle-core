...
public class LuxxleSearchEnginePreference extends SearchEngineSettings {
    ...
    public LuxxleSearchEnginePreference(boolean isPrivate) {
        mPrivate = isPrivate;
    }
    ...
    public void createAdapterIfNecessary() {
        ...
        mSearchEngineAdapter = new LuxxleSearchEngineAdapter(getActivity(), getProfile(mPrivate));
    }
