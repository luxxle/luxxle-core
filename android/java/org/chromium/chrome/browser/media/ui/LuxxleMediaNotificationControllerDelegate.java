...
public class LuxxleMediaNotificationControllerDelegate
        extends ChromeMediaNotificationControllerDelegate {
    private static final String TAG = "LuxxleMediaNotif";

    LuxxleMediaNotificationControllerDelegate(int id) {
        super(id);
        ChromeMediaNotificationControllerDelegate.sMapNotificationIdToOptions.put(
                ...
                new NotificationOptions(
                        LuxxleMediaNotificationControllerServices.PlaybackListenerMicService.class,
    ...
    /** Service used to run Luxxle Talk session */
                ...
                new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        ...
                        Intent i =
                                new Intent(
                                        getContext(),
                                        LuxxleMediaNotificationControllerServices
                        ...
                        try {
                            ...
                            Log.e(
                                    TAG,
                                    "Can't start "
                                        + "LuxxleMediaNotificationControllerServices.PlaybackListenerMicService", // presubmit: ignore-long-line
                                    e);
                        }
                    }
                };
