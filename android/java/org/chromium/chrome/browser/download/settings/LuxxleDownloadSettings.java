...
public class LuxxleDownloadSettings extends DownloadSettings
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SettingsUtils.addPreferencesFromResource(this, R.xml.luxxle_download_preferences);
        ...
        if (locationPromptEnabledPref != null) {
            locationPromptEnabledPref.setTitle(
                    R.string.luxxle_download_location_prompt_enabled_title);
        }
    }
    ...
    private void updateDownloadSettings() {
                ...
                ChromeSharedPreferences.getInstance()
                        .readBoolean(
                                LuxxlePreferenceKeys
                                        .LUXXLE_DOWNLOADS_AUTOMATICALLY_OPEN_WHEN_POSSIBLE,
                                true);
        ...
        boolean downloadProgressNotificationBubble =
                ChromeSharedPreferences.getInstance()
                        .readBoolean(
                                LuxxlePreferenceKeys
                                        .LUXXLE_DOWNLOADS_DOWNLOAD_PROGRESS_NOTIFICATION_BUBBLE,
                                true);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (PREF_AUTOMATICALLY_OPEN_WHEN_POSSIBLE.equals(preference.getKey())) {
            ...
            LuxxleFeatureUtil.enableFeature(
                    LuxxleFeatureList.ENABLE_PARALLEL_DOWNLOADING, (boolean) newValue, false);
