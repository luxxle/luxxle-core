...
/** See org.luxxle.bytecode.LuxxleManageSyncSettingsClassAdapter */
public class LuxxleManageSyncSettings extends ManageSyncSettings {
    ...
    private LuxxlePasswordAccessReauthenticationHelper mReauthenticationHelper;
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, String rootKey) {
        ...
        if (syncAutofill != null) {
            syncAutofill.setTitle(R.string.luxxle_sync_autofill);
        }
                            ...
                            try {
                                ...
                                if (mReauthenticationHelper == null) {
                                    ...
                                    mReauthenticationHelper =
                                            new LuxxlePasswordAccessReauthenticationHelper(
                                                    ContextUtils.getApplicationContext(),
                                                    fragmentManager);
                                }
                                ...
                                Log.e(
                                        TAG,
                                        "LuxxleManageSyncSettings.OnPreferenceChange"
                                                + " IllegalStateException ex=",
                                        ex);
                            } catch (Exception ex) {
                                Log.e(TAG, "LuxxleManageSyncSettings.OnPreferenceChange ex=", ex);
                            }
                        }
                        return false;
                    } else {
