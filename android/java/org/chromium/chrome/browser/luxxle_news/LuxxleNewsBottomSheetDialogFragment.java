...
public class LuxxleNewsBottomSheetDialogFragment extends BottomSheetDialogFragment {
    private String mUrl;
    ...
    public static LuxxleNewsBottomSheetDialogFragment newInstance() {
        return new LuxxleNewsBottomSheetDialogFragment();
    }

    public void setController(LuxxleNewsController controller) {
        mLuxxleNewsController = controller;
    }
    ...
    public View onCreateView(
        ...
        View view = inflater.inflate(R.layout.luxxle_news_card_menu, container, false);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        disableText.append(
                getResources().getString(R.string.luxxle_news_disable_content, mPublisherName));
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                                        ...
                                        ChromeSharedPreferences.getInstance()
                                                .writeBoolean(
                                                        LuxxlePreferenceKeys
                                                                .LUXXLE_NEWS_CHANGE_SOURCE,
                                                        true);
                                        mLuxxleNewsController.setPublisherPref(
                                                mPublisherId, UserEnabled.DISABLED);
                                        LuxxleNewsUtils.disableFollowingPublisherList(mPublisherId);
                        ...
                        Toast.makeText(
                                        ...
                                        getResources()
                                                .getString(
                                                        R.string.luxxle_news_disabled_content,
                                                        mPublisherName),
                                        Toast.LENGTH_SHORT)
                                .show();
                    }
