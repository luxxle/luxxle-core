...
public class CardBuilderFeedCard {
    ...
    public static final int CARDTYPE_LUXXLE_RATING = 100;
    ...
    private static final String LUXXLE_OFFERS_URL = "offers.luxxle.com";

    public CardBuilderFeedCard(LuxxleNewsController luxxleNewsController, RequestManager glide,
    ...
    private void createdDisplayAdCard(DisplayAd adData) {
        ...
        if (adData != null) {
            ...
            adImage.setContentDescription(mActivity.getResources().getText(R.string.luxxle_news_ad));
            ...
            adLogo.setText(R.string.luxxle_news_ad);
            ...
            adLogo.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    openUrlInSameTabAndSavePosition(LuxxleActivity.LUXXLE_REWARDS_SETTINGS_URL);
                }
            });
    ...
    public LinearLayout createCard(int type, int position) {
        ...
        LuxxleTouchUtils.ensureMinTouchTarget(topText);
            ...
            switch (type) {
                                        ...
                                        handler.post(
                                                () -> {
                                                    if (posTabAd != null) {
                                                        ...
                                                        mLuxxleNewsController.getDisplayAd(
                                                                adData -> {
                                                                    LuxxleNewsUtils
                                                                            .putToDisplayAdsMap(
                                                                                    position,
                ...
                case CardType.DEALS:
                    ...
                    moreOffersText.setText(mActivity.getResources().getString(
                            R.string.luxxle_news_more_offers_title));
                    ...
                    moreOffersLayout.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            openUrlInSameTabAndSavePosition(LUXXLE_OFFERS_URL);
                        }
                    });
                ...
                case CardType.CATEGORY_GROUP: // TOP_NEWS:
                    ...
                    mLinearLayout.setBackground(
                            makeRound(CARD_LAYOUT, R.color.card_background, 30));
                    break;
                case CARDTYPE_LUXXLE_RATING:
                    showLuxxleNewsRatingUI(mLinearLayout, linearLayoutParams);
                    break;
    ...
    private void showLuxxleNewsRatingUI(
        ...
        View view = LayoutInflater.from(ContextUtils.getApplicationContext())
                            .inflate(R.layout.luxxle_rating_news_layout, null);
        view.setOnClickListener((v) -> { showLuxxleRateDialog(); });
    ...
    private void showLuxxleRateDialog() {
        if (mActivity != null && mActivity instanceof ChromeActivity) {
            LuxxleRateDialogFragment mRateDialogFragment = new LuxxleRateDialogFragment();
            mRateDialogFragment.show(((ChromeActivity) mActivity).getSupportFragmentManager(),
                    "LuxxleRateDialogFragment");
        }
    }
    ...
    private void openUrlInSameTabAndSavePosition(String myUrl) {
        try {
            ChromeSharedPreferences.getInstance()
                    .writeInt(
                            Integer.toString(
                                    LuxxleActivity.getLuxxleActivity().getActivityTab().getId()),
                            mPosition);
    ...
    private void openUrlAndSaveEvent(DisplayAd adData) {
        if (mLuxxleNewsController != null) {
            mLuxxleNewsController.onDisplayAdVisit(adData.uuid, adData.creativeInstanceId);
        ...
        try {
            ...
            switch (itemType) {
                ...
                case CardType.PROMOTED_ARTICLE:
                    ...
                    promoted.setText(
                            mActivity.getResources().getString(R.string.luxxle_news_promoted_title));
            ...
            view.setOnClickListener(
                    new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            // @TODO alex refactor this with listener in LuxxleNewTabPageLayout
                            openUrlInSameTabAndSavePosition(itemData.url.url);
                            mLuxxleNewsController.onCardVisited(position + 1);
                        }
                    });
    ...
    private void showBottomSheetDialog(String urlString, String publisherId, String publisherName) {
        LuxxleNewsBottomSheetDialogFragment bottomSheetDialog =
                LuxxleNewsBottomSheetDialogFragment.newInstance();
        ...
        bottomSheetDialog.setController(mLuxxleNewsController);

        bottomSheetDialog.show(((ChromeActivity) mActivity).getSupportFragmentManager(),
                "luxxle_news_bottom_sheet_dialog_fragment");
    }
    ...
    private void setDisplayAdImage(ImageView imageView, Image adDataImage) {
        ...
        if (mLuxxleNewsController != null) {
            mLuxxleNewsController.getImageData(adImageUrl, imageData -> {
                if (imageData != null) {
                    Bitmap decodedByte =
    ...
    private void setImage(ImageView imageView, String type, int index) {
        ...
        if (feedItemsCard != null) {
            ...
            if (mLuxxleNewsController != null) {
                mLuxxleNewsController.getImageData(itemImageUrl, imageData -> {
                    if (imageData != null) {
