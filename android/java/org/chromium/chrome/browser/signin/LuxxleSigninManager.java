...
@NullMarked
public class LuxxleSigninManager implements SigninManager {
    private final IdentityManager mIdentityManager;

    LuxxleSigninManager(IdentityManager identityManager) {
    ...
    static SigninManager create(
        ...
        return new LuxxleSigninManager(identityManager);
    }
