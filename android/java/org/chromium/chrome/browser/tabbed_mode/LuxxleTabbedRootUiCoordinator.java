...
public class LuxxleTabbedRootUiCoordinator extends TabbedRootUiCoordinator {
    private AppCompatActivity mActivity;
    private OneshotSupplier<HubManager> mHubManagerSupplier;
    private final ObservableSupplier<EdgeToEdgeController> mEdgeToEdgeControllerSupplier;

    public LuxxleTabbedRootUiCoordinator(
    ...
    public void onPostInflationStartup() {
        ...
        assert mActivity instanceof LuxxleActivity;

        if (mActivity instanceof LuxxleActivity) {
            ((LuxxleActivity) mActivity)
