...
public class LuxxleLocationBarMediator extends LocationBarMediator {
    ...
    public LuxxleLocationBarMediator(
    ...
    void updateQRButtonColors() {
        if (mLocationBarLayout instanceof LuxxleLocationBarLayout) {
            ((LuxxleLocationBarLayout) mLocationBarLayout)
                    .setQRButtonTint(
    ...
    private void openQRCodeDialog() {
        if (mContext != null && mContext instanceof AppCompatActivity) {
            LuxxleLocationBarQRDialogFragment luxxleLocationBarQRDialogFragment =
                    LuxxleLocationBarQRDialogFragment.newInstance(this);
            luxxleLocationBarQRDialogFragment.setCancelable(false);
            luxxleLocationBarQRDialogFragment.show(
                    ((AppCompatActivity) mContext).getSupportFragmentManager(),
                    "LuxxleLocationBarQRDialogFragment");
        }
    }
}
