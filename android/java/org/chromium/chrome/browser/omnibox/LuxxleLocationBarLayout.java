...
public class LuxxleLocationBarLayout extends LocationBarLayout {
    private ImageButton mQRButton;

    public LuxxleLocationBarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mQRButton = findViewById(R.id.qr_button);
    }

    public LuxxleLocationBarLayout(Context context, AttributeSet attrs, int layoutId) {
