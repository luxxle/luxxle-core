...
public class LuxxleLocationBarQRDialogFragment
    ...
    // https://github.com/luxxle/luxxle-browser/issues/41454
    public LuxxleLocationBarQRDialogFragment() {
        super();
    }

    private LuxxleLocationBarQRDialogFragment(LocationBarMediator locationBarMediator) {
        mLocationBarMediator = locationBarMediator;
    }

    public static LuxxleLocationBarQRDialogFragment newInstance(
            LocationBarMediator locationBarMediator) {
        return new LuxxleLocationBarQRDialogFragment(locationBarMediator);
    }
    ...
    public View onCreateView(
        ...
        View view =
                inflater.inflate(R.layout.fragment_luxxle_location_bar_qr_dialog, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        LuxxleTouchUtils.ensureMinTouchTarget(backImageView);
