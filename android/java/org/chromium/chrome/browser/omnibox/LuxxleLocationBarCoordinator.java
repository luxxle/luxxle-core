...
@NullUnmarked
public class LuxxleLocationBarCoordinator extends LocationBarCoordinator {
    /**
    ...
    public LuxxleLocationBarCoordinator(
        ...
        if (mLocationBarMediator instanceof LuxxleLocationBarMediator) {
            mQRButton = locationBarLayout.findViewById(R.id.qr_button);
            mQRButton.setOnClickListener(
                    ((LuxxleLocationBarMediator) mLocationBarMediator)::qrButtonClicked);
        }
    }
    ...
    private static boolean isLuxxleBottomControlsVisible() {
        return BottomToolbarConfiguration.isLuxxleBottomControlsEnabled()
                && LuxxleMenuButtonCoordinator.isMenuFromBottom();
    }
}
