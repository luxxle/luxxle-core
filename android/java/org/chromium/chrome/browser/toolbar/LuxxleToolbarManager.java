...
import org.chromium.chrome.browser.toolbar.bottom.LuxxleBottomControlsCoordinator;
import org.chromium.chrome.browser.toolbar.bottom.LuxxleScrollingBottomViewResourceFrameLayout;
...
import org.chromium.chrome.browser.toolbar.top.LuxxleTopToolbarCoordinator;
...
public class LuxxleToolbarManager extends ToolbarManager
        implements OnSharedPreferenceChangeListener {
    private static final String TAG = "LuxxleToolbarManager";
    ...
    // Own members.
    private boolean mIsLuxxleBottomControlsVisible;
    ...
    private HomepageManager.HomepageStateListener mLuxxleHomepageStateListener;
    private AppCompatActivity mActivity;
    private WindowAndroid mWindowAndroid;
    private CompositorViewHolder mCompositorViewHolder;
    private final Object mLock = new Object();
    private boolean mBottomControlsEnabled;
    private LuxxleScrollingBottomViewResourceFrameLayout mBottomControls;
    ...
    public LuxxleToolbarManager(
        ...
        if (isToolbarPhone()) {
            updateLuxxleBottomControlsVisibility();
            mLayoutStateProviderSupplier.onAvailable(
                    mCallbackController.makeCancelable(this::setLayoutStateProvider));
        }

        mLuxxleHomepageStateListener =
                () -> {
                    if (mBottomControlsCoordinatorSupplier != null
                            && mBottomControlsCoordinatorSupplier.get()
                                    instanceof LuxxleBottomControlsCoordinator) {
                        ((LuxxleBottomControlsCoordinator) mBottomControlsCoordinatorSupplier.get())
                                .updateHomeButtonState();
                    }
                };
        HomepageManager.getInstance().addListener(mLuxxleHomepageStateListener);
    }
    ...
    public void enableBottomControls() {
        ...
        synchronized (mLock) {
            ...
            mBottomControls =
                    (LuxxleScrollingBottomViewResourceFrameLayout) bottomControlsStub.inflate();
            ...
            var bottomControlsCoordinator =
                    new LuxxleBottomControlsCoordinator(
                            mLayoutStateProviderSupplier,
            ...
            updateLuxxleBottomControlsVisibility();
            if (mIsLuxxleBottomControlsVisible) {
    ...
    public void initializeWithNative(
        ...
        if (isToolbarPhone() && BottomToolbarConfiguration.isLuxxleBottomControlsEnabled()) {
        ...
        assert toolbarLayout instanceof LuxxleToolbarLayoutImpl
                : "Something has changed in the upstream!";
        if (toolbarLayout instanceof LuxxleToolbarLayoutImpl) {
            ((LuxxleToolbarLayoutImpl) toolbarLayout)
    ...
    public void destroy() {
        ...
        super.destroy();
        HomepageManager.getInstance().removeListener(mLuxxleHomepageStateListener);
    }
        ...
        if (!mIncognitoStateProvider.isIncognitoSelected()) {
            if (mActivity instanceof LuxxleActivity) {
                MiscAndroidMetrics miscAndroidMetrics =
                        ((LuxxleActivity) mActivity).getMiscAndroidMetrics();
    ...
    protected void onOrientationChange() {
        ...
        if (mBottomControlsCoordinatorSupplier.get() != null
            ...
            boolean isLuxxleBottomControlsVisible =
                    mCurrentOrientation != Configuration.ORIENTATION_LANDSCAPE;
            setLuxxleBottomControlsVisible(isLuxxleBottomControlsVisible);
        }
        ...
        if (mActivity instanceof LuxxleActivity) {
            ((LuxxleActivity) mActivity).updateBottomSheetPosition(mCurrentOrientation);
        }
    }
    ...
    protected void updateBookmarkButtonStatus() {
        ...
        if (mBottomControlsCoordinatorSupplier.get() instanceof LuxxleBottomControlsCoordinator) {
            ((LuxxleBottomControlsCoordinator) mBottomControlsCoordinatorSupplier.get())
    ...
    private void setLuxxleBottomControlsVisible(boolean visible) {
        mIsLuxxleBottomControlsVisible = visible;
        boolean isMenuFromBottom =
                (mIsLuxxleBottomControlsVisible
                                && BottomToolbarConfiguration.isLuxxleBottomControlsEnabled())
                        || BottomToolbarConfiguration.isToolbarBottomAnchored();
        LuxxleMenuButtonCoordinator.setMenuFromBottom(isMenuFromBottom);

        if (mToolbar instanceof LuxxleTopToolbarCoordinator) {
            ((LuxxleTopToolbarCoordinator) mToolbar).onBottomControlsVisibilityChanged(visible);
        }
        if (mBottomControlsCoordinatorSupplier.get() instanceof LuxxleBottomControlsCoordinator) {
            ((LuxxleBottomControlsCoordinator) mBottomControlsCoordinatorSupplier.get())
    ...
    private void updateLuxxleBottomControlsVisibility() {
        boolean isLuxxleBottomControlsVisible =
                BottomToolbarConfiguration.isLuxxleBottomControlsEnabled()
    ...
    private boolean isToolbarPhone() {
        assert (mToolbar instanceof LuxxleTopToolbarCoordinator);
        return mToolbar instanceof LuxxleTopToolbarCoordinator
                && ((LuxxleTopToolbarCoordinator) mToolbar).isToolbarPhone();
    }

    private ObservableSupplier<Integer> getConstraintsProxy() {
        if (mToolbar instanceof LuxxleTopToolbarCoordinator) {
            return ((LuxxleTopToolbarCoordinator) mToolbar).getConstraintsProxy();
        }
    ...
    public void onSharedPreferenceChanged(
        ...
        if (ChromePreferenceKeys.TOOLBAR_TOP_ANCHORED.equals(key)) {
            if (sharedPreferences.getBoolean(
                    LuxxlePreferenceKeys.LUXXLE_BOTTOM_TOOLBAR_ENABLED_KEY, true)) {
                updateLuxxleBottomControlsVisibility();
            }
        }
    }
                ...
                new LayoutStateProvider.LayoutStateObserver() {
                    ...
                    public void onStartedShowing(@LayoutType int layoutType) {
                        if (layoutType == LayoutType.TAB_SWITCHER
                                && BottomToolbarConfiguration.isToolbarBottomAnchored()) {
                            LuxxleMenuButtonCoordinator.setMenuFromBottom(false);
                        }
                    }
                    ...
                    public void onStartedHiding(@LayoutType int layoutType) {
                        if (layoutType == LayoutType.TAB_SWITCHER
                                && BottomToolbarConfiguration.isToolbarBottomAnchored()) {
                            LuxxleMenuButtonCoordinator.setMenuFromBottom(true);
                        }
                    }
                };
