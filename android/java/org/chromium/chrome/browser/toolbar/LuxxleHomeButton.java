...
/** Luxxle's extension of HomeButton. */
public class LuxxleHomeButton extends HomeButton implements TintObserver {
    private ThemeColorProvider mThemeColorProvider;

    public LuxxleHomeButton(Context context, AttributeSet attrs) {
        super(context, attrs);
