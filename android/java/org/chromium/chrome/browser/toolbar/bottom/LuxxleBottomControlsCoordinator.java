...
public class LuxxleBottomControlsCoordinator extends BottomControlsCoordinator {
    ...
    public LuxxleBottomControlsCoordinator(
    ...
    public void setBottomToolbarVisible(boolean visible) {
        if (mMediator instanceof LuxxleBottomControlsMediator) {
            ((LuxxleBottomControlsMediator) mMediator).setBottomToolbarVisible(visible);
        }
        if (mBottomToolbarCoordinator != null) {
    ...
    public ObservableSupplierImpl<Boolean> getBottomToolbarVisibleSupplier() {
        if (mMediator instanceof LuxxleBottomControlsMediator) {
            return ((LuxxleBottomControlsMediator) mMediator).getBottomToolbarVisibleSupplier();
        }
    ...
    public ObservableSupplierImpl<Boolean> getTabGroupUiVisibleSupplier() {
        if (mMediator instanceof LuxxleBottomControlsMediator) {
            return ((LuxxleBottomControlsMediator) mMediator).getTabGroupUiVisibleSupplier();
        }
        assert false : "Make sure mMediator is properly patched in bytecode.";
        return null;
    }
