...
public class LuxxleScrollingBottomViewResourceFrameLayout
    ...
    public LuxxleScrollingBottomViewResourceFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setBottomControlsCoordinatorSupplier(
        ...
        luxxleBottomControlsCoordinator().getBottomToolbarVisibleSupplier().addObserver(
        ...
        luxxleBottomControlsCoordinator().getTabGroupUiVisibleSupplier().addObserver(
                mCallbackController.makeCancelable((visible) -> {
                    // Only make changes if visibility changed.
                    if (mBottomContainerSlot != null
    ...
    private LuxxleBottomControlsCoordinator luxxleBottomControlsCoordinator() {
        if (mBottomControlsCoordinatorSupplier != null
                && mBottomControlsCoordinatorSupplier.get()
                                instanceof LuxxleBottomControlsCoordinator) {
            return (LuxxleBottomControlsCoordinator) mBottomControlsCoordinatorSupplier.get();
        }
        return null;
    }
