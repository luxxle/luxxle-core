...
public class LuxxleMenuButtonCoordinator extends MenuButtonCoordinator {
    private Activity mActivity;

    public LuxxleMenuButtonCoordinator(
    ...
    private void updateMenuButtonState() {
        LuxxleToolbarLayoutImpl layout =
                (LuxxleToolbarLayoutImpl) mActivity.findViewById(R.id.toolbar);
        assert layout != null;
        if (layout != null) {
    ...
    public static void setMenuFromBottom(boolean isMenuFromBottom) {
        ContextUtils.getAppSharedPreferences()
                .edit()
                .putBoolean(LuxxlePreferenceKeys.LUXXLE_IS_MENU_FROM_BOTTOM, isMenuFromBottom)
                .apply();
    }
