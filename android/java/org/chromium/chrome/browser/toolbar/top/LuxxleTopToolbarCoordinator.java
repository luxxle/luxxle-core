...
public class LuxxleTopToolbarCoordinator extends TopToolbarCoordinator {
    ...
    // Own members.
    private ToolbarLayout mLuxxleToolbarLayout;
    private MenuButtonCoordinator mLuxxleMenuButtonCoordinator;
    ...
    public LuxxleTopToolbarCoordinator(
        ...
        mLuxxleToolbarLayout = toolbarLayout;
        mLuxxleMenuButtonCoordinator = browsingModeMenuButtonCoordinator;
        ...
        if (isToolbarPhone()) {
            ...
            Object toolbarContext =
                    LuxxleReflectionUtil.invokeMethod(
                            android.view.View.class, mLuxxleToolbarLayout, "getContext");
            ...
            LuxxleReflectionUtil.setField(
                    ToolbarPhone.class,
                    "mLocationBarBackgroundColorForNtp",
                    mLuxxleToolbarLayout,
    ...
    public void onBottomControlsVisibilityChanged(boolean isVisible) {
        ...
        if (mLuxxleToolbarLayout instanceof LuxxleToolbarLayout) {
            ((LuxxleToolbarLayoutImpl) mLuxxleToolbarLayout)
    ...
    public boolean isToolbarPhone() {
        return mLuxxleToolbarLayout instanceof ToolbarPhone;
    }

    @Override
    public MenuButton getMenuButtonWrapper() {
        // We consider that there is no top toolbar menu button, if bottom controls are visible.
        return mIsBottomControlsVisible ? null : mLuxxleMenuButtonCoordinator.getMenuButton();
    }
