...
/**
 * LuxxleRewardsNativeWorker.GetPublisherBanner json response converted to this pojo class
 * */
public class LuxxleRewardsBannerInfo {
    ...
    public LuxxleRewardsBannerInfo(String jsonExternalWallet) throws JSONException {
    ...
    public String toString() {
        return "LuxxleRewardsBannerInfo{"
