...
public class LuxxleVpnServerSelectionAdapter
        extends RecyclerView.Adapter<LuxxleVpnServerSelectionAdapter.ViewHolder> {
    private final Context mContext;
    private List<Region> mRegions = new ArrayList<>();
    private OnServerRegionSelection mOnServerRegionSelection;

    public LuxxleVpnServerSelectionAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View listItem = layoutInflater.inflate(
                R.layout.luxxle_vpn_server_selection_item_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (region != null) {
            holder.serverIconText.setText(LuxxleVpnUtils.countryCodeToEmoji(region.countryIsoCode));
            ...
            holder.serverRadioButton.setChecked(
                    LuxxleVpnPrefUtils.getRegionIsoCode().equals(region.countryIsoCode));
