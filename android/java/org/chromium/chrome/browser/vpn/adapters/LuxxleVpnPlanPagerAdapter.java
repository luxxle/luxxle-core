...
public class LuxxleVpnPlanPagerAdapter extends PagerAdapter {
    private final Context context;
    public LuxxleVpnPlanPagerAdapter(Context context) {
    ...
    public Object instantiateItem(ViewGroup collection, int position) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.fragment_luxxle_vpn_plan, null);
