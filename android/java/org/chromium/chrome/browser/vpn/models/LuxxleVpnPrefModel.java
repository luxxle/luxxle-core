...
public class LuxxleVpnPrefModel {
    ...
    private LuxxleVpnServerRegion mServerRegion;
    ...
    public void setServerRegion(LuxxleVpnServerRegion serverRegion) {
    ...
    public LuxxleVpnServerRegion getServerRegion() {
