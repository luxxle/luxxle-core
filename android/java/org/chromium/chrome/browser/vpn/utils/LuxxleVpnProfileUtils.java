...
public class LuxxleVpnProfileUtils {
    private static volatile LuxxleVpnProfileUtils sLuxxleVpnProfileUtils;
    private static Object sMutex = new Object();

    private LuxxleVpnProfileUtils() {}

    public static LuxxleVpnProfileUtils getInstance() {
        LuxxleVpnProfileUtils result = sLuxxleVpnProfileUtils;
        if (result == null) {
            synchronized (sMutex) {
                result = sLuxxleVpnProfileUtils;
                if (result == null) sLuxxleVpnProfileUtils = result = new LuxxleVpnProfileUtils();
            }
        }
        return result;
    }

    public boolean isLuxxleVPNConnected(Context context) {
    ...
    public void startVpn(Context context) {
        ...
        LuxxlePermissionUtils.showNotificationPermissionDialog(context);
    }
