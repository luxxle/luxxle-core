...
import org.chromium.chrome.browser.vpn.activities.LuxxleVpnSupportActivity;
...
import org.chromium.chrome.browser.vpn.fragments.LuxxleVpnAlwaysOnErrorDialogFragment;
import org.chromium.chrome.browser.vpn.fragments.LuxxleVpnConfirmDialogFragment;
...
public class LuxxleVpnUtils {
    ...
    public static LuxxleVpnServerRegion selectedServerRegion;
    ...
    public static void openLuxxleVpnPlansActivity(@Nullable Context context) {
        if (context == null) {
            return;
        }
        Intent luxxleVpnPlanIntent = new Intent(context, VpnPaywallActivity.class);
        luxxleVpnPlanIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        luxxleVpnPlanIntent.setAction(Intent.ACTION_VIEW);
        context.startActivity(luxxleVpnPlanIntent);
    }

    public static void openLuxxleVpnProfileActivity(Activity activity) {
        if (activity == null) {
            return;
        }
        Intent luxxleVpnProfileIntent = new Intent(activity, LuxxleVpnProfileActivity.class);
        luxxleVpnProfileIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        luxxleVpnProfileIntent.setAction(Intent.ACTION_VIEW);
        activity.startActivity(luxxleVpnProfileIntent);
    }

    public static void openLuxxleVpnSupportActivity(Activity activity) {
        if (activity == null) {
            return;
        }
        Intent luxxleVpnSupportIntent = new Intent(activity, LuxxleVpnSupportActivity.class);
        luxxleVpnSupportIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        luxxleVpnSupportIntent.setAction(Intent.ACTION_VIEW);
        activity.startActivity(luxxleVpnSupportIntent);
    }
    ...
    public static void openSplitTunnelActivity(Activity activity) {
        ...
        Intent luxxleVpnSupportIntent = new Intent(activity, SplitTunnelActivity.class);
        luxxleVpnSupportIntent.setAction(Intent.ACTION_VIEW);
        activity.startActivity(luxxleVpnSupportIntent);
    }
    ...
    public static LuxxleVpnServerRegion getServerRegionForTimeZone(
            ...
            for (int i = 0; i < regions.length(); i++) {
                ...
                for (int j = 0; j < timezones.length(); j++) {
                    if (timezones.getString(j).equals(currentTimezone)) {
                        ...
                        return luxxleVpnServerRegion;
                    }
                }
            }
        } catch (JSONException e) {
            Log.e(TAG, "LuxxleVpnUtils -> getRegionForTimeZone JSONException error " + e);
        }
        return null;
    }
    ...
    public static Pair<String, String> getHostnameForRegion(String jsonHostnames) {
        ...
        try {
            ...
            Log.e(TAG, "LuxxleVpnUtils -> getHostnameForRegion JSONException error " + e);
        }
        return new Pair<String, String>("", "");
    }

    public static LuxxleVpnWireguardProfileCredentials getWireguardProfileCredentials(
        ...
        try {
            ...
            LuxxleVpnWireguardProfileCredentials luxxleVpnWireguardProfileCredentials =
                    new LuxxleVpnWireguardProfileCredentials(
            ...
            return luxxleVpnWireguardProfileCredentials;
        } catch (JSONException e) {
            Log.e(TAG, "LuxxleVpnUtils -> getWireguardProfileCredentials JSONException error " + e);
        }
        return null;
    }
    ...
    public static Long getPurchaseExpiryDate(String json) {
        try {
            ...
            Log.e(
                    TAG,
                    "LuxxleVpnUtils -> getPurchaseExpiryDate JSONException | NumberFormatException"
                            + " error "
                            + e);
        }
        return 0L;
    ...
    public static int getPaymentState(String json) {
        try {
            ...
            Log.e(TAG, "LuxxleVpnUtils -> getPaymentState JSONException error " + e);
        }
        return 0;
    }
    ...
    public static void resetProfileConfiguration(Activity activity) {
        ...
        LuxxleVpnPrefUtils.setResetConfiguration(true);
    ...
    public static void updateProfileConfiguration(Activity activity) {
        ...
        if (LuxxleVpnProfileUtils.getInstance().isLuxxleVPNConnected(activity)) {
            LuxxleVpnProfileUtils.getInstance().stopVpn(activity);
            LuxxleVpnProfileUtils.getInstance().startVpn(activity);
        }
        dismissProgressDialog();
    }

    public static void showVpnAlwaysOnErrorDialog(Activity activity) {
        LuxxleVpnAlwaysOnErrorDialogFragment mLuxxleVpnAlwaysOnErrorDialogFragment =
                new LuxxleVpnAlwaysOnErrorDialogFragment();
        mLuxxleVpnAlwaysOnErrorDialogFragment.show(
                ((FragmentActivity) activity).getSupportFragmentManager(),
                "LuxxleVpnAlwaysOnErrorDialogFragment");
    }

    public static void showVpnConfirmDialog(Activity activity) {
        LuxxleVpnConfirmDialogFragment luxxleVpnConfirmDialogFragment =
                new LuxxleVpnConfirmDialogFragment();
        luxxleVpnConfirmDialogFragment.show(
                ((FragmentActivity) activity).getSupportFragmentManager(),
                "LuxxleVpnConfirmDialogFragment");
    }

    public static void reportBackgroundUsageP3A() {
        // Will report previous/current session timestamps...
        LuxxleVpnNativeWorker.getInstance().reportBackgroundP3A(
                LuxxleVpnPrefUtils.getSessionStartTimeMs(), LuxxleVpnPrefUtils.getSessionEndTimeMs());
        // ...and then reset the timestamps so we don't report the same session again.
        LuxxleVpnPrefUtils.setSessionStartTimeMs(-1);
        LuxxleVpnPrefUtils.setSessionEndTimeMs(-1);
    }
