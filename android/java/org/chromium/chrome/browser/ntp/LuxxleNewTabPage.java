...
import org.chromium.chrome.browser.feed.LuxxleFeedSurfaceCoordinator;
...
public class LuxxleNewTabPage extends NewTabPage {
    ...
    public LuxxleNewTabPage(
        ...
        assert mNewTabPageLayout instanceof LuxxleNewTabPageLayout;
        if (mNewTabPageLayout instanceof LuxxleNewTabPageLayout) {
            ((LuxxleNewTabPageLayout) mNewTabPageLayout).setTab(tab);
            ((LuxxleNewTabPageLayout) mNewTabPageLayout).setTabProvider(activityTabProvider);
        }
    ...
    protected void initializeMainView(
        ...
        FeedSurfaceCoordinator feedSurfaceCoordinator =
                new LuxxleFeedSurfaceCoordinator(
                        activity,
                        snackbarManager,
                        windowAndroid,
                        mJankTracker,
    ...
    public void updateSearchProviderHasLogo() {
        // Search provider logo is not used in Luxxle's NTP.
