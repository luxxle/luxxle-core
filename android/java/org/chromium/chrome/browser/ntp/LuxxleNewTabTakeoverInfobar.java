...
@NullMarked
public class LuxxleNewTabTakeoverInfobar {
    ...
    public LuxxleNewTabTakeoverInfobar(Profile profile) {
        mProfile = profile;
    }
    ...
    public void maybeDisplayAndIncrementCounter(Activity activity, WebContents webContents) {
        ...
        LuxxleSimpleConfirmInfoBarBuilder.create(
                webContents,
    ...
    private boolean shouldDisplayInfobar() {
        ...
        final int infobarDisplayCount =
                prefService.getInteger(LuxxlePref.NEW_TAB_TAKEOVER_INFOBAR_REMAINING_DISPLAY_COUNT);
    ...
    private void recordInfobarWasDisplayed() {
        ...
        prefService.setInteger(
                LuxxlePref.NEW_TAB_TAKEOVER_INFOBAR_REMAINING_DISPLAY_COUNT,
                infobarDisplayCount - 1);
    }

    private void suppressInfobar() {
        PrefService prefService = UserPrefs.get(mProfile);
        prefService.setInteger(LuxxlePref.NEW_TAB_TAKEOVER_INFOBAR_REMAINING_DISPLAY_COUNT, 0);
    }
}
