...
public class LuxxleSpeedReaderUtils {
    public static void toggleEnabledForWebContent(WebContents webContents, boolean enabled) {
        LuxxleSpeedReaderUtilsJni.get().toggleEnabledForWebContent(webContents, enabled);
    }

    public static boolean tabStateIsDistilled(Tab tab) {
        return LuxxleSpeedReaderUtilsJni.get().tabStateIsDistilled(tab);
    }

    public static boolean tabSupportsDistillation(Tab tab) {
        return LuxxleSpeedReaderUtilsJni.get().tabSupportsDistillation(tab);
    }

    public static void singleShotSpeedreaderForWebContent(WebContents webContents) {
        LuxxleSpeedReaderUtilsJni.get().singleShotSpeedreaderForWebContent(webContents);
    }

    public static boolean tabProbablyReadable(Tab tab) {
        return LuxxleSpeedReaderUtilsJni.get().tabProbablyReadable(tab);
    }
