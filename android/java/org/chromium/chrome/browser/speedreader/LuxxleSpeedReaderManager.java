 ...
 * message UI.
 */
public class LuxxleSpeedReaderManager extends EmptyTabObserver implements UserData {
    /** The key to access this object from a {@Tab}. */
    public static final Class<LuxxleSpeedReaderManager> USER_DATA_KEY =
            LuxxleSpeedReaderManager.class;

    private static final String TAG = "LuxxleSpeedreaderMgr";
    ...
    LuxxleSpeedReaderManager(Tab tab, Supplier<MessageDispatcher> messageDispatcherSupplier) {
        super();
        mTab = tab;
    ...
    void tryShowingPrompt() {
        ...
        if (mIsDismissed || !LuxxleSpeedReaderUtils.tabSupportsDistillation(mTab)) {
            return;
        }
    ...
    private void showReaderModeMessage(MessageDispatcher messageDispatcher) {
        ...
        mMessageModel = new PropertyModel.Builder(MessageBannerProperties.ALL_KEYS)
                                ...
                                .with(MessageBannerProperties.ON_PRIMARY_ACTION,
                                        () -> {
                                            LuxxleSpeedReaderUtils.enableSpeedreaderMode(mTab);
    ...
    public static boolean isEnabled() {
        boolean isFeatureEnabled = ChromeFeatureList.isEnabled(LuxxleFeatureList.LUXXLE_SPEEDREADER);
