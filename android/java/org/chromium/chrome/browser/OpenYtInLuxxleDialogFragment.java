...
public class OpenYtInLuxxleDialogFragment extends LuxxleDialogFragment
    ...
    public View onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_open_yt_in_luxxle_dialog, container, false);
    }
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_done) {
            LuxxlePrefServiceBridge.getInstance().setPlayYTVideoInBrowserEnabled(true);
