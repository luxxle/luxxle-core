...
@NullMarked
public class LuxxleIntentHandler {
    private static final String TAG = "LuxxleIntentHandler";

    public static final String CONNECTION_INFO_HELP_URL =
            "https://support.google.com/chrome?p=android_connection_info";
    public static final String LUXXLE_CONNECTION_INFO_HELP_URL =
            "https://support.luxxle.com/hc/en-us/articles/360018185871-How-do-I-check-if-a-site-s-connection-is-secure-";
    public static final String FALLBACK_SUPPORT_URL =
            "https://support.google.com/chrome/topic/6069782";
    public static final String LUXXLE_FALLBACK_SUPPORT_URL = "https://support.luxxle.com/hc/en-us";
