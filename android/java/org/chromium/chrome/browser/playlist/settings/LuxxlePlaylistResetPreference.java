...
/**
 * The preference used to reset Luxxle Playlist.
 */
public class LuxxlePlaylistResetPreference
        extends Preference implements Preference.OnPreferenceClickListener {
    private String TAG = "LuxxlePlaylistResetPreference";

    private int mPrefAccentColor;

    /** Constructor for LuxxlePlaylistResetPreference. */
    public LuxxlePlaylistResetPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
