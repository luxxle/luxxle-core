...
@NullMarked
public class LuxxleRewardsHelper implements LargeIconBridge.LargeIconCallback {
    private static final String PREF_SHOW_LUXXLE_REWARDS_ONBOARDING_MODAL =
            "show_luxxle_rewards_onboarding_modal";
    private static final String PREF_SHOW_LUXXLE_REWARDS_ONBOARDING_ONCE =
            "show_luxxle_rewards_onboarding_once";
    ...
    public static boolean isRewardsEnabled() {
        LuxxleRewardsNativeWorker worker = LuxxleRewardsNativeWorker.getInstance();
    ...
    public static void resetRewards() {
        ...
        ChromeSharedPreferences.getInstance()
                .writeBoolean(PREF_SHOW_LUXXLE_REWARDS_ONBOARDING_MODAL, true);
        ChromeSharedPreferences.getInstance()
                .writeBoolean(PREF_SHOW_LUXXLE_REWARDS_ONBOARDING_ONCE, false);
    ...
    public static boolean shouldShowRewardsOnboardingModalOnDay4() {
        ...
        if (!hasRewardsOnboardingModalShown()
                ...
                && luxxleRewardsNativeWorker != null
                && luxxleRewardsNativeWorker.isSupported()) {
            if (isRewardsEnabled()) {
    ...
    public static boolean shouldShowLuxxleRewardsOnboardingModal() {
        return ChromeSharedPreferences.getInstance()
                .readBoolean(PREF_SHOW_LUXXLE_REWARDS_ONBOARDING_MODAL, true);
    }

    public static void setShowLuxxleRewardsOnboardingModal(boolean enabled) {
        ChromeSharedPreferences.getInstance()
                .writeBoolean(PREF_SHOW_LUXXLE_REWARDS_ONBOARDING_MODAL, enabled);
    }

    public static boolean shouldShowLuxxleRewardsOnboardingOnce() {
        return ChromeSharedPreferences.getInstance()
                .readBoolean(PREF_SHOW_LUXXLE_REWARDS_ONBOARDING_ONCE, false);
    }

    public static void setShowLuxxleRewardsOnboardingOnce(boolean enabled) {
        ChromeSharedPreferences.getInstance()
                .writeBoolean(PREF_SHOW_LUXXLE_REWARDS_ONBOARDING_ONCE, enabled);
    }
    ...
    public LuxxleRewardsHelper(Tab tab) {
        mTab = tab;
        assert mTab != null;
    ...
    public static ChromeTabbedActivity getChromeTabbedActivity() {
        return LuxxleActivity.getChromeTabbedActivity();
    }

    public static LuxxleActivity getLuxxleActivity()
            throws LuxxleActivity.LuxxleActivityNotFoundException {
        return LuxxleActivity.getLuxxleActivity();
    }

    public static String getCurrentMonth(
            Calendar currentTime, Resources resources, boolean upperCase) {
        String month = resources.getString(R.string.luxxle_ui_month_jan);
        switch (currentTime.get(Calendar.MONTH)) {
            case Calendar.JANUARY:
                month = resources.getString(R.string.luxxle_ui_month_jan);
                break;
            case Calendar.FEBRUARY:
                month = resources.getString(R.string.luxxle_ui_month_feb);
                break;
            case Calendar.MARCH:
                month = resources.getString(R.string.luxxle_ui_month_mar);
                break;
            case Calendar.APRIL:
                month = resources.getString(R.string.luxxle_ui_month_apr);
                break;
            case Calendar.MAY:
                month = resources.getString(R.string.luxxle_ui_month_may);
                break;
            case Calendar.JUNE:
                month = resources.getString(R.string.luxxle_ui_month_jun);
                break;
            case Calendar.JULY:
                month = resources.getString(R.string.luxxle_ui_month_jul);
                break;
            case Calendar.AUGUST:
                month = resources.getString(R.string.luxxle_ui_month_aug);
                break;
            case Calendar.SEPTEMBER:
                month = resources.getString(R.string.luxxle_ui_month_sep);
                break;
            case Calendar.OCTOBER:
                month = resources.getString(R.string.luxxle_ui_month_oct);
                break;
            case Calendar.NOVEMBER:
                month = resources.getString(R.string.luxxle_ui_month_nov);
                break;
            case Calendar.DECEMBER:
                month = resources.getString(R.string.luxxle_ui_month_dec);
                break;
        }
    ...
    public static Tab currentActiveChromeTabbedActivityTab() {
        ChromeTabbedActivity activity = LuxxleRewardsHelper.getChromeTabbedActivity();
        if (activity == null) {
            return null;
        }
    ...
    public static SpannableString tosSpannableString(String text, int colorRes) {
        ...
        ChromeClickableSpan termsOfServiceClickableSpan =
                new ChromeClickableSpan(
                        ...
                        (textView) -> {
                            CustomTabActivity.showInfoPage(context, LuxxleActivity.LUXXLE_TERMS_PAGE);
                        });
                ...
                new ChromeClickableSpan(
                        ...
                        (textView) -> {
                            CustomTabActivity.showInfoPage(
                                    context, LuxxleActivity.LUXXLE_PRIVACY_POLICY);
                        });
