...
import org.chromium.base.LuxxleUrlConstants;
...
import org.chromium.chrome.browser.crypto_wallet.LuxxleWalletProviderDelegateImplHelper;
...
public class LuxxleWalletPanel implements DialogInterface {
    private static final String TAG = "LuxxleWalletPanel";
    ...
    public LuxxleWalletPanel(
        ...
        try {
            ...
            Log.e(TAG, "LuxxleWalletPanel Constructor", e);
        }
        ...
        mActivity = LuxxleActivity.getChromeTabbedActivity();
        ...
        mAllAccountsInfoObserver =
                allAccountsInfo -> {
                    ...
                    final LuxxleWalletService luxxleWalletService =
                            mWalletModel.getLuxxleWalletService();
                    if (luxxleWalletService == null) {
                        return;
                    }
    ...
    private boolean handleMenuItemClick(MenuItem item) {
        if (item.getItemId() == R.id.action_lock_wallet) {
            ...
            try {
                ...
                activity.openLuxxleConnectedSitesSettings();
                dismiss();
            } catch (LuxxleActivity.LuxxleActivityNotFoundException e) {
            ...
            try {
                LuxxleActivity activity = LuxxleActivity.getLuxxleActivity();
                activity.openLuxxleWalletSettings();
                dismiss();
            } catch (LuxxleActivity.LuxxleActivityNotFoundException e) {
    ...
    private void updateSolanaConnected(AccountInfo selectedAccount) {
        try {
            ...
            if (activity.getActivityTab() != null) {
                LuxxleWalletProviderDelegateImplHelper.isSolanaConnected(
        ...
        if (showSolStatus) {
            ...
            try {
                ...
                if (activity.getActivityTab() != null) {
                    ...
                    if (!lastCommittedUrl.getScheme().equals(LuxxleUrlConstants.LUXXLE_SCHEME)
    ...
    private void setUpViews() {
        ...
        mPopupView = (ViewGroup) inflater.inflate(R.layout.luxxle_wallet_panel_layout, null);
    ...
    private final View.OnClickListener mOnConnectedAccountClick =
            v -> {
                try {
                    LuxxleActivity activity = LuxxleActivity.getLuxxleActivity();
                    activity.openLuxxleWalletDAppsActivity(
                            LuxxleWalletDAppsActivity.ActivityType.CONNECT_ACCOUNT);
                } catch (LuxxleActivity.LuxxleActivityNotFoundException e) {
