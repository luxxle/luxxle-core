...
import static org.chromium.chrome.browser.crypto_wallet.activities.LuxxleWalletDAppsActivity.ActivityType.GET_ENCRYPTION_PUBLIC_KEY_REQUEST;
...
public class LuxxleWalletDAppsActivity extends LuxxleWalletBaseActivity
        implements TransactionConfirmationListener,
                AddSwitchChainNetworkFragment.AddSwitchRequestProcessListener {
    private static final String TAG = "LuxxleWalletDApps";
    ...
    protected void triggerLayoutInflation() {
        setContentView(R.layout.activity_luxxle_wallet_dapps);
    ...
    public void onDestroy() {
        ...
        try {
            final LuxxleActivity activity = LuxxleActivity.getLuxxleActivity();
