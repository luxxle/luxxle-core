...
/** Main Luxxle Wallet activity */
public class LuxxleWalletActivity extends LuxxleWalletBaseActivity implements OnNextPage {
    ...
    protected void triggerLayoutInflation() {
        setContentView(R.layout.activity_luxxle_wallet);
        mIsFromDapps = false;
    ...
    public void finishNativeInitialization() {
        ...
        mWalletOnboardingPagerAdapter =
                new WalletOnboardingPagerAdapter(
                        this, mLuxxleWalletP3A, mRestartSetupAction, mRestartRestoreAction);
