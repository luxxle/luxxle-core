...
public abstract class LuxxleWalletBaseActivity extends AsyncInitializationActivity
    ...
    protected LuxxleWalletP3a mLuxxleWalletP3A;
    protected LuxxleWalletService mLuxxleWalletService;
    ...
    public void onConnectionError(MojoException e) {
        ...
        if (mLuxxleWalletP3A != null) mLuxxleWalletP3A.close();
    ...
    protected void initLuxxleWalletP3A() {
        if (mLuxxleWalletP3A != null) {
            return;
        }

        mLuxxleWalletP3A = LuxxleWalletServiceFactory.getInstance().getLuxxleWalletP3A(this);
    }

    protected void initLuxxleWalletService() {
    ...
    public LuxxleWalletP3a getLuxxleWalletP3A() {
        return mLuxxleWalletP3A;
    }
