...
public class LuxxlePermissionAccountsListAdapter
        extends RecyclerView.Adapter<LuxxlePermissionAccountsListAdapter.ViewHolder> {
    ...
    public enum Mode {
         ...
         *
         * @see LuxxleDappPermissionPromptDialog
         */
    ...
    public LuxxlePermissionAccountsListAdapter(
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.luxxle_wallet_accounts_list_item, parent, false);
            ...
            case ACCOUNT_CONNECTION -> {
                ...
                if (CoinType.SOL == mSelectedAccount.accountId.coin) {
                    connectionButtonText =
                            hasPermission
                                    ? R.string.luxxle_wallet_site_permissions_revoke
                                    : R.string.luxxle_wallet_site_permissions_trust;
                } else {
                    if (hasPermission) {
                        if (isConnected) {
