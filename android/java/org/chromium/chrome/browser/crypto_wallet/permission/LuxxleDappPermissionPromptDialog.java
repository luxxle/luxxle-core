...
public class LuxxleDappPermissionPromptDialog
        implements ModalDialogProperties.Controller, ConnectionErrorHandler {
    private static final String TAG = "LuxxleDappPermission";
    ...
    @CalledByNative
    private static LuxxleDappPermissionPromptDialog create(
            long nativeDialogController,
            @NonNull WindowAndroid windowAndroid,
            String favIconURL,
            @CoinType.EnumType int coinType) {
        return new LuxxleDappPermissionPromptDialog(
                nativeDialogController, windowAndroid, favIconURL, coinType);
    }

    public LuxxleDappPermissionPromptDialog(
            long nativeDialogController,
            @NonNull WindowAndroid windowAndroid,
            String favIconURL,
            @CoinType.EnumType int coinType) {
        ...
        try {
            ...
            Log.e(TAG, "LuxxleDappPermissionPromptDialog", e);
        }
    }
    ...
    void show() {
        View customView =
                LayoutInflaterUtils.inflate(
                        mWindow, R.layout.luxxle_permission_prompt_dialog, null, false);
        ...
        mLuxxleWalletService.getActiveOrigin(
                originInfo -> {
        ...
        mPropertyModel =
                new PropertyModel.Builder(ModalDialogProperties.ALL_KEYS)
                        ...
                        .with(
                                ...
                                mContext.getString(
                                        R.string
                                                .permissions_connect_luxxle_wallet_connect_button_text))
                        .with(
                                ModalDialogProperties.NEGATIVE_BUTTON_TEXT,
                                mContext.getString(
                                        R.string.permissions_connect_luxxle_wallet_back_button_text))
                ...
                .fetchAccountsForConnectionReq(
                        ...
                        selectedAccountAllAccounts -> {
                            ...
                            if (capd != null) {
                                ...
                                LuxxleDappPermissionPromptDialogJni.get()
    ...
    public void onDismiss(PropertyModel model, int dismissalCause) {
        ...
        LuxxleDappPermissionPromptDialogJni.get().onDialogDismissed(mNativeDialogController);
    ...
    interface Natives {
        void onPrimaryButtonClicked(
                long nativeLuxxleDappPermissionPromptDialogController,
                String[] accounts,
                int permissionLifetimeOption);

        void onNegativeButtonClicked(long nativeLuxxleDappPermissionPromptDialogController);

        void onDialogDismissed(long nativeLuxxleDappPermissionPromptDialogController);
    }
}
