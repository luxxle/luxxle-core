...
public class LuxxleTileView extends TileView {
    private static final String TAG = "LuxxleTileView";

    public LuxxleTileView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
        ...
        if (ProfileManager.isInitialized()) {
            ...
            if (UserPrefs.get(ProfileManager.getLastUsedRegularProfile())
                ...
                mTitleView.setTextColor(
                        getContext().getColor(R.color.luxxle_state_time_count_color));
