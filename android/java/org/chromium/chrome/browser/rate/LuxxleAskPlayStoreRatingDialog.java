...
public class LuxxleAskPlayStoreRatingDialog extends BottomSheetDialogFragment {
    public static final String TAG_FRAGMENT = "luxxle_ask_play_store_rating_dialog_tag";
    ...
    public static LuxxleAskPlayStoreRatingDialog newInstance(boolean isFromSettings) {
        Bundle bundle = new Bundle();
        bundle.putBoolean(RateUtils.FROM_SETTINGS, isFromSettings);
        LuxxleAskPlayStoreRatingDialog fragment = new LuxxleAskPlayStoreRatingDialog();
    ...
    public void show(@NonNull FragmentManager manager, @Nullable String tag) {
        try {
            LuxxleAskPlayStoreRatingDialog fragment =
                    (LuxxleAskPlayStoreRatingDialog) manager.findFragmentByTag(
    ...
    public void setupDialog(@NonNull Dialog dialog, int style) {
        ...
        final View view = LayoutInflater.from(getContext())
                                  .inflate(R.layout.luxxle_ask_play_store_rating_dialog, null);
