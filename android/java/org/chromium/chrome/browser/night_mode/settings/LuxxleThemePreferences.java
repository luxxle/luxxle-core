...
public class LuxxleThemePreferences extends ThemeSettingsFragment {
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, String rootKey) {
        SettingsUtils.addPreferencesFromResource(this, R.xml.luxxle_theme_preferences);
        ...
        LuxxleRadioButtonGroupThemePreference radioButtonGroupThemePreference =
            (LuxxleRadioButtonGroupThemePreference) findPreference(PREF_UI_THEME_PREF);
