...
public class LuxxleLeoVoiceRecognitionHandler {
    ...
    class VoiceRecognitionCompleteCallback implements WindowAndroid.IntentCallback {
        ...
        private void handleTranscriptionResult(Intent data) {
            List<LuxxleLeoVoiceRecognitionHandler.VoiceResult> voiceResults =
                    convertBundleToVoiceResults(data.getExtras());
            LuxxleLeoVoiceRecognitionHandler.VoiceResult topResult =
    ...
    public LuxxleLeoVoiceRecognitionHandler(
    ...
    private List<LuxxleLeoVoiceRecognitionHandler.VoiceResult> convertBundleToVoiceResults(
            Bundle extras) {
        ...
        List<LuxxleLeoVoiceRecognitionHandler.VoiceResult> results = new ArrayList<>();
        for (int i = 0; i < strings.size(); ++i) {
            results.add(
                    new LuxxleLeoVoiceRecognitionHandler.VoiceResult(
    ...
    private boolean showSpeechRecognitionIntent(Intent intent) {
        return mWindowAndroid.showCancelableIntent(
                        intent,
                        new LuxxleLeoVoiceRecognitionHandler.VoiceRecognitionCompleteCallback(),
                        null)
                >= 0;
    }
