...
/** Luxxle's Activity for AI Chat Plans */
public class LuxxleLeoPlansActivity extends AsyncInitializationActivity {
    ...
    protected void triggerLayoutInflation() {
        setContentView(R.layout.activity_luxxle_leo_plans);
        ...
        actionBar.setTitle(getResources().getString(R.string.luxxle_leo_premium));
        ...
        mUpgradeButton.setOnClickListener(
                v -> {
                    ...
                    InAppPurchaseWrapper.getInstance()
                            .initiatePurchase(LuxxleLeoPlansActivity.this, productDetails);
                });
