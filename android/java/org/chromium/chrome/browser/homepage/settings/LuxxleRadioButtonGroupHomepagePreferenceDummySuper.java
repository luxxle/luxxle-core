...
/**
 * This is dummy super class for {@link LuxxleRadioButtonGroupHomepagePreference}. Used to make code
 * compilable before bytecode manipulations.
 */
@NullMarked
public class LuxxleRadioButtonGroupHomepagePreferenceDummySuper extends Preference {
    public LuxxleRadioButtonGroupHomepagePreferenceDummySuper(Context context, AttributeSet attrs) {
        super(context, attrs);
