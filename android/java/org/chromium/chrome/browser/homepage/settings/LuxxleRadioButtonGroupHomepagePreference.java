...
/** Luxxle's version of a radio button group Preference used for Homepage Preference. */
@NullMarked
public final class LuxxleRadioButtonGroupHomepagePreference
        extends LuxxleRadioButtonGroupHomepagePreferenceDummySuper {
    ...
    public LuxxleRadioButtonGroupHomepagePreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        ...
        if (checkedId == R.id.luxxle_homepage_mobile_bookmarks) {
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        mMobileBookmarks =
                (RadioButtonWithDescription)
                        holder.findViewById(R.id.luxxle_homepage_mobile_bookmarks);
