...
@NullMarked
public class LuxxleAdFreeCalloutDialogFragment extends LuxxleDialogFragment {
    private static final String TAG = "LuxxleAdFreeCallout";
