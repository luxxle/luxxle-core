...
public class LuxxleStatsTable {
    public static final String TABLE_NAME = "luxxle_stats_table";
    ...
    public LuxxleStatsTable(String url, String domain, String statType, String statSite, String statSiteDomain, String timestamp) {
        mUrl = url;
        mDomain = domain;
        mStatType = statType;
        mStatSite = statSite;
