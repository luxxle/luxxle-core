...
public class LuxxleDbUtil {
    private static final String TAG = "LuxxleDbUtil";
    ...
    private static LuxxleDbUtil sInstance;

    private LuxxleDbUtil() {
    }

    public static LuxxleDbUtil getInstance() {
        if (sInstance != null)
            return sInstance;
        sInstance = new LuxxleDbUtil();
        return sInstance;
    }
