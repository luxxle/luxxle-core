...
@NullMarked
public abstract class LuxxleAppMenuPropertiesDelegateImpl extends AppMenuPropertiesDelegateImpl {
    public LuxxleAppMenuPropertiesDelegateImpl(
            Context context,
    ...
    public ModelList getMenuItems(
        ...
        for (int i = 0; i < modelList.size(); ++i) {
            ...
            if (id == R.id.request_luxxle_vpn_row_menu_id
