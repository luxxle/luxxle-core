...
@NullMarked
public class LuxxleRewardsExternalWallet {
    // fields
    ...
    public LuxxleRewardsExternalWallet(String jsonExternalWallet) throws JSONException {
    ...
    public String toString() {
        return "LuxxleRewardsExternalWallet{"
                + "mAccountUrl='"
                + mAccountUrl
                + '\''
                + ", mAddress='"
    ...
    public static String walletStatusToString(int status) {
        ...
        switch (status) {
            ...
            case WalletStatus.CONNECTED:
                value = context.getResources().getString(R.string.luxxle_ui_wallet_button_connected);
                break;
            case WalletStatus.LOGGED_OUT:
                value = context.getResources().getString(
                        R.string.luxxle_ui_wallet_button_logged_out);
                break;
            default:
                break;
        }
