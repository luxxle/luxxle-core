...
public class LuxxleTabGroupUiCoordinator extends TabGroupUiCoordinator {
    ...
    public LuxxleTabGroupUiCoordinator(
        ...
        if (toolbarNewTabButton != null) {
            toolbarNewTabButton.setImageResource(R.drawable.luxxle_new_group_tab);
        }
    }
    ...
    public void initializeWithNative(
        ...
        // at LuxxleTabGroupUiCoordinator.initializeWithNative (LuxxleTabGroupUiCoordinator.java:97)
    ...
    public void destroy() {
        try {
            ...
            // https://github.com/luxxle/luxxle-browser/issues/40673
        }
    }
}
